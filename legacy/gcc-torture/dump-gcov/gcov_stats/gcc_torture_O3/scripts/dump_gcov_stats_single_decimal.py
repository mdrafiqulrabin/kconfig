...
path_all_c_gcov_files = "gcov_data/gcov_stats_all"
output_file = "gcov_data/gcov_stats_single/gcov_stats_single_decimal.tsv"
gcov_stats_zero = "gcov_data/gcov_stats_single/gcov_stats_zero.tsv"
...
result_binary_2d = getBinary2d(gcov_stats_zero)
