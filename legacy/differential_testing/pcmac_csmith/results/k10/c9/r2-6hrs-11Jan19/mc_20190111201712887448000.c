...
/* --- GLOBAL VARIABLES --- */
static const int16_t g_3 = 7;
static int32_t g_35 = 0x4981C586;
...
{ /* block id: 36 */
    ...
    int32_t *l_33 = (void*)0;
    int32_t *l_34 = &g_35;
    (*l_34) = (__builtin_ctzll(l_28) > __builtin_popcountll((((g_3 , g_3) ^ (__builtin_parityl((((l_29 <= g_3) > (safe_lshift_func_int16_t_s_s(((l_28 ^ g_3) || ((__builtin_popcount(g_3) < l_29) , l_28)), 4))) || l_28)) | 0x7B47E0FA)) < l_32)));
    return (*l_34);
}
