...
static int32_t g_34 = 0x4B064BAE;
static uint32_t g_35 = 0xC0E2632C;
...
/* 
 * reads : g_3 g_32 g_34
 * writes: g_32 g_33 g_34 g_35
 */
static int32_t  func_26(void)
{ /* block id: 36 */
    int32_t l_29 = 0x5F0B101A;
    g_32 = (safe_mod_func_int16_t_s_s(l_29, (safe_lshift_func_uint16_t_u_s(__builtin_ctzl(l_29), 0))));
    g_34 = (__builtin_ia32_crc32qi((g_33 = l_29), l_29) == g_32);
    g_35 = g_34;
    return l_29;
}
