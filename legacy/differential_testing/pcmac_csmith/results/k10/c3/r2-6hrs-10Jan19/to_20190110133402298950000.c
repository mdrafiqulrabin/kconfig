...
static int32_t g_29 = 0xDF2EF51A;
...
{ /* block id: 36 */
    int32_t *l_28 = &g_29;
    uint32_t l_32[6] = {4294967287U,4294967287U,4294967287U,4294967287U,4294967287U,4294967287U};
    int i;
lbl_33:
    (*l_28) = g_3;
    (*l_28) = ((safe_rshift_func_int16_t_s_u((*l_28), l_32[1])) != (g_3 , g_29));
    if (g_3)
        goto lbl_33;
    return (*l_28);
}
