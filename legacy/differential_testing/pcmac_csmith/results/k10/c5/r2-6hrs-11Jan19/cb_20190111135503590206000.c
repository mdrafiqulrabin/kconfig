...
static int32_t g_44 = 0x241A59C3;
...
/* 
 * reads : g_7 g_44 g_46
 * writes: g_42 g_45 g_46
 */
static uint32_t  func_28(void)
{ /* block id: 36 */
    int32_t l_29 = 0x11023DCD;
    int32_t l_36 = 0x664087A9;
    uint32_t l_43 = 0U;
    uint32_t l_47 = 4294967292U;
    l_47 ^= (l_29 ^ (safe_add_func_int32_t_s_s((safe_add_func_int32_t_s_s((g_7 >= l_29), (g_46 |= (safe_lshift_func_uint16_t_u_u((l_29 || (((g_45 = __builtin_ia32_crc32qi(l_36, (((g_7 , ((g_7 >= (((safe_sub_func_int16_t_s_s((g_7 != (safe_sub_func_int32_t_s_s(__builtin_ffsll((((((!(((g_42 = (0x3F36 >= (-3))) & l_43) , g_7)) <= 4294967286U) > g_7) ^ g_44) , l_36)), g_7))), g_44)) < g_7) && 65535U)) & l_29)) == 0x72A6DFE1) , g_44))) >= l_43) && 1)), 7))))), 0x5C1ED529)));
    return l_47;
}
