...
{ /* block id: 36 */
    ...
    int16_t l_42 = 1;
    int16_t l_43 = 0x5004;
    int32_t l_44 = 0xF8BA7967;
    for (g_3 = 0; (g_3 == 12); g_3 = safe_add_func_uint32_t_u_u(g_3, 1))
    { /* block id: 39 */
        l_31 = 0x3AB1943C;
        l_32 = 0x203BD652;
    }
    l_44 = (safe_unary_minus_func_uint16_t_u(((safe_lshift_func_int16_t_s_s(g_3, ((l_32 = (safe_rshift_func_int16_t_s_s(g_3, 7))) == __builtin_popcountl(l_31)))) & __builtin_bswap64((__builtin_ia32_crc32qi(g_3, ((safe_rshift_func_uint16_t_u_s(((((((g_3 < (((0x91C8 && ((safe_rshift_func_uint16_t_u_s(((__builtin_ffs(l_42) > g_3) , g_3), 9)) && l_31)) & g_3) || l_31)) | 0x550E) == l_42) | g_3) == 0xD9751230) > l_42), 11)) , l_43)) , 4294967295U)))));
    return g_3;
}
