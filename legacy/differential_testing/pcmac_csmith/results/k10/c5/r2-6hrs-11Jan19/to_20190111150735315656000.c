...
static uint32_t g_31 = 0xF4A41637;
...
/* 
 * reads : g_3 g_31 g_33
 * writes: g_3 g_31 g_32 g_33
 */
static int16_t  func_27(void)
{ /* block id: 36 */
    int32_t l_30 = 0x17E2F9D4;
lbl_36:
    for (g_3 = 19; (g_3 == 23); g_3 = safe_add_func_uint32_t_u_u(g_3, 3))
    { /* block id: 39 */
        g_31 ^= l_30;
    }
    g_32 = l_30;
