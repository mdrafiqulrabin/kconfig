...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_9 = 0xDE0B4074;
static int32_t g_36 = (-1);
static int32_t g_44 = 0x51FA4C82;
...
/* 
 * reads : g_9 g_36 g_44
 * writes: g_36 g_9 g_44
 */
static uint32_t  func_33(void)
{ /* block id: 36 */
    int16_t l_37 = (-5);
    l_37 &= (safe_lshift_func_uint16_t_u_s((g_36 = g_9), 12));
    for (g_36 = 0; (g_36 > (-10)); g_36 = safe_sub_func_uint16_t_u_u(g_36, 1))
    { /* block id: 41 */
        for (g_9 = 0; (g_9 > 32); g_9 = safe_add_func_uint32_t_u_u(g_9, 1))
        { /* block id: 44 */
            for (l_37 = (-11); (l_37 == (-12)); l_37 = safe_sub_func_uint16_t_u_u(l_37, 1))
            { /* block id: 47 */
                g_44 ^= g_36;
            }
        }
