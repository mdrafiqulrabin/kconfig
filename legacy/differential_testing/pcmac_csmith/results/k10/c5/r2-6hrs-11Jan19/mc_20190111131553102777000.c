...
{ /* block id: 36 */
    int16_t l_30 = (-6);
    g_32 |= (safe_mod_func_uint32_t_u_u(((l_30 == ((g_31 = __builtin_clz((l_30 > g_5))) == 0x3B288586)) && (((((__builtin_parity(g_5) || (g_31 & (4294967295U < g_31))) , (-1)) & l_30) >= g_31) , 0x780F885B)), 4294967295U));
    return l_30;
}
