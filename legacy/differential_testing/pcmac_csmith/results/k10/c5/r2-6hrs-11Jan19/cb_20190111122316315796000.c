...
static int32_t  func_26(void)
{ /* block id: 36 */
    int32_t l_27 = 0xEDCA8FEC;
    int32_t l_30 = (-5);
    int16_t l_33 = 0xD850;
    uint16_t l_37 = 65530U;
    int32_t l_38 = 2;
    l_38 = ((((__builtin_ia32_crc32qi(l_27, (safe_lshift_func_uint16_t_u_u((l_30 |= l_27), 4))) , (((((safe_add_func_uint16_t_u_u((l_33 == ((g_12 = __builtin_clzl(g_12)) ^ (safe_add_func_int16_t_s_s(l_30, (l_27 = g_36))))), l_37)) , g_36) , l_33) == l_33) <= l_33)) >= 1) , l_37) | l_38);
    return g_12;
}
