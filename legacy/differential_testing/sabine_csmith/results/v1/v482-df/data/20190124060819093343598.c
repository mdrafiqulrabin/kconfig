...
static int32_t g_6[6] = {0x1B66BAFCL,0x1B66BAFCL,0x1B66BAFCL,0x1B66BAFCL,0x1B66BAFCL,0x1B66BAFCL};
static uint32_t g_7 = 0x0815898FL;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 2; i++)
        l_5[i] = &l_4;
    --g_7;
    for (g_3 = (-6); (g_3 > (-16)); g_3 = safe_sub_func_int64_t_s_s(g_3, 1))
    { /* block id: 4 */
        return g_6[5];
    }
    return g_6[5];
