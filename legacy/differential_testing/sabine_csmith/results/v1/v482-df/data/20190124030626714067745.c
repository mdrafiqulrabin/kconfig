...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_5 = {-15649,-3L,0x44CAL,608,4511,3080,-12942,1,4929};/* VOLATILE GLOBAL g_5 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[6] = {4294967286UL,4294967286UL,4294967286UL,4294967286UL,4294967286UL,4294967286UL};
    int i;
    ++l_2[4];
    return g_5;
}
