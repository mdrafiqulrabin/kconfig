...
static union U1 g_11 = {1L};/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    int16_t l_9 = 0x182AL;
    int32_t l_10 = 0L;
    l_10 = ((safe_div_func_int16_t_s_s((safe_mul_func_uint8_t_u_u((g_6 != 1L), g_6)), (safe_mul_func_int16_t_s_s(g_6, l_9)))) && (l_9 < g_6));
    return g_11;
}
