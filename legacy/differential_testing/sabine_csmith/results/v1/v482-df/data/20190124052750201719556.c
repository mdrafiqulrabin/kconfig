...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_2 = {251UL,0xD9BA07E4L};/* VOLATILE GLOBAL g_2 */
static struct S0 * volatile g_3[1][2] = {{&g_2,&g_2}};
static struct S0 g_5 = {0UL,-10L};/* VOLATILE GLOBAL g_5 */
static struct S0 g_6 = {6UL,5L};/* VOLATILE GLOBAL g_6 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    struct S0 *l_4[9] = {&g_2,&g_2,&g_2,&g_2,&g_2,&g_2,&g_2,&g_2,&g_2};
    int i;
    g_5 = g_2;
    return g_6;
}
