...
static int8_t g_4[1][10] = {{1L,0x00L,0xBCL,0xBCL,0x00L,1L,0x00L,0xBCL,0xBCL,0x00L}};
static int32_t g_7 = 0xA1650187L;
static int32_t * volatile g_6[2] = {&g_7,&g_7};
