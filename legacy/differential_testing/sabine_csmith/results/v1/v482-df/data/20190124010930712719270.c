...
/* --- GLOBAL VARIABLES --- */
static int64_t g_3 = 0xDCDF5EF889A278C0LL;
static int32_t g_5[1][1][6] = {{{0x2189F42CL,0x2189F42CL,0x2189F42CL,0x2189F42CL,0x2189F42CL,0x2189F42CL}}};
...
{ /* block id: 0 */
    ...
    (*l_4) &= (0xD7D711E7BFF44CACLL < ((*l_2) = (-9L)));
    return g_3;
}
