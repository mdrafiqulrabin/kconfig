...
static volatile int32_t g_5[3][3] = {{7L,0x3D837BC7L,7L},{7L,0x3D837BC7L,7L},{7L,0x3D837BC7L,7L}};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        for (g_6 = 0; (g_6 != (-9)); g_6 = safe_sub_func_int8_t_s_s(g_6, 9))
        { /* block id: 6 */
            if (g_5[1][0])
                break;
        }
    }
    for (g_2 = (-14); (g_2 >= (-15)); --g_2)
    { /* block id: 12 */
        return g_5[1][0];
    }
    return l_11;
