...
static int32_t  func_27(void)
{ /* block id: 36 */
    uint32_t l_34 = 0x56810853;
    int32_t *l_35 = &g_36;
    int32_t *l_37 = &g_38;
    (*l_37) = (((safe_add_func_uint32_t_u_u(((safe_sub_func_int32_t_s_s((safe_add_func_uint32_t_u_u(4294967294U, l_34)), 0x14CD4959)) ^ ((*l_35) = (__builtin_ctzl(l_34) ^ 0x1E1C5A3D))), (2 > ((g_3 && (g_3 == g_3)) == l_34)))) > g_3) < g_3);
    return g_38;
}
