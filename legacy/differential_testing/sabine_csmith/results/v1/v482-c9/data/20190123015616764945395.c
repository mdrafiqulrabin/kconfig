...
static int32_t g_35 = 0x23E52509;
...
/* ------------------------------------------ */
/* 
 * reads : g_26 g_27 g_4 g_38
 * writes: g_26 g_27 g_35 g_38
 */
static int16_t  func_25(void)
{ /* block id: 36 */
    int16_t l_30 = (-1);
    g_26 = g_26;
    for (g_27 = 2; (g_27 == 7); g_27 = safe_add_func_int32_t_s_s(g_27, 1))
    { /* block id: 40 */
        int32_t l_32 = 0xEE34EDF6;
        int32_t *l_33 = (void*)0;
        int32_t *l_34 = &g_35;
        int32_t *l_36 = (void*)0;
        int32_t *l_37 = &g_38;
        (*l_37) &= ((__builtin_popcountl(l_30) < g_4) >= ((*l_34) = (safe_unary_minus_func_uint16_t_u(l_32))));
    }
    for (g_38 = 0; (g_38 < (-13)); g_38 = safe_sub_func_uint16_t_u_u(g_38, 5))
    { /* block id: 46 */
        int32_t l_41 = (-7);
        return l_41;
    }
