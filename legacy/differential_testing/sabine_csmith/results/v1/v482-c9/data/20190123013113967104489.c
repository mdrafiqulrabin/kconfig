...
static uint16_t g_20 = 0x4173;
static uint16_t g_32 = 9U;
static int32_t g_34 = 0xCF04B064;
...
/* ------------------------------------------ */
/* 
 * reads : g_20 g_8 g_34 g_32
 * writes: g_32 g_34
 */
static const uint32_t  func_29(void)
{ /* block id: 36 */
    uint32_t l_30 = 0xEFA5F9C7;
    uint16_t *l_31 = &g_32;
    int32_t *l_33 = &g_34;
    const int32_t l_35 = 0xB641B44A;
    (*l_33) ^= ((g_20 >= (((*l_31) = l_30) , (&g_32 == (void*)0))) >= g_8);
    (*l_33) |= (g_32 ^ 2);
    return l_35;
}
