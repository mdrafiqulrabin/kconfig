...
static uint32_t g_36 = 4294967286U;
...
{ /* block id: 36 */
    ...
    (*l_37) |= (safe_sub_func_uint16_t_u_u((__builtin_bswap32(g_3) != (l_31 > g_3)), ((((((safe_rshift_func_uint16_t_u_u(l_30, l_31)) | (g_36 &= 0x814B11F3)) , __builtin_ctzl(g_3)) <= g_3) != g_3) | l_31)));
    (*l_39) = (void*)0;
    g_41 = &g_38;
    return g_3;
}
