...
/* --- GLOBAL VARIABLES --- */
static int32_t g_7 = 0x97EEDE0B;
static uint32_t g_34 = 0xE1C5A3D7;
...
static const uint32_t  func_31(void)
{ /* block id: 36 */
    uint32_t l_32 = 0xFA3DFAD5;
    uint32_t *l_33 = &g_34;
    int32_t *l_49 = &g_7;
    (*l_49) = (((((*l_33) = l_32) , l_32) != (safe_add_func_int32_t_s_s((l_32 , 0xB43D2717), (safe_lshift_func_int16_t_s_u((safe_mod_func_int32_t_s_s(l_32, (safe_rshift_func_uint16_t_u_u((safe_add_func_int16_t_s_s(g_7, g_7)), ((safe_sub_func_int32_t_s_s(g_7, (safe_lshift_func_uint16_t_u_s((9U <= l_32), 13)))) || 0x91C84132))))), g_7))))) && l_32);
    return g_34;
}
