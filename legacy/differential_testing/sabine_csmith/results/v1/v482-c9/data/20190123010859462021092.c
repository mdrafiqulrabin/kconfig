...
{ /* block id: 36 */
    ...
    int16_t *l_29 = (void*)0;
    int16_t *l_30 = &g_4;
    const int32_t l_33 = 0xAA9DADE6;
    int32_t l_39 = 1;
    uint32_t l_44 = 0x76C56D20;
    if ((((*l_30) = 1) != (safe_lshift_func_uint16_t_u_s(0x83DC, 14))))
    { /* block id: 38 */
        return l_33;
    }
    else
    { /* block id: 40 */
        int32_t l_36 = 0;
        int32_t *l_42 = &l_39;
        (*l_42) = (((&g_4 == (void*)0) , (safe_sub_func_int16_t_s_s(((((g_4 < l_36) || (safe_mod_func_int32_t_s_s(((l_39 >= (safe_sub_func_uint32_t_u_u((l_36 == g_4), __builtin_clzl(l_36)))) && g_4), g_4))) , l_33) ^ g_4), g_4))) == g_4);
        (*l_42) = (safe_unary_minus_func_uint16_t_u(l_44));
        (*l_42) &= 0x45E2138B;
    }
    return g_4;
}
