...
static int16_t g_34 = 0xFA3D;
static int32_t g_39 = 0xCA7B5CF1;
...
{ /* block id: 36 */
    ...
    int32_t *l_37 = (void*)0;
    int32_t *l_38 = &g_39;
    (*l_31) = ((safe_mod_func_int32_t_s_s(l_30, 0x66D210EC)) > l_30);
    for (g_3 = 0; (g_3 < (-12)); g_3 = safe_sub_func_uint16_t_u_u(g_3, 1))
    { /* block id: 40 */
        g_34 &= g_3;
    }
    (*l_38) ^= (safe_rshift_func_uint16_t_u_u(g_3, 13));
    return g_39;
}
