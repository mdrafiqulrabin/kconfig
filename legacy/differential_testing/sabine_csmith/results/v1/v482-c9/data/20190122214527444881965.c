...
{ /* block id: 36 */
    ...
    uint16_t *l_29 = &g_30;
    int32_t *l_37 = &g_5;
    (*l_37) = (((((*l_29) |= l_28) > ((0xDC41 < (-5)) < ((g_5 >= 0) | (0x3BD5DE1F && (safe_rshift_func_uint16_t_u_u(0xD850, 7)))))) < (safe_sub_func_uint16_t_u_u(0U, (safe_add_func_uint16_t_u_u(l_28, 1U))))) || 0xD967);
    return (*l_37);
}
