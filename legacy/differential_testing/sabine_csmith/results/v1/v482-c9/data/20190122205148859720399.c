...
static int32_t g_37 = 0x07383CC4;
...
static int32_t  func_26(void)
{ /* block id: 36 */
    int32_t l_31 = 0x49D585ED;
    int32_t *l_38 = &g_39;
    (*l_38) ^= (safe_lshift_func_uint16_t_u_u(func_29(l_31), 10));
    return (*l_38);
}
...
static uint16_t  func_29(int16_t  p_30)
{ /* block id: 37 */
    uint32_t l_36 = 0xB2E4145C;
    g_37 ^= (safe_rshift_func_int16_t_s_u((safe_lshift_func_uint16_t_u_s(l_36, 7)), 7));
    return l_36;
}
