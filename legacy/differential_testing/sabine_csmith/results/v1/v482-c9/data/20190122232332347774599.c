...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_3 = 0x03342EB9;
...
static int32_t  func_26(void)
{ /* block id: 36 */
    uint32_t l_34 = 0x4B0B4EF6;
    for (g_27 = 0; (g_27 == (-21)); g_27 = safe_sub_func_uint16_t_u_u(g_27, 1))
    { /* block id: 39 */
        int32_t *l_32 = &g_33;
        (*l_32) = (safe_mod_func_uint16_t_u_u(g_27, g_3));
    }
    return l_34;
}
