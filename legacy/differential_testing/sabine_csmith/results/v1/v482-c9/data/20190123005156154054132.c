...
static int32_t g_29 = 0xC312FBB6;
...
static int32_t  func_26(void)
{ /* block id: 36 */
    int32_t l_34 = 0x32FD2D1A;
    for (g_3 = 0; (g_3 <= 11); g_3 = safe_add_func_int16_t_s_s(g_3, 8))
    { /* block id: 39 */
        for (g_29 = 0; (g_29 != 18); g_29 = safe_add_func_uint16_t_u_u(g_29, 1))
        { /* block id: 42 */
            int32_t *l_32 = &g_33;
            (*l_32) ^= 1;
        }
