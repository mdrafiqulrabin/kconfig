...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_5 = 0x25E7A66F;
static int32_t g_35 = 0x9C2D621E;
...
/* ------------------------------------------ */
/* 
 * reads : g_34 g_35 g_40
 * writes: g_34 g_35 g_40
 */
static uint32_t  func_31(void)
{ /* block id: 36 */
    int32_t **l_36 = &g_34;
    int32_t *l_39 = &g_40;
    (*l_36) = func_32(g_34);
    (*l_39) = ((*g_34) = (g_35 <= (safe_sub_func_int32_t_s_s((*g_34), (*g_34)))));
    return g_40;
}
