...
/* --- GLOBAL VARIABLES --- */
static const uint32_t g_3 = 0x11F7E279;
...
{ /* block id: 36 */
    int16_t l_29 = 0xE34B;
    for (g_26 = (-14); (g_26 >= (-16)); g_26 = safe_sub_func_int32_t_s_s(g_26, 9))
    { /* block id: 39 */
        return l_29;
    }
    for (g_26 = (-17); (g_26 == (-10)); g_26 = safe_add_func_int32_t_s_s(g_26, 2))
    { /* block id: 44 */
        int16_t l_32 = 1;
        return l_32;
    }
