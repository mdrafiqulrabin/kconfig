...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_3 = 5;
static int32_t g_30 = 0xA9C21324;
static uint32_t g_33 = 0x8D303F02;
...
{ /* block id: 36 */
    int16_t l_28 = (-1);
    int32_t *l_29 = &g_30;
    (*l_29) = (safe_mod_func_int16_t_s_s(g_3, l_28));
    for (g_30 = 29; (g_30 != 0); g_30 = safe_sub_func_uint16_t_u_u(g_30, 1))
    { /* block id: 40 */
        g_33 = g_30;
    }
    return (*l_29);
