...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_10 = 0x0647DC4B;
...
/* ------------------------------------------ */
/* 
 * reads : g_26 g_10 g_35
 * writes: g_26 g_10 g_35
 */
static uint32_t  func_25(void)
{ /* block id: 36 */
    uint16_t l_33 = 0xDD01;
    int32_t *l_34 = &g_35;
    g_26 = 0xE2A8D3A1;
    for (g_26 = 0; (g_26 < 23); g_26 = safe_add_func_int32_t_s_s(g_26, 1))
    { /* block id: 40 */
        for (g_10 = 0; (g_10 > 42); g_10 = safe_add_func_int16_t_s_s(g_10, 3))
        { /* block id: 43 */
            if (g_10)
                break;
        }
        for (g_10 = 0; (g_10 == 32); g_10 = safe_add_func_uint32_t_u_u(g_10, 1))
        { /* block id: 48 */
            return g_26;
        }
    }
