...
/* 
 * reads : g_7 g_47
 * writes: g_7 g_41 g_42 g_47
 */
static int32_t  func_29(void)
{ /* block id: 36 */
    uint32_t l_48 = 0xDA7209C3;
    for (g_7 = 21; (g_7 != (-14)); g_7 = safe_sub_func_uint16_t_u_u(g_7, 1))
    { /* block id: 39 */
        uint16_t l_39 = 1U;
        int16_t *l_40 = &g_41;
        int32_t *l_45 = (void*)0;
        int32_t *l_46 = &g_47;
        (*l_46) |= (func_32((g_42 = ((*l_40) = (safe_sub_func_uint32_t_u_u(g_7, (safe_sub_func_int16_t_s_s(l_39, l_39)))))), (safe_lshift_func_int16_t_s_u(g_7, 8))) || l_39);
    }
    return l_48;
}
