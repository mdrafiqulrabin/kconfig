...
lbl_8:
    (*l_3) = (void*)0;
    for (g_5 = 0; (g_5 != 18); g_5 = safe_add_func_int32_t_s_s(g_5, 9))
    { /* block id: 4 */
        if (g_5)
            break;
    }
