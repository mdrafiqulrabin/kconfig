...
/* --- GLOBAL VARIABLES --- */
static struct S2 g_3 = {7,4091};
static volatile int32_t g_6 = 0x6E483BBBL;/* VOLATILE GLOBAL g_6 */
static volatile uint64_t g_7 = 18446744073709551610UL;/* VOLATILE GLOBAL g_7 */
