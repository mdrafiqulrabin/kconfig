...
{ /* block id: 0 */
    uint32_t l_4 = 0U;
    struct S1 l_5 = {4294967295U,{-9,0xD8AF,0x716B5B38},3U,0x28D5FEAF,0x6F25,0,0x058EFA97,{0x51EF9953,-2,4294967287U},0x8AAB5641,0xD7FEAE21};
    l_4 = ((uint16_t)0x09E7 >> (uint16_t)11);
    return l_5;
}
