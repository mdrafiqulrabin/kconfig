...
static int32_t g_25[5][10] = {{(-4L),2L,(-1L),1L,(-1L),2L,(-4L),1L,0L,0x7E44142BL},{1L,0L,0x39C7C6F1L,1L,(-4L),(-4L),1L,0x39C7C6F1L,0L,1L},{0xDBD0176DL,0L,0L,(-1L),1L,0x7E44142BL,(-4L),0x7E44142BL,1L,(-1L)},{(-1L),2L,(-1L),0L,1L,8L,1L,(-1L),(-1L),1L},{1L,(-4L),8L,8L,(-4L),1L,0L,1L,1L,0L}};
...
inline static int32_t  func_23(void)
{ /* block id: 36 */
    int32_t *l_24 = &g_25[1][2];
    int32_t *l_26 = &g_25[1][5];
    int32_t *l_27 = &g_25[4][5];
    int32_t *l_28 = &g_25[2][4];
    int32_t *l_29 = &g_25[1][2];
    int32_t l_30[5] = {1L,1L,1L,1L,1L};
    int32_t *l_31 = &g_25[0][1];
    int32_t *l_32 = (void*)0;
    int32_t *l_33 = &l_30[3];
    int32_t *l_34 = &l_30[1];
    int32_t *l_35 = (void*)0;
    int32_t *l_36[4] = {&g_25[0][9],&g_25[0][9],&g_25[0][9],&g_25[0][9]};
    uint32_t l_37 = 0xD9532955L;
    int i;
    l_37--;
    return g_25[2][7];
}
