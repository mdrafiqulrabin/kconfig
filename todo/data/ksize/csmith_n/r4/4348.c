...
/* --- GLOBAL VARIABLES --- */
static float g_11 = 0x0.Fp-1;
static uint32_t g_19 = 4294967295UL;
static int8_t g_34[6][1] = {{0x8CL},{0x8CL},{0x8CL},{0x8CL},{0x8CL},{0x8CL}};
static int8_t *g_36 = &g_34[4][0];
...
inline static uint16_t  func_31(void)
{ /* block id: 36 */
    int8_t *l_33 = &g_34[3][0];
    int8_t **l_32 = &l_33;
    int32_t l_37 = 1L;
    g_35 = ((((*l_32) = (void*)0) != (void*)0) , (void*)0);
    /* statement id: 38 */
    assert (l_33 == 0);
    assert (g_35 == 0);
    return l_37;
