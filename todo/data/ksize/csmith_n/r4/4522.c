...
/* --- GLOBAL VARIABLES --- */
static int8_t g_3 = 0x5BL;
static int32_t g_40[2][10] = {{(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L)}};


/* --- FORWARD DECLARATIONS --- */
static float  func_25(void);
inline static uint16_t  func_28(int8_t  p_29, const int32_t  p_30, int16_t  p_31);
...
static float  func_25(void)
{ /* block id: 36 */
    const int64_t l_32[6] = {1L,1L,1L,1L,1L,1L};
    int i;
    for (g_3 = 0; (g_3 != (-20)); g_3--)
    { /* block id: 39 */
        uint32_t l_33 = 1UL;
        int32_t *l_39 = &g_40[1][2];
        (*l_39) &= (func_28(g_3, l_32[1], l_33) >= 0UL);
    }
    return g_40[1][5];
}
...
{ /* block id: 40 */
    uint8_t l_38 = 246UL;
    for (p_29 = (-3); (p_29 == 22); p_29 = safe_add_func_int16_t_s_s(p_29, 4))
    { /* block id: 43 */
        for (p_31 = (-11); (p_31 != (-12)); p_31 = safe_sub_func_uint8_t_u_u(p_31, 1))
        { /* block id: 46 */
            return l_38;
        }
    }
