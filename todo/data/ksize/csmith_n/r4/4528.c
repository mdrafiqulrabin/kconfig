...
/* --- GLOBAL VARIABLES --- */
static float g_3 = 0x6.8p+1;
static uint8_t g_10 = 255UL;
static int32_t g_31 = 0x5C8100C4L;
...
inline static uint8_t  func_29(void)
{ /* block id: 36 */
    int8_t l_30[8][3] = {{0x17L,0x17L,0x17L},{0x7AL,0x7AL,0x7AL},{0x17L,0x17L,0x17L},{0x7AL,0x7AL,0x7AL},{0x17L,0x17L,0x17L},{0x7AL,0x7AL,0x7AL},{0x17L,0x17L,0x17L},{0x7AL,0x7AL,0x7AL}};
    int i, j;
