...
/* --- GLOBAL VARIABLES --- */
static int8_t g_3[10] = {0xB3L,0xB3L,0xB3L,0xB3L,0xB3L,0xB3L,0xB3L,0xB3L,0xB3L,0xB3L};
...
{ /* block id: 36 */
    int32_t *l_29 = &g_30;
    int32_t l_34[7] = {6L,6L,8L,6L,6L,8L,6L};
    int i;
    (*l_29) ^= 0x7689A5A4L;
    (*l_29) = (((~__builtin_ffs((*l_29))) <= (safe_sub_func_int16_t_s_s(g_3[8], g_30))) >= l_34[3]);
    return g_30;
}
