...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_11 = 0x1FL;
static uint32_t g_24[1] = {0xC6FE23A2L};
static int32_t g_35[1][10][6] = {{{0xDD93BA6AL,1L,(-1L),1L,0xDD93BA6AL,0xE491BA6BL},{0L,1L,(-7L),1L,1L,1L},{0L,0L,0L,1L,(-7L),1L},{0xDD93BA6AL,0xE491BA6BL,(-7L),6L,(-7L),0xE491BA6BL},{(-7L),0L,(-1L),6L,1L,1L},{0xDD93BA6AL,1L,(-1L),1L,0xDD93BA6AL,0xE491BA6BL},{0L,1L,(-7L),1L,1L,1L},{0L,0L,0L,1L,0L,6L},{(-7L),1L,0L,0L,0L,1L},{0L,0xE491BA6BL,1L,0L,0xDD93BA6AL,1L}}};
...
{ /* block id: 36 */
    int32_t *l_33 = (void*)0;
    int32_t *l_34 = &g_35[0][3][3];
    int32_t *l_36 = &g_35[0][4][5];
    int32_t *l_37 = &g_35[0][2][3];
    int32_t *l_38[4] = {&g_35[0][3][2],&g_35[0][3][2],&g_35[0][3][2],&g_35[0][3][2]};
    int32_t l_39 = (-1L);
    uint64_t l_40 = 0xA3418EB0BADCAB39LL;
    int i;
    l_40++;
    return g_24[0];
}
