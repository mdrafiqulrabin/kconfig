...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_10 = 0xDA8E97EEDE0B4074LL;
...
/* 
 * reads : g_27
 * writes: g_10 g_26 g_27
 */
inline static int16_t  func_24(void)
{ /* block id: 36 */
    float l_25[2][5][4] = {{{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1}},{{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1},{0x1.3p+1,0x1.3p+1,0x1.3p+1,0x1.3p+1}}};
    int i, j, k;
