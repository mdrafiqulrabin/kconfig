...
static union U0  func_28(void)
{ /* block id: 36 */
    int32_t l_29 = 0x683648BDL;
    int32_t l_37 = 1L;
    int32_t l_38 = 0xA19820B2L;
    int32_t l_39 = 0xDBAF9EB1L;
    int32_t l_40 = (-5L);
    int32_t l_41 = 0xA0CEC519L;
    uint32_t l_42 = 0x885B3D92L;
    union U0 l_45 = {0xC417L};
    for (l_29 = (-4); (l_29 != (-29)); l_29--)
    { /* block id: 39 */
        int32_t l_33 = 0xD13D8C53L;
        int32_t *l_32 = &l_33;
        int32_t *l_34 = (void*)0;
        int32_t *l_35 = &l_33;
        int32_t *l_36[9] = {&l_33,&l_33,&l_33,&l_33,&l_33,&l_33,&l_33,&l_33,&l_33};
        int i;
        ++l_42;
        (*l_32) = (-7L);
        (*l_35) &= l_29;
