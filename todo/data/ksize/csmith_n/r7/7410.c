...
{ /* block id: 36 */
    ...
    int32_t *l_36 = &l_30;
    int32_t *l_37 = &l_30;
    int32_t *l_38[4] = {&l_30,&l_30,&l_30,&l_30};
    uint32_t l_39 = 1UL;
    uint32_t l_47 = 0xDA84ADE7L;
    int i;
    l_39++;
    (*l_33) = (safe_unary_minus_func_int16_t_s(__builtin_clz((safe_lshift_func_uint8_t_u_u((*l_36), (safe_rshift_func_uint8_t_u_s((*l_37), 7)))))));
    return l_47;
}
