...
{ /* block id: 0 */
    ...
    uint16_t l_11 = 0U;
    int16_t l_12 = 0xB0BF;
    int32_t l_13 = 0xD9827359;
    int32_t l_14 = 0x562B994B;
    l_13 = (l_2 > ((int16_t)((l_2 <= (l_2 , ((int16_t)(l_2 < (l_2 || (l_2 | ((uint16_t)((uint16_t)l_11 >> (uint16_t)2) >> (uint16_t)12)))) + (int16_t)l_12))) | (l_12 < l_11)) >> (int16_t)l_12));
    l_13 = l_2;
    l_14 = (l_13 = 0x63069BE5);
    return l_11;
}
