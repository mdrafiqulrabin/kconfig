...
{ /* block id: 0 */
    int32_t l_2[2];
    int32_t l_9 = (-7L);
    int32_t l_10 = 0x06695998L;
    int32_t l_11 = 0x670012AFL;
    int32_t l_12 = 1L;
    int32_t l_13 = 0L;
    int32_t l_14[3][1];
    float l_15 = 0x7.F49DCBp-65;
    int8_t l_18[9] = {0x13L,0xFFL,0x13L,0x13L,0xFFL,0x13L,0x13L,0xFFL,0x13L};
    uint8_t l_19 = 1UL;
    int i, j;
    for (i = 0; i < 2; i++)
        l_2[i] = 0x57FD5464L;
    ...
    for (l_2[1] = 11; (l_2[1] == (-10)); l_2[1]--)
    { /* block id: 3 */
        int32_t l_6[1];
        int32_t *l_5 = &l_6[0];
        int32_t *l_7 = &l_6[0];
        int32_t *l_8[6] = {&l_2[1],&l_2[1],&l_2[1],&l_2[1],&l_2[1],&l_2[1]};
        int32_t l_16 = 0L;
        int16_t l_17 = 0L;
        int i;
        for (i = 0; i < 1; i++)
