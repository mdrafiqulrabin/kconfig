...
static int64_t g_39 = 0x28405CEFD06BDE64LL;
static int32_t g_40 = 0x7A81A82EL;
...
static uint64_t  func_29(void)
{ /* block id: 36 */
    uint16_t l_32[8] = {1UL,1UL,1UL,1UL,1UL,1UL,1UL,1UL};
    uint16_t l_41 = 0x5EBDL;
    int i;
    for (g_9 = 0; (g_9 != (-24)); g_9 = safe_sub_func_uint64_t_u_u(g_9, 6))
    { /* block id: 39 */
        int8_t l_37 = 0x92L;
        --l_32[1];
        if (g_9)
            break;
        l_37 &= (0xCEL & (safe_lshift_func_int8_t_s_u(g_9, 5)));
    }
    ++l_41;
    return g_9;
}
