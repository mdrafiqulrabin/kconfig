...
/* --- GLOBAL VARIABLES --- */
static int8_t g_12 = 0xDBL;
static volatile int32_t g_39 = 0x4FF5452FL;/* VOLATILE GLOBAL g_39 */
...
/* ------------------------------------------ */
/* 
 * reads : g_38 g_12 g_39 g_41
 * writes: g_38
 */
inline static uint16_t  func_30(void)
{ /* block id: 36 */
    const uint32_t l_35 = 0xF4F23013L;
    int32_t *l_40 = &g_41;
    g_38 = (((safe_rshift_func_int8_t_s_u((safe_sub_func_int64_t_s_s(l_35, (l_35 && 0UL))), (((safe_lshift_func_uint8_t_u_u((g_38 == l_40), g_12)) , (safe_rshift_func_uint8_t_u_u((safe_lshift_func_int16_t_s_u(((g_39 || (safe_mod_func_uint16_t_u_u(((*l_40) > 0xBCL), g_41))) < g_41), 6)), 7))) , g_39))) & (*l_40)) , (void*)0);
    /* statement id: 37 */
    assert (g_38 == 0);
    return g_12;
}
