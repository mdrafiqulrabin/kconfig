...
static struct S1 g_30 = {-1L};/* VOLATILE GLOBAL g_30 */
static uint16_t g_36 = 9UL;
static int32_t g_40 = 0xB2D3650DL;
...
inline static const uint16_t  func_28(void)
{ /* block id: 36 */
    int64_t l_29 = 0xB79DF9481F3403CALL;
    uint16_t *l_35 = &g_36;
    int32_t *l_39 = &g_40;
    (*l_39) = (__builtin_ffs(l_29) != ((g_30 , l_29) , ((safe_add_func_uint8_t_u_u(0UL, (g_5 || (safe_mod_func_uint16_t_u_u(((*l_35)++), g_30.f0))))) || 1UL)));
    return g_5;
}
