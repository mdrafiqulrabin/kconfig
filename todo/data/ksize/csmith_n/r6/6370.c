...
static struct S3 g_8 = {4725,-1953,21022,{0x86FF18EE85EC4150LL,0x1.Cp+1,249UL,0x19L,0x314E764939E63A5BLL,0xD857289CL}};/* VOLATILE GLOBAL g_8 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_8.f3.f1, sizeof(g_8.f3.f1), "g_8.f3.f1", print_hash_value);
