...
{ /* block id: 36 */
    int64_t l_31 = (-9L);
    int32_t l_33[4][8] = {{2L,2L,2L,2L,2L,2L,2L,2L},{2L,2L,2L,2L,2L,2L,2L,2L},{2L,2L,2L,2L,2L,2L,2L,2L},{2L,2L,2L,2L,2L,2L,2L,2L}};
    int32_t *l_32 = &l_33[3][1];
    float l_34 = 0x7.76270Ep+9;
    uint32_t l_35 = 0x77C422D5L;
    int i, j;
    (*l_32) = l_31;
    return l_35;
}
