...
static uint64_t  func_31(void)
{ /* block id: 36 */
    int32_t l_33[6][2][4] = {{{0L,9L,(-4L),(-4L)},{5L,5L,0L,(-4L)}},{{(-1L),9L,(-1L),0L},{(-1L),0L,0L,(-1L)}},{{5L,0L,(-4L),0L},{0L,9L,(-4L),(-4L)}},{{5L,5L,0L,(-4L)},{(-1L),9L,(-1L),0L}},{{(-1L),0L,0L,(-1L)},{5L,0L,(-4L),0L}},{{0L,9L,(-4L),(-4L)},{5L,5L,(-1L),9L}}};
    const int32_t *l_32 = &l_33[3][1][3];
    int32_t *l_35 = &l_33[4][1][0];
    int32_t **l_34 = &l_35;
    int8_t l_36 = 0xDDL;
    int i, j, k;
    (*l_34) = l_32;
