...
{ /* block id: 0 */
    ...
    int32_t *l_3 = &l_4;
    int32_t *l_18 = (void*)0;
    int32_t l_19 = 0x1F3813BFL;
    uint16_t l_20 = 65528UL;
    (*l_3) = l_2;
    l_19 ^= (safe_lshift_func_int8_t_s_u((safe_rshift_func_uint16_t_u_u((((*l_3) <= ((*l_3) > (&l_4 != &l_4))) & (safe_lshift_func_uint8_t_u_s((((0x97L || (((func_15((*l_3)) || func_15((&l_4 == (void*)0))) || (*l_3)) | 0L)) != (*l_3)) <= (*l_3)), 7))), 12)), (*l_3)));
    (*l_3) = (*l_3);
    return l_20;
}
