...
{ /* block id: 0 */
    ...
    int32_t l_7 = 0x035C5735;
    int32_t l_8 = 0x8A94B2AB;
    int16_t l_9 = 1;
    int32_t l_16 = 5;
    l_16 = (l_2 | ((uint16_t)((uint32_t)l_2 + (uint32_t)(((l_8 = (l_7 = 1)) <= (((l_2 && (l_9 < (((l_2 ^ ((int32_t)l_2 + (int32_t)0xC3825062)) , (((int32_t)((uint16_t)65535U - (uint16_t)l_9) + (int32_t)l_2) , l_9)) ^ 4294967295U))) <= l_9) , l_9)) , 0)) << (uint16_t)4));
    return l_9;
}
