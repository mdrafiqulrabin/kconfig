...
{ /* block id: 0 */
    int32_t l_4 = 3;
    int32_t l_11 = 3;
    int32_t l_12 = 0xCEFFB91E;
    uint16_t l_13 = 65535U;
    int32_t l_14 = 0x11B9C6FE;
    int32_t l_15 = (-5);
    int32_t l_16 = 0xEC7E318B;
    int32_t l_17 = 0xAD7BA966;
    struct S0 l_18 = {2U};
    l_16 = (((((((uint16_t)l_4 >> (uint16_t)7) == ((l_15 = ((((uint16_t)0U << (uint16_t)6) && (l_14 = (l_13 = (((int16_t)((uint16_t)(l_12 = (0x5A63A74A <= (l_11 = 0x855EEC80))) << (uint16_t)l_4) - (int16_t)l_4) , l_12)))) & l_4)) , ((l_16 != l_14) , l_13))) > l_17) & l_17) != 0x6C8A81D5) ^ 0x9DCB);
    return l_18;
}
