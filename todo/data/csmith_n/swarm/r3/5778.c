 ...
 * Git version: 30dccd7
 * Options:   --argc --arrays --bitfields --comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --pre-incr-operator --pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --int8 --uint8 --float --math64 --inline-function --no-muls --safe-math --packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --no-volatile-pointers --no-const-pointers --global-variabless --no-builtins
 * Seed:      1587476714
 */
...
/* --- GLOBAL VARIABLES --- */
static const uint32_t g_5 = 0x17F75960;
static float g_7 = (-0x10.Ep+1);
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0xBA394643;
    float *l_6 = &g_7;
    int32_t *l_8 = &l_4;
    (*l_6) = (safe_add_func_float_f_f(l_4, (l_4 >= g_5)));
    (*l_8) = g_5;
    return g_5;
}
