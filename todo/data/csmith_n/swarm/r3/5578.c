 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --no-bitfields --no-comma-operators --compound-assignment --consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --uint8 --float --math64 --inline-function --muls --no-safe-math --packed-struct --no-paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      4030168046
 */
...
static int32_t  func_32(void)
{ /* block id: 36 */
    int32_t l_34 = 0xB5486B6FL;
    int32_t *l_33 = &l_34;
    int32_t **l_35 = (void*)0;
    int32_t **l_36 = &l_33;
    int16_t l_37 = 0x4891L;
    (*l_36) = l_33;
    (**l_36) = __builtin_ffsl((*l_33));
    return l_37;
}
