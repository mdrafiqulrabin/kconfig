...
static int16_t  func_29(void)
{ /* block id: 36 */
    for (g_3 = 10; (g_3 != 5); g_3 = safe_sub_func_uint16_t_u_u(g_3, 5))
    { /* block id: 39 */
        if (g_3)
            break;
    }
