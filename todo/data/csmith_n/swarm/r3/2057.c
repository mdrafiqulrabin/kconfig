...
static int32_t  func_33(void)
{ /* block id: 36 */
    int32_t l_34 = 0xF0244C3FL;
    for (l_34 = 0; (l_34 == 9); l_34 += 4)
    { /* block id: 39 */
        return l_34;
    }
    return l_34;
