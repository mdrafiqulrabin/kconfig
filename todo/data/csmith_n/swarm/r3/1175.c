...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_5 = 0xDAL;
static uint16_t g_33 = 0x4307L;
...
static uint16_t  func_29(void)
{ /* block id: 36 */
    int32_t l_32 = 0x10977A12L;
    int32_t l_36 = 4L;
    g_33 = (safe_lshift_func_int16_t_s_u(l_32, 5));
    l_36 = (safe_lshift_func_int16_t_s_s(0xFAA3L, 15));
    return g_33;
}
