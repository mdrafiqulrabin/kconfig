...
{ /* block id: 0 */
    int32_t l_2 = (-1);
    for (l_2 = 0; (l_2 != 27); l_2 = safe_add_func_uint32_t_u_u(l_2, 1))
    { /* block id: 3 */
        int32_t *l_6 = (void*)0;
        int32_t **l_5 = &l_6;
        (*l_5) = (void*)0;
