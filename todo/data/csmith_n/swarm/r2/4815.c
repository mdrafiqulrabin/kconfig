...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_9 = 0x8BAC04EE;
...
{ /* block id: 36 */
    int8_t l_28 = 0xDF;
    l_28 = 0;
    for (l_28 = 0; (l_28 != 14); l_28 = safe_add_func_uint32_t_u_u(l_28, 7))
    { /* block id: 40 */
        return l_28;
    }
    return g_9;
