...
inline static int16_t  func_27(void)
{ /* block id: 36 */
    int32_t l_28 = 0x07182B47;
    int32_t *l_34[2][3] = {{(void*)0,&l_28,(void*)0},{(void*)0,&l_28,(void*)0}};
    ...
    for (i = 0; i < 1; i = i + 1)
    {
        ...
        {
            for (k = 0; k < 2; k = k + 1)
                l_35[i][j][k] = 0xA3F30045;
        }
    }
    for (l_28 = 8; (l_28 >= 20); l_28 += 1)
    { /* block id: 39 */
        int32_t *l_32[3][3] = {{&l_28,(void*)0,&l_28},{&l_28,(void*)0,&l_28},{&l_28,(void*)0,&l_28}};
