...
inline static uint16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0x738AB659L;
    l_2 = (0x0.568345p-29 < (0x4.DE713Ap-78 == 0xE.905D09p+99));
    return l_2;
}
