...
static struct S0 g_11 = {4294967289UL,-1L,8UL,1L,0x9F3FAA32L,0x3FL,-0x6.5p+1,0x0.0p+1,0x01L};
...
int main (void)
{
    ...
    transparent_crc_bytes (&g_11.f6, sizeof(g_11.f6), "g_11.f6", print_hash_value);
    transparent_crc_bytes (&g_11.f7, sizeof(g_11.f7), "g_11.f7", print_hash_value);
