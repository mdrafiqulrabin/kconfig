...
static struct S0 g_10 = {15213,0x70A3267EL,0xAA165420L};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    int32_t l_4 = (-1L);
    int32_t l_5 = 0xD42374B1L;
    int32_t l_9 = 8L;
    l_4 &= g_2;
    l_5 |= 0x4EEA2A3BL;
    g_6 &= g_2;
    g_6 ^= (g_2 ^ ((uint16_t)l_9 << (uint16_t)15));
    return g_10;
}
