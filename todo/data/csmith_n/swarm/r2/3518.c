 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --comma-operators --no-compound-assignment --no-consts --divs --embedded-assigns --pre-incr-operator --pre-decr-operator --post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --no-uint8 --no-float --math64 --inline-function --muls --no-safe-math --no-packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      838011624
 */
...
inline static uint16_t  func_35(void)
{ /* block id: 36 */
    int16_t l_36 = 0x373AL;
    int32_t l_38 = 0x5714FFD8L;
    int32_t *l_37 = &l_38;
    int32_t **l_39 = &l_37;
    int32_t *l_41 = &l_38;
    int32_t **l_40 = &l_41;
...
XXX percentage a fresh-made variable is used: 72
XXX percentage an existing variable is used: 28
********************* end of statistics **********************/
