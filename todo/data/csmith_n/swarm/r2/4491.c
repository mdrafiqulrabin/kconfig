 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --compound-assignment --consts --no-divs --no-embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --uint8 --float --math64 --inline-function --muls --safe-math --packed-struct --no-paranoid --no-pointers --no-structs --no-unions --no-volatiles --volatile-pointers --const-pointers --global-variabless --builtins
 * Seed:      1402797866
 */
...
/* --- GLOBAL VARIABLES --- */
static float g_10 = 0xE.CB8CE3p-4;
static float g_11 = 0x7.1p+1;
static uint8_t g_12 = 3UL;
static int64_t g_30 = 0x13E13A6C9CD49FCFLL;
static uint8_t g_33 = 0xA8L;
...
{ /* block id: 36 */
    uint8_t l_29 = 0x91L;
    g_30 ^= l_29;
    g_33 = (safe_rshift_func_int16_t_s_s(g_30, 8));
    return g_12;
}
