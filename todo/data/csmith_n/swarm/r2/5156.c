...
static uint64_t g_9 = 0x00FA72C25FCC58A0LL;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 4; i = i + 1)
        l_3[i] = (void*)0;
    ++g_4;
    g_2 = ((safe_sub_func_int32_t_s_s(g_4, g_9)) > g_9);
    return g_4;
}
