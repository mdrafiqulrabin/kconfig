 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --comma-operators --no-compound-assignment --consts --divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --no-float --no-math64 --inline-function --no-muls --no-safe-math --packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      124790844
 */
...
inline static int32_t * func_28(const uint32_t  p_29, int32_t * p_30, int32_t * p_31, int32_t  p_32);
...
static uint16_t  func_27(void)
{ /* block id: 36 */
    const int32_t l_33 = (-8);
    int32_t l_35 = 0x9AC54C97;
    int32_t *l_34 = &l_35;
    int32_t *l_36 = &l_35;
    uint32_t l_37 = 0xEE34EDF6;
    int32_t **l_45 = &l_36;
    uint16_t l_46 = 0x85C2;
    (*l_45) = func_28(l_33, l_34, l_36, l_37);
    return l_46;
}
