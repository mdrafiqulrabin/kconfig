 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --no-int8 --uint8 --no-float --no-math64 --inline-function --no-muls --no-safe-math --packed-struct --no-paranoid --pointers --structs --no-unions --no-volatiles --volatile-pointers --const-pointers --global-variabless --builtins
 * Seed:      1395728896
 */
...
static int32_t g_39 = 0x23C5AD05L;
...
{ /* block id: 36 */
    int32_t l_37 = 5L;
    int32_t *l_38 = &g_39;
    (*l_38) = ((uint16_t)(((uint16_t)((uint16_t)g_3 % (uint16_t)(+(0xDBCABEBFL >= l_37))) / (uint16_t)__builtin_clzl(l_37)) >= l_37) << (uint16_t)7);
    return (*l_38);
}
