 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --no-uint8 --float --math64 --inline-function --muls --no-safe-math --no-packed-struct --paranoid --no-pointers --structs --no-unions --volatiles --no-volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      2476272362
 */
...
inline static const int32_t  func_31(void)
{ /* block id: 36 */
    uint32_t l_32 = 0x6501874D;
    int32_t l_33 = 2;
    int32_t l_34 = (-1);
lbl_37:
    l_33 = (0x92ED == l_32);
    l_34 = l_34;
    l_33 = ((int16_t)l_33 * (int16_t)l_32);
    if (l_32)
        goto lbl_37;
    return l_34;
}
