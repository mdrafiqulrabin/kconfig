...
static int32_t g_28 = 0x34F545EE;
...
static int16_t  func_23(void)
{ /* block id: 36 */
    for (g_4 = 0; (g_4 <= 53); g_4 = safe_add_func_uint32_t_u_u(g_4, 7))
    { /* block id: 39 */
        int32_t *l_27 = &g_28;
        int32_t **l_26 = &l_27;
        (*l_26) = (void*)0;
