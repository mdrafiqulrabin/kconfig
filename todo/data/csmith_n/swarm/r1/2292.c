...
static struct S3  func_1(void)
{ /* block id: 0 */
    int32_t l_3 = 0xDBC1C234L;
    int32_t *l_2 = &l_3;
    struct S3 l_4 = {4UL,65527UL,{1L,254UL,-10L,18446744073709551615UL,2UL,7UL},0x072C02A3L,{1UL,0x4B15D3E9L,0x73063D62L,0x04F77722L,0xBAC8L,5UL},18446744073709551615UL};
    (*l_2) = 0xE81720D7L;
    return l_4;
}
