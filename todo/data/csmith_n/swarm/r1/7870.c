 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --compound-assignment --consts --no-divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --no-int8 --no-uint8 --float --math64 --no-inline-function --no-muls --safe-math --no-packed-struct --paranoid --pointers --structs --unions --no-volatiles --volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      2948966764
 */
...
static float g_32 = 0xF.DAD816p+82;
static union U0 g_34 = {7UL};
...
/* 
 * reads : g_3 g_28 g_36
 * writes: g_28 g_3 g_32
 */
static int16_t  func_26(void)
{ /* block id: 36 */
    int32_t *l_27 = &g_28;
    const union U0 *l_33 = &g_34;
    const union U0 **l_35 = &l_33;
    (*l_27) |= g_3;
