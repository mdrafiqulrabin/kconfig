 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --consts --no-divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --float --math64 --inline-function --no-muls --safe-math --packed-struct --no-paranoid --pointers --structs --no-unions --no-volatiles --no-volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      3462772818
 */
...
static int32_t g_35 = 0x018D303F;
static float g_39 = 0x1.945CB8p-22;
...
/* 
 * reads : g_3 g_35
 * writes: g_35 g_3 g_39
 */
static const int16_t  func_31(void)
{ /* block id: 36 */
    uint32_t l_32 = 0x1D594D03;
    int32_t *l_33 = (void*)0;
    int32_t *l_34 = &g_35;
    (*l_34) = l_32;
