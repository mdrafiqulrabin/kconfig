...
/* --- GLOBAL VARIABLES --- */
static struct S1 g_2 = {0x2B4746A1L,0L,249UL,18446744073709551615UL,43,{13,-74},0x1BL,1L};/* VOLATILE GLOBAL g_2 */
static struct S1 g_3[3] = {{0xE81720D7L,-4L,0UL,0x6DBC1C234AC0198ALL,11,{7,-41},0x4FL,0x8D7CL},{0xE81720D7L,-4L,0UL,0x6DBC1C234AC0198ALL,11,{7,-41},0x4FL,0x8D7CL},{0xE81720D7L,-4L,0UL,0x6DBC1C234AC0198ALL,11,{7,-41},0x4FL,0x8D7CL}};
...
int main (int argc, char* argv[])
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        transparent_crc(g_3[i].f5.f0, "g_3[i].f5.f0", print_hash_value);
        transparent_crc(g_3[i].f5.f1, "g_3[i].f5.f1", print_hash_value);
