...
static struct S0 g_9 = {3,-1475,12};
...
static struct S0  func_1(void)
{ /* block id: 0 */
    uint64_t l_2[9] = {1UL,8UL,1UL,1UL,8UL,1UL,1UL,8UL,1UL};
    int32_t *l_4[6] = {&g_5[1],&g_5[1],&g_5[1],&g_5[1],&g_5[1],&g_5[1]};
    uint32_t l_6 = 0xBD652568L;
    int i;
