...
static uint16_t g_8[9] = {65533UL,65533UL,65533UL,65533UL,65533UL,65533UL,65533UL,65533UL,65533UL};
...
{ /* block id: 0 */
    ...
    uint16_t *l_7 = &g_8[4];
    (*g_3) = g_2;
    (*g_9) &= (safe_div_func_uint16_t_u_u(((*l_7) &= l_6), 6L));
    return l_6;
}
