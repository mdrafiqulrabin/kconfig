...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[3] = {0x38DC5336L,0x38DC5336L,0x38DC5336L};
static union U3 g_7[5] = {{1UL},{1UL},{1UL},{1UL},{1UL}};
...
static union U3  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[3][2] = {{&g_3[0],&g_3[2]},{&g_3[0],&g_3[0]},{&g_3[2],&g_3[0]}};
    uint64_t l_4 = 0xFEBFB2C41AC3DC99LL;
    int i, j;
    l_4++;
    return g_7[2];
}
