...
static int32_t g_11[1] = {0x5653D423L};
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_14 = 0x91B68DEEL;
    for (g_2 = 21; (g_2 >= 2); g_2 = safe_sub_func_uint16_t_u_u(g_2, 1))
    { /* block id: 3 */
        uint32_t l_8[7][4];
        int32_t l_13 = 0xB9876427L;
        int i, j;
        for (i = 0; i < 7; i++)
        {
            for (j = 0; j < 4; j++)
                l_8[i][j] = 18446744073709551609UL;
        }
        for (g_5 = (-24); (g_5 >= (-18)); g_5 = safe_add_func_uint32_t_u_u(g_5, 8))
        { /* block id: 6 */
            int32_t *l_9 = (void*)0;
            int32_t *l_10 = &g_11[0];
            int32_t *l_12 = (void*)0;
