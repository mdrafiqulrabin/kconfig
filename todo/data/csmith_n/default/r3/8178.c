...
static volatile uint32_t g_11 = 4294967292UL;/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_4;
    int32_t *l_6 = &g_4;
    int32_t l_7 = 0xFE04822BL;
    int32_t *l_8 = &g_4;
    int32_t *l_9 = &g_4;
    int32_t *l_10[1][9] = {{&l_7,&g_4,&l_7,&l_7,&g_4,&l_7,&l_7,&g_4,&l_7}};
    uint32_t l_14 = 0x752F67D5L;
    int i, j;
    g_11++;
    return l_14;
}
