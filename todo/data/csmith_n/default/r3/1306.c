...
static int32_t g_11 = 0xB583DC0EL;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_6 = 0x6A07563FL;
    for (g_3 = (-21); (g_3 != 3); g_3 = safe_add_func_uint32_t_u_u(g_3, 8))
    { /* block id: 3 */
        if (l_6)
            break;
        for (l_6 = 0; (l_6 >= 5); l_6 = safe_add_func_int64_t_s_s(l_6, 4))
        { /* block id: 7 */
            int32_t *l_9 = (void*)0;
            int32_t *l_10 = &g_11;
            (*l_10) ^= g_3;
