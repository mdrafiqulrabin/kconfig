...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x6038591BL;
static int32_t g_6 = 0x4207647FL;
static int8_t g_7 = (-1L);
static volatile uint64_t g_8 = 0x13E19F23E52509E7LL;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3;
    int32_t *l_5[2];
    struct S0 l_11 = {0x974EDF0EBF90350DLL,1L,0x71L,255UL,-2L,7L,0x28D5L};
    int i;
    for (i = 0; i < 2; i++)
        l_5[i] = &g_3;
    ++g_8;
