...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_7 = 0x48C443EB60693009LL;
static struct S0 g_11 = {0x63FFL,1L};/* VOLATILE GLOBAL g_11 */


/* --- FORWARD DECLARATIONS --- */
static uint8_t  func_1(void);
static struct S0  func_2(int64_t  p_3, int16_t  p_4, uint16_t  p_5);
...
{ /* block id: 0 */
    int32_t l_6 = 1L;
    int16_t l_10 = 0xDCD6L;
    struct S0 *l_12 = &g_11;
    (*l_12) = func_2(l_6, ((g_7 >= 0x4562L) > (safe_rshift_func_uint16_t_u_u(g_7, 6))), l_10);
    return g_11.f0;
}
