...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[6] = {1L,0x1A049FE3L,1L,1L,0x1A049FE3L,1L};
static int32_t g_5 = 0x8114768CL;
static volatile int32_t g_8 = 7L;/* VOLATILE GLOBAL g_8 */
static volatile int32_t g_9 = (-1L);/* VOLATILE GLOBAL g_9 */
static int32_t g_10[1][10] = {{0x5653D423L,8L,0x5653D423L,0x5653D423L,8L,0x5653D423L,0x5653D423L,8L,0x5653D423L,0x5653D423L}};
...
/* 
 * reads : g_2 g_10
 * writes: g_2 g_5 g_10 g_15
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_13 = &g_10[0][4];
    for (g_2[1] = 0; (g_2[1] >= (-10)); g_2[1]--)
    { /* block id: 3 */
        for (g_5 = 0; (g_5 >= (-24)); g_5 = safe_sub_func_int64_t_s_s(g_5, 4))
        { /* block id: 6 */
            for (g_10[0][4] = (-29); (g_10[0][4] < 9); g_10[0][4] = safe_add_func_uint8_t_u_u(g_10[0][4], 1))
            { /* block id: 9 */
                int32_t **l_14[5];
                int i;
                for (i = 0; i < 5; i++)
