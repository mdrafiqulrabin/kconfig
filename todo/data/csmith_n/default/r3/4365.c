...
static int32_t * volatile g_18 = &g_11;/* VOLATILE GLOBAL g_18 */
...
/* ------------------------------------------ */
/* 
 * reads : g_6 g_9 g_10 g_16 g_18 g_11
 * writes: g_11 g_17
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    ...
    int32_t *l_15 = (void*)0;
    (*g_10) = (safe_sub_func_int32_t_s_s((safe_rshift_func_uint16_t_u_u(g_6, 5)), ((~l_8) ^ g_9)));
    for (l_8 = 8; (l_8 > 6); --l_8)
    { /* block id: 4 */
