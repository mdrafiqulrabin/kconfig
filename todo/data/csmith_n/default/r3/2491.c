...
/* --- GLOBAL VARIABLES --- */
static const volatile struct S0 g_3 = {1127,253UL};/* VOLATILE GLOBAL g_3 */
static const volatile struct S0 * volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
static volatile struct S0 g_5 = {2352,0UL};/* VOLATILE GLOBAL g_5 */
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    const volatile struct S0 * volatile l_4[1];
    int i;
    for (i = 0; i < 1; i++)
        l_4[i] = &g_5;
    l_4[0] = g_2;
