...
static int16_t g_21[7] = {0xBC38L,0xBC38L,0xBC38L,0xBC38L,0xBC38L,0xBC38L,0xBC38L};
static int32_t g_23 = 0xF839E071L;
...
{ /* block id: 0 */
    ...
    (*l_22) |= ((+(safe_mod_func_int64_t_s_s(((safe_add_func_int8_t_s_s(((4294967292UL | g_4) == (safe_mul_func_uint16_t_u_u((safe_rshift_func_uint16_t_u_u((safe_add_func_uint32_t_u_u(g_4, g_4)), 0)), (l_16 |= l_2[1])))), (safe_sub_func_int16_t_s_s(((*l_20) = 0xC430L), g_3)))) ^ 5UL), 0x6085E0710DD013D0LL))) && g_3);
    return (*l_22);
}
