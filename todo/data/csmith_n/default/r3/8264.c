...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_4 = 0x91L;/* VOLATILE GLOBAL g_4 */
static union U3 g_8 = {0x594D0357L};/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    ...
    union U3 *l_7 = &g_8;
    union U3 **l_6 = &l_7;
    (*l_6) = (((safe_div_func_uint8_t_u_u(g_4, l_5)) != l_5) , (void*)0);
    return g_8;
}
