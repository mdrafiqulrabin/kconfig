...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t l_4 = 0x54FDDD3FL;
    int32_t *l_5 = &l_4;
    int32_t *l_6[5];
    int16_t l_7[5][6] = {{(-6L),0x4800L,(-6L),(-6L),0x4800L,(-6L)},{(-6L),0x4800L,(-6L),(-6L),0x4800L,(-6L)},{(-6L),0x4800L,(-6L),(-6L),0x4800L,(-6L)},{(-6L),0x4800L,(-6L),(-6L),0x4800L,(-6L)},{(-6L),0x4800L,(-6L),(-6L),0x4800L,(-6L)}};
    int i, j;
    for (i = 0; i < 5; i++)
        l_6[i] = &g_3;
    g_8--;
