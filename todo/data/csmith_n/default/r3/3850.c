...
static int32_t g_14 = 0x2215256EL;


/* --- FORWARD DECLARATIONS --- */
static int16_t  func_1(void);
static int32_t * func_2(uint32_t  p_3, uint8_t  p_4, int8_t * p_5, int8_t  p_6, int32_t  p_7);
...
{ /* block id: 0 */
    ...
    int32_t *l_16 = &g_14;
    int32_t **l_15 = &l_16;
    (*l_15) = func_2(g_8, l_9, g_10, ((safe_mod_func_uint16_t_u_u(65535UL, l_9)) , g_8), l_9);
    return (*l_16);
}
