...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_3 = {-4};/* VOLATILE GLOBAL g_3 */
static struct S0 * volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
static int32_t g_6[3] = {0x921DED68L,0x921DED68L,0x921DED68L};
static int32_t g_8[4] = {0xDFE4D9EDL,0xDFE4D9EDL,0xDFE4D9EDL,0xDFE4D9EDL};
