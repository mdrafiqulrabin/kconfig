...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[3] = {0x90069F30L,0x90069F30L,0x90069F30L};
...
{ /* block id: 0 */
    ...
    int32_t *l_14 = &g_3[2];
    int32_t *l_15[9][4];
    int64_t l_16 = 0xF49C23EDB39523DDLL;
    int64_t l_18 = 0x5ADB51FD9AB8A87ELL;
    uint32_t l_19 = 0xA3766593L;
    int i, j;
    for (i = 0; i < 9; i++)
    {
        for (j = 0; j < 4; j++)
