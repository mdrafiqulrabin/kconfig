...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x0FECAFE8L;
static uint16_t g_8[7][1] = {{0xBAEFL},{1UL},{0xBAEFL},{1UL},{0xBAEFL},{1UL},{0xBAEFL}};
static union U3 g_11 = {0x21E124DCL};/* VOLATILE GLOBAL g_11 */
