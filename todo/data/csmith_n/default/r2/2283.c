...
/* --- GLOBAL VARIABLES --- */
static volatile union U2 g_3 = {{1UL,247UL}};/* VOLATILE GLOBAL g_3 */
static volatile union U2 * const  volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    volatile union U2 *l_5[8];
    volatile union U2 * volatile *l_4 = &l_5[1];
    int32_t l_6[9] = {1L,1L,1L,1L,1L,1L,1L,1L,1L};
    int32_t *l_7 = &l_6[3];
    int32_t *l_8 = &l_6[6];
    int32_t *l_9 = &l_6[3];
    int32_t *l_10 = &l_6[3];
