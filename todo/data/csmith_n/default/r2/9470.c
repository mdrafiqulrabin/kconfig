...
static const union U3 g_7 = {1L};/* VOLATILE GLOBAL g_7 */
...
static const union U3  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[3][2][4] = {{{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3}},{{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3}},{{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3}}};
    uint16_t l_4 = 1UL;
    int i, j, k;
    l_4--;
    return g_7;
