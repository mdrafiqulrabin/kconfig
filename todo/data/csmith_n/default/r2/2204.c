...
static struct S0 g_15 = {-5L,-1L,0x126CL,0xF05F4326L,-6L,89,-1L,-6L,-4L,65535UL};/* VOLATILE GLOBAL g_15 */
...
{ /* block id: 2 */
    ...
    { /* block id: 5 */
        for (g_4 = 0; (g_4 > 24); g_4 = safe_add_func_uint16_t_u_u(g_4, 2))
        { /* block id: 8 */
            return p_3;
        }
        return l_12;
