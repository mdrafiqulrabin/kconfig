...
{ /* block id: 0 */
    ...
    int32_t *l_12[7][1] = {{&g_13},{&g_13},{&g_13},{&g_13},{&g_13},{&g_13},{&g_13}};
    int64_t l_14 = 1L;
    int i, j;
    g_4 = g_2;
    l_14 |= (l_10[7] = (safe_mod_func_uint8_t_u_u((safe_sub_func_int8_t_s_s(l_9, 8UL)), l_9)));
    return g_2;
}
