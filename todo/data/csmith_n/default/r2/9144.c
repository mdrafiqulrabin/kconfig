...
static volatile int16_t g_7[1][3][9] = {{{0L,0xFD2DL,0xFD2DL,0L,0L,0xFD2DL,0xFD2DL,0L,0L},{(-3L),3L,(-3L),3L,(-3L),3L,(-3L),3L,(-3L)},{0L,0L,0xFD2DL,0xFD2DL,0L,0L,0xFD2DL,0xFD2DL,0L}}};
...
{ /* block id: 0 */
    ...
    volatile int32_t **l_3[6] = {&l_4,&l_4,&l_4,&l_4,&l_4,&l_4};
    uint32_t l_8 = 18446744073709551615UL;
    const int16_t l_11 = 0x8EF0L;
    int i;
    (*g_5) = g_2;
    l_8++;
    return l_11;
