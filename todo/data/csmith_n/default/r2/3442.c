...
/* --- GLOBAL VARIABLES --- */
static int32_t g_8 = 0x7AB3921DL;


/* --- FORWARD DECLARATIONS --- */
static uint32_t  func_1(void);
static const uint16_t  func_4(uint64_t  p_5, uint16_t  p_6, const int16_t  p_7);
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    const int16_t l_9[6] = {0xE64FL,0L,0xE64FL,0xE64FL,0L,0xE64FL};
    int32_t *l_10 = (void*)0;
    int32_t l_11 = 0x2F80C341L;
    int32_t *l_12 = &g_8;
    uint16_t l_14 = 1UL;
    int i;
lbl_13:
    l_11 |= (safe_mul_func_uint16_t_u_u(func_4(g_8, (g_8 & g_8), l_9[5]), l_9[0]));
    (*l_12) = 1L;
    if (g_8)
        goto lbl_13;
    return l_14;
