...
static int32_t g_8 = 0xD66A0756L;
static struct S0 g_9 = {0xF0720718L,-10L,0UL,1UL,0x7C7747BB7AB61B58LL,1UL,1UL,0x7631L};/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    int32_t *l_5 = &g_6;
    int32_t *l_7 = &g_8;
    (*l_7) &= ((*l_5) &= (0xEBL < (safe_lshift_func_uint16_t_u_s(g_4, 13))));
    return g_9;
}
