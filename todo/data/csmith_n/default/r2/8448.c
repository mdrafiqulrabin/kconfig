...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xE3E63E31L;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 1L;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = (-1L);/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5[6][5] = {{1L,(-1L),(-4L),(-4L),(-1L)},{6L,0xFE012D2CL,(-4L),0xA6C9CD49L,0xFE012D2CL},{6L,(-1L),0x5D0D658EL,0xA6C9CD49L,(-1L)},{1L,(-1L),(-4L),(-4L),(-1L)},{6L,0xFE012D2CL,(-4L),0xA6C9CD49L,0xFE012D2CL},{6L,(-1L),0x5D0D658EL,0xA6C9CD49L,(-1L)}};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_9 = 0x628405CEL;
    int32_t *l_10[2];
    int i;
    for (i = 0; i < 2; i++)
        l_10[i] = &g_6;
    for (g_6 = 0; (g_6 >= (-8)); g_6 = safe_sub_func_int32_t_s_s(g_6, 6))
    { /* block id: 3 */
        int32_t **l_11[10] = {&l_10[0],&l_10[0],&l_10[0],&l_10[0],&l_10[0],&l_10[0],&l_10[0],&l_10[0],&l_10[0],&l_10[0]};
        int i;
        if (l_9)
            break;
        g_12 = l_10[1];
