...
/* --- GLOBAL VARIABLES --- */
static volatile int8_t g_4[1][6][3] = {{{0x97L,0x97L,0x97L},{0x97L,0x97L,0x97L},{0x97L,0x97L,0x97L},{0x97L,0x97L,0x97L},{0x97L,0x97L,0x97L},{0x97L,0x97L,0x97L}}};
static int32_t g_7 = 1L;
static struct S0 g_8 = {2479,7993,198};/* VOLATILE GLOBAL g_8 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    uint32_t l_5 = 0x4A90611BL;
    int32_t *l_6 = &g_7;
    (*l_6) &= (safe_rshift_func_uint16_t_u_s(g_4[0][0][0], l_5));
    return g_8;
}
