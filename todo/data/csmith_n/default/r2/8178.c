...
/* --- GLOBAL VARIABLES --- */
static union U3 g_2 = {0x3F365653D42374B1LL};/* VOLATILE GLOBAL g_2 */
static const union U1 g_4[9] = {{1L},{0xB987L},{1L},{1L},{0xB987L},{1L},{1L},{0xB987L},{1L}};
static union U1 g_7 = {0x0A32L};/* VOLATILE GLOBAL g_7 */
static const union U1 *g_6 = &g_7;
...
static const union U1  func_1(void)
{ /* block id: 0 */
    const union U1 *l_3 = &g_4[5];
    const union U1 **l_5[5][3] = {{(void*)0,&l_3,(void*)0},{(void*)0,&l_3,(void*)0},{(void*)0,&l_3,(void*)0},{(void*)0,&l_3,(void*)0},{(void*)0,&l_3,(void*)0}};
    int i, j;
    g_6 = (g_2 , l_3);
    return (*g_6);
}
