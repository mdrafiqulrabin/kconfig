...
static volatile int16_t g_8[6] = {0x1B40L,0x1B40L,0x1B40L,0x1B40L,0x1B40L,0x1B40L};
static int32_t g_9 = 0xC3D21462L;
static uint8_t g_10 = 0x65L;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    const volatile int32_t * volatile *l_3 = &g_2;
    int32_t *l_4 = &g_5;
    int32_t *l_6[4];
    int i;
    for (i = 0; i < 4; i++)
