...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[4][7][2] = {{{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L}},{{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L}},{{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L}},{{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L},{0L,0L}}};
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3[1][6][1];
    int32_t *l_5 = &g_3[1][0][0];
    int32_t *l_6 = (void*)0;
    int32_t *l_7 = &g_3[3][5][0];
    int32_t *l_8 = &g_3[2][3][1];
    int32_t *l_9[2][1][3];
    uint32_t l_10 = 0xF0720718L;
    int i, j, k;
    for (i = 0; i < 2; i++)
    {
        for (j = 0; j < 1; j++)
