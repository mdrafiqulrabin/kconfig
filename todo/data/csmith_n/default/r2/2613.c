...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xD714F98CL;
static int32_t g_6 = 1L;
static int16_t g_9 = 5L;
static int32_t g_10[1][7] = {{8L,8L,8L,8L,8L,8L,8L}};
...
{ /* block id: 0 */
    ...
    int i, j;
    g_3 ^= (-7L);
    for (g_3 = 0; (g_3 <= (-18)); g_3 = safe_sub_func_uint8_t_u_u(g_3, 9))
    { /* block id: 4 */
        for (g_6 = 0; (g_6 < 5); g_6 = safe_add_func_int32_t_s_s(g_6, 5))
        { /* block id: 7 */
            g_9 &= g_6;
            g_10[0][5] = g_6;
        }
