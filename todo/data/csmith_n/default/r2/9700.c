...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[1][4] = {{0x3248C66FL,0x3248C66FL,0x3248C66FL,0x3248C66FL}};
static int32_t g_6[1][3][3] = {{{0xF307D7C1L,0xF307D7C1L,0xF307D7C1L},{0xB844A754L,0xB844A754L,0xB844A754L},{0xF307D7C1L,0xF307D7C1L,0xF307D7C1L}}};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3[0][0];
    int32_t *l_5 = &g_6[0][1][2];
    (*l_2) = 2L;
    (*l_2) ^= (safe_unary_minus_func_int8_t_s(((void*)0 != l_2)));
    (*l_5) |= (*l_2);
    return g_6[0][1][2];
}
