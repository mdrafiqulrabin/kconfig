...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0xDA622A14L;
static int32_t g_6 = 0xCA3C0BF9L;
static int32_t g_8[6] = {0xD0D658EDL,0x247ADF1AL,0xD0D658EDL,0xD0D658EDL,0x247ADF1AL,0xD0D658EDL};
...
{ /* block id: 0 */
    uint32_t *l_2 = &g_3;
    int32_t *l_7 = &g_8[1];
    int32_t *l_9[8] = {&g_8[1],(void*)0,&g_8[1],&g_8[1],(void*)0,&g_8[1],&g_8[1],(void*)0};
    int64_t l_10 = 0xA16501874DA86284LL;
    int i;
    (*l_7) &= (g_6 = ((0x0CB8CE3EL >= ((*l_2)++)) , g_3));
    g_6 ^= g_8[4];
    return l_10;
}
