...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_7[6] = {0xDAL,0xDAL,0xDAL,0xDAL,0xDAL,0xDAL};
static int32_t g_12 = 0x66E58D02L;
...
{ /* block id: 0 */
    uint8_t *l_6 = &g_7[5];
    int32_t l_10 = 0L;
    (*g_11) = (safe_add_func_uint8_t_u_u((safe_div_func_uint8_t_u_u((--(*l_6)), l_10)), l_10));
    return l_10;
}
