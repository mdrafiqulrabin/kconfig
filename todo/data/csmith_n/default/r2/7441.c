...
static union U1 g_5 = {{1L,0x9CEC79E672CA3C0BLL,6L,1L,0x71247ADF1ADB2BC4LL,-5L,65535UL,-2L,0x65L,18446744073709551611UL}};/* VOLATILE GLOBAL g_5 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc(g_5.f0.f8, "g_5.f0.f8", print_hash_value);
    transparent_crc(g_5.f0.f9, "g_5.f0.f9", print_hash_value);
