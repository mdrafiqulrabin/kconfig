...
static int64_t g_11 = 0xD6B65720B963AB19LL;
static volatile uint64_t g_12 = 0xA266D210EC3203BDLL;/* VOLATILE GLOBAL g_12 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = (-10); (g_2 == 17); ++g_2)
    { /* block id: 3 */
        int32_t *l_5 = (void*)0;
        int32_t *l_6 = &g_7;
        int32_t *l_8 = &g_7;
        int32_t *l_9[10][2] = {{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7},{&g_7,&g_7}};
        int i, j;
        g_12--;
    }
    return g_2;
