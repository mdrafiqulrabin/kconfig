...
static volatile int32_t g_11 = 0x8C9A01C7L;/* VOLATILE GLOBAL g_11 */
static int16_t g_12 = 0x37D0L;
static volatile uint16_t g_13 = 65534UL;/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    int32_t l_7 = (-6L);
    int32_t *l_8 = &g_4;
    int32_t *l_9[9][1] = {{&l_7},{&l_7},{&l_7},{&l_7},{&l_7},{&l_7},{&l_7},{&l_7},{&l_7}};
    int i, j;
    (*l_3) = l_2;
    (*l_6) = (&g_4 == ((*l_5) = l_3));
    --g_13;
