...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int16_t *l_7 = &g_8;
        int32_t l_9 = 0L;
        l_9 = (safe_sub_func_int16_t_s_s(((*l_7) = 0xF545L), (((g_2 | g_2) <= g_2) == g_2)));
        if (l_9)
            continue;
        for (l_9 = 28; (l_9 >= 15); l_9 = safe_sub_func_int16_t_s_s(l_9, 1))
        { /* block id: 9 */
            uint64_t l_12 = 0x720348F4A8FE2430LL;
            return l_12;
        }
    }
    return g_2;
