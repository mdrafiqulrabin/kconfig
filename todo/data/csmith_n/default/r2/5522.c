...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t l_6[10] = {0x8AB659D5L,1L,0x8AB659D5L,0x8AB659D5L,1L,0x8AB659D5L,0x8AB659D5L,1L,0x8AB659D5L,0x8AB659D5L};
    int i;
    (*g_3) = l_2;
    if (l_6[8])
    { /* block id: 2 */
        int32_t *l_9[7] = {&l_6[1],&l_6[1],&l_6[1],&l_6[1],&l_6[1],&l_6[1],&l_6[1]};
        int i;
        l_6[8] ^= ((safe_div_func_uint64_t_u_u(0x8C443EB60693009CLL, 0x562513244D513C61LL)) || g_5);
    }
    else
    { /* block id: 4 */
