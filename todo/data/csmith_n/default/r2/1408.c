...
/* --- GLOBAL VARIABLES --- */
static union U2 g_3 = {0x5C28L};/* VOLATILE GLOBAL g_3 */
static union U2 *g_2[1] = {&g_3};
static union U2 ** const  volatile g_4 = &g_2[0];/* VOLATILE GLOBAL g_4 */
static union U2 **g_6 = &g_2[0];
static union U2 *** volatile g_5 = &g_6;/* VOLATILE GLOBAL g_5 */
static union U1 g_7 = {8UL};/* VOLATILE GLOBAL g_7 */
