...
static int8_t g_7 = 0xB3L;
static int32_t g_10 = 0xE96B779CL;
static int32_t * volatile g_9 = &g_10;/* VOLATILE GLOBAL g_9 */
static union U0 g_11 = {0x0785L};/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    int8_t *l_6 = &g_7;
    for (g_3 = 0; (g_3 < (-11)); g_3 = safe_sub_func_int32_t_s_s(g_3, 5))
    { /* block id: 3 */
        int8_t *l_8 = &g_7;
        (*g_9) = (l_6 == l_8);
    }
