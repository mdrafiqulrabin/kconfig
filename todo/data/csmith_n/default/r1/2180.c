...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_5 = 0x6F9B2CFBL;
static int32_t g_8[1] = {(-7L)};
static int32_t * volatile g_7[8] = {&g_8[0],&g_8[0],&g_8[0],&g_8[0],&g_8[0],&g_8[0],&g_8[0],&g_8[0]};
static int32_t *g_14 = &g_8[0];
...
{ /* block id: 0 */
    ...
    (*l_9) = (safe_sub_func_uint64_t_u_u((+g_5), g_5));
    g_13 = &l_9;
    return g_8[0];
}
