...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0x8F90A3CFL;/* VOLATILE GLOBAL g_3 */
static int16_t g_5 = 9L;
static int32_t g_9[4] = {1L,1L,1L,1L};
static struct S0 g_10 = {0x29EF4A0426A7609FLL,0L};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = (void*)0;
    int32_t *l_7 = (void*)0;
    int32_t *l_8[5][2] = {{&g_9[3],&g_9[3]},{&g_9[3],&g_9[3]},{&g_9[3],&g_9[3]},{&g_9[3],&g_9[3]},{&g_9[3],&g_9[3]}};
    int i, j;
    g_9[0] |= (((*l_4) = (l_2 && g_3)) < l_2);
    return g_10;
}
