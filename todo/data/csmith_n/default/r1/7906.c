...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &g_3;
    int32_t *l_8[2];
    uint64_t l_11[6] = {18446744073709551612UL,18446744073709551612UL,0x9B6917AB6DAD816FLL,18446744073709551612UL,18446744073709551612UL,0x9B6917AB6DAD816FLL};
    int i;
    for (i = 0; i < 2; i++)
        l_8[i] = &g_3;
    l_11[3]++;
