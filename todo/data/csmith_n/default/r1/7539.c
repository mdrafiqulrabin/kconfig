...
{ /* block id: 0 */
    ...
    int32_t *l_15 = &g_3;
    int32_t *l_16 = &g_3;
    int32_t l_17 = 0x3773672DL;
    int32_t *l_18[6][5] = {{&l_7,&l_7,&l_7,&l_7,&l_7},{&l_7,&l_17,&l_17,&l_7,&l_17},{&l_7,&l_7,&g_3,&l_7,&l_7},{&l_17,&l_7,&l_17,&l_17,&l_7},{&l_7,&l_7,&l_7,&l_7,&l_7},{&l_7,&l_7,&l_17,&l_7,&l_7}};
    int i, j;
    ++g_19;
    return (*l_10);
}
