...
static struct S0 g_17 = {-9921,3,1938,4294967295UL};/* VOLATILE GLOBAL g_17 */
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3;
    int32_t *l_5 = &g_3;
    int32_t l_6[4] = {0x34C865B4L,0x34C865B4L,0x34C865B4L,0x34C865B4L};
    int32_t *l_7 = &g_3;
    int32_t *l_8 = &g_3;
    int32_t *l_9 = &l_6[1];
    int32_t *l_10 = &l_6[1];
    int32_t *l_11[6] = {&l_6[1],&l_6[1],&l_6[1],&l_6[1],&l_6[1],&l_6[1]};
    int16_t l_13 = 1L;
    int i;
    g_14--;
    return g_17;
