...
static uint32_t g_21[9] = {0x4207647FL,0x4207647FL,0x4207647FL,0x4207647FL,0x4207647FL,0x4207647FL,0x4207647FL,0x4207647FL,0x4207647FL};
static int64_t g_23 = 0L;
static volatile uint32_t g_24 = 0xF86F25DBL;/* VOLATILE GLOBAL g_24 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_9 g_15 g_24
 * writes: g_2 g_9 g_15 g_21 g_24
 */
static const int8_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 < (-6)); g_2--)
    { /* block id: 3 */
        uint64_t *l_7 = (void*)0;
        uint64_t *l_8 = &g_9;
        uint16_t *l_14[8] = {&g_15,&g_15,&g_15,&g_15,&g_15,&g_15,&g_15,&g_15};
        int32_t l_20 = 0x0A3267E6L;
        int32_t *l_22[7] = {&l_20,&l_20,&l_20,&l_20,&l_20,&l_20,&l_20};
        int i;
        g_21[2] = (safe_div_func_uint64_t_u_u(((*l_8)--), (l_20 &= (safe_mul_func_uint16_t_u_u((g_15++), (safe_rshift_func_uint8_t_u_u(g_2, 7)))))));
        g_24--;
    }
    return g_15;
}
