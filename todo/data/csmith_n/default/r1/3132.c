...
static int32_t g_8 = 0xF4990069L;
static int32_t g_9[4][2] = {{0x65E3EDFAL,0x86BA47C9L},{0x86BA47C9L,0x65E3EDFAL},{0x86BA47C9L,0x86BA47C9L},{0x65E3EDFAL,0x86BA47C9L}};
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 == 10); g_2 = safe_add_func_uint64_t_u_u(g_2, 7))
    { /* block id: 3 */
        int32_t *l_7 = &g_8;
        g_9[0][1] = (safe_sub_func_int32_t_s_s(((*l_7) = g_2), g_2));
    }
    return g_9[3][0];
}
