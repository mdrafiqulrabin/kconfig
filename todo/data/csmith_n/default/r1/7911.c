...
static int32_t g_6 = 0x6EB6B9DDL;
...
{ /* block id: 0 */
    int32_t *l_7 = &g_6;
    int32_t *l_8[7] = {&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6};
    uint8_t l_9 = 0x73L;
    int i;
    for (g_2 = 10; (g_2 > (-23)); g_2 = safe_sub_func_int16_t_s_s(g_2, 9))
    { /* block id: 3 */
        uint64_t l_5[8];
        int i;
        for (i = 0; i < 8; i++)
