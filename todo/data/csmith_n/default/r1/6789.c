...
static union U2 g_8 = {0x9C45C1D1L};/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3[1];
    int32_t *l_4[5] = {&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2]};
    uint8_t l_5[9] = {254UL,254UL,254UL,254UL,254UL,254UL,254UL,254UL,254UL};
    int i;
    (*l_2) = 0x7F737A9AL;
    ++l_5[4];
    return g_8;
