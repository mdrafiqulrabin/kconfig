...
static volatile int32_t g_3[6] = {0x48F69F7FL,0x48F69F7FL,0x48F69F7FL,0x48F69F7FL,0x48F69F7FL,0x48F69F7FL};
...
static int32_t g_11 = 0x9253A34CL;
...
{ /* block id: 0 */
    int32_t *l_13 = &g_11;
    int32_t **l_12 = &l_13;
    const int32_t l_14[2] = {0xB2E4145CL,0xB2E4145CL};
    int i;
    for (g_7 = 0; (g_7 == 20); g_7 = safe_add_func_int64_t_s_s(g_7, 9))
    { /* block id: 3 */
