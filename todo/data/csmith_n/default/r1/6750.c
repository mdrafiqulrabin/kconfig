...
static int32_t g_8[3] = {0x7BEDEDB5L,0x7BEDEDB5L,0x7BEDEDB5L};
...
{ /* block id: 0 */
    ...
    int32_t *l_7[7];
    int64_t l_9 = (-1L);
    int32_t l_10 = 0xC6F0D4A7L;
    uint32_t l_11 = 0xC6C2DB60L;
    int i;
    for (i = 0; i < 7; i++)
        l_7[i] = &g_3;
    --l_11;
...
XXX times a pointer is qualified to be dereferenced: 229
