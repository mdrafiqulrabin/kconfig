...
static uint16_t g_6[2][10] = {{0xE3E7L,4UL,0xE3E7L,0x1FBCL,4UL,1UL,1UL,4UL,0x1FBCL,0xE3E7L},{0x3161L,0x3161L,65530UL,4UL,0x7AB6L,65530UL,0x7AB6L,4UL,65530UL,0x3161L}};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t l_4 = 4L;
    int32_t *l_5[1][2][5] = {{{&g_3,&l_4,&l_4,&l_4,&l_4},{&g_3,&l_4,&l_4,&l_4,&l_4}}};
