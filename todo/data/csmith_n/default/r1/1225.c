...
static int32_t g_12 = 0x2FDAD5A5L;
static volatile uint64_t g_13 = 8UL;/* VOLATILE GLOBAL g_13 */
static int32_t g_19 = 0x21FBB9CFL;
...
/* ------------------------------------------ */
/* 
 * reads : g_13 g_3 g_12 g_19 g_20
 * writes: g_13 g_3 g_19
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    ...
    int32_t *l_5 = &g_3;
    int32_t *l_6 = &g_3;
    int32_t l_7[8] = {0x29C1464FL,(-8L),0x29C1464FL,0x29C1464FL,(-8L),0x29C1464FL,0x29C1464FL,(-8L)};
    int32_t *l_8 = (void*)0;
    int32_t *l_9 = &g_3;
    int32_t *l_10 = (void*)0;
    int32_t *l_11[5];
    ...
    for (i = 0; i < 5; i++)
        l_11[i] = &g_3;
    g_13++;
    for (g_3 = (-5); (g_3 > 29); g_3 = safe_add_func_uint64_t_u_u(g_3, 3))
    { /* block id: 4 */
        g_19 ^= ((-1L) > ((safe_unary_minus_func_int64_t_s((*l_2))) != g_12));
    }
    return g_20;
}
