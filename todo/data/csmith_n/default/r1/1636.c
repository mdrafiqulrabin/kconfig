...
static volatile uint16_t g_9 = 0xC587L;/* VOLATILE GLOBAL g_9 */
static union U1 g_12 = {1UL};/* VOLATILE GLOBAL g_12 */
...
{ /* block id: 0 */
    ...
    int32_t *l_8[10][2] = {{&g_3,&l_6},{&l_7,&l_6},{&l_7,&l_6},{&g_3,&l_7},{&l_6,&l_6},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&l_6},{&l_6,&l_7},{&g_3,&l_6}};
    int i, j;
    --g_9;
    return g_12;
}
