...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xBA095A97L;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 0xBA20B95AL;/* VOLATILE GLOBAL g_3 */
static int32_t g_4[5] = {0x9F6D4A0DL,0x9F6D4A0DL,0x9F6D4A0DL,0x9F6D4A0DL,0x9F6D4A0DL};
static int32_t g_8 = 8L;
static int32_t g_11 = 0x64D07DDBL;
static int16_t g_12[3] = {0L,0L,0L};
static uint8_t g_14 = 0x99L;
static struct S0 g_17 = {8,1025,9219,996,84,-1,-10};/* VOLATILE GLOBAL g_17 */
...
{ /* block id: 0 */
    int8_t l_10 = 0xF9L;
    int32_t l_13 = 0x97867A7BL;
    for (g_4[3] = (-26); (g_4[3] >= 24); g_4[3]++)
    { /* block id: 3 */
        int32_t *l_7 = &g_8;
        int32_t *l_9[3];
        int i;
