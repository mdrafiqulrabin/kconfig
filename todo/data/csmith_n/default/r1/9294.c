...
static int16_t g_13 = 0x831DL;
static int32_t g_18 = 0x4A55F07CL;
static volatile int32_t g_19 = 0xA4C924B5L;/* VOLATILE GLOBAL g_19 */
static volatile uint32_t g_20 = 6UL;/* VOLATILE GLOBAL g_20 */
...
{ /* block id: 0 */
    ...
    g_20++;
    (*l_14) ^= (g_18 && 0x0DE5741311E2DB80LL);
    return g_5;
}
