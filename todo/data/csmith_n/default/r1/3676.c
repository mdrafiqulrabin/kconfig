...
static volatile int8_t g_9 = 0xD3L;/* VOLATILE GLOBAL g_9 */
static uint64_t g_10 = 0x7941CE3CB5AF9F7CLL;
...
{ /* block id: 0 */
    ...
    int16_t l_8[6] = {0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL};
    int i;
    g_10--;
    return g_10;
}
