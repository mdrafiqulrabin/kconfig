...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[10] = {3L,0xA41449C9L,0L,0L,0xA41449C9L,3L,0xA41449C9L,0L,0L,0xA41449C9L};
static int32_t g_3 = 0L;
static int32_t g_9 = 9L;
static uint8_t g_13 = 0x8DL;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_2 g_9 g_13
 * writes: g_3 g_9
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t * const l_10 = &g_9;
    int32_t *l_12 = &g_3;
    int32_t **l_11 = &l_12;
    for (g_3 = 0; (g_3 > 1); ++g_3)
    { /* block id: 3 */
        int32_t *l_8 = &g_9;
        (*l_8) &= (safe_lshift_func_int8_t_s_s(g_2[5], 0));
    }
    (*l_11) = l_10;
    return g_13;
}
