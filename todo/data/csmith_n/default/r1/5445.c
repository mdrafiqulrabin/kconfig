...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[7] = {0xD4EA6801L,0xD4EA6801L,0xD4EA6801L,0xD4EA6801L,0xD4EA6801L,0xD4EA6801L,0xD4EA6801L};
static volatile int32_t g_3 = (-3L);/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 0x7D65121AL;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = 0x88999D94L;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    ...
    int32_t *l_13 = &g_8;
    int32_t *l_14 = &g_8;
    int32_t l_15 = 0x6890C544L;
    int32_t l_16 = 0x8ED4A55FL;
    int32_t *l_17 = &g_8;
    int32_t *l_18[3];
    uint16_t l_19 = 0x61BEL;
    int i;
    for (i = 0; i < 3; i++)
        l_18[i] = &l_15;
    for (g_8 = 0; (g_8 > (-28)); g_8 = safe_sub_func_int16_t_s_s(g_8, 1))
    { /* block id: 3 */
        return g_2[4];
    }
    l_19--;
