...
static int32_t g_39 = 0x6595AD33L;
static int32_t g_41 = 0xEE67B38EL;
static union U1 g_42 = {0};/* VOLATILE GLOBAL g_42 */
...
{ /* block id: 36 */
    ...
    int32_t *l_38 = &g_39;
    int32_t *l_40 = &g_41;
    (*l_40) = ((*l_38) = ((safe_lshift_func_int8_t_s_s(g_8, 6)) == (l_35 ^ ((l_36 , l_36) > g_8))));
    return g_42;
    /* statement id: 39 */
...
XXX percent of pointers has null in alias set: 77.8
