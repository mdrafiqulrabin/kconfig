...
inline static int16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2[6][1] = {{4L},{6L},{6L},{4L},{6L},{6L}};
    int32_t l_6[9][1][3] = {{{0x7AB3921DL,1L,0x7AB3921DL}},{{(-1L),0xD6804445L,(-1L)}},{{0x7AB3921DL,1L,0x7AB3921DL}},{{(-1L),0xD6804445L,(-1L)}},{{0x7AB3921DL,1L,0x7AB3921DL}},{{(-1L),0xD6804445L,(-1L)}},{{0x7AB3921DL,1L,0x7AB3921DL}},{{(-1L),0xD6804445L,(-1L)}},{{0x7AB3921DL,1L,0x7AB3921DL}}};
    int32_t *l_5[6];
    int16_t l_7 = (-7L);
    int i, j, k;
    for (i = 0; i < 6; i++)
        l_5[i] = &l_6[8][0][0];
    for (l_2[4][0] = 0; (l_2[4][0] < 5); ++l_2[4][0])
    { /* block id: 3 */
        l_5[2] = (void*)0;
    }
    /* facts after for loop */
    //assert (l_5[0] == 0 || (l_5[0] >= &l_6[0][0][0] && l_5[0] <= &l_6[8][0][2]));
    return l_7;
}
