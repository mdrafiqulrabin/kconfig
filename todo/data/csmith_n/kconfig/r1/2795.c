...
static volatile int32_t g_4 = 0x704F3D4EL;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0xB568BE13L;
static volatile int32_t g_8 = 0x9C213245L;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int8_t l_17 = 0xECL;
    int32_t *l_18 = &g_5;
    for (g_5 = 0; (g_5 != (-12)); g_5 = safe_sub_func_uint64_t_u_u(g_5, 2))
    { /* block id: 3 */
        for (g_9 = 0; (g_9 >= 20); g_9 = safe_add_func_uint16_t_u_u(g_9, 4))
        { /* block id: 6 */
            int32_t *l_12 = (void*)0;
            int32_t *l_13 = (void*)0;
            int32_t *l_14 = (void*)0;
