...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_8[9] = {0xFA5CL,0x3980L,0xFA5CL,0xFA5CL,0x3980L,0xFA5CL,0xFA5CL,0x3980L,0xFA5CL};
...
{ /* block id: 36 */
    ...
    { /* block id: 38 */
        if ((*l_33))
        { /* block id: 39 */
            (*l_33) |= __builtin_clz(g_8[6]);
            return (*l_33);
        }
        else
        { /* block id: 42 */
            int8_t l_37[8] = {0x86L,0x9BL,0x86L,0x86L,0x9BL,0x86L,0x86L,0x9BL};
            int i;
