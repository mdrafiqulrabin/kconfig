...
static int32_t  func_28(void)
{ /* block id: 36 */
    uint32_t l_29 = 0x9884CB8FL;
    int32_t l_32 = 0xF985589BL;
    int32_t l_34 = (-1L);
    int32_t *l_33 = &l_34;
    uint32_t l_35 = 0x997B09B3L;
    (*l_33) = ((__builtin_ffs(l_29) ^ l_29) >= ((int16_t)(l_32 <= (5UL == 0xBDD7770B168F928DLL)) >> (int16_t)11));
    return l_35;
}
