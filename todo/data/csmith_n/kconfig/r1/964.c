...
/* --- GLOBAL VARIABLES --- */
static volatile struct S1 g_2 = {{4},7,-60,0,{0xFE64FD9E},0xA8D3,890};/* VOLATILE GLOBAL g_2 */
static volatile struct S1 g_3 = {{0x0611BC38},0xC67EE39F,47,0xA32F,{0},0,302};/* VOLATILE GLOBAL g_3 */
static union U3 g_4 = {0xDFDDAE97};/* VOLATILE GLOBAL g_4 */
