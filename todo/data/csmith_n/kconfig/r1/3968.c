...
static float g_33[8] = {0x6.B7E80Dp-99,0x6.B7E80Dp-99,0x6.B7E80Dp-99,0x6.B7E80Dp-99,0x6.B7E80Dp-99,0x6.B7E80Dp-99,0x6.B7E80Dp-99,0x6.B7E80Dp-99};
static float g_35 = 0x1.Ap+1;
...
{ /* block id: 36 */
    int32_t l_32 = (-3);
    for (g_16 = 0; (g_16 > (-22)); g_16 = safe_sub_func_uint32_t_u_u(g_16, 3))
    { /* block id: 39 */
        uint32_t l_34[3];
        int32_t l_37[2][4];
        int i, j;
