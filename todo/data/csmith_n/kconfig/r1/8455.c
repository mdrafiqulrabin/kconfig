...
{ /* block id: 36 */
    ...
    int32_t **l_34 = &l_35;
    int32_t l_38 = 0L;
    uint32_t l_39 = 0x8407374FL;
    int32_t *l_42 = (void*)0;
    float l_43 = 0xA.5533F2p+24;
    int32_t *l_44 = (void*)0;
    int32_t *l_45 = &l_38;
    uint32_t l_46 = 0x45180735L;
    (*l_34) = (void*)0;
    l_38 = ((uint16_t)(((__builtin_clzl(l_38) != ((*l_34) != (*l_34))) && (-1L)) || ((l_39 || (0x0B08L & l_38)) >= ((int16_t)(l_39 || l_39) << (int16_t)l_39))) - (uint16_t)0x161EL);
    (*l_45) = (l_39 ^ l_39);
    return l_46;
}
