...
{ /* block id: 36 */
    int8_t l_36 = (-1L);
    int32_t l_38 = 0x889E022AL;
    int32_t *l_37 = &l_38;
    int16_t l_43 = 0x0AE7L;
    (*l_37) = (safe_lshift_func_int16_t_s_u((safe_div_func_uint16_t_u_u(__builtin_bswap32(l_36), __builtin_ctz(l_36))), 4));
    for (l_38 = (-10); (l_38 == 12); l_38 = safe_add_func_uint16_t_u_u(l_38, 6))
    { /* block id: 40 */
