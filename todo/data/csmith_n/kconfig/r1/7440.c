...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2[10] = {0xFA5C62E0,2U,0xFA5C62E0,0xFA5C62E0,2U,0xFA5C62E0,0xFA5C62E0,2U,0xFA5C62E0,0xFA5C62E0};
static int16_t g_3 = 0x9A92;
...
{ /* block id: 0 */
    uint16_t l_6 = 1U;
    int32_t *l_7 = &g_8;
    (*l_7) = ((g_2[0] > ((-8) || g_3)) < ((safe_add_func_uint32_t_u_u(g_2[6], (0x95AE649F >= l_6))) || 0x14EB));
    return g_3;
}
