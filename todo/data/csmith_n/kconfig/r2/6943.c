...
/* --- GLOBAL VARIABLES --- */
static float g_3 = 0xE.C03342p-62;
static int32_t g_7[1][10] = {{0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL,0x4C3C69AEL}};
static int32_t g_28 = 1L;
static volatile int32_t g_29 = 0xB4EF66B1L;/* VOLATILE GLOBAL g_29 */
...
/* 
 * reads :
 * writes: g_28 g_29 g_7
 */
static uint32_t  func_27(void)
{ /* block id: 36 */
    int16_t l_30 = 0xE80DL;
