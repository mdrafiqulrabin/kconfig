...
static float  func_2(uint8_t  p_3, uint32_t  p_4);
...
{ /* block id: 0 */
    ...
    uint32_t *l_6 = (void*)0;
    uint32_t l_8 = 0x756A3367L;
    uint32_t *l_7 = &l_8;
    float l_13[7] = {0x6.B101EBp+63,0x6.B101EBp+63,0x6.B101EBp+63,0x6.B101EBp+63,0x6.B101EBp+63,0x6.B101EBp+63,0x6.B101EBp+63};
    float *l_12 = &l_13[5];
    int i;
    (*l_12) = func_2(l_5, ((*l_7) = (l_5 , l_5)));
    return l_8;
}
