...
inline static uint32_t  func_28(void)
{ /* block id: 36 */
    uint16_t l_31 = 0x03BD;
    int32_t l_32 = (-9);
    int32_t l_33 = 8;
    int32_t l_40 = 0x39EE491B;
    int32_t l_41 = 0x97E7C14A;
    l_41 = (l_40 = (((int16_t)__builtin_bswap64((l_33 = ((l_32 = l_31) < l_31))) % (int16_t)(-5)) , ((uint16_t)((int16_t)(l_33 = ((uint16_t)l_31 << (uint16_t)12)) >> (int16_t)l_31) >> (uint16_t)11)));
    return l_33;
}
