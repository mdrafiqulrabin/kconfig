...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[8][5] = {{3,0xC3EEE2FD,1,1,0xC3EEE2FD},{0xA9EF72D4,0x4A8B108F,1,1,0x4A8B108F},{3,0xC3EEE2FD,1,1,0xC3EEE2FD},{0xA9EF72D4,0x4A8B108F,1,1,0x4A8B108F},{3,0xC3EEE2FD,1,1,0xC3EEE2FD},{0xA9EF72D4,0x4A8B108F,1,1,0x4A8B108F},{3,0xC3EEE2FD,1,1,0xC3EEE2FD},{0xA9EF72D4,0x4A8B108F,1,1,0x4A8B108F}};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 5; i = i + 1)
        l_2[i] = 5U;
    for (g_3[3][1] = 4; (g_3[3][1] >= 1); g_3[3][1] -= 1)
    { /* block id: 3 */
        uint32_t l_4 = 0x32A831D2;
        if (g_3[3][1])
            break;
        l_4 = g_3[3][1];
    }
