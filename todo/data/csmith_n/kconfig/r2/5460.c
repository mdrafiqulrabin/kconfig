...
static uint32_t g_8[4][1] = {{4294967292UL},{4294967292UL},{4294967292UL},{4294967292UL}};
...
static int8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_6 = 0x3C69L;
    g_8[3][0] = (safe_lshift_func_uint16_t_u_s((safe_sub_func_int16_t_s_s(0xB136L, l_6)), g_7));
    return l_6;
}
