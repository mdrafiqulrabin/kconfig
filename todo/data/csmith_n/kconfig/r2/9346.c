...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_2[6][4] = {{0xFD41L,0x2E08L,0xF57AL,0xF57AL},{0x8070L,0x8070L,0xFD41L,0xF57AL},{0x167FL,0x2E08L,0x167FL,0xFD41L},{0x167FL,0xFD41L,0xFD41L,0x167FL},{0x8070L,0xFD41L,0xF57AL,0xFD41L},{0xFD41L,0x2E08L,0xF57AL,0xF57AL}};
    int32_t l_3 = (-1L);
    int i, j;
    l_3 = l_2[4][2];
    return g_4;
