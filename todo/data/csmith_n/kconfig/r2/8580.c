...
{ /* block id: 0 */
    int32_t l_5 = 5;
    int32_t l_12 = 0x5DAA08BB;
    union U1 l_13 = {1};
    l_12 = ((g_2 <= (((0x095A && (0x95AE649F ^ g_2)) != ((int32_t)g_2 % (int32_t)((l_5 && (0xF4F8 != (((l_5 != ((uint32_t)((int16_t)((int16_t)0x936B % (int16_t)0x6DFC) << (int16_t)l_5) % (uint32_t)0xDE450BB1)) | g_2) == 5))) && l_5))) | 0x60813C27)) && g_2);
    return l_13;
}
