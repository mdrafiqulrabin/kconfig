...
static volatile int16_t g_30 = (-10);/* VOLATILE GLOBAL g_30 */
static volatile uint32_t g_32 = 0xDFE936BE;/* VOLATILE GLOBAL g_32 */
...
inline static int32_t  func_26(void)
{ /* block id: 36 */
    uint32_t l_27 = 0xF4F823AA;
    int32_t l_31[6] = {0x11BBB4F5,0x99CDF9C7,0x11BBB4F5,0x11BBB4F5,0x99CDF9C7,0x11BBB4F5};
    int i;
    l_27++;
    ++g_32;
    return g_32;
