...
/* --- GLOBAL VARIABLES --- */
static float * volatile g_4 = (void*)0;/* VOLATILE GLOBAL g_4 */
static float g_6 = 0x1.1p+1;
static struct S0 g_7 = {65,4294967294UL,0x100C4307L};/* VOLATILE GLOBAL g_7 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x8E418A52L;
    float *l_3 = (void*)0;
    float *l_5 = &g_6;
    (*l_5) = (0xD.7FE64Fp+82 >= l_2);
    return g_7;
}
