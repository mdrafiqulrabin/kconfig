...
{ /* block id: 0 */
    ...
    int32_t l_3 = (-6);
    int16_t l_15 = 0x3836;
    uint16_t l_17 = 0xB51F;
    l_3 = l_2;
    l_17 = ((1 && (((uint16_t)l_2 % (uint16_t)(-(int16_t)(((int16_t)(l_3 < l_2) << (int16_t)7) != ((uint16_t)((((uint32_t)(l_3 > (l_2 != (l_15 ^ (((~(l_3 > (l_2 > 1))) != (-1)) >= l_3)))) % (uint32_t)l_15) != l_2) ^ l_15) << (uint16_t)0)))) & l_2)) | l_3);
    return l_17;
}
