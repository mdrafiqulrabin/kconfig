...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xAAEB9AE7L;
static float g_15 = 0x1.Bp-1;
static float * volatile g_14 = &g_15;/* VOLATILE GLOBAL g_14 */
...
{ /* block id: 0 */
    int8_t *l_10 = (void*)0;
    int32_t l_13 = 0L;
    uint16_t l_16 = 0xEE39L;
    for (g_2 = 16; (g_2 >= 21); g_2 = safe_add_func_uint8_t_u_u(g_2, 2))
    { /* block id: 3 */
        uint32_t l_5 = 18446744073709551610UL;
        if (l_5)
            break;
    }
    (*g_14) = (safe_sub_func_float_f_f((safe_div_func_float_f_f((l_10 != l_10), (safe_add_func_float_f_f(0xA.C10977p+47, l_13)))), g_2));
    return l_16;
}
