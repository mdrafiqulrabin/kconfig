...
{ /* block id: 36 */
    ...
    int16_t l_47 = (-9);
    (*l_35) = l_33;
    (*l_46) = ((__builtin_popcountl((l_37 == (void*)0)) != (!((float)((float)((((float)(**l_35) - (float)(*l_36)) < (((*l_33) == (((((((**l_35) > ((((void*)0 != (*l_35)) <= (*l_36)) >= 0x4.Ep+1)) >= 0x6.F28A99p+87) < (**l_35)) < (*l_36)) < (**l_35)) == 0xB.4A2C6Ep+6)) < (**l_37))) >= 0x5.F890BAp+33) - (float)(-0x9.9p+1)) + (float)0x0.3p+1))) <= l_45);
    (*l_46) = __builtin_bswap64((**l_37));
    return l_47;
}
