...
static int32_t  func_24(void)
{ /* block id: 36 */
    int32_t l_27 = 0xBF2465CD;
    uint16_t l_30 = 0x21AA;
    int32_t l_31 = 5;
    uint32_t l_32 = 0x39956A21;
    l_27 = func_25(g_3);
    l_30 = ((0x056EBF4D == func_25((((int16_t)(g_3 > g_3) << (int16_t)__builtin_ffs(g_3)) >= g_3))) & ((g_3 | ((g_3 < l_27) != g_3)) < g_3));
    l_31 = l_30;
    return l_32;
}
