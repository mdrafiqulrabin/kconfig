...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xAA32B1CE;/* VOLATILE GLOBAL g_2 */
static int32_t g_3 = 5;
static volatile int32_t g_6 = 0;/* VOLATILE GLOBAL g_6 */
static int32_t g_7 = 0xB733C633;
...
{ /* block id: 0 */
    uint8_t l_11 = 0xEF;
    int32_t l_13 = (-1);
    for (g_3 = 0; (g_3 == 22); g_3 += 7)
    { /* block id: 3 */
        volatile uint8_t l_12 = 0x25;/* VOLATILE GLOBAL l_12 */
