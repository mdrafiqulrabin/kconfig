...
{ /* block id: 36 */
    ...
    int32_t l_35 = 0x28033590;
    l_35 ^= ((safe_sub_func_int16_t_s_s((safe_rshift_func_int16_t_s_u((g_6[0] & (l_32 | ((g_6[0] == l_32) >= (1 == ((g_6[0] & (l_32 && (safe_sub_func_int16_t_s_s(g_6[0], (__builtin_popcount(g_6[0]) == g_6[0]))))) != g_6[0]))))), g_6[0])), l_32)) && 255U);
    return g_6[0];
}
