...
{ /* block id: 0 */
    ...
    int32_t *l_2 = &l_3;
    const int32_t l_6 = 0xCD509978L;
    const int32_t *l_5[10] = {&l_6,&l_6,&l_6,&l_6,&l_6,&l_6,&l_6,&l_6,&l_6,&l_6};
    const int32_t **l_4[7][3] = {{&l_5[2],&l_5[2],&l_5[2]},{(void*)0,&l_5[2],(void*)0},{&l_5[2],&l_5[2],&l_5[2]},{(void*)0,&l_5[2],(void*)0},{&l_5[2],&l_5[2],&l_5[2]},{(void*)0,&l_5[2],(void*)0},{&l_5[2],&l_5[2],&l_5[2]}};
    int32_t **l_7 = &l_2;
    int32_t *l_8 = (void*)0;
    int16_t l_9 = (-1L);
    int i, j;
