...
static int32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_2[6][5] = {{0,3,0,0,3},{0x47DC,1,0xE77A,0xB8FA,0xE77A},{3,3,0xB4E1,3,3},{0xE77A,0xB8FA,0xE77A,1,0x47DC},{3,0,0,3,0},{0x47DC,0xB8FA,0,0xB8FA,0x47DC}};
    int32_t l_4 = 0xDFE4D9ED;
    uint32_t l_5 = 0U;
    int i, j;
    l_2[3][4] = (-1);
    l_4 = g_3;
