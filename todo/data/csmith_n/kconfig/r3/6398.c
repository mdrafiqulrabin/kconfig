...
static int8_t  func_1(void)
{ /* block id: 0 */
    float l_2[10] = {0xB.CA0029p-59,(-0x1.5p-1),0xB.CA0029p-59,0xB.CA0029p-59,(-0x1.5p-1),0xB.CA0029p-59,0xB.CA0029p-59,(-0x1.5p-1),0xB.CA0029p-59,0xB.CA0029p-59};
    int32_t l_5 = 0xEA122098L;
    int i;
    l_2[5] = 0x2.AC204Ep+76;
    g_6 = (safe_rshift_func_int8_t_s_u(l_5, 2));
    return g_6;
}
