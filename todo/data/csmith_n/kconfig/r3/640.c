...
static int32_t  func_28(void)
{ /* block id: 36 */
    uint32_t l_29 = 0x56A42623L;
    uint8_t l_31 = 0xAEL;
    int8_t * const l_32 = &g_33;
    int32_t l_34 = 0x8A514227L;
    int32_t l_35[9][4] = {{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)},{(-3L),1L,1L,(-3L)}};
    int i, j;
    g_30 &= l_29;
    l_35[4][0] = (l_31 > (l_34 ^= ((void*)0 == l_32)));
    g_36 = ((void*)0 != &g_33);
    return l_29;
}
