...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_5 = 0x34504CD4L;
static int32_t g_33 = (-7L);
static int32_t * volatile g_32[2] = {&g_33,&g_33};
static int32_t * volatile g_34[3] = {&g_33,&g_33,&g_33};
static int32_t * volatile g_35 = &g_33;/* VOLATILE GLOBAL g_35 */
...
inline static int8_t  func_29(void)
{ /* block id: 36 */
    float l_30[5] = {0x7.A1C17Cp+22,0x7.A1C17Cp+22,0x7.A1C17Cp+22,0x7.A1C17Cp+22,0x7.A1C17Cp+22};
    int32_t l_31 = 1L;
    int i;
    (*g_35) = l_31;
    return g_33;
