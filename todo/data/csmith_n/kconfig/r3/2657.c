...
static const union U3  func_31(void);
inline static union U3 * func_32(union U3 * p_33);
...
static const union U3  func_31(void)
{ /* block id: 36 */
    union U3 l_35 = {0x5C0C8FBF};
    union U3 *l_34 = &l_35;
    union U3 **l_39 = (void*)0;
    union U3 **l_40 = &l_34;
    const union U3 l_44 = {0x2BE2FF5F};
lbl_43:
    (*l_40) = func_32(l_34);
    for (l_35.f3 = 0; (l_35.f3 < 26); l_35.f3++)
    { /* block id: 43 */
        if (l_35.f3)
            goto lbl_43;
    }
...
inline static union U3 * func_32(union U3 * p_33)
{ /* block id: 37 */
    uint16_t l_36 = 0x8838;
    float l_38 = 0x0.0p+1;
    float *l_37 = &l_38;
    (*l_37) = l_36;
    return p_33;
    /* statement id: 39 */
    //assert (func_32_rv == &l_35);
}
