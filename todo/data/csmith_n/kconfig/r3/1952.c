...
/* --- GLOBAL VARIABLES --- */
static float g_2 = 0x5.Ep+1;
static uint32_t g_13 = 4294967295UL;


/* --- FORWARD DECLARATIONS --- */
static int32_t  func_1(void);
static float  func_7(uint16_t  p_8, int32_t  p_9, int16_t  p_10, int32_t  p_11);
...
{ /* block id: 0 */
    int8_t l_12 = 0xC1L;
    g_2 = ((g_2 > (safe_sub_func_float_f_f((((-0x6.Ap+1) == ((((((((safe_mul_func_float_f_f(func_7((l_12 && g_13), g_13, l_12, l_12), (safe_div_func_float_f_f(l_12, 0x0.Fp+1)))) != g_13) > 0x9.13D0BBp+32) < g_2) < 0x1.5p-1) >= 0x1.071A05p-50) < l_12) <= l_12)) >= 0xA.AE974Cp+69), g_2))) != g_2);
    return g_13;
}
