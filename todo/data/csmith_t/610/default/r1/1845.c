...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xE677B568L;
static struct S2 g_5 = {0x9141L,65535UL,0x13L,0x45L,22,-1L,-3L};/* VOLATILE GLOBAL g_5 */
...
static struct S2  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 != 16); g_2 = safe_add_func_uint8_t_u_u(g_2, 1))
    { /* block id: 3 */
        if (g_2)
            break;
    }
