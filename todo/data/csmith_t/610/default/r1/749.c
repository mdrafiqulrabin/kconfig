...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_4 = 0x52L;/* VOLATILE GLOBAL g_4 */
static uint16_t g_5 = 7UL;
static uint32_t g_13 = 0x0069F30CL;
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_6 = 0xE7D2L;
    uint8_t l_9 = 0UL;
    uint32_t *l_12 = &g_13;
    int32_t l_14 = (-1L);
    l_14 |= ((safe_mul_func_int8_t_s_s(g_4, (g_5 || l_6))) == (safe_add_func_uint8_t_u_u(l_6, (l_9 != (safe_sub_func_uint32_t_u_u(((*l_12) = g_5), ((void*)0 == l_12)))))));
    return g_13;
}
