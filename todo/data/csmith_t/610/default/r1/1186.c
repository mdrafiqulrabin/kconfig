...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xA012E1DFL;
static const union U2 g_9 = {0};/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    ...
    g_3 = 0x4800FA72L;
    for (g_3 = 0; (g_3 >= (-12)); g_3 = safe_sub_func_uint64_t_u_u(g_3, 3))
    { /* block id: 4 */
        const union U2 *l_7 = (void*)0;
        const union U2 **l_6 = &l_7;
