...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int16_t l_3 = 0x98A5L;
    int32_t * volatile *l_6[8][1] = {{&g_4},{&l_2},{&l_2},{&g_4},{&l_2},{&l_2},{&g_4},{&l_2}};
    int i, j;
    l_3 &= 0x10C93B4EL;
    g_4 = g_4;
    for (l_3 = (-1); (l_3 == (-6)); l_3 = safe_sub_func_int8_t_s_s(l_3, 3))
    { /* block id: 5 */
        uint8_t l_9[5][10] = {{255UL,0UL,255UL,0x91L,0x91L,255UL,0UL,255UL,0x91L,0x91L},{255UL,0UL,255UL,0x91L,0x91L,255UL,0UL,255UL,0x91L,0x91L},{255UL,0UL,255UL,0x91L,0x91L,255UL,0UL,255UL,0x91L,0x91L},{255UL,0UL,255UL,0x91L,0x91L,255UL,0UL,255UL,255UL,255UL},{0x13L,0xCDL,0x13L,255UL,255UL,0x13L,0xCDL,0x13L,255UL,255UL}};
        int i, j;
        if (l_9[0][5])
            break;
    }
    for (g_5 = (-23); (g_5 > 26); g_5 = safe_add_func_uint8_t_u_u(g_5, 4))
    { /* block id: 10 */
        uint8_t l_12 = 0UL;
        l_12 = (*g_4);
    }
