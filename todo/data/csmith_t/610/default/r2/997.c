...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[9] = {0xE0184DCCL,0xE0184DCCL,0xE0184DCCL,0xE0184DCCL,0xE0184DCCL,0xE0184DCCL,0xE0184DCCL,0xE0184DCCL,0xE0184DCCL};
...
{ /* block id: 0 */
    int16_t l_2 = 5L;
    int32_t *l_3[6] = {&g_4[7],&g_4[7],&g_4[7],&g_4[7],&g_4[7],&g_4[7]};
    uint32_t l_5[1][4] = {{4294967292UL,4294967292UL,4294967292UL,4294967292UL}};
    int i, j;
    l_5[0][3]--;
    return g_4[7];
}
