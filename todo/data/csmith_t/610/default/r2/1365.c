...
/* --- GLOBAL VARIABLES --- */
static volatile uint16_t g_4 = 0xA7C2L;/* VOLATILE GLOBAL g_4 */
static uint8_t g_9[10] = {1UL,0x00L,1UL,1UL,0x00L,1UL,1UL,0x00L,1UL,1UL};
static int16_t g_19 = 0L;
static int16_t g_21 = 0x8F4FL;
static uint8_t g_22 = 0xD6L;
...
/* 
 * reads : g_4 g_9 g_22
 * writes: g_4 g_9 g_19 g_21 g_22
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t *l_3 = (void*)0;
    int32_t l_7 = 0x62E08974L;
    int32_t *l_8[1][1][8] = {{{&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7}}};
    int16_t *l_18 = &g_19;
    int16_t *l_20 = &g_21;
    int i, j, k;
    ++g_4;
    g_9[1]++;
    g_22 = ((-5L) > (safe_lshift_func_uint16_t_u_s(3UL, (g_9[1] == (safe_sub_func_int16_t_s_s(1L, (safe_lshift_func_int16_t_s_s(((*l_20) = ((*l_18) = g_9[8])), 2))))))));
    return g_22;
}
