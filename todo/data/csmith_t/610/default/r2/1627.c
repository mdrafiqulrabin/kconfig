...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x8F4F823AL;/* VOLATILE GLOBAL g_2 */
static int32_t g_3 = (-7L);
static int32_t g_7 = 0x77509CB0L;
...
static int8_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_9 = 0x1EB64D07DDBF4DF7LL;
    for (g_3 = 16; (g_3 != 7); g_3 = safe_sub_func_uint32_t_u_u(g_3, 9))
    { /* block id: 3 */
        int32_t *l_6 = &g_7;
        int32_t *l_8[8][4] = {{&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7}};
        int i, j;
        l_9--;
    }
    return l_9;
