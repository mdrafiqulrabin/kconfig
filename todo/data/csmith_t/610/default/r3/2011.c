...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x13281D21L;/* VOLATILE GLOBAL g_2 */
...
static int32_t g_6[1][4] = {{1L,1L,1L,1L}};
static int32_t g_10 = 0x4DBBE568L;
...
{ /* block id: 0 */
    uint32_t l_14 = 1UL;
    for (g_6[0][1] = 0; (g_6[0][1] != 13); g_6[0][1]++)
    { /* block id: 3 */
        int32_t *l_9 = &g_10;
        int32_t *l_11 = &g_10;
        int32_t *l_12 = &g_10;
        int32_t *l_13[2][3] = {{&g_10,&g_10,&g_10},{(void*)0,(void*)0,(void*)0}};
        int i, j;
        l_14++;
    }
    return g_6[0][1];
