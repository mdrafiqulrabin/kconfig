...
static volatile uint32_t g_8 = 0x977A1245L;/* VOLATILE GLOBAL g_8 */
...
static union U2  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[7] = {0x921DED68L,0x624CDB8FL,0x921DED68L,0x921DED68L,0x624CDB8FL,0x921DED68L,0x921DED68L};
    int i;
    ...
    for (g_3 = (-5); (g_3 > (-21)); g_3 = safe_sub_func_int32_t_s_s(g_3, 8))
    { /* block id: 9 */
        int16_t l_6 = 0L;
        int32_t *l_7 = (void*)0;
        ++g_8;
