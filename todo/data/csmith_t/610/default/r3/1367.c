...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2[1] = {4294967289UL};
static int32_t g_3 = 0x20F89B54L;
static int32_t g_5 = 0x2C58FB77L;
static int32_t g_10 = 0xA964A90CL;
static volatile uint16_t g_11 = 0xAB9CL;/* VOLATILE GLOBAL g_11 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_11 g_2 g_10 g_5
 * writes: g_3 g_11 g_10 g_5
 */
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_9 = (-1L);
    ...
    { /* block id: 3 */
        ...
        int32_t *l_6 = &g_5;
        int32_t *l_7 = &g_5;
        int32_t *l_8[2][4] = {{&g_5,&g_5,&g_3,&g_5},{&g_5,(void*)0,(void*)0,&g_5}};
        int i, j;
        --g_11;
        if (g_2[g_3])
            continue;
