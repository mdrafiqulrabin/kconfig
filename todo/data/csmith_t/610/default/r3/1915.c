...
static uint32_t g_7 = 0x2065C829L;
static volatile int32_t g_12 = 0x356EC7E4L;/* VOLATILE GLOBAL g_12 */
...
{ /* block id: 0 */
    ...
    int32_t *l_3 = &g_4;
    int32_t *l_5 = &g_4;
    int32_t *l_6[3][5] = {{&g_4,&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4,&g_4}};
    int i, j;
    g_7++;
    for (g_7 = 0; (g_7 < 20); g_7 = safe_add_func_uint16_t_u_u(g_7, 8))
    { /* block id: 4 */
