...
static const union U1 g_11 = {-2L};/* VOLATILE GLOBAL g_11 */
...
static const union U1  func_1(void)
{ /* block id: 0 */
    uint16_t l_8[7] = {1UL,1UL,1UL,1UL,1UL,1UL,1UL};
    int32_t *l_9 = &g_10;
    int i;
    (*l_9) &= (safe_rshift_func_int16_t_s_s((safe_mod_func_uint8_t_u_u(0x15L, (safe_sub_func_uint32_t_u_u(8UL, (l_8[4] = (-8L)))))), 2));
    return g_11;
}
