...
/* --- GLOBAL VARIABLES --- */
static int32_t g_6 = 0x0FE6E324L;
static int32_t * volatile g_29 = (void*)0;/* VOLATILE GLOBAL g_29 */
static union U0 g_32[2] = {{4294967295UL},{4294967295UL}};
...
inline static float  func_27(void)
{ /* block id: 36 */
    int32_t l_28 = 0x1A62A969L;
    int32_t l_30 = 0x840EB449L;
    union U0 *l_31 = &g_32[0];
    l_30 &= __builtin_popcount((((-3L) && (l_28 >= l_28)) > (g_6 > g_6)));
    l_31 = (void*)0;
    /* statement id: 38 */
    assert (l_31 == 0);
    return g_6;
