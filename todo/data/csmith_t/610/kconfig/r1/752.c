...
static int32_t g_4 = 0xF40FC027;
static volatile int32_t g_31[7] = {0x45CB81EC,0x45CB81EC,0x45CB81EC,0x45CB81EC,0x45CB81EC,0x45CB81EC,0x45CB81EC};
...
{ /* block id: 36 */
    ...
    { /* block id: 39 */
        for (g_31[3] = 0; g_31[3] < 10; g_31[3] += 1)
        {
            l_30[g_31[3]] = 0x0231;
        }
    }
