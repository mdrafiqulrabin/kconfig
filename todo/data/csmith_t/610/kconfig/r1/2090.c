...
/* --- GLOBAL VARIABLES --- */
static float g_3 = 0x1.B9F9B3p-20;
static int32_t g_5 = 0x8094A188;
static int8_t g_28 = 0x8C;
static int32_t g_35 = 0x686A37BD;
...
static uint32_t  func_33(void)
{ /* block id: 36 */
    int32_t l_34 = 0xD4AA41A8;
    g_36 = ((__builtin_parityl((g_35 = l_34)) < 0xFD) <= g_5);
    return g_35;
}
