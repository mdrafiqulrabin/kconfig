...
/* --- GLOBAL VARIABLES --- */
static float g_7[3] = {0x1.Bp-1,0x1.Bp-1,0x1.Bp-1};
...
/* ------------------------------------------ */
/* 
 * reads : g_13 g_40 g_41
 * writes: g_41
 */
inline static uint32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31 = 0xFDAD5A51L;
    int32_t l_38 = 0x01516EA3L;
    (*g_40) ^= (__builtin_bswap32(l_31) < (__builtin_bswap32((l_31 > (safe_lshift_func_int8_t_s_s(((l_31 || (((safe_div_func_int16_t_s_s(((l_31 != (l_31 , l_31)) < ((l_31 , (safe_rshift_func_uint8_t_u_s((l_31 || g_13), l_38))) > 0UL)), g_13)) != g_13) >= g_13)) ^ l_38), g_13)))) != g_13));
    return l_31;
}
