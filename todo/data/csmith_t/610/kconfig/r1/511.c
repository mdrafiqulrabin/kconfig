...
static volatile int8_t g_29 = 0L;/* VOLATILE GLOBAL g_29 */
static volatile int8_t * volatile g_28[5] = {&g_29,&g_29,&g_29,&g_29,&g_29};
...
/* ------------------------------------------ */
/* 
 * reads : g_8 g_28 g_30 g_31
 * writes: g_31
 */
static uint32_t  func_27(void)
{ /* block id: 36 */
    float l_32 = 0x0.5p+1;
    (*g_30) = ((g_8 > ((void*)0 != g_28[1])) & g_8);
    return g_31;
}
