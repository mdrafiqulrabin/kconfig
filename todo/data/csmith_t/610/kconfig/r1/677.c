...
static uint32_t  func_27(void)
{ /* block id: 36 */
    uint32_t l_30 = 0xB01D91E6;
    int32_t l_42 = (-8);
    int32_t *l_41 = &l_42;
    uint16_t l_43 = 0x68E1;
    (*l_41) = (((uint32_t)l_30 % (uint32_t)((((uint16_t)0x3CC9 << (uint16_t)14) <= (((uint16_t)(((uint16_t)(((l_30 && ((0x806AA1C3 ^ ((int16_t)0x6091 << (int16_t)11)) == l_30)) == 3) , __builtin_popcountl(l_30)) - (uint16_t)l_30) ^ l_30) >> (uint16_t)l_30) >= l_30)) , l_30)) & l_30);
    return l_43;
}
