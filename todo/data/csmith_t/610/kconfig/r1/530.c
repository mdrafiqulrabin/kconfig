...
/* --- GLOBAL VARIABLES --- */
static int8_t g_3 = 0xBAL;
static union U2 g_34 = {0x996A53086335C0DELL};
static union U2 *g_33 = &g_34;


/* --- FORWARD DECLARATIONS --- */
static uint8_t  func_29(void);
static union U2 * func_30(uint8_t  p_31, const int8_t * p_32);


/* --- FUNCTIONS --- */
/* ------------------------------------------ */
/* 
 * reads : g_3 g_33 g_34.f2
 * writes: g_33
 */
static uint8_t  func_29(void)
{ /* block id: 36 */
    g_33 = func_30(g_3, &g_3);
    return g_34.f2;
}
