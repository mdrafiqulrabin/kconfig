...
{ /* block id: 36 */
    int32_t l_33 = 4;
    int32_t l_34 = 0xC44D9964;
    l_33 = ((int16_t)((uint16_t)(0x30DF || (((0x2FA8 <= (l_33 >= (-3))) , ((l_34 &= l_33) == ((uint16_t)((int16_t)l_33 << (int16_t)l_33) * (uint16_t)(((int16_t)l_33 >> (int16_t)(l_33 | l_33)) != l_33)))) == l_33)) * (uint16_t)1) << (int16_t)l_33);
    return l_34;
}
