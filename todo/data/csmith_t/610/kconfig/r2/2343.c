...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0x6AF1124F;
static int16_t g_43 = 0x4593;
...
{ /* block id: 36 */
    ...
    l_47 = ((int16_t)(0xD3833037 ^ (l_33 | 0U)) - (int16_t)func_34(l_33, g_3, ((((!g_3) || 0xD8EF068C) & (l_33 && func_40(g_3))) == 4294967295U), l_33));
    g_48 = (-9);
    return g_43;
}
...
{ /* block id: 40 */
    ...
    l_46 = ((int32_t)((g_3 ^ g_3) ^ p_36) - (int32_t)p_36);
    return l_46;
}
