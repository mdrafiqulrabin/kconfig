...
/* --- GLOBAL VARIABLES --- */
static const uint64_t g_3[2] = {0x1E124DC41FD9D089LL,0x1E124DC41FD9D089LL};
static volatile int32_t g_36 = 0L;/* VOLATILE GLOBAL g_36 */
static int32_t g_37 = 0xA52FA57AL;
...
{ /* block id: 36 */
    ...
    int32_t **l_34 = &l_35;
    (*l_34) = (void*)0;
    for (g_37 = 0; (g_37 < (-26)); g_37 = safe_sub_func_int8_t_s_s(g_37, 7))
    { /* block id: 40 */
        return g_37;
    }
    return g_3[1];
