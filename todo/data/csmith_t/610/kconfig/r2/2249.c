...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_2[9] = {18446744073709551615UL,0x3185299DADA439BELL,18446744073709551615UL,18446744073709551615UL,0x3185299DADA439BELL,18446744073709551615UL,18446744073709551615UL,0x3185299DADA439BELL,18446744073709551615UL};
    int32_t l_3[9][2] = {{(-1L),(-1L)},{(-1L),(-3L)},{(-1L),0xB9AE77ABL},{(-3L),0xB9AE77ABL},{(-1L),(-3L)},{(-1L),(-1L)},{(-1L),(-3L)},{(-1L),0xB9AE77ABL},{(-3L),0xB9AE77ABL}};
    int i, j;
    l_3[3][1] ^= l_2[6];
    return l_2[4];
}
