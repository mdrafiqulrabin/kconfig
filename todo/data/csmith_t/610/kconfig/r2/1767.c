...
static uint32_t g_37 = 0x4C6F4446;
...
static uint16_t  func_26(void)
{ /* block id: 36 */
    int32_t l_31 = 0xDE6F885E;
    int16_t l_34 = 1;
    g_37 = (g_4 ^ ((int16_t)((uint16_t)(l_31 == ((((int32_t)0xF34BDAC8 + (int32_t)g_4) > (g_4 && (((((l_34 || (((int16_t)g_4 >> (int16_t)15) && (l_31 || l_34))) | 4294967293U) ^ g_4) && l_31) | l_31))) || 0xDC9FE9A5)) >> (uint16_t)l_31) << (int16_t)l_31));
    return l_31;
}
