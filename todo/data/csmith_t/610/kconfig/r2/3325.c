...
static float g_39 = 0x5.716399p+90;
...
static uint32_t  func_29(void)
{ /* block id: 36 */
    uint32_t l_30 = 0xCCDE6BC0L;
    int64_t l_33 = 1L;
    (*g_38) = (l_30 != ((((((safe_lshift_func_int8_t_s_s((__builtin_ctzll(g_9) > (g_9 , (l_33 && (safe_sub_func_uint16_t_u_u(g_9, g_9))))), 3)) , (safe_mod_func_uint16_t_u_u((((g_9 != 0x495E0E2BL) || l_33) & g_9), l_30))) || l_30) > l_30) , l_30) >= 0x4.A83AFDp-36));
    return g_9;
}
