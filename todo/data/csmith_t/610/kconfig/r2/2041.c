...
inline static uint16_t  func_29(void)
{ /* block id: 36 */
    int32_t l_32 = 0xF746E33A;
    struct S0 l_33 = {4488,5,6021,0xB7A14055,5,2196};
    int32_t l_34 = 0;
    int32_t l_36 = 9;
    int32_t *l_35 = &l_36;
    int32_t l_38 = 0x583E3585;
    int32_t *l_37 = &l_38;
    int32_t *l_39 = (void*)0;
    int32_t l_40 = 0x77DFCC86;
    uint16_t l_41 = 0x5AD6;
    l_40 = ((*l_37) = (((uint32_t)__builtin_ffsll(l_32) - (uint32_t)((l_33 , ((l_34 &= 0x81DE) || (-10))) & ((*l_35) |= __builtin_popcount(l_33.f3)))) & 0x28AD));
    return l_41;
}
