...
{ /* block id: 36 */
    ...
    int32_t l_36 = 0L;
    int32_t l_44 = (-1L);
    int32_t l_45 = 0xB870004DL;
    uint32_t l_46 = 0xAC3EFC16L;
    int32_t *l_47 = (void*)0;
    int32_t l_48 = 0xD423CB8EL;
    l_48 |= (__builtin_parityl(l_36) & (safe_mul_func_uint8_t_u_u((safe_add_func_uint16_t_u_u((!(((((safe_mul_func_int16_t_s_s(l_36, 1UL)) && l_36) || l_44) || l_36) && __builtin_ctzll(l_45))), (-5L))), l_46)));
    return l_45;
}
