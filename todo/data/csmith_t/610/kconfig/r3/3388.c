...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_5 = 0xD00693E9;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0x8094A188;
    int32_t l_6[6] = {0x3607A988,0x3607A988,0x3607A988,0x3607A988,0x3607A988,0x3607A988};
    int i;
    l_6[4] = (l_2 == (((int32_t)(1U <= g_5) + (int32_t)(-1)) && 1));
    return g_5;
}
