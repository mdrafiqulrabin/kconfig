...
{ /* block id: 36 */
    ...
    int32_t *l_50 = &l_43;
    uint32_t l_51 = 0U;
    if ((safe_lshift_func_uint16_t_u_s((safe_lshift_func_uint16_t_u_u(((*l_34) = 65531U), 12)), l_36)))
    { /* block id: 38 */
        int32_t *l_37 = &l_36;
        int32_t l_39 = 0xF7B1466A;
        int32_t *l_38 = &l_39;
        (*l_38) |= ((*l_37) = l_36);
        for (l_35 = (-16); (l_35 == 53); l_35 = safe_add_func_uint16_t_u_u(l_35, 1))
        { /* block id: 43 */
            int32_t **l_42 = &l_38;
            (*l_42) = &l_36;
            /* statement id: 44 */
        ...
        assert (l_38 == &l_36 || l_38 == &l_39);
        l_43 |= (*l_37);
    }
    else
    { /* block id: 48 */
        uint32_t l_46 = 5U;
        for (l_36 = 8; (l_36 < (-20)); l_36 = safe_sub_func_int32_t_s_s(l_36, 1))
        { /* block id: 51 */
            int32_t *l_47 = &l_43;
            (*l_47) &= l_46;
        }
    }
    (*l_50) = __builtin_clzll(((void*)0 == l_48));
    return l_51;
}
