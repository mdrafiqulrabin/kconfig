 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --compound-assignment --no-consts --no-divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --no-uint8 --float --no-math64 --inline-function --no-muls --safe-math --packed-struct --no-paranoid --pointers --structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --no-builtins
 * Seed:      259096924
 */
...
inline static int16_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_2 = 0x68C0L;
    int32_t *l_3 = (void*)0;
    int32_t l_5 = 0x509978F3L;
    int32_t *l_4 = &l_5;
    union U1 l_8 = {0xBFC88EB9L};
    union U1 *l_7 = &l_8;
    union U1 **l_6 = &l_7;
    int32_t l_9 = 0x65420764L;
    (*l_4) ^= l_2;
    (*l_4) = (*l_4);
    (*l_6) = (void*)0;
    return l_9;
