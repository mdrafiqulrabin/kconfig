...
static volatile struct S0 g_30 = {0L,4294967295UL,0L,0L,5L};/* VOLATILE GLOBAL g_30 */
static volatile struct S0 *g_29 = &g_30;
...
static int32_t  func_28(void)
{ /* block id: 36 */
    volatile struct S0 **l_31 = (void*)0;
    volatile struct S0 **l_32 = &g_29;
    int32_t *l_33 = &g_34;
    (*l_32) = g_29;
    (*l_33) = (-10L);
    return g_30.f2;
