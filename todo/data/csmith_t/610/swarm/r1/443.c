 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --compound-assignment --consts --divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --uint8 --no-float --no-math64 --no-inline-function --no-muls --no-safe-math --packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --no-volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      3531744522
 */
...
static uint32_t  func_32(void)
{ /* block id: 36 */
    const uint32_t l_33 = 0x8FB0B44CL;
    int32_t l_36 = 0x1A7A81A8L;
    int32_t l_37 = (-10L);
    int32_t l_38 = 0x461E7071L;
    l_38 ^= (l_33 & ((uint32_t)((0x4DA8L & 0x8405L) & (l_36 != l_37)) - (uint32_t)l_36));
    return l_33;
}
