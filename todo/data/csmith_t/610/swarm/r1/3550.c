...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x473EB905L;
    float l_3 = 0x0.7p-1;
    g_4 = ((0x5.504CD4p+64 < l_2) <= l_3);
    return g_4;
}
