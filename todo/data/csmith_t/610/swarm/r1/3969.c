...
/* --- GLOBAL VARIABLES --- */
static union U1 g_4 = {4294967288UL};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    const union U1 *l_3 = &g_4;
    const union U1 **l_2 = &l_3;
    int32_t l_5 = 9L;
    (*l_2) = (void*)0;
    /* statement id: 1 */
    assert (l_3 == 0);
