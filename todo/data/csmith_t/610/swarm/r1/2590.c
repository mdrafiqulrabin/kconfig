 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --no-uint8 --float --math64 --no-inline-function --no-muls --safe-math --packed-struct --paranoid --pointers --structs --no-unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      2112716762
 */
...
static float  func_28(uint32_t  p_29, uint16_t  p_30, float  p_31);
...
static uint32_t  func_27(void)
{ /* block id: 36 */
    uint16_t l_32 = 0xFDAD;
    float l_38 = 0xC.520EA0p-24;
    float *l_37 = &l_38;
    (*l_37) = func_28(l_32, l_32, (l_32 > (-0x1.2p+1)));
    return l_32;
}
