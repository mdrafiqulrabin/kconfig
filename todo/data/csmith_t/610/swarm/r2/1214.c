...
{ /* block id: 36 */
    int16_t l_33 = 0x93D0;
    int32_t l_38 = 0x0389A9B8;
    g_39 = ((int16_t)((int16_t)(((((int16_t)1 >> (int16_t)15) != l_33) & ((-1) & ((((uint8_t)l_33 << (uint8_t)2) < (__builtin_parity(g_3) != (-(uint32_t)0xF88E10E5))) != (+4U)))) != (l_38 = (g_3 >= g_3))) - (int16_t)0xD5B6) % (int16_t)g_3);
    return g_3;
}
