...
{ /* block id: 0 */
    int32_t **l_2 = (void*)0;
    int32_t *l_3 = (void*)0;
    int32_t l_8 = 0x2ABBF9ACL;
    int32_t *l_15 = (void*)0;
    int32_t *l_16 = (void*)0;
    int32_t l_17 = 0x90FC520EL;
    l_3 = (void*)0;
    l_17 ^= ((int16_t)0L - (int16_t)((int32_t)(0UL > ((((void*)0 == l_3) == 5UL) ^ l_8)) % (int32_t)(~((uint16_t)((int16_t)l_8 << (int16_t)((-9L) && (~l_8))) * (uint16_t)0UL))));
    return l_8;
}
