...
/* --- GLOBAL VARIABLES --- */
static volatile float g_2 = 0x4.1p+1;/* VOLATILE GLOBAL g_2 */
static volatile uint32_t g_3 = 0x13638ECFL;/* VOLATILE GLOBAL g_3 */
