...
/* --- GLOBAL VARIABLES --- */
static int8_t g_4[6] = {0x0D,0x0D,0x0D,0x0D,0x0D,0x0D};
...
static int32_t  func_28(void)
{ /* block id: 36 */
    uint16_t l_29 = 0x3F4F;
    l_29 = __builtin_ffs(g_4[5]);
    return l_29;
}
