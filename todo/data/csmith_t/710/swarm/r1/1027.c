 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --comma-operators --no-compound-assignment --no-consts --no-divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --no-int8 --no-uint8 --float --no-math64 --no-inline-function --no-muls --no-safe-math --no-packed-struct --paranoid --pointers --structs --no-unions --no-volatiles --volatile-pointers --const-pointers --global-variabless --no-builtins
 * Seed:      3312003292
 */
...
static float g_7 = 0x3.09978Fp+49;
static int32_t g_8 = 0xA2A3B3F3L;
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        float *l_5 = (void*)0;
        float *l_6 = &g_7;
        (*l_6) = (0xC.114768p+28 != g_2);
        for (g_8 = (-29); (g_8 >= 28); ++g_8)
        { /* block id: 7 */
            int32_t l_11 = (-9L);
            if (g_2)
                break;
