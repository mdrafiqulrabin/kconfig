 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --no-compound-assignment --no-consts --divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --int8 --no-uint8 --float --math64 --no-inline-function --muls --safe-math --no-packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --no-volatile-pointers --no-const-pointers --global-variabless --no-builtins
 * Seed:      2641880916
 */
...
static float g_7 = 0xC.C4C8D3p-13;
static float g_11 = 0x5.32CF41p-86;
static float g_13 = 0x2.6FE23Ap-4;
...
{ /* block id: 0 */
    ...
    float *l_12 = &g_13;
    int32_t l_14 = 8L;
    l_14 = ((((safe_sub_func_float_f_f(g_4, (((*l_6) = 0x7.0p-1) > (l_5 != (void*)0)))) >= (g_4 > ((*l_10) = 0x0.Cp+1))) == ((*l_12) = 0x1.Ep-1)) == l_14);
    return g_4;
}
