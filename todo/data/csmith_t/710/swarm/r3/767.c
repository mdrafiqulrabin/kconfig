...
static uint16_t g_8 = 0x4276L;
static int32_t g_33 = 5L;
static struct S0 g_34 = {0x0EF7D594L};/* VOLATILE GLOBAL g_34 */
...
{ /* block id: 36 */
    ...
    { /* block id: 39 */
        uint16_t l_32[5][5] = {{0UL,0x3579L,0x3579L,0UL,0UL},{65535UL,4UL,65535UL,4UL,65535UL},{0UL,0UL,0x3579L,0x3579L,0UL},{9UL,4UL,9UL,4UL,9UL},{0UL,0x3579L,0x3579L,0UL,0UL}};
        int i, j;
        for (g_5 = 0; g_5 < 5; g_5 += 1)
        {
            for (g_33 = 0; g_33 < 5; g_33 += 1)
            {
                l_32[g_5][g_33] = 0xC2F4L;
            }
        }
    }
    return g_34;
