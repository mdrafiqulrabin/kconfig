 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --no-compound-assignment --consts --no-divs --embedded-assigns --pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --float --no-math64 --no-inline-function --no-muls --no-safe-math --packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --no-volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      3030379466
 */
...
static uint32_t  func_31(void)
{ /* block id: 36 */
    uint16_t l_32 = 0x525D;
    float l_34 = 0x7.3p+1;
    float *l_33 = &l_34;
    float *l_35 = (void*)0;
    int32_t l_37 = 0xD06BDE64;
    int32_t *l_36 = &l_37;
    uint16_t l_38 = 0x1E70;
    (*l_33) = l_32;
    (*l_36) = ((void*)0 != l_35);
    return l_38;
}
