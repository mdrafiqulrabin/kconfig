 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --no-pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --no-uint8 --float --math64 --inline-function --no-muls --safe-math --packed-struct --no-paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      3977324460
 */
...
inline static int16_t  func_32(void)
{ /* block id: 36 */
    int32_t l_35 = 0x8FECF792;
    int32_t *l_34 = &l_35;
    int32_t **l_33 = &l_34;
    uint32_t l_38 = 0xB6917AB6;
    (*l_33) = (void*)0;
    for (l_35 = (-1); (l_35 < (-4)); l_35 = safe_sub_func_uint16_t_u_u(l_35, 1))
    { /* block id: 40 */
        float *l_39 = (void*)0;
        float l_41 = (-0x1.6p-1);
        float *l_40 = &l_41;
