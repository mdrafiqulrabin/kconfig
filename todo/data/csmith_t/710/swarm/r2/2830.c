 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --comma-operators --compound-assignment --no-consts --no-divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --no-int8 --uint8 --float --no-math64 --no-inline-function --muls --no-safe-math --no-packed-struct --no-paranoid --pointers --structs --unions --no-volatiles --volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      2899405854
 */
...
{ /* block id: 36 */
    ...
    uint16_t *l_46 = &l_47;
    int32_t l_49 = 0x28D029B4;
    int32_t *l_48 = &l_49;
    uint32_t l_50 = 0x45D44756;
    (*l_48) |= __builtin_ffsll(((((((*l_46) = (l_33 >= (l_33 & ((uint16_t)((((*l_44) &= ((uint16_t)((((l_33 < (0x5.62A4B1p+80 < l_33)) , ((~__builtin_ctz((0x30045702 | (-(uint32_t)((uint16_t)((((int16_t)l_33 + (int16_t)__builtin_popcount(l_33)) || 0x2E71) | l_33) >> (uint16_t)14))))) < l_33)) , l_33) == l_33) * (uint16_t)l_33)) , l_33) ^ (-1)) << (uint16_t)l_33)))) < l_33) && 65529U) == l_33) , l_33));
    return l_50;
}
