...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_9 = 0x55B7CEFA;
...
{ /* block id: 36 */
    uint32_t l_31 = 4U;
    int32_t l_32 = 1;
    l_32 = __builtin_bswap64(((l_31 , l_31) , l_31));
    return g_9;
}
