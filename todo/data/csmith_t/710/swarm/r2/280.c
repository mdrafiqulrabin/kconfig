 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --comma-operators --compound-assignment --consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --float --math64 --inline-function --muls --no-safe-math --packed-struct --no-paranoid --no-pointers --structs --unions --volatiles --no-volatile-pointers --const-pointers --global-variabless --no-builtins
 * Seed:      291039388
 */
...
static volatile int32_t g_3 = 0xFE387FB0;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 1;
static volatile float g_7 = 0xD.0C170Cp-76;/* VOLATILE GLOBAL g_7 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    float l_8 = 0x6.B3F365p+39;
    int32_t l_9 = (-7);
    uint32_t l_10 = 0x25BFC88E;
    for (g_4 = 2; (g_4 < 11); g_4 += 2)
    { /* block id: 3 */
        g_7 = g_2;
        l_9 = 6;
    }
