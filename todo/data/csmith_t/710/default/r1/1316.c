...
static struct S2 g_8 = {13,6400,0x15F84255EBDA1846LL,-26497,307,23,-108,14424,6,6838};/* VOLATILE GLOBAL g_8 */
...
static struct S2  func_1(void)
{ /* block id: 0 */
    for (g_2 = (-18); (g_2 == (-27)); g_2 = safe_sub_func_uint16_t_u_u(g_2, 8))
    { /* block id: 3 */
        int32_t **l_5 = (void*)0;
        int32_t *l_7 = &g_2;
        int32_t **l_6 = &l_7;
