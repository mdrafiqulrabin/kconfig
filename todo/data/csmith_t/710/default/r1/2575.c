...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0x8F0AA6E6L;/* VOLATILE GLOBAL g_3 */
static volatile int32_t *g_2 = &g_3;
static volatile int32_t ** volatile g_4[2][3] = {{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2}};
static union U0 g_7 = {0x564DBB9A2F725DC8LL};/* VOLATILE GLOBAL g_7 */
...
static union U0  func_1(void)
{ /* block id: 0 */
    volatile int32_t **l_5[6] = {&g_2,&g_2,&g_2,&g_2,&g_2,&g_2};
