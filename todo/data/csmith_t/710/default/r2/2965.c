...
static uint32_t g_7 = 0x5E1F6F08L;
static int32_t * volatile g_8 = (void*)0;/* VOLATILE GLOBAL g_8 */
static int32_t g_10 = (-7L);
static int32_t * volatile g_9[3][2] = {{&g_10,&g_10},{&g_10,&g_10},{&g_10,&g_10}};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2[8] = {0x4D073FF8L,0x4D073FF8L,0x4D073FF8L,0x4D073FF8L,0x4D073FF8L,0x4D073FF8L,0x4D073FF8L,0x4D073FF8L};
    uint32_t *l_6 = &g_7;
    int i;
    ...
    (*g_11) = (safe_sub_func_int32_t_s_s(g_3, ((*l_6) |= 0x4E677B56L)));
    return g_7;
}
