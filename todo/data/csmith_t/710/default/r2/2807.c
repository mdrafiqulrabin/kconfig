...
static volatile int32_t g_6 = 0xAFA2FAFDL;/* VOLATILE GLOBAL g_6 */
static int32_t g_7 = 0x962EE6D0L;
static uint32_t g_16 = 0xDA3C3D21L;
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int8_t l_5[10] = {0L,0x52L,0L,0L,0x52L,0L,0L,0x52L,0L,0L};
    int32_t l_14 = 0x4A90C6D2L;
    int32_t l_15 = 1L;
    int32_t *l_19 = &g_2;
    int i;
    for (g_2 = 0; (g_2 < (-17)); g_2 = safe_sub_func_uint64_t_u_u(g_2, 5))
    { /* block id: 3 */
        int32_t *l_11 = &g_7;
        int32_t *l_12 = &g_7;
        int32_t *l_13[3][6] = {{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7}};
        int i, j;
        if (l_5[9])
            break;
