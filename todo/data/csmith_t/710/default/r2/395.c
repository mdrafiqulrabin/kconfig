...
{ /* block id: 0 */
    int32_t *l_7 = &g_8;
    int32_t *l_11 = &g_10;
    uint32_t l_12 = 0x3989226CL;
    for (g_3 = 0; (g_3 == (-5)); g_3 = safe_sub_func_uint64_t_u_u(g_3, 9))
    { /* block id: 3 */
        int32_t l_6[6] = {0xDDD3F467L,0xDDD3F467L,0xDDD3F467L,0xDDD3F467L,0xDDD3F467L,0xDDD3F467L};
        int i;
        if (l_6[0])
            break;
        if (g_2[1])
