...
/* --- GLOBAL VARIABLES --- */
static struct S1 g_3 = {0x6CDEAD9BL,-1L,1UL,0x4E94F934L,0x545EL,0x28FDEB77L,0x78FA8F90L,0x3CL,15,-1L};/* VOLATILE GLOBAL g_3 */
static struct S1 *g_5 = &g_3;
static struct S1 ** volatile g_4[3] = {&g_5,&g_5,&g_5};
static struct S1 g_8 = {0x8FA48A2BL,0xEAL,18446744073709551615UL,-1L,0x611FL,0x8EB5EA28L,0x7FFFAA23L,0x40L,81,-3L};/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    struct S1 *l_2[1];
    struct S1 **l_6[8][1] = {{(void*)0},{&g_5},{&g_5},{(void*)0},{&g_5},{&g_5},{(void*)0},{&g_5}};
    struct S1 *l_7[2];
    int i, j;
    for (i = 0; i < 1; i++)
        l_2[i] = &g_3;
