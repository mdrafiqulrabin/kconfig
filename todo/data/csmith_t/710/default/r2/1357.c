...
/* --- GLOBAL VARIABLES --- */
static volatile uint16_t g_4 = 0x97A4L;/* VOLATILE GLOBAL g_4 */
static int32_t * volatile g_5 = (void*)0;/* VOLATILE GLOBAL g_5 */
static int32_t g_7 = 0x2EDC7555L;
static int32_t * volatile g_6 = &g_7;/* VOLATILE GLOBAL g_6 */
static int32_t * volatile g_10[10][3] = {{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7}};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 8; i++)
        l_8[i] = 0x6A162C9CL;
    (*g_6) = (safe_div_func_int8_t_s_s(g_4, 5L));
    (*g_11) = (l_8[1] , l_9);
    return g_4;
}
