...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[7] = {0xAA6E6F7FL,7L,0xAA6E6F7FL,0xAA6E6F7FL,7L,0xAA6E6F7FL,0xAA6E6F7FL};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3[4];
    int32_t l_4 = 0x90EF307DL;
    int32_t *l_5[10] = {&g_3[5],&g_3[5],&g_3[6],&g_3[5],&g_3[5],&g_3[6],&g_3[5],&g_3[5],&g_3[6],&g_3[5]};
    int64_t l_6 = (-1L);
    uint64_t l_7 = 7UL;
    int i;
    l_7--;
