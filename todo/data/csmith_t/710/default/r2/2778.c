...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_5 = 0xF4672159L;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    uint32_t l_8 = 1UL;
    int64_t *l_9 = &g_10;
    int32_t l_11 = 0x58A012E1L;
    l_11 ^= (safe_unary_minus_func_uint64_t_u((safe_div_func_int64_t_s_s((g_5 || (safe_lshift_func_uint16_t_u_u(65535UL, 4))), ((*l_9) = l_8)))));
    return l_8;
}
