...
static volatile int64_t g_8 = 0x65E08CCCDDD1D8F8LL;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = (void*)0;
    int32_t *l_6 = &g_3;
    int32_t *l_7[3][5] = {{(void*)0,&g_3,&g_3,&g_3,&g_3},{(void*)0,&g_3,&g_3,&g_3,&g_3},{(void*)0,&g_3,&g_3,&g_3,&g_3}};
    int32_t l_12 = 1L;
    int i, j;
    g_9++;
    return l_12;
