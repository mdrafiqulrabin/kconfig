...
static volatile uint32_t g_5 = 0x53A34C86L;/* VOLATILE GLOBAL g_5 */
static int32_t *g_9 = &g_4;
static int32_t ** volatile g_8[5] = {&g_9,&g_9,&g_9,&g_9,&g_9};
...
{ /* block id: 0 */
    int16_t l_2 = 0x69F7L;
    int32_t *l_3[8] = {&g_4,(void*)0,&g_4,(void*)0,&g_4,(void*)0,&g_4,(void*)0};
    int i;
    g_5--;
    (*g_10) = l_3[6];
    return g_5;
