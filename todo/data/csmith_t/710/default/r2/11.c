...
static int32_t g_3[3][5] = {{3L,3L,3L,3L,3L},{0L,(-1L),0L,(-1L),0L},{3L,3L,3L,3L,3L}};
static volatile int32_t g_6 = (-4L);/* VOLATILE GLOBAL g_6 */
static volatile int32_t g_7 = 0x0ED3C15DL;/* VOLATILE GLOBAL g_7 */
static volatile int32_t g_8 = 0L;/* VOLATILE GLOBAL g_8 */
static volatile int32_t g_9[1][2][3] = {{{0x7A7525D2L,0x7A7525D2L,0x7A7525D2L},{2L,2L,2L}}};
static int32_t g_10 = 0L;
static int32_t * volatile g_19 = &g_3[0][4];/* VOLATILE GLOBAL g_19 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_10 g_9 g_19
 * writes: g_3 g_10
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_18 = 0x81A82E77L;
    for (g_3[0][4] = 7; (g_3[0][4] < 26); g_3[0][4]++)
    { /* block id: 3 */
        int32_t l_16[3];
        int32_t *l_17 = &l_16[2];
        int i;
        for (i = 0; i < 3; i++)
            l_16[i] = 0L;
        for (g_10 = 29; (g_10 != (-16)); g_10 = safe_sub_func_uint16_t_u_u(g_10, 1))
        { /* block id: 6 */
            int32_t l_13 = 2L;
            return l_13;
        }
        (*l_17) = (g_9[0][0][0] >= (safe_mod_func_int16_t_s_s(g_3[0][4], l_16[2])));
    }
    (*g_19) |= l_18;
    return l_18;
}
