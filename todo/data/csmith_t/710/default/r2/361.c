...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x999D94B4L;
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_2[1][9][2] = {{{0UL,0UL},{0UL,0UL},{0UL,0UL},{0UL,0UL},{0UL,0UL},{0UL,0UL},{0UL,0UL},{0UL,0UL},{0UL,0UL}}};
    int32_t *l_3 = &g_4;
    int32_t *l_5[10];
    uint64_t l_6 = 0x63C407858F9C25B0LL;
    int i, j, k;
    for (i = 0; i < 10; i++)
        l_5[i] = &g_4;
    (*l_3) = l_2[0][5][0];
