...
static int32_t g_6[8][1][3] = {{{(-9L),(-8L),(-8L)}},{{6L,(-7L),6L}},{{(-9L),(-9L),(-8L)}},{{1L,(-7L),1L}},{{(-9L),(-8L),(-8L)}},{{6L,(-7L),6L}},{{(-9L),(-9L),(-8L)}},{{1L,(-7L),1L}}};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_10 = 0x2391CB4E76AB2AEELL;
    for (g_2 = 0; (g_2 != (-8)); g_2 = safe_sub_func_uint64_t_u_u(g_2, 8))
    { /* block id: 3 */
        int32_t *l_5 = &g_6[3][0][2];
        int32_t *l_7 = &g_6[7][0][2];
        int32_t *l_8 = &g_6[3][0][2];
        int32_t *l_9[2];
        int i;
        for (i = 0; i < 2; i++)
            l_9[i] = (void*)0;
