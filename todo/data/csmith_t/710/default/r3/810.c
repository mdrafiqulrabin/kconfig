...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_2 = 0x6F9BL;
static int32_t g_7[10] = {1L,9L,1L,1L,9L,1L,1L,9L,1L,1L};
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_7[6];
    int32_t *l_8 = &g_9;
    uint64_t l_10[7] = {2UL,2UL,18446744073709551608UL,2UL,2UL,18446744073709551608UL,2UL};
    uint32_t l_11 = 0x5D9B4E94L;
    int i, j;
    for (i = 0; i < 1; i++)
    {
        for (j = 0; j < 6; j++)
            l_5[i][j] = 18446744073709551607UL;
    }
    l_10[2] = ((*l_8) = ((*l_6) = ((++g_2) >= l_5[0][5])));
    (*l_8) = l_11;
    return g_2;
}
