...
static int32_t g_5[7][3] = {{(-1L),5L,0x4822B165L},{0xC3099CFEL,(-2L),0xC3099CFEL},{0L,(-1L),0x4822B165L},{0xDEDB5CABL,0xDEDB5CABL,0x45D811F0L},{(-1L),(-1L),(-1L)},{0x45D811F0L,(-2L),0xC662A2B3L},{(-1L),5L,(-1L)}};
static int32_t *g_9 = &g_5[0][2];
static int32_t ** volatile g_8 = &g_9;/* VOLATILE GLOBAL g_8 */
static int32_t g_10 = 0x13EC752FL;
...
/* ------------------------------------------ */
/* 
 * reads : g_5 g_8 g_10 g_2
 * writes: g_5 g_9 g_10
 */
static uint64_t  func_1(void)
{ /* block id: 0 */
    int16_t l_13 = 5L;
    for (g_5[1][2] = 15; (g_5[1][2] > (-19)); g_5[1][2]--)
    { /* block id: 3 */
        (*g_8) = &g_5[4][0];
    }
    for (g_10 = 9; (g_10 != (-5)); --g_10)
    { /* block id: 8 */
        return g_2;
    }
    return l_13;
