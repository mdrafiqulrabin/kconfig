...
static int32_t ** const  volatile g_12[9] = {&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4};
static int32_t ** volatile g_13 = &g_4;/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 1 */
    int32_t *l_7 = &g_5;
    int32_t *l_8[6];
    uint64_t l_9 = 0xD4E703026D8D3833LL;
    int i;
    for (i = 0; i < 6; i++)
        l_8[i] = &g_5;
    g_6 = &g_4;
