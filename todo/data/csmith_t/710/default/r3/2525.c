...
static struct S0 g_8 = {0x4D513C61C71BC7DCLL,-1L,0UL,1L,0xFAL,0x0720L};/* VOLATILE GLOBAL g_8 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_10 g_8.f5
 * writes: g_2 g_11
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    struct S0 *l_7 = &g_8;
    for (g_2 = 0; (g_2 >= 26); g_2 = safe_add_func_uint8_t_u_u(g_2, 6))
    { /* block id: 3 */
        if (g_2)
            break;
    }
