...
static volatile int32_t g_9 = 0xFB2C41ACL;/* VOLATILE GLOBAL g_9 */
static volatile int8_t g_11 = (-5L);/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &g_3;
    int32_t *l_8[8][4] = {{&l_6,&g_3,&l_6,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&l_6,&l_6,&g_3},{&l_6,&g_3,&l_6,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&l_6,&l_6,&g_3},{&l_6,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3}};
    int8_t l_10 = 0x4FL;
    int i, j;
    --g_12;
    return g_15;
