...
static int32_t g_6[10] = {0x9EA98311L,(-6L),0xD526D2E8L,0xD526D2E8L,(-6L),0x9EA98311L,(-6L),0xD526D2E8L,0xD526D2E8L,(-6L)};
static volatile int32_t g_7[3][1][2] = {{{0x48C443EBL,0x48C443EBL}},{{0x48C443EBL,0x48C443EBL}},{{0x48C443EBL,0x48C443EBL}}};
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_8 g_6 g_7
 * writes: g_2 g_6 g_8
 */
static const uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_11 = &g_8;
    for (g_2 = 0; (g_2 != 16); g_2 = safe_add_func_int8_t_s_s(g_2, 4))
    { /* block id: 3 */
        int32_t *l_5 = &g_6[5];
        (*l_5) = 0xDE713A47L;
        for (g_8 = 0; (g_8 != 8); g_8 = safe_add_func_uint8_t_u_u(g_8, 8))
        { /* block id: 7 */
            return (*l_5);
        }
    }
