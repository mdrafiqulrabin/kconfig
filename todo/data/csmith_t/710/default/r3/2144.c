...
static int8_t g_7[7] = {0L,0L,0L,0L,0L,0L,0L};
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_5 g_11 g_7
 * writes: g_7 g_10 g_11 g_5
 */
static int8_t  func_1(void)
{ /* block id: 0 */
    int8_t *l_6 = &g_7[3];
    int32_t *l_8 = (void*)0;
    int32_t *l_9[10] = {&g_5,&g_10,&g_10,&g_5,(void*)0,&g_5,&g_10,&g_10,&g_5,(void*)0};
    int i;
    g_11 ^= (safe_sub_func_int32_t_s_s((g_4 == ((*l_6) = g_5)), (g_10 = g_5)));
    g_5 &= (g_4 , (+(safe_div_func_int16_t_s_s(g_4, 0x890CL))));
    return g_7[3];
}
