...
/* --- GLOBAL VARIABLES --- */
static const volatile union U2 g_2 = {0};/* VOLATILE GLOBAL g_2 */
static volatile int8_t g_4 = 0x16L;/* VOLATILE GLOBAL g_4 */
...
XXX percent of pointers has null in alias set: 81.8
