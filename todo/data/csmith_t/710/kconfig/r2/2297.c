...
{ /* block id: 0 */
    int32_t l_6 = (-4);
    uint32_t l_16 = 0x4129B857;
    int32_t *l_18 = (void*)0;
    int32_t l_20 = 0xF8E3BF11;
    int32_t *l_19 = &l_20;
    uint16_t l_21 = 0U;
    (*l_19) = (func_2(((-(uint32_t)4294967295U) <= (((0x1A9565E0 != (l_6 , ((int16_t)(!(l_6 , ((((int16_t)(l_6 | l_6) % (int16_t)((int16_t)l_6 - (int16_t)(0x17B722BA == ((uint16_t)l_6 >> (uint16_t)8)))) , l_6) | l_6))) << (int16_t)l_16))) > l_16) , l_6)), l_16) ^ l_16);
    return l_21;
}
