...
static const uint32_t  func_15(const int16_t  p_16, int16_t  p_17, uint16_t  p_18, uint32_t  p_19);
...
{ /* block id: 0 */
    uint8_t l_6 = 0xE2;
    const uint16_t l_20 = 0U;
    int32_t l_25 = 0;
    uint32_t l_28 = 4294967295U;
    int32_t *l_29 = &l_25;
    int32_t l_30 = (-5);
    l_25 = ((safe_lshift_func_int8_t_s_s((safe_rshift_func_int16_t_s_s(l_6, l_6)), 1)) <= ((0xB5 || (((4294967286U != (safe_sub_func_int8_t_s_s((((safe_div_func_int16_t_s_s(((l_6 < 0xFF) ^ l_6), (safe_mod_func_int32_t_s_s((safe_add_func_uint32_t_u_u(func_15((l_6 && ((l_6 < l_6) | l_20)), l_6, l_6, l_6), l_6)), l_6)))) ^ 0xF4) > l_6), 0))) != l_20) <= l_20)) >= l_20));
    (*l_29) = (safe_mod_func_int16_t_s_s(l_6, l_28));
    return l_30;
}
