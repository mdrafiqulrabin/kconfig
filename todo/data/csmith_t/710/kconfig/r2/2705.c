...
{ /* block id: 36 */
    uint32_t l_38 = 9U;
    g_44 = (g_3 || ((uint16_t)((int16_t)(((uint16_t)((uint16_t)l_38 >> (uint16_t)g_3) + (uint16_t)1U) != ((((0xEAB3 != g_3) & (~((uint32_t)((int16_t)__builtin_clzl(g_3) + (int16_t)1) - (uint32_t)8U))) || 0x628217C7) >= (-7))) + (int16_t)l_38) - (uint16_t)0xC352));
    return g_3;
}
