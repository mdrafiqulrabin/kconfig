...
{ /* block id: 36 */
    int32_t l_35 = 1L;
    int32_t l_36 = 0xAA32F3F6L;
    int64_t l_37 = (-1L);
    uint32_t l_38 = 0x9A130DFDL;
    l_37 = (safe_add_func_float_f_f(__builtin_ffsl((safe_lshift_func_int16_t_s_u((l_36 = l_35), 8))), l_35));
    l_36 = 0x0.3p-1;
    l_36 = (l_38 = 0x1.071A05p-6);
    g_39 = 9L;
    return g_39;
}
