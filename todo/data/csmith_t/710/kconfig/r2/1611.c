...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xD21F1EB3;
static uint32_t g_10 = 0x145714FF;
static union U3 g_13 = {{0xB80EBBD4}};
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_13 g_13.f4
 * writes: g_2 g_10 g_13.f4
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_5 = 1U;
    union U3 l_8 = {{0x227D373E}};
    int32_t l_19 = 0x0F1FA6F6;
    int32_t l_20 = 0x4ACD6BA8;
    for (g_2 = 0; (g_2 < 0); g_2 += 1)
    { /* block id: 3 */
        return l_5;
    }
    l_20 = (((((g_10 = func_6(l_8)) != (((l_19 = ((int32_t)((g_13.f4 = func_6(g_13)) & (g_2 >= ((-5) == (65533U < ((int16_t)(((uint16_t)(-(uint32_t)((l_8.f0.f0 < (g_2 && g_2)) > l_8.f0.f0)) % (uint16_t)l_5) || g_2) % (int16_t)l_8.f0.f0))))) - (int32_t)g_2)) ^ g_2) == 0x0D7C8A36)) < g_2) <= l_8.f0.f0) < 0x39F3);
    return g_13.f4;
}
