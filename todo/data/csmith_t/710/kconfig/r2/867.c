...
/* --- GLOBAL VARIABLES --- */
static int32_t g_8[5] = {0xFD9E2A8D,0xFD9E2A8D,0xFD9E2A8D,0xFD9E2A8D,0xFD9E2A8D};
...
static int32_t g_31[2] = {(-10),(-10)};
static struct S2 g_36 = {5586};/* VOLATILE GLOBAL g_36 */
...
{ /* block id: 36 */
    ...
    struct S2 *l_35 = &g_36;
    uint16_t l_37 = 0xB11F;
    for (g_31[0] = 19; (g_31[0] > (-28)); g_31[0] -= 3)
    { /* block id: 39 */
        if (g_29)
            break;
    }
