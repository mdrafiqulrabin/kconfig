...
{ /* block id: 36 */
    int32_t l_27 = (-4);
    l_27 = ((int16_t)l_27 >> (int16_t)((l_27 | (-3)) >= ((((0x27D373EE & __builtin_ffs(g_3)) & ((int16_t)l_27 - (int16_t)(((int16_t)(((int16_t)(((int16_t)1 << (int16_t)((int16_t)((-6) >= l_27) - (int16_t)g_3)) >= 0x39CE) + (int16_t)0xB2E8) ^ 0xAF7B) % (int16_t)0x4073) >= g_3))) ^ l_27) ^ 0xDB88)));
    return l_27;
}
