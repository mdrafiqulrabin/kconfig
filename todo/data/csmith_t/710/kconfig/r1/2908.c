...
inline static int64_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3[7] = {(-5L),1L,(-5L),(-5L),1L,(-5L),(-5L)};
    int32_t *l_2 = &l_3[5];
    int32_t *l_4 = &l_3[6];
    int32_t *l_5 = &l_3[6];
    int32_t *l_6 = &l_3[5];
    ...
    int32_t *l_8 = &l_3[0];
    int32_t *l_9 = &l_3[3];
    int32_t *l_10[5][7] = {{&l_3[5],&l_3[2],&l_3[5],&l_3[2],&l_3[5],&l_3[3],&l_3[5]},{&l_3[5],&l_3[5],&l_3[5],&l_3[5],&l_3[5],&l_3[5],&l_3[5]},{&l_3[5],&l_3[2],&l_3[5],&l_3[5],&l_3[5],&l_3[5],&l_3[5]},{&l_3[5],&l_3[5],(void*)0,&l_3[5],&l_3[5],(void*)0,&l_3[5]},{&l_3[5],&l_3[5],&l_3[5],&l_3[2],&l_3[5],&l_3[5],&l_3[5]}};
    uint32_t l_11[5];
    uint32_t l_14 = 9UL;
    int i, j;
    for (i = 0; i < 5; i++)
