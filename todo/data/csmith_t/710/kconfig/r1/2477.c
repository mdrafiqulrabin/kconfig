...
static uint32_t  func_26(void)
{ /* block id: 36 */
    uint32_t l_27 = 0xE32CF415;
    uint32_t l_28 = 7U;
    uint32_t l_29 = 1U;
    int32_t l_35 = 0xBB086619;
    l_28 = l_27;
    l_35 = (((g_3 & l_29) > ((int16_t)(g_3 || l_27) << (int16_t)l_27)) != ((l_27 > (((uint16_t)((-7) >= (0xB653 <= (!8))) - (uint16_t)65535U) < 0xDD93)) == 4294967295U));
    return g_3;
}
