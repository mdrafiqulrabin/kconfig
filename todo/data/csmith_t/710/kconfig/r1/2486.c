...
inline static uint16_t  func_27(void)
{ /* block id: 36 */
    uint32_t l_33 = 0x823AAF5BL;
    int32_t *l_42 = (void*)0;
    int32_t l_43 = 0x00955205L;
    l_43 = ((safe_unary_minus_func_int16_t_s((safe_add_func_int8_t_s_s((-6L), (safe_lshift_func_int16_t_s_u(l_33, (safe_add_func_uint32_t_u_u((safe_add_func_int8_t_s_s(((safe_rshift_func_uint8_t_u_s(1UL, (safe_lshift_func_uint16_t_u_s(l_33, 15)))) > (0xFC9BL >= l_33)), (l_33 <= (((l_33 ^ l_33) != 0xC27FL) >= l_33)))), l_33)))))))) != 0xC7L);
    return l_33;
}
