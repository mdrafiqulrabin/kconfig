...
inline static int32_t  func_29(void)
{ /* block id: 36 */
    int32_t l_30[8][6] = {{1L,1L,1L,(-1L),(-1L),1L},{(-1L),(-1L),1L,1L,1L,1L},{(-1L),1L,1L,(-1L),1L,1L},{1L,(-1L),1L,1L,(-1L),1L},{1L,1L,1L,(-1L),(-1L),1L},{(-1L),(-1L),1L,1L,1L,1L},{(-1L),1L,1L,(-1L),1L,1L},{1L,(-1L),1L,1L,(-1L),1L}};
    float l_32[6] = {0xE.7F39CEp-13,0x0.Ep+1,0xE.7F39CEp-13,0xE.7F39CEp-13,0x0.Ep+1,0xE.7F39CEp-13};
    float *l_31[4][5];
    int8_t l_33 = 0L;
    int32_t l_34 = (-2L);
    int i, j;
