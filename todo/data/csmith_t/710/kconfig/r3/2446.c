...
{ /* block id: 36 */
    ...
    uint32_t l_54 = 0U;
    int16_t l_55 = 0xAEBB;
    int32_t l_56 = 0x0997736E;
    l_56 = (((int16_t)((uint16_t)((uint32_t)((uint16_t)l_45 >> (uint16_t)9) + (uint32_t)l_45) - (uint16_t)0x79D4) + (int16_t)__builtin_popcountl(((uint16_t)((uint32_t)l_45 - (uint32_t)((uint32_t)((__builtin_parity(l_45) | (l_45 <= ((uint16_t)l_54 >> (uint16_t)l_45))) != l_45) + (uint32_t)l_55)) * (uint16_t)0x3709))) || l_55);
    return l_54;
}
