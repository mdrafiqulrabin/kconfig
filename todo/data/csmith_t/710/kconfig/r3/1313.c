...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x65352F76L;
static int32_t g_28 = 0x7209C399L;
...
{ /* block id: 36 */
    ...
    int32_t l_29 = 0x37D02268L;
    for (g_3 = (-18); (g_3 >= (-29)); g_3 = safe_sub_func_int64_t_s_s(g_3, 6))
    { /* block id: 39 */
        l_29 = (2L && (g_28 = (l_27 == 0x261FC42FF18C9A01LL)));
    }
    return g_3;
}
