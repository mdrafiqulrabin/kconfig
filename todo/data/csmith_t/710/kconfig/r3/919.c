...
{ /* block id: 0 */
    int32_t **l_4 = (void*)0;
    int32_t *l_5 = &g_6;
    int32_t l_15 = 0xAA32F3F6L;
    g_3 &= (g_2 | 0L);
    l_5 = (void*)0;
    (*g_16) = (g_3 != (safe_div_func_float_f_f(g_2, ((safe_sub_func_float_f_f((&g_6 != &g_6), g_3)) != ((-0x7.Cp-1) > (safe_mul_func_float_f_f((-0x9.Cp-1), ((safe_mul_func_float_f_f((-0x8.1p-1), l_15)) < g_3))))))));
    return g_2;
}
