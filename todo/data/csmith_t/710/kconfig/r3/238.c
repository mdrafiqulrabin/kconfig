...
/* --- GLOBAL VARIABLES --- */
static int32_t g_11 = 0xE418A527L;
static union U2 g_27[10] = {{0UL},{0xA32F3F60L},{0UL},{0UL},{0xA32F3F60L},{0UL},{0UL},{0xA32F3F60L},{0UL},{0UL}};
static union U1 g_32 = {0x7AL};/* VOLATILE GLOBAL g_32 */
static const union U1 *g_35 = &g_32;
static const union U1 ** volatile g_34 = &g_35;/* VOLATILE GLOBAL g_34 */
static union U3 g_37 = {0x3813BF58L};/* VOLATILE GLOBAL g_37 */
...
/* ------------------------------------------ */
/* 
 * reads : g_11 g_34 g_37
 * writes: g_11 g_35
 */
inline static union U3  func_25(void)
{ /* block id: 36 */
    const union U2 *l_26 = &g_27[6];
    const union U2 **l_28 = &l_26;
    const union U1 *l_31[9][7] = {{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32},{&g_32,&g_32,&g_32,&g_32,&g_32,&g_32,&g_32}};
    int i, j;
    (*l_28) = l_26;
    for (g_11 = 10; (g_11 < (-21)); g_11 = safe_sub_func_int16_t_s_s(g_11, 1))
    { /* block id: 40 */
        const union U1 **l_33 = &l_31[3][4];
        int32_t l_36 = 0L;
        (*g_34) = ((*l_33) = l_31[2][0]);
        if (l_36)
            break;
