...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_6 = 0xC62E08974B666A75LL;
static int32_t g_51 = 0x02BE2FF5L;
static int8_t g_52 = 0xC7L;
...
/* ------------------------------------------ */
/* 
 * reads : g_6 g_52 g_51 g_54 g_55 g_56
 * writes: g_6 g_54 g_56 g_51
 */
inline static uint64_t  func_30(void)
{ /* block id: 36 */
    int8_t **l_32 = (void*)0;
    ...
    int32_t **l_49 = &l_50;
    (*l_31) = (void*)0;
    for (g_6 = 27; (g_6 != 45); g_6 = safe_add_func_int8_t_s_s(g_6, 9))
    { /* block id: 40 */
        int32_t *l_36 = (void*)0;
        int32_t **l_35 = &l_36;
        int32_t *l_38 = (void*)0;
        ...
        uint64_t *l_53 = &g_54;
        (*l_37) = ((*l_35) = (void*)0);
        (*g_55) |= ((g_6 | (~((-5L) || __builtin_clzll(((*l_53) |= __builtin_parity(__builtin_popcountll((((safe_lshift_func_int16_t_s_u((((safe_add_func_int8_t_s_s(__builtin_popcount(((safe_rshift_func_int16_t_s_s(g_6, 7)) , (g_6 >= (safe_unary_minus_func_int64_t_s(__builtin_bswap32((((l_47 || (!(((void*)0 != l_49) ^ g_6))) || __builtin_popcountl(g_52)) <= g_52))))))), (**l_49))) <= 0xEDL) < 0xA3BB1D4416DA84B5LL), g_51)) , g_51) < 0xB1EC6C04L)))))))) != g_51);
        (**l_49) = (*g_55);
        (*l_50) |= (*g_55);
    }
    return g_52;
