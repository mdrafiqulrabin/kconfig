...
{ /* block id: 36 */
    uint32_t l_29 = 0U;
    g_41 = ((l_29 | 0xB2C41AC3) || (((g_3 >= 0) < ((uint32_t)((int16_t)__builtin_ffs(((uint16_t)g_3 << (uint16_t)(-(uint16_t)((int16_t)(0U ^ g_3) - (int16_t)l_29)))) << (int16_t)3) - (uint32_t)0x55C0C8FB)) & 0));
    return g_3;
}
