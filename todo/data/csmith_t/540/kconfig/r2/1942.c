...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_4 = 0xC7C44D99L;
static int32_t g_27[9] = {0x9634D71BL,0x9634D71BL,0x9634D71BL,0x9634D71BL,0x9634D71BL,0x9634D71BL,0x9634D71BL,0x9634D71BL,0x9634D71BL};
...
{ /* block id: 36 */
    int32_t *l_26[9];
    int16_t l_28 = 0xD9F0L;
    uint16_t l_29 = 0x80BFL;
    int i;
    for (i = 0; i < 9; i++)
        l_26[i] = &g_27[8];
    l_29--;
