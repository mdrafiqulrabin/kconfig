...
{ /* block id: 36 */
    ...
    { /* block id: 37 */
        ...
        float l_32 = 0x0.D4A55Fp-2;
        float *l_31 = &l_32;
        (*l_31) = __builtin_bswap32(l_30);
    }
    else
    { /* block id: 39 */
        uint32_t l_33 = 0x924B5411L;
        int32_t l_39 = 0x61BE360DL;
        int32_t *l_38 = &l_39;
        (*l_38) = (l_33 > (safe_add_func_uint16_t_u_u(l_29, (safe_lshift_func_int16_t_s_s(0x33C7L, 2)))));
    }
    return l_40;
}
