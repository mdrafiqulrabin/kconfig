...
inline static uint8_t  func_1(void)
{ /* block id: 0 */
    const uint32_t l_4[7] = {18446744073709551610UL,18446744073709551610UL,18446744073709551610UL,18446744073709551610UL,18446744073709551610UL,18446744073709551610UL,18446744073709551610UL};
    int32_t l_5 = 0x0BE4438BL;
    int i;
    l_5 ^= ((safe_div_func_int32_t_s_s(l_4[1], l_4[1])) > l_4[1]);
    return l_4[3];
}
