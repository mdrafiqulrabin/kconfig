...
{ /* block id: 36 */
    int32_t l_30 = 4L;
    int32_t l_38 = (-1L);
    union U1 l_41 = {0x8.4p+1};
    for (l_30 = (-24); (l_30 > (-25)); --l_30)
    { /* block id: 39 */
        int64_t l_37 = 0L;
        int32_t l_40 = 0xB43D2717L;
        int32_t *l_39 = &l_40;
        (*l_39) = (safe_add_func_int32_t_s_s(0x27FA3DFAL, (safe_lshift_func_uint16_t_u_s((l_38 = l_37), 11))));
    }
    return l_41;
    /* statement id: 43 */
    }
