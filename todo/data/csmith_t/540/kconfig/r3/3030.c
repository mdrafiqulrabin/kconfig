...
{ /* block id: 36 */
    int16_t l_33 = 0xD0E7;
    int32_t l_35[5];
    int32_t l_36 = 0x44694486;
    int32_t l_37[8] = {0,0,0,0,0,0,0,0};
    int i;
    for (i = 0; i < 5; i++)
        l_35[i] = 0x5C9B8DB3;
    l_37[0] |= (0xF34BDAC8 >= (((((l_35[4] &= ((l_33 = (safe_mul_func_int16_t_s_s(((g_9 || (0xFF79 < 1U)) > (-1)), 65535U))) >= (~0xDC9FE9A5))) < g_9) == 0x0783) >= l_36) != 0x8EF3352F));
    return l_37[0];
}
