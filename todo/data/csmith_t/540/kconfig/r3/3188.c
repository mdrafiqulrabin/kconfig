...
static volatile uint16_t g_32 = 0xB042L;/* VOLATILE GLOBAL g_32 */
static int32_t g_37 = 0xECBFCF41L;
...
{ /* block id: 36 */
    int32_t *l_30 = &g_5;
    int16_t l_35 = 0xFC72L;
    (*g_36) = (safe_div_func_uint32_t_u_u((((*l_30) = g_5) != (safe_unary_minus_func_int16_t_s(g_32))), (safe_mul_func_int16_t_s_s(l_35, __builtin_parityll(l_35)))));
    return (*l_30);
}
