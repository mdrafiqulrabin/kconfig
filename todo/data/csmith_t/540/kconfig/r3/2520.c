...
/* --- GLOBAL VARIABLES --- */
static int32_t g_5 = 0xEF72D4EAL;
static union U0 g_31 = {-1L};/* VOLATILE GLOBAL g_31 */
static union U0 g_32 = {0L};/* VOLATILE GLOBAL g_32 */
...
static union U0  func_26(void)
{ /* block id: 36 */
    for (g_5 = 11; (g_5 == (-3)); g_5 = safe_sub_func_uint8_t_u_u(g_5, 2))
    { /* block id: 39 */
        int32_t *l_30 = &g_5;
        int32_t **l_29 = &l_30;
        (*l_29) = &g_5;
