...
{ /* block id: 0 */
    uint64_t l_2[7];
    int32_t l_4[3];
    int32_t *l_3[9][1] = {{&l_4[0]},{&l_4[1]},{&l_4[0]},{&l_4[1]},{&l_4[0]},{&l_4[1]},{&l_4[0]},{&l_4[1]},{&l_4[0]}};
    uint32_t l_5 = 6UL;
    uint32_t l_6[6] = {4294967294UL,4294967294UL,4294967294UL,4294967294UL,4294967294UL,4294967294UL};
    int i, j;
    for (i = 0; i < 7; i++)
        l_2[i] = 0x115252CB13638ECFLL;
    for (i = 0; i < 3; i++)
        l_4[i] = 0L;
    l_5 &= l_2[2];
    return l_6[4];
