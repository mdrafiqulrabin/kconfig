...
static volatile struct S0 g_4 = {0x869EC427,2};/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0x95751CFD;
static struct S0 g_8 = {4294967295U,1};/* VOLATILE GLOBAL g_8 */
static struct S0 g_9 = {1U,-3};/* VOLATILE GLOBAL g_9 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t l_3 = 0x61C0F806;/* VOLATILE GLOBAL l_3 */
    l_3 = g_2;
    g_4 = g_4;
    for (g_5 = (-15); (g_5 == 28); g_5 += 6)
    { /* block id: 5 */
        return g_4.f0;
    }
    g_9 = g_8;
