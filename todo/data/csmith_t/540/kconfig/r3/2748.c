...
{ /* block id: 0 */
    ...
    int32_t *l_10 = &l_4[0];
    int32_t *l_11 = (void*)0;
    int32_t *l_12[10] = {&l_4[3],&l_4[3],&l_4[3],&l_4[3],&l_4[3],&l_4[3],&l_4[3],&l_4[3],&l_4[3],&l_4[3]};
    float l_13 = 0x0.D2CC91p+85;
    uint64_t l_14 = 0xDFB1AF9D66DE6B93LL;
    int32_t l_17 = 1L;
    uint64_t l_20[6] = {0UL,0UL,0UL,0UL,0UL,0UL};
    uint32_t l_21 = 1UL;
    int i;
    l_14++;
    l_20[0] ^= ((l_17 = 0xF3L) < ((safe_add_func_int32_t_s_s((*l_10), (&l_4[2] == &l_4[3]))) , (*l_9)));
    return l_21;
}
