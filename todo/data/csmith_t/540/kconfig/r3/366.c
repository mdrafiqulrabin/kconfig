...
inline static uint32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_2[8][9] = {{0L,0x13L,0x88L,1L,0x88L,0x13L,0L,1L,0x6DL},{0x87L,0x2BL,0xB4L,0x81L,(-9L),1L,(-9L),0x81L,0xB4L},{1L,1L,(-1L),0x12L,0x6DL,8L,0x13L,1L,0x13L},{0xB4L,0xD4L,0x2BL,0x2BL,0xD4L,0xB4L,5L,0L,0x4AL},{1L,0L,(-1L),(-3L),0L,0L,(-3L),(-1L),0L},{0xD4L,0xEEL,0L,0x2BL,0L,1L,0x81L,0x81L,1L},{8L,0x13L,1L,0x13L,8L,0x6DL,0x12L,(-1L),1L},{5L,0xEEL,0x2BL,1L,0x87L,1L,0x2BL,0xEEL,5L}};
    int i, j;
    return l_2[5][4];
}
