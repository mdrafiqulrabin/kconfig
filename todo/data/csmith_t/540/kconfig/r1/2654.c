...
static int8_t g_27[7] = {0L,0xE0L,0L,0L,0xE0L,0L,0L};
static const int8_t *g_26 = &g_27[3];
static const int8_t * volatile * const  volatile g_25[6] = {&g_26,&g_26,&g_26,&g_26,&g_26,&g_26};
...
static int32_t  func_24(void)
{ /* block id: 36 */
    const int8_t * volatile * volatile l_28[7];
    int32_t l_29 = 2L;
    int i;
    for (i = 0; i < 7; i = i + 1)
        l_28[i] = &g_26;
