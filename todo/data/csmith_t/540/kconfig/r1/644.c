...
static int32_t g_34 = 0xCCCAEA0AL;
static float g_38 = (-0x1.3p-1);
static volatile int16_t g_39 = 0L;/* VOLATILE GLOBAL g_39 */
...
{ /* block id: 36 */
    ...
    int32_t l_35 = (-3L);
    int32_t *l_36[4][1];
    int8_t l_37[9] = {0xA4L,0xA4L,0xA4L,0xA4L,0xA4L,0xA4L,0xA4L,0xA4L,0xA4L};
    uint32_t l_40 = 0x02089CE3L;
    int32_t **l_43 = (void*)0;
    int32_t **l_44 = &l_36[2][0];
    int i, j;
    for (i = 0; i < 4; i = i + 1)
    {
        for (j = 0; j < 1; j = j + 1)
