...
{ /* block id: 36 */
    int16_t l_31 = 0;
    int32_t l_38 = 6;
    int32_t l_46 = 0xB2455F99;
    l_46 = ((int16_t)l_31 + (int16_t)((func_32(l_31, (l_31 || ((int16_t)(l_38 = ((!(-6)) , __builtin_parityl(l_31))) * (int16_t)l_31))) , (~func_32((l_38 = (((uint16_t)l_31 * (uint16_t)9U) < (-1))), l_31))) && 0x5A12A2EF));
    return l_31;
}
...
inline static int32_t  func_32(int8_t  p_33, uint32_t  p_34)
{ /* block id: 38 */
    uint32_t l_39 = 0xABC24891;
    int32_t l_42 = 0x9B8FA48A;
    l_42 = (l_39 , ((uint16_t)p_34 >> (uint16_t)6));
    return l_39;
}
