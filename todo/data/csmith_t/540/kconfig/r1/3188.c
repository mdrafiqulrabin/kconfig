...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_3 = 0x96A485BFL;
static int32_t g_38 = 0x5BB00289L;
...
inline static int8_t  func_30(void)
{ /* block id: 36 */
    float l_35 = 0x1.F748DCp+31;
    int32_t l_36[8];
    int32_t *l_37 = &g_38;
    int i;
    for (i = 0; i < 8; i++)
        l_36[i] = 0x7806AA1CL;
    (*l_37) ^= (safe_lshift_func_uint8_t_u_u((safe_sub_func_int32_t_s_s(l_36[0], g_3)), 2));
    return (*l_37);
}
