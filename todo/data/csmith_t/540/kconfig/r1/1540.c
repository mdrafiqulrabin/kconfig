...
/* --- GLOBAL VARIABLES --- */
static const int16_t g_5 = 0x7DD6L;
static int32_t g_26 = 1L;
static int32_t g_35 = 0x753589FEL;
...
/* ------------------------------------------ */
/* 
 * reads : g_26 g_5 g_35 g_44
 * writes: g_26 g_44
 */
inline static int32_t  func_31(void)
{ /* block id: 36 */
    uint16_t l_41 = 0x6123L;
    for (g_26 = (-3); (g_26 > 1); g_26 += 5)
    { /* block id: 39 */
        int32_t *l_34 = &g_35;
        int32_t *l_36 = &g_35;
        int32_t *l_37 = &g_35;
        ...
        for (i = 0; i < 7; i++)
            l_40[i] = &g_35;
        ++l_41;
        g_44 ^= (0xD0C11E043EEF7D26LL && (((g_5 && l_41) == 0xAC31L) | g_35));
        return (*l_39);
    }
    return l_41;
}
