...
/* --- GLOBAL VARIABLES --- */
static struct S2 g_2 = {0xD069L,0x49L,-3L,{7UL,{0xCD40L}},0x884CB8F6L,{4294967295UL,{0xE993L}},0UL};
...
int main (void)
{
    ...
    transparent_crc(g_2.f3.f1.f0, "g_2.f3.f1.f0", print_hash_value);
    transparent_crc(g_2.f4, "g_2.f4", print_hash_value);
    transparent_crc(g_2.f5.f0, "g_2.f5.f0", print_hash_value);
    transparent_crc(g_2.f5.f1.f0, "g_2.f5.f1.f0", print_hash_value);
