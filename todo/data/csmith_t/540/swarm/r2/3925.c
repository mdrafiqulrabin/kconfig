...
static int32_t  func_28(void)
{ /* block id: 36 */
    volatile int32_t **l_37 = &g_35;
    for (g_5 = 0; (g_5 == 37); g_5 = safe_add_func_int32_t_s_s(g_5, 6))
    { /* block id: 39 */
        int32_t l_33 = 0xB2C41AC3;
        int32_t *l_34 = &l_33;
        (*l_34) = (safe_rshift_func_int8_t_s_s(l_33, 4));
    }
    (*l_37) = g_35;
    g_35 = (*l_37);
    return (**l_37);
