...
inline static uint32_t  func_34(void)
{ /* block id: 36 */
    uint32_t l_37 = 0x0348F4A8;
    int32_t l_38 = (-10);
    l_38 = (safe_lshift_func_uint16_t_u_u((l_37 || l_37), 7));
    return l_37;
}
