...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2 = 4294967290U;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_4 = 0;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0xA87013DC;


/* --- FORWARD DECLARATIONS --- */
static uint32_t  func_1(void);
inline static uint16_t  func_8(int32_t  p_9, int32_t * p_10, int32_t * p_11, int32_t  p_12, uint32_t  p_13);
...
{ /* block id: 0 */
    ...
    { /* block id: 4 */
        int32_t *l_15 = &l_14;
        float l_16 = (-0x3.0p-1);
        int32_t l_19 = 0x84E5A945;
        (*l_15) = (g_4 > func_8((g_5 && l_14), l_15, &g_5, l_14, ((safe_sub_func_int8_t_s_s((g_5 < ((&g_5 != &g_5) ^ (*l_15))), l_14)) > l_19)));
    }
    return g_4;
}
