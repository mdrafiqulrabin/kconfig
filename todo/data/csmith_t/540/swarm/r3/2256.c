...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x63185299;/* VOLATILE GLOBAL g_2 */
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    volatile uint8_t l_3 = 0x9B;/* VOLATILE GLOBAL l_3 */
    l_3 = g_2;
    return g_2;
}
