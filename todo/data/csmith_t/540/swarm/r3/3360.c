...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_5 = 0xA87013DCL;
...
static int16_t  func_26(void)
{ /* block id: 36 */
    int16_t l_27[8] = {0x4217L,0x4217L,0x4217L,0x4217L,0x4217L,0x4217L,0x4217L,0x4217L};
    int i;
    return l_27[2];
}
