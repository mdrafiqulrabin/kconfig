...
inline static uint16_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_5 = 0x3938L;
    int32_t l_14 = 0x2522ABF7L;
    l_14 = (-(int64_t)((int16_t)l_5 << (int16_t)(((((uint32_t)4294967289UL % (uint32_t)((l_5 | ((uint16_t)l_5 >> (uint16_t)((((int32_t)(l_5 > ((l_5 >= 18446744073709551615UL) > (((int8_t)(l_5 | l_5) << (int8_t)l_5) != 0xAD53L))) - (int32_t)l_5) == l_5) == 1UL))) || l_5)) || l_5) && l_5) == l_5)));
    return l_5;
}
