...
inline static uint32_t  func_28(void)
{ /* block id: 36 */
    int16_t l_29 = 0x101AL;
    int32_t l_30 = 1L;
    int16_t l_33 = (-1L);
    l_30 = l_29;
    l_30 = ((uint16_t)__builtin_clzll(l_33) << (uint16_t)9);
    return g_3;
}
