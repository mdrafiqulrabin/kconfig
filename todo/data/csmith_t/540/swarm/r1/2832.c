...
{ /* block id: 0 */
    ...
    g_6 = (safe_sub_func_int32_t_s_s(0L, (safe_unary_minus_func_uint16_t_u(((0x14D2L == l_5) && 0xA9D1L)))));
    l_7 = l_5;
    return l_5;
}
