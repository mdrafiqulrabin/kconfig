...
static int32_t g_26[4] = {0xFCF33F23L,0xFCF33F23L,0xFCF33F23L,0xFCF33F23L};
...
{ /* block id: 36 */
    int32_t *l_25 = &g_26[3];
    uint32_t l_30 = 0x10E5E534L;
    (*l_25) &= 0xF90A3CFCL;
    for (g_3 = 3; (g_3 != 4); g_3++)
    { /* block id: 40 */
        int32_t l_29 = 1L;
        (*l_25) &= l_29;
        if (__builtin_ctzll(g_26[3]))
        { /* block id: 42 */
            if (g_26[3])
                break;
            return (*l_25);
