...
inline static int8_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_4 = 0x8ECF54C3C69AED23LL;
    int32_t l_5[1];
    int i;
    for (i = 0; i < 1; i = i + 1)
        l_5[i] = (-10L);
    l_5[0] = (((uint16_t)l_4 >> (uint16_t)6) == l_4);
    return g_6;
}
