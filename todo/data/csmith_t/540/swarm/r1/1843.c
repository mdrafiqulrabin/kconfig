...
static int32_t  func_29(void)
{ /* block id: 36 */
    for (g_5 = 0; (g_5 > 52); g_5 = safe_add_func_uint32_t_u_u(g_5, 1))
    { /* block id: 39 */
        for (g_32 = 18; (g_32 < 21); g_32 = safe_add_func_uint32_t_u_u(g_32, 1))
        { /* block id: 42 */
