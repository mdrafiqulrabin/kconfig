...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t l_9 = 0xD14CD495L;
    int32_t **l_20 = &l_2;
    int32_t *l_21 = &g_3;
    (*l_20) = (((l_2 == &g_3) & (((*l_2) , ((int64_t)4L + (int64_t)((uint16_t)g_3 / (uint16_t)((*l_2) & (!(l_9 | g_3)))))) < ((int16_t)((int32_t)(((int64_t)((uint64_t)(((int64_t)g_3 + (int64_t)0x9EE491BA6B42BE19LL) < g_3) % (uint64_t)0xB653B1DAB551FA4CLL) - (int64_t)(*l_2)) && g_3) / (int32_t)g_3) >> (int16_t)10))) , (void*)0);
    /* statement id: 1 */
    assert (l_2 == 0);
    (*l_21) = g_3;
    return g_3;
