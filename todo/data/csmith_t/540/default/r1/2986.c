...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_10[8][3] = {{(void*)0,&g_6[2],(void*)0},{&g_6[1],&g_6[2],&g_6[1]},{&g_6[1],&g_6[1],&g_6[2]},{(void*)0,&g_6[2],&g_6[2]},{&g_6[2],&g_6[2],&g_6[1]},{(void*)0,&g_6[2],(void*)0},{&g_6[1],&g_6[2],&g_6[1]},{&g_6[1],&g_6[1],&g_6[2]}};
    int32_t **l_9 = &l_10[7][0];
    int i, j;
    (*l_9) = func_2(g_4);
    return g_4;
}
