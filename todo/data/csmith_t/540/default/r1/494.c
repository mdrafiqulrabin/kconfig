...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xEA964A90L;
static int32_t *g_5[1][2] = {{(void*)0,(void*)0}};
static int32_t ** volatile g_4[9] = {&g_5[0][0],&g_5[0][0],&g_5[0][0],&g_5[0][0],&g_5[0][0],&g_5[0][0],&g_5[0][0],&g_5[0][0],&g_5[0][0]};
