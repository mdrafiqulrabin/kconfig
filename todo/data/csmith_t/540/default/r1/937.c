...
static volatile uint16_t g_7 = 0x0657L;/* VOLATILE GLOBAL g_7 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_3[2][10] = {{&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4}};
    int16_t l_6 = 0x3A34L;
    int i, j;
    ++g_7;
    return g_2;
