...
/* --- GLOBAL VARIABLES --- */
static int8_t g_5[9][1] = {{0L},{0x63L},{0L},{0x63L},{0L},{0x63L},{0L},{0x63L},{0L}};
static int8_t * const  volatile * volatile g_6 = (void*)0;/* VOLATILE GLOBAL g_6 */
