...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_3 = {3,0xC5336DE0L,177};/* VOLATILE GLOBAL g_3 */
static volatile struct S0 * const  volatile g_4 = (void*)0;/* VOLATILE GLOBAL g_4 */
static volatile struct S0 * volatile g_5 = &g_3;/* VOLATILE GLOBAL g_5 */
static volatile struct S0 * const  volatile *g_7 = &g_5;
static volatile struct S0 * const  volatile ** volatile g_6 = &g_7;/* VOLATILE GLOBAL g_6 */
