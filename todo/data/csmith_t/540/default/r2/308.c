...
static struct S0 g_5 = {12254,-26834};/* VOLATILE GLOBAL g_5 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_4 g_5.f0
 * writes: g_3 g_4
 */
static uint64_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[6] = {0UL,0xEA983111L,0UL,0UL,0xEA983111L,0UL};
    struct S0 **l_6[4][1] = {{(void*)0},{&g_4},{(void*)0},{&g_4}};
    int32_t *l_8 = &g_3;
    int32_t l_11 = 4L;
    int i, j;
