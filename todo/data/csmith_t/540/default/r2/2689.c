...
static uint32_t g_15 = 0xCD3624B6L;
static int8_t g_18[2][10] = {{(-1L),0xE0L,(-1L),0L,0xE0L,0x33L,0x33L,0xE0L,0L,(-1L)},{0xA4L,0xA4L,0x87L,0xE0L,0x6BL,0x87L,0x6BL,0xE0L,0x87L,0xA4L}};
static volatile int32_t g_19 = 0xA47B6C41L;/* VOLATILE GLOBAL g_19 */
static uint8_t g_21 = 0x2BL;
