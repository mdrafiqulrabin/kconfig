...
static struct S0 g_6 = {3L,1L,0L,5L};
...
static struct S0  func_1(void)
{ /* block id: 0 */
    struct S0 l_2[7][1] = {{{0x6A1CL,6L,0x747BB7ABL,0x1B583DC0L}},{{0xD3F7L,0L,0xC443EB60L,0x93009CE4L}},{{0xD3F7L,0L,0xC443EB60L,0x93009CE4L}},{{0x6A1CL,6L,0x747BB7ABL,0x1B583DC0L}},{{0xD3F7L,0L,0xC443EB60L,0x93009CE4L}},{{0xD3F7L,0L,0xC443EB60L,0x93009CE4L}},{{0x6A1CL,6L,0x747BB7ABL,0x1B583DC0L}}};
    struct S0 *l_3 = &l_2[4][0];
    int i, j;
    (*l_3) = l_2[4][0];
    for (g_4 = 0; g_4 < 7; g_4 += 1)
    {
        ...
        {
            struct S0 tmp = {0x8CAEL,-1L,0x1720D700L,0x986D6DBCL};
            l_2[g_4][g_5] = tmp;
        }
    }
    return g_6;
