...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[7] = {0x226C312FL,(-9L),0x226C312FL,0x226C312FL,(-9L),0x226C312FL,0x226C312FL};
static struct S0 g_10 = {3043,17,2,147,7UL,6L,1510};/* VOLATILE GLOBAL g_10 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[5] = {&g_3[4],&g_3[4],&g_3[4],&g_3[4],&g_3[4]};
    int16_t l_4 = 1L;
    int8_t l_5 = 1L;
    int16_t l_6 = 0x49CEL;
    uint64_t l_7 = 0xCDFFA870C387C7A5LL;
    int i;
    --l_7;
    return g_10;
}
...
XXX times a pointer is qualified to be dereferenced: 153
