...
static volatile int32_t ** volatile g_9[10] = {&g_10,&g_10,&g_10,&g_10,&g_10,&g_10,&g_10,&g_10,&g_10,&g_10};
static volatile int32_t ** volatile g_11 = &g_10;/* VOLATILE GLOBAL g_11 */
...
static int8_t  func_1(void)
{ /* block id: 0 */
    const uint32_t l_8 = 0x2D83D783L;
    int32_t *l_13 = &g_5;
    int32_t **l_12 = &l_13;
    for (g_5 = 6; (g_5 == (-11)); g_5 = safe_sub_func_uint16_t_u_u(g_5, 6))
    { /* block id: 3 */
        (*g_11) = (l_8 , &g_4);
    }
    (*l_12) = (void*)0;
