...
static struct S0 g_7 = {0xDBL,0UL,65530UL,0L,0x8EC3L,18446744073709551615UL,0UL,0x76D2L,0UL,0x86AEBA4DL};/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    int8_t l_4 = 0L;
    int32_t l_6 = 0L;
    l_6 = (safe_div_func_int64_t_s_s((l_4 , g_5), l_4));
    return g_7;
}
