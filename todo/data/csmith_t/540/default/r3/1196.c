...
static int32_t * volatile g_13[1][5][6] = {{{&g_14,&g_14,&g_14,&g_14,&g_14,&g_14},{&g_14,&g_14,&g_14,&g_14,&g_14,&g_14},{(void*)0,&g_14,&g_14,(void*)0,&g_14,(void*)0},{(void*)0,&g_14,(void*)0,&g_14,&g_14,(void*)0},{&g_14,&g_14,&g_14,&g_14,&g_14,&g_14}}};
...
{ /* block id: 0 */
    uint32_t l_7[3];
    uint8_t *l_8 = &g_9;
    int32_t l_12 = 0x82BAEF6EL;
    int32_t *l_15 = &g_14;
    int16_t l_16 = (-4L);
    int i;
    for (i = 0; i < 3; i++)
        l_7[i] = 0xA2B3B7BEL;
    (*l_15) |= ((safe_lshift_func_uint8_t_u_s((safe_sub_func_int16_t_s_s((+(l_7[2] & l_7[0])), 65527UL)), 4)) != (((*l_8)++) ^ (((l_12 = l_7[2]) || 0x9EDCL) > 0UL)));
    return l_16;
}
