...
static volatile uint32_t g_5[9] = {0x658EDFE0L,0x658EDFE0L,0x658EDFE0L,0x658EDFE0L,0x658EDFE0L,0x658EDFE0L,0x658EDFE0L,0x658EDFE0L,0x658EDFE0L};
static struct S0 g_8 = {0,1,-24350,371,5322,0UL,13,0};/* VOLATILE GLOBAL g_8 */
