...
static struct S0  func_5(int16_t  p_6, const int32_t * p_7);
...
{ /* block id: 0 */
    ...
    (*l_3) = l_2;
    (*l_3) = (func_5((*l_3), l_8) , 0xD60A2215L);
    return l_12;
}
...
static struct S0  func_5(int16_t  p_6, const int32_t * p_7)
{ /* block id: 2 */
    struct S0 l_10 = {0xDEADL,0xBACCL,3L,-4L};
    struct S0 *l_9 = &l_10;
    struct S0 l_11 = {0xFA8FL,8UL,5L,0xE2949F4FFCF33F23LL};
    l_9 = l_9;
    return l_11;
}
