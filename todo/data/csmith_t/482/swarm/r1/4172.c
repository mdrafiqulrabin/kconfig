...
static float g_4 = 0x2.3E90A6p-15;
static volatile uint32_t g_5 = 0xAAEB9AE7L;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    ...
    g_5++;
    g_8++;
    l_13 = (safe_div_func_uint32_t_u_u(4294967295UL, 4UL));
    return g_5;
}
