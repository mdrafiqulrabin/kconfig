...
static int32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_37 = 0x28ED4A55;
    int32_t l_38 = 0x6373A4C9;
    l_38 = ((float)((float)((float)l_37 * (float)l_37) / (float)__builtin_bswap64(g_10)) - (float)l_37);
    return g_10;
}
