...
static uint64_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_3 = 0x7CE5L;
    int32_t l_4 = (-8L);
    l_4 = (safe_unary_minus_func_int16_t_s(l_3));
    return l_3;
}
