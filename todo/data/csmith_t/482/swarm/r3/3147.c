 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --no-compound-assignment --consts --no-divs --no-embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --no-longlong --no-int8 --uint8 --no-float --math64 --no-inline-function --muls --no-safe-math --packed-struct --paranoid --pointers --no-structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --global-variabless --no-builtins
 * Seed:      1252907950
 */
...
/* --- GLOBAL VARIABLES --- */
static const int16_t g_2 = 0xFB63;
static int32_t g_4 = 0x16210B99;
...
{ /* block id: 0 */
    ...
    int32_t l_16 = 0;
    (*l_3) = g_2;
    (*l_3) = (((*l_3) & ((*l_3) >= ((uint16_t)((int16_t)l_9 << (int16_t)((uint16_t)((((void*)0 != l_3) & ((int16_t)(((uint16_t)(l_16 , (0xA0426A76 > (*l_3))) % (uint16_t)g_2) || 0U) << (int16_t)(*l_3))) || 6U) >> (uint16_t)1)) * (uint16_t)65529U))) && 0x2603);
    return g_4;
}
