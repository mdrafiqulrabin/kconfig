...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_2 = {0UL,-1L,1L};/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 0xB65720B9L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0xB1943C6FL;
