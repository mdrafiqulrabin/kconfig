...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0x162C9CC1L;
...
inline static uint32_t  func_24(void)
{ /* block id: 36 */
    uint32_t l_29 = 0xCF04B064L;
    for (g_3 = 0; (g_3 != 45); g_3 = safe_add_func_int16_t_s_s(g_3, 5))
    { /* block id: 39 */
        uint8_t l_27 = 0UL;
        g_28 = l_27;
    }
