...
{ /* block id: 0 */
    ...
    for (g_3 = (-18); (g_3 <= (-15)); g_3 = safe_add_func_int16_t_s_s(g_3, 1))
    { /* block id: 3 */
        if (g_3)
            break;
        return g_3;
