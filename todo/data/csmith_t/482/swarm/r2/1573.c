...
static uint32_t g_12 = 0xE9734172L;
...
{ /* block id: 0 */
    int16_t l_2 = 0L;
    uint16_t l_13 = 0xFE24L;
    g_12 = (((l_2 > (0xDAE5A60DL == 0x585B7F37L)) ^ (g_3 != ((!((safe_add_func_int32_t_s_s((!g_3), 0xFCE2949FL)) || l_2)) != l_2))) >= (safe_sub_func_uint16_t_u_u((safe_rshift_func_uint16_t_u_s(l_2, 0)), l_2)));
    return l_13;
}
