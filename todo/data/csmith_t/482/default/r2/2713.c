...
static int32_t g_3 = 0x47D1AFD0L;
static int32_t g_12 = 0x09D70CADL;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_6 = 0xA0C8D467L;
    for (g_3 = 0; (g_3 > (-1)); g_3 = safe_sub_func_uint32_t_u_u(g_3, 9))
    { /* block id: 3 */
        int32_t *l_11 = &g_12;
        l_6--;
        (*l_11) = (safe_lshift_func_uint16_t_u_u(l_6, 9));
    }
    return l_6;
}
