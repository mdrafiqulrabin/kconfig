...
static volatile int32_t g_3[7] = {0x76B0F738L,0x76B0F738L,0x76B0F738L,0x76B0F738L,0x76B0F738L,0x76B0F738L,0x76B0F738L};
...
static int64_t  func_1(void)
{ /* block id: 0 */
    for (g_4 = 26; (g_4 >= 10); g_4 = safe_sub_func_uint8_t_u_u(g_4, 7))
    { /* block id: 3 */
        return g_3[2];
    }
    return g_2;
