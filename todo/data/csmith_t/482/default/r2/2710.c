...
static const struct S0 g_6[2] = {{5L,0UL,0L,0x1AC3L,0xC9L,0UL,18446744073709551610UL},{5L,0UL,0L,0x1AC3L,0xC9L,0UL,18446744073709551610UL}};
...
static const struct S0  func_1(void)
{ /* block id: 0 */
    uint32_t l_5 = 0x78F4F823L;
    for (g_2 = 0; (g_2 < (-24)); g_2 = safe_sub_func_uint64_t_u_u(g_2, 2))
    { /* block id: 3 */
        if (l_5)
            break;
    }
