...
static uint32_t g_5[2] = {0x17C10977L,0x17C10977L};
static struct S0 g_7 = {7526,5318,-243,524,3,0x3C67L,-2270};/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    int16_t l_3[2];
    uint32_t *l_4 = &g_5[0];
    int32_t l_6 = 0x0C4307E4L;
    int i;
    for (i = 0; i < 2; i++)
        l_3[i] = 0x2F80L;
    l_6 |= ((g_2 == 0xD3A18E41L) && ((*l_4) &= l_3[1]));
    return g_7;
}
