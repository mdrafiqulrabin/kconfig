...
static volatile int32_t g_7 = 0x9565E08CL;/* VOLATILE GLOBAL g_7 */
static int32_t g_8 = 0xDD1D8F8FL;
...
{ /* block id: 0 */
    ...
    for (g_3 = 21; (g_3 == 2); g_3 = safe_sub_func_int16_t_s_s(g_3, 8))
    { /* block id: 3 */
        for (g_8 = 2; (g_8 >= 0); g_8 -= 1)
        { /* block id: 6 */
            int i, j;
            return l_6[g_8][(g_8 + 6)];
        }
    }
    return g_8;
}
