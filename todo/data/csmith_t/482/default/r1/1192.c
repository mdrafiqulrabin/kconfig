...
static volatile uint8_t g_11 = 0x83L;/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    int32_t *l_8[10];
    int8_t l_18 = 0x4AL;
    uint32_t l_19 = 0xAE8B0121L;
    uint32_t l_20 = 0x377D6446L;
    int i;
    for (i = 0; i < 10; i++)
        l_8[i] = &g_3;
    g_11--;
    g_21 = (safe_sub_func_int32_t_s_s(((*l_2) = (l_2 == (void*)0)), (g_10 != (g_9 && (((safe_sub_func_int16_t_s_s(l_18, 0x198AL)) > g_9) , (l_20 |= l_19))))));
    return g_9;
}
