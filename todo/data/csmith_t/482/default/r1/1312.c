...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2 = 0x2CFB6318L;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_4 = 0x0B999FB0L;/* VOLATILE GLOBAL g_4 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t *l_3[2][1][4] = {{{&g_4,&g_4,&g_4,&g_4}},{{&g_4,&g_4,&g_4,&g_4}}};
    int i, j, k;
    g_4 = g_2;
    return g_4;
}
