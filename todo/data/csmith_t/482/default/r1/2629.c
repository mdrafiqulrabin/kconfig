...
static int16_t g_7 = 0x9FA8L;
static int32_t g_9 = 0L;
static int8_t g_11 = 0xD6L;
static volatile int8_t * volatile *g_12[1] = {(void*)0};
...
/* 
 * reads : g_3 g_9 g_12
 * writes: g_3 g_7 g_9 g_12
 */
static int8_t  func_1(void)
{ /* block id: 0 */
    int64_t l_6 = (-4L);
    int8_t *l_10[9] = {(void*)0,&g_11,&g_11,(void*)0,&g_11,&g_11,(void*)0,&g_11,&g_11};
    int i;
    for (g_3[3] = 15; (g_3[3] <= 29); ++g_3[3])
    { /* block id: 3 */
        int32_t *l_8 = &g_9;
        volatile int8_t * volatile **l_13 = &g_12[0];
        (*l_8) ^= (g_7 = l_6);
        (*l_8) &= ((void*)0 != l_10[0]);
        (*l_13) = g_12[0];
    }
