...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_6[2] = {8L,8L};
static uint64_t g_9 = 0UL;
static uint64_t g_10 = 0x5336DE0184DCC80FLL;
...
{ /* block id: 0 */
    int32_t *l_11 = &g_12;
    (*l_11) = func_2((safe_div_func_uint32_t_u_u(g_6[0], (safe_lshift_func_uint16_t_u_s((g_9 = 0x14EBL), g_10)))));
    return (*l_11);
}
