...
static volatile int32_t g_7 = 0x6B9C2D62L;/* VOLATILE GLOBAL g_7 */
static volatile uint16_t g_8 = 65526UL;/* VOLATILE GLOBAL g_8 */
static struct S1 g_11 = {-25,163,19,0,-51,962};
...
{ /* block id: 0 */
    ...
    int32_t *l_3 = &g_4;
    int32_t *l_5 = &g_4;
    int32_t *l_6[5][4] = {{&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,(void*)0,&g_4},{&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,(void*)0,&g_4}};
    int i, j;
    ++g_8;
    return g_11;
}
