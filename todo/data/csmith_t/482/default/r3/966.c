...
/* --- GLOBAL VARIABLES --- */
static int32_t g_5[7] = {0x57E8B72FL,0x57E8B72FL,0x57E8B72FL,0x57E8B72FL,0x57E8B72FL,0x57E8B72FL,0x57E8B72FL};
...
{ /* block id: 0 */
    ...
    int32_t **l_3 = &l_4;
    (*l_3) = (void*)0;
    g_5[6] = (safe_unary_minus_func_int16_t_s(((g_5[5] && g_5[3]) == (-7L))));
    return g_5[6];
}
