...
static uint32_t g_10 = 0x867B8F5FL;
static int32_t g_12 = (-6L);
static int32_t * volatile g_11[2] = {&g_12,&g_12};


/* --- FORWARD DECLARATIONS --- */
static int8_t  func_1(void);
static int64_t  func_3(uint64_t  p_4, int16_t  p_5);
