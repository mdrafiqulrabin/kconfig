...
static int32_t g_6 = 0x2513244DL;
static union U1 g_21 = {0xDA56L};
...
static union U1  func_1(void)
{ /* block id: 0 */
    int32_t l_10 = 0xE7631615L;
    int32_t l_11 = 1L;
    int32_t l_12 = (-3L);
    int32_t l_13 = 0L;
    int32_t l_14 = 0L;
    for (g_3 = 0; (g_3 < (-19)); g_3 = safe_sub_func_int16_t_s_s(g_3, 6))
    { /* block id: 3 */
        uint8_t l_18[6] = {254UL,0x1CL,254UL,254UL,0x1CL,254UL};
        int i;
        for (g_6 = 0; (g_6 >= 3); g_6 = safe_add_func_uint64_t_u_u(g_6, 8))
        { /* block id: 6 */
            int32_t *l_9[10][1] = {{(void*)0},{&g_3},{&g_3},{(void*)0},{(void*)0},{(void*)0},{&g_3},{&g_3},{(void*)0},{(void*)0}};
            uint16_t l_15 = 0x9EB8L;
            int i, j;
            --l_15;
            l_18[5]++;
        }
