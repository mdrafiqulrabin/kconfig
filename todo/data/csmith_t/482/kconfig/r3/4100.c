...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_7 = 0x6444696A;
static union U0 g_30 = {0x6F97812A};/* VOLATILE GLOBAL g_30 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_30.f2, sizeof(g_30.f2), "g_30.f2", print_hash_value);
