...
{ /* block id: 36 */
    int16_t l_32 = 7;
    int32_t l_37 = 0xB39523DD;
    int32_t l_46 = (-9);
    int32_t l_47 = (-1);
    int32_t l_48 = 0;
    l_48 = ((l_32 , ((((uint32_t)((l_32 | l_32) == ((((uint16_t)(l_37 |= l_32) >> (uint16_t)7) , 0x40A98CEE) , (l_47 = ((l_37 = l_37) >= ((int32_t)((uint16_t)(l_46 = ((l_32 & ((int32_t)l_32 + (int32_t)((int16_t)l_32 >> (int16_t)l_32))) , l_32)) >> (uint16_t)l_32) - (int32_t)l_32))))) - (uint32_t)l_32) == 0xD679) >= l_32)) <= l_32);
    return l_47;
}
