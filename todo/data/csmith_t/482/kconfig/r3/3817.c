...
{ /* block id: 36 */
    uint32_t l_28 = 1U;
    int32_t l_38 = 0x089CED66;
    l_38 = (0xAD7D711E ^ ((l_28 || g_13) || ((((int16_t)g_13 << (int16_t)15) == ((int32_t)((__builtin_popcountll((l_28 > ((uint32_t)((uint16_t)0x7550 - (uint16_t)(2U & l_28)) - (uint32_t)(!0x4150)))) > l_28) > 0x9314E764) + (int32_t)0)) | 9)));
    return g_13;
}
