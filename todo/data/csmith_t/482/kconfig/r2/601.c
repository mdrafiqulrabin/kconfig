...
/* --- GLOBAL VARIABLES --- */
static int32_t g_16 = 0x23B1A956;
...
static int32_t  func_28(void)
{ /* block id: 36 */
    int32_t l_31 = 0xC218E993;
    uint32_t l_44 = 4294967295U;
    int32_t l_52 = 0xED5EBAE8;
    l_52 = ((((uint16_t)l_31 + (uint16_t)(((int32_t)l_31 - (int32_t)(g_16 & g_34)) < g_34)) <= ((func_35(((uint32_t)(0x7DCD < (((int16_t)__builtin_ctzl((((g_16 <= (-1)) != ((((int32_t)0xEAF6082F % (int32_t)g_34) > g_16) | g_34)) & l_44)) >> (int16_t)5) && 0x295A)) - (uint32_t)l_31), g_34) || l_31) | 65535U)) >= l_31);
    return g_34;
}
...
{ /* block id: 37 */
    ...
    int32_t l_46 = (-1);
    l_45 = p_36;
    g_51 = ((l_46 >= ((int32_t)__builtin_parity(l_46) % (int32_t)(0x0561 || g_34))) < (((uint16_t)__builtin_ctzl(g_16) << (uint16_t)7) <= (p_37 & (((3 | 0) & 0x2FD1) >= g_16))));
    return g_34;
}
