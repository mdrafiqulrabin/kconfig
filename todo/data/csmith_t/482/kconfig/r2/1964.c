...
{ /* block id: 36 */
    ...
    const uint64_t l_43 = 0x8E10D32DE9E5A939LL;
    (*l_33) = (safe_rshift_func_uint16_t_u_u(l_32, 14));
    (*l_35) = &l_32;
    for (l_32 = 11; (l_32 >= (-23)); l_32 = safe_sub_func_int32_t_s_s(l_32, 1))
    { /* block id: 41 */
        int32_t l_39 = 9L;
        int32_t *l_38 = &l_39;
        (*l_38) |= ((void*)0 == (*l_35));
    ...
    (**l_35) = (safe_mod_func_uint64_t_u_u((**l_35), (**l_35)));
    return l_43;
}
