...
/* --- GLOBAL VARIABLES --- */
static int16_t g_7[9] = {1L,1L,1L,1L,1L,1L,1L,1L,1L};
...
static int8_t  func_24(void)
{ /* block id: 36 */
    float l_25[9] = {0xD.158018p+29,0x9.7F1A96p-64,0xD.158018p+29,0x9.7F1A96p-64,0xD.158018p+29,0x9.7F1A96p-64,0xD.158018p+29,0x9.7F1A96p-64,0xD.158018p+29};
    int32_t l_26 = (-9L);
    int i;
    return l_26;
}
