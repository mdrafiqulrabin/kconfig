...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_4 = 0x7CC42477;
static struct S0 g_5 = {1U,8109,2,-243,4,-725,0,-1494,0};/* VOLATILE GLOBAL g_5 */
static struct S0 g_6 = {255U,10478,1,-1333,13,-796,0,-1719,13};/* VOLATILE GLOBAL g_6 */
