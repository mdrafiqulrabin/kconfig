...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_6 = 0x638ECF54C3C69AEDLL;
static float g_32 = (-0x4.8p-1);
...
inline static uint8_t  func_29(void)
{ /* block id: 36 */
    uint32_t l_30 = 0x77DCDA72L;
    (*g_31) = ((g_6 , l_30) , __builtin_clzll(l_30));
    for (g_6 = (-14); (g_6 <= 14); g_6 = safe_add_func_int8_t_s_s(g_6, 2))
    { /* block id: 40 */
        if (g_6)
            break;
    }
