...
static uint16_t  func_25(void)
{ /* block id: 36 */
    uint32_t l_28 = 0x0D461E3F;
    int16_t l_34 = 0xCDF9;
    uint32_t l_36 = 4294967295U;
    int32_t l_37 = 0x0DE450BB;
    if (((uint32_t)l_28 % (uint32_t)l_28))
    { /* block id: 37 */
        g_6 = 0x4AD38DC5;
    }
    else
    { /* block id: 39 */
        uint32_t l_33 = 0x6FEBFB2C;
        g_6 = ((uint16_t)((uint32_t)l_33 % (uint32_t)l_34) >> (uint16_t)((~l_33) == g_6));
        l_36 = 0x1DFE936B;
    }
    l_37 = l_36;
    return g_6;
