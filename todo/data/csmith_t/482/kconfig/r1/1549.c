...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_5 = 0xA1L;/* VOLATILE GLOBAL g_5 */
static volatile uint8_t g_6 = 0xF1L;/* VOLATILE GLOBAL g_6 */
static struct S0 g_7 = {22,177,0UL,18446744073709551615UL,33,0,3L};/* VOLATILE GLOBAL g_7 */
