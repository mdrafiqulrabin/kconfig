...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x8E17C109L;
static int32_t * const  volatile g_2[4] = {&g_3,&g_3,&g_3,&g_3};
static int32_t * volatile * volatile g_4 = (void*)0;/* VOLATILE GLOBAL g_4 */
static int32_t * volatile g_7 = &g_3;/* VOLATILE GLOBAL g_7 */
static int32_t g_14[8] = {5L,5L,1L,5L,5L,1L,5L,5L};
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t * volatile *l_5 = (void*)0;
    int32_t * volatile *l_6 = &g_7;
    (*l_6) = g_2[1];
