...
static volatile uint8_t g_14 = 0x2FL;/* VOLATILE GLOBAL g_14 */
...
{ /* block id: 0 */
    ...
    uint16_t l_9 = 0UL;
    int32_t *l_12 = &g_3;
    int32_t *l_13[5][2][2] = {{{&g_3,&g_3},{&g_3,&g_3}},{{&g_3,&g_3},{&g_3,&g_3}},{{&g_3,&g_3},{&g_3,&g_3}},{{&g_3,&g_3},{&g_3,&g_3}},{{&g_3,&g_3},{&g_3,&g_3}}};
    int i, j, k;
    l_9--;
    g_14++;
    return (*l_2);
