...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xB7F37C04L;
...
static struct S1  func_1(void)
{ /* block id: 0 */
    int8_t l_2[3][8] = {{0L,0x00L,(-9L),5L,(-9L),0x00L,0L,0xDEL},{(-9L),0x00L,0L,0xDEL,0xFBL,0xFBL,0xDEL,0L},{0x5DL,0x5DL,0x00L,7L,0xFBL,5L,1L,5L}};
    int32_t l_5 = (-4L);
    int32_t *l_6 = &l_5;
    struct S1 l_7 = {0x45EE28FDL};
    int i, j;
