...
static struct S0 g_13[5] = {{116},{116},{116},{116},{116}};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3[4];
    int32_t *l_4 = &g_3[4];
    int32_t l_5 = 0xA624CDB8L;
    int32_t *l_6[3][10] = {{&l_5,&g_3[4],&l_5,&g_3[4],&l_5,&g_3[2],&g_3[4],&l_5,&l_5,&g_3[4]},{&l_5,&g_3[2],(void*)0,(void*)0,&g_3[2],&l_5,(void*)0,&g_3[4],&l_5,&g_3[4]},{&g_3[4],(void*)0,&l_5,&l_5,&l_5,(void*)0,&g_3[4],(void*)0,&l_5,&l_5}};
    uint8_t l_7 = 0xC5L;
    uint64_t l_10 = 0x9BF5BF81606DC068LL;
    int i, j;
    l_7--;
    l_10--;
    return g_13[3];
