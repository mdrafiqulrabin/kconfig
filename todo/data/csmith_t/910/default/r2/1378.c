...
static volatile int32_t g_12 = 0x25DB2B05L;/* VOLATILE GLOBAL g_12 */
...
static union U2  func_1(void)
{ /* block id: 0 */
    uint64_t l_7[8] = {18446744073709551615UL,18446744073709551615UL,18446744073709551615UL,18446744073709551615UL,18446744073709551615UL,18446744073709551615UL,18446744073709551615UL,18446744073709551615UL};
    int32_t *l_8 = &g_9;
    int32_t **l_10 = (void*)0;
    union U2 l_13 = {0x7F51EF99L};
    int i;
    (*l_8) = func_2(g_5, l_7[6]);
    g_11 = ((*l_8) , (void*)0);
    return l_13;
}
