...
static int32_t * volatile g_8 = &g_2;/* VOLATILE GLOBAL g_8 */
...
static int16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_6[6] = {1UL,0x039D6B9CL,1UL,1UL,0x039D6B9CL,1UL};
    int32_t *l_7 = (void*)0;
    int i;
    for (g_2 = 0; (g_2 == 27); g_2 = safe_add_func_uint16_t_u_u(g_2, 3))
    { /* block id: 3 */
        int64_t l_5 = 0xA0D018D303F0244CLL;
        return l_5;
    }
    for (g_2 = 0; g_2 < 6; g_2 += 1)
    {
        l_6[g_2] = 18446744073709551609UL;
    }
    (*g_8) |= l_6[0];
    return g_2;
}
