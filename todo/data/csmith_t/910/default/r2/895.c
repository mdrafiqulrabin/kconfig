...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_4 = 0x96L;/* VOLATILE GLOBAL g_4 */
static uint64_t g_7[6] = {9UL,9UL,9UL,9UL,9UL,9UL};
...
{ /* block id: 0 */
    ...
    uint64_t *l_6 = &g_7[2];
    int32_t *l_8 = &g_9;
    (*l_8) &= (safe_sub_func_int8_t_s_s((g_4 != ((*l_6) = (l_5 ^ 0x22B16580849F845DLL))), 0xC3L));
    return (*l_8);
}
