...
/* --- GLOBAL VARIABLES --- */
static int8_t g_2[2][3] = {{0x9EL,0x9EL,0x9EL},{0x3CL,0x3CL,0x3CL}};
static union U0 g_3 = {0L};
static int64_t g_5 = 0xC87A7525D2D91509LL;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_3 g_3.f0 g_5
 * writes: g_5
 */
static union U0  func_1(void)
{ /* block id: 0 */
    uint32_t l_4 = 0xB2BC40EDL;
    union U0 l_6 = {0xE1L};
    g_5 ^= (((g_2[0][0] & (g_3 , l_4)) >= g_3.f0) , 0x0D658EDFL);
    return l_6;
}
