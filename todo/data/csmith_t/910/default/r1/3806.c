...
static volatile int32_t g_4 = 0x93009CE4L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0x513244D5L;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    const volatile int8_t ** volatile *l_3[1][4][5] = {{{&g_2,&g_2,&g_2,&g_2,&g_2},{(void*)0,&g_2,&g_2,(void*)0,&g_2},{(void*)0,(void*)0,&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2,&g_2,&g_2}}};
    int i, j, k;
    g_2 = g_2;
    for (g_5 = 0; (g_5 < 1); ++g_5)
    { /* block id: 4 */
