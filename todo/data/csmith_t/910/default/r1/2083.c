...
/* --- GLOBAL VARIABLES --- */
static int8_t g_2[7][1] = {{0x80L},{0xACL},{0xACL},{0x80L},{0xACL},{0xACL},{0x80L}};
static volatile int32_t g_3 = 0x9DCEE34EL;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = (-7L);/* VOLATILE GLOBAL g_4 */
static struct S0 g_5 = {11922,0,32586,73,0,172,23,695,1};/* VOLATILE GLOBAL g_5 */
