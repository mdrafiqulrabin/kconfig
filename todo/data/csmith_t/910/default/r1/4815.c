...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x08901F2CL;/* VOLATILE GLOBAL g_2 */
static int32_t g_3 = 7L;
static int64_t g_6 = 0x29EA41449C9FB37BLL;
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        int32_t *l_9 = &g_10;
        (*l_9) ^= (g_6 = 0xF4672159L);
        for (g_6 = 3; (g_6 < 5); g_6 = safe_add_func_uint16_t_u_u(g_6, 9))
        { /* block id: 8 */
            (*l_9) = (g_10 | g_10);
        }
