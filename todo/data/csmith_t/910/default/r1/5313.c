...
static int32_t g_16 = 0x0EC3203BL;
...
{ /* block id: 0 */
    ...
    int i;
    for (i = 0; i < 1; i++)
        l_17[i] = 0x68108531D14CD495LL;
    for (g_3 = (-14); (g_3 >= 21); ++g_3)
    { /* block id: 3 */
        uint64_t l_11 = 0xA6E6F7FBF2121F90LL;
        int32_t *l_15 = &g_16;
        (*g_7) = (safe_unary_minus_func_int8_t_s(g_3));
        (*l_15) |= ((safe_sub_func_uint16_t_u_u(l_11, (g_8 >= g_3))) < (((safe_div_func_uint16_t_u_u((+(18446744073709551611UL >= g_2)), 0x943CL)) , g_3) <= g_3));
    }
    return l_17[0];
}
