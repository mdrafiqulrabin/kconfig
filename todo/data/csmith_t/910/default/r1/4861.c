...
/* --- GLOBAL VARIABLES --- */
static volatile union U2 g_2 = {1UL};/* VOLATILE GLOBAL g_2 */
static int32_t g_4 = 1L;
static union U1 g_5 = {{-1L,0xD658EDFEL,0x12L,6L,8L,4L,1UL,0x91509CF13E13A6C9LL}};/* VOLATILE GLOBAL g_5 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc(g_5.f0.f7, "g_5.f0.f7", print_hash_value);
