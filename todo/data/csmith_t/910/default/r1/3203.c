...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x8AFA2FAFL;/* VOLATILE GLOBAL g_2 */
static int32_t g_3[2][5] = {{1L,0xD962EE6DL,1L,1L,0xD962EE6DL},{0xD962EE6DL,1L,1L,0xD962EE6DL,1L}};
...
{ /* block id: 0 */
    int64_t l_6 = (-4L);
    int32_t *l_12 = &g_11;
    for (g_3[0][3] = (-27); (g_3[0][3] == (-6)); g_3[0][3] = safe_add_func_int64_t_s_s(g_3[0][3], 5))
    { /* block id: 3 */
        if (l_6)
            break;
        for (l_6 = 22; (l_6 >= 28); ++l_6)
        { /* block id: 7 */
