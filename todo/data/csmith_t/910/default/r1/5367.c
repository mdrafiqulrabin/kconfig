...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_7[1] = {65535UL};
static uint16_t g_9 = 0x63BAL;
static uint32_t g_11 = 0xD4A0D461L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_14[i] = &g_15;
    g_15 |= (safe_mul_func_int16_t_s_s(0xB666L, ((safe_sub_func_uint16_t_u_u(((*l_8) = ((*l_6) = 0UL)), 65535UL)) <= ((*l_10)++))));
    return g_11;
}
