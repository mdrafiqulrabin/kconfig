...
/* --- GLOBAL VARIABLES --- */
static volatile int16_t g_5 = 0x63C4L;/* VOLATILE GLOBAL g_5 */
static int32_t g_8 = 0x6890C544L;
static int32_t * volatile g_7 = &g_8;/* VOLATILE GLOBAL g_7 */
static volatile union U2 g_10 = {-1L};/* VOLATILE GLOBAL g_10 */
static volatile union U2 *g_9 = &g_10;
static int32_t * volatile g_12 = &g_8;/* VOLATILE GLOBAL g_12 */
static union U3 g_13 = {0x143836745799333CLL};/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 3; i++)
        l_11[i] = 5L;
    (*g_7) = (+(safe_add_func_uint32_t_u_u(g_5, l_6)));
    g_9 = (void*)0;
    (*g_12) = (g_5 , l_11[1]);
    return g_13;
}
