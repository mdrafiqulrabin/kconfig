...
/* --- GLOBAL VARIABLES --- */
static int16_t g_6 = 0x7C9DL;
static int32_t g_10 = 0x864BA8B3L;
static int32_t * volatile g_9 = &g_10;/* VOLATILE GLOBAL g_9 */
static int32_t g_12 = 0x959C45C1L;
...
{ /* block id: 0 */
    ...
    int8_t *l_8 = (void*)0;
    int32_t *l_11 = &g_12;
    uint64_t l_13 = 0xDB821342F3D47941LL;
    (*g_9) = (safe_rshift_func_uint16_t_u_s((safe_mul_func_int16_t_s_s((l_7 = g_6), ((void*)0 != l_8))), 10));
    (*l_11) &= (*g_9);
    (*l_11) |= (((void*)0 == &g_12) || (l_13 , g_10));
    return (*l_11);
}
