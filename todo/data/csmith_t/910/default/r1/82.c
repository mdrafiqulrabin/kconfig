...
static int32_t g_9[5][2] = {{(-4L),0xA9B64FDAL},{0xA9B64FDAL,(-4L)},{0xA9B64FDAL,0xA9B64FDAL},{(-4L),0xA9B64FDAL},{0xA9B64FDAL,(-4L)}};
static int32_t * volatile g_8 = &g_9[0][1];/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t *l_3 = &g_4[2];
    int16_t l_7 = 0x591BL;
    (*g_8) |= ((g_2 <= ((*l_3) = g_2)) | (safe_add_func_int64_t_s_s(g_2, l_7)));
    return g_4[2];
}
