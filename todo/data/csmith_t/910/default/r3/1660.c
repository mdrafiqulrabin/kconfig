...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[10] = {0x9FEBB674L,0x9FEBB674L,0x9FEBB674L,0x9FEBB674L,0x9FEBB674L,0x9FEBB674L,0x9FEBB674L,0x9FEBB674L,0x9FEBB674L,0x9FEBB674L};
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3[9];
    int32_t *l_5 = (void*)0;
    int32_t *l_6[5] = {&g_3[9],&g_3[9],&g_3[9],&g_3[9],&g_3[9]};
    int8_t l_7 = 0xAAL;
    uint32_t l_8[6];
    int i;
    for (i = 0; i < 6; i++)
