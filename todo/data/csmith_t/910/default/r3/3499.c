...
static int8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_8 = 0x2B3B7BEDL;
    int32_t l_9 = 0x7213EC75L;
    uint32_t l_12 = 1UL;
    for (g_2 = 0; (g_2 > (-20)); g_2 = safe_sub_func_int64_t_s_s(g_2, 7))
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        int32_t *l_7[7][1] = {{&g_6},{(void*)0},{&g_6},{(void*)0},{&g_6},{(void*)0},{&g_6}};
        int i, j;
        l_12++;
    }
    return l_12;
