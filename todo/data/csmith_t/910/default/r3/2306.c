...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xE56F9B2CL;
static volatile uint64_t g_27 = 18446744073709551614UL;/* VOLATILE GLOBAL g_27 */
...
{ /* block id: 0 */
    ...
    int32_t *l_23 = &l_21;
    int32_t *l_24 = (void*)0;
    int32_t l_25 = 0x48F4A8FEL;
    int32_t *l_26[8] = {&g_3,&l_25,&g_3,&g_3,&l_25,&g_3,&g_3,&l_25};
    int i;
    for (i = 0; i < 1; i++)
        l_10[i] = (-1L);
    ++g_27;
