...
static int16_t g_9 = 0x57EAL;
static volatile uint16_t g_10 = 0x4F88L;/* VOLATILE GLOBAL g_10 */
static const struct S0 g_15 = {4294967294UL,6UL};/* VOLATILE GLOBAL g_15 */
...
{ /* block id: 0 */
    ...
    int32_t l_6 = 1L;
    int32_t *l_7 = (void*)0;
    int32_t *l_8[8][1] = {{&l_6},{&l_6},{&l_6},{&l_6},{&l_6},{&l_6},{&l_6},{&l_6}};
    int i, j;
    ++g_10;
    for (g_9 = 13; (g_9 < 7); --g_9)
    { /* block id: 4 */
        if (g_3)
            break;
    }
