...
/* --- GLOBAL VARIABLES --- */
static const volatile struct S0 g_4 = {65528UL,0UL,0xBC3EC3D4L,0x703026D8L,0x3833L,4294967293UL};/* VOLATILE GLOBAL g_4 */
static int32_t g_6 = 0xC38EC326L;
...
static int8_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_5[4][1] = {{&g_6},{&g_6},{&g_6},{&g_6}};
    int i, j;
    g_6 = (safe_div_func_uint8_t_u_u((g_4 , g_4.f0), 0xB7L));
    return g_4.f2;
}
