...
static uint16_t * volatile g_10 = (void*)0;/* VOLATILE GLOBAL g_10 */
static int32_t g_12 = 0x7FBF2121L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_13 = 0x307DL;
    for (g_2 = 0; (g_2 < (-24)); --g_2)
    { /* block id: 3 */
        uint16_t *l_7 = (void*)0;
        uint16_t *l_8 = &g_9;
        int32_t *l_11 = &g_12;
        (*l_11) = (safe_rshift_func_uint16_t_u_u(((*l_8) &= 0UL), ((void*)0 == g_10)));
    }
    return l_13;
}
