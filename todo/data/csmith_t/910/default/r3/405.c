...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[3] = {0xE814B733L,0xE814B733L,0xE814B733L};
...
{ /* block id: 0 */
    int32_t l_2[4];
    int32_t *l_3 = &g_4[2];
    int32_t *l_5[9] = {&g_4[2],(void*)0,&g_4[2],(void*)0,&g_4[2],(void*)0,&g_4[2],(void*)0,&g_4[2]};
    uint32_t l_6 = 0xAB430688L;
    int i;
    for (i = 0; i < 4; i++)
        l_2[i] = 9L;
    l_6--;
