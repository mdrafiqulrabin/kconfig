...
/* --- GLOBAL VARIABLES --- */
static int16_t g_5[3] = {0x3989L,0x3989L,0x3989L};
...
static int64_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_2 = 0x8A012E1DFE0091DFLL;
    int32_t *l_9 = &g_7;
    int32_t *l_10 = &g_7;
    int32_t *l_11 = &g_7;
    int32_t *l_12 = &g_7;
    ...
    int32_t *l_14 = &g_7;
    int32_t *l_15 = &g_7;
    int32_t l_16 = 0x38E486AEL;
    int32_t *l_17[10] = {&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7};
    uint8_t l_18 = 0x49L;
    int i;
    l_2++;
