...
static int8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_4 = 0x9EF7L;
    uint32_t l_8 = 0UL;
    g_9 = ((-1L) | (safe_add_func_int8_t_s_s((l_4 ^ g_5), (safe_rshift_func_uint16_t_u_s((l_8 ^ l_4), 13)))));
    return g_5;
}
