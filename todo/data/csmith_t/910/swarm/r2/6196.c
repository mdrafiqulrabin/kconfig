...
/* --- GLOBAL VARIABLES --- */
static struct S1 g_2 = {660,0,36,3,-5683,57};/* VOLATILE GLOBAL g_2 */
static struct S1 g_3 = {13001,1,13,2,7511,34};/* VOLATILE GLOBAL g_3 */
