 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --no-consts --divs --no-embedded-assigns --pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --no-float --no-math64 --no-inline-function --no-muls --no-safe-math --no-packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --volatile-pointers --const-pointers --no-global-variables --no-builtins
 * Seed:      2974722796
 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_6 = 0xAC70C309;
    int32_t **l_7 = (void*)0;
    int32_t **l_8 = (void*)0;
    int32_t *l_10 = &l_6;
    int32_t **l_9 = &l_10;
    uint32_t l_11 = 0U;
    (*l_9) = func_2(l_6, l_6, &l_6);
    return l_11;
}
