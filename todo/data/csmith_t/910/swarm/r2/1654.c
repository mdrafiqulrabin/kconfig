...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        uint8_t l_6 = 6UL;
        float l_8 = 0x8.B37B04p+39;
        float *l_7 = &l_8;
        float l_10 = 0xF.012E1Dp+46;
        float *l_9 = &l_10;
        (*l_9) = (!(l_2 <= ((l_6 > ((*l_7) = l_2)) < l_6)));
    }
    return l_2;
}
