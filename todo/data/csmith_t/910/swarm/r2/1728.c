...
inline static int32_t  func_26(void)
{ /* block id: 36 */
    uint16_t l_32 = 0xA326L;
    for (g_7 = 0; (g_7 >= 3); g_7++)
    { /* block id: 39 */
        return g_7;
    }
    g_31 = (safe_sub_func_uint32_t_u_u(4294967292UL, g_7));
    return l_32;
}
