...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_6 = 0x39EDL;
    g_2 = (-10L);
    g_5 |= ((uint16_t)65527UL << (uint16_t)4);
    return l_6;
}
