...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xCB13638E;
static uint8_t g_30 = 0x98;
static union U0 g_33 = {0};/* VOLATILE GLOBAL g_33 */
...
static union U0  func_26(void)
{ /* block id: 36 */
    int32_t l_29[2][5] = {{1,0x4B0B4EF6,(-1),(-1),0x4B0B4EF6},{1,0x4B0B4EF6,(-1),(-1),0x4B0B4EF6}};
    int i, j;
    for (g_3 = 10; (g_3 == (-10)); g_3 = safe_sub_func_uint16_t_u_u(g_3, 2))
    { /* block id: 39 */
        g_30 = l_29[0][0];
    }
    g_3 = (~(~0x9BDD7770));
