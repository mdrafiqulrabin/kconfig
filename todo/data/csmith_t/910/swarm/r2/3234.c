...
static int32_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t l_3 = 0xB457102DL;/* VOLATILE GLOBAL l_3 */
    int32_t l_10 = 0L;
    l_3 = g_2;
    l_10 = ((uint16_t)func_6(l_3, l_10, l_10) << (uint16_t)g_11);
    l_10 = g_11;
    return g_2;
}
