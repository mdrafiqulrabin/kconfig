...
static struct S4 g_26 = {0x0D8AF871L,7UL,{{2L},{0L}},{0x28L},-3L,-1L,-7L,0x5DB2B058L};/* VOLATILE GLOBAL g_26 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc(g_26.f2.f0.f0, "g_26.f2.f0.f0", print_hash_value);
    transparent_crc(g_26.f2.f1.f0, "g_26.f2.f1.f0", print_hash_value);
