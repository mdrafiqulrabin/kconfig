...
/* --- GLOBAL VARIABLES --- */
static const int32_t *g_2[4] = {(void*)0,(void*)0,(void*)0,(void*)0};
...
{ /* block id: 0 */
    ...
    const int32_t **l_4 = &g_2[1];
    (*l_4) = g_2[3];
    for (g_5 = (-30); (g_5 >= 18); g_5 = safe_add_func_uint64_t_u_u(g_5, 1))
    { /* block id: 4 */
        for (g_8 = 0; (g_8 <= (-6)); g_8 = safe_sub_func_uint64_t_u_u(g_8, 1))
        { /* block id: 7 */
    ...
    //assert (g_2[0] == &g_8 || g_2[0] == 0);
    (*l_4) = &g_5;
    /* statement id: 16 */
    //assert (g_2[0] == &g_5 || g_2[0] == &g_8 || g_2[0] == 0);
    return g_8;
}
