...
{ /* block id: 0 */
    uint16_t l_5 = 65529U;
    int16_t l_6 = 0x04EE;
    for (g_2 = 0; (g_2 < 9); g_2 = safe_add_func_uint16_t_u_u(g_2, 1))
    { /* block id: 3 */
        l_5 = g_2;
    }
    return l_6;
