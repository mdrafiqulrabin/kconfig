...
{ /* block id: 0 */
    ...
    /* statement id: 1 */
    assert (l_3 == 0);
    for (l_4 = (-11); (l_4 == 17); l_4 = safe_add_func_uint16_t_u_u(l_4, 1))
    { /* block id: 4 */
        uint8_t l_7 = 1UL;
        int32_t l_8 = 3L;
        int32_t **l_9 = &l_3;
