...
{ /* block id: 0 */
    uint32_t l_2 = 1UL;
    int32_t l_4 = 0x65B49D58L;
    int32_t *l_3 = &l_4;
    struct S0 l_5 = {1941,2,47,13,-325,2,-229,-19989,2,2100};
    (*l_3) &= (l_2 > l_2);
    (*l_3) = (*l_3);
    return l_5;
}
