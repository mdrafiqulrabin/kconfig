...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_8 = 0x770A77C8L;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    uint8_t l_6 = 0x32L;
    uint32_t l_7 = 0UL;
    g_9 = ((uint32_t)((int8_t)l_6 >> (int8_t)l_7) - (uint32_t)g_8);
    return g_8;
}
