...
{ /* block id: 0 */
    int32_t l_2 = (-1);
    int32_t l_6 = 0x12FBB6BC;
    for (l_2 = 7; (l_2 > (-20)); l_2 -= 9)
    { /* block id: 3 */
        uint16_t l_5 = 0x3989;
        l_6 = ((l_2 < 0xD.FE0091p-5) < l_5);
    }
