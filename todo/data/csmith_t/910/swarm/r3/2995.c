...
inline static union U0  func_1(void)
{ /* block id: 0 */
    int64_t l_2 = 0x68C0AA39ED080C17LL;
    int32_t **l_7 = &g_6;
    int32_t ***l_8 = &l_7;
    union U0 l_9 = {-1L};
    l_2 = (-10L);
    for (l_2 = 0; (l_2 >= (-9)); l_2 = safe_sub_func_uint64_t_u_u(l_2, 1))
    { /* block id: 4 */
        int32_t *l_5 = (void*)0;
        l_5 = (void*)0;
    }
