...
{ /* block id: 36 */
    ...
    { /* block id: 40 */
        ...
        int i;
        (*l_29) = ((safe_lshift_func_int16_t_s_s(l_31[g_3], 2)) < (!(safe_sub_func_uint16_t_u_u(g_3, __builtin_parityll(((safe_rshift_func_int16_t_s_u((*l_29), (l_39 = (*l_29)))) <= (-1)))))));
    }
    return (*l_29);
}
