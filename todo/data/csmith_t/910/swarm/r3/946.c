...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_4 = 0x38ECL;
    int32_t l_5 = (-1L);
    l_5 = (safe_lshift_func_uint16_t_u_u(0UL, l_4));
    return l_4;
}
