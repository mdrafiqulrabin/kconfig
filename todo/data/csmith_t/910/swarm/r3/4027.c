...
/* --- GLOBAL VARIABLES --- */
static int16_t g_5[1][5] = {{0x6834,0x6834,0x6834,0x6834,0x6834}};
...
inline static const int32_t  func_26(void)
{ /* block id: 36 */
    int32_t *l_27[1][6] = {{&g_28,&g_28,&g_28,&g_28,&g_28,&g_28}};
    int i, j;
    ++g_29;
    return g_28;
}
