...
inline static int8_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31[7] = {0x33F23E93L,0x33F23E93L,0x33F23E93L,0x33F23E93L,0x33F23E93L,0x33F23E93L,0x33F23E93L};
    int32_t l_32 = (-1L);
    int i;
    l_32 = l_31[1];
    return g_5;
