...
{ /* block id: 0 */
    int8_t l_5 = 0xE8L;
    int32_t l_7 = 1L;
    for (g_2 = 0; (g_2 <= 23); g_2 = safe_add_func_uint16_t_u_u(g_2, 8))
    { /* block id: 3 */
        uint32_t l_6 = 0x14D2EDC7L;
        l_6 &= l_5;
    }
    g_2 ^= l_5;
    g_2 = 0x6A162C9CL;
