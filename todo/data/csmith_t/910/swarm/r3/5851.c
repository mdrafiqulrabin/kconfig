...
inline static const int16_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_2 = 0x5052061F665683C8LL;
    int32_t l_3 = 8L;
    l_3 = (l_2 && 0x55L);
    return l_3;
}
