...
{ /* block id: 36 */
    uint32_t l_29 = 1UL;
    int32_t l_30 = 0x2AEE5A98L;
    l_30 = (((-(float)l_29) <= l_29) >= 0xC.EB2391p+85);
    return l_29;
}
