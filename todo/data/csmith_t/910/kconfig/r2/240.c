...
static int32_t * volatile g_46[6] = {(void*)0,(void*)0,(void*)0,(void*)0,(void*)0,(void*)0};
...
inline static int64_t  func_29(void)
{ /* block id: 36 */
    int16_t l_40 = 0x0811L;
    (*g_48) = (safe_div_func_uint64_t_u_u(((safe_sub_func_uint16_t_u_u((safe_add_func_uint8_t_u_u(0xA5L, (safe_add_func_uint16_t_u_u((((safe_add_func_uint16_t_u_u((l_40 | (safe_add_func_uint64_t_u_u((+0L), (safe_rshift_func_uint16_t_u_s((g_7 , 1UL), 6))))), (l_40 | 0x87292079L))) ^ l_40) >= 1L), g_7)))), l_40)) > 0x5CF0ADC1L), 3L));
    return l_40;
}
