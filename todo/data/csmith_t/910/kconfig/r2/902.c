...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_2[6][3] = {{7UL,0x8529L,0x8529L},{65535UL,0x439BL,65535UL},{7UL,7UL,0x8529L},{0xDC4BL,0x439BL,0xDC4BL},{7UL,0x8529L,0x8529L},{65535UL,0x439BL,65535UL}};
    int32_t l_4[8] = {0L,0L,0L,0L,0L,0L,0L,0L};
    int32_t *l_3 = &l_4[5];
    float l_5[7];
    uint32_t l_6 = 0xA1245C81L;
    int i, j;
    for (i = 0; i < 7; i++)
        l_5[i] = 0x8.A18E41p-99;
    (*l_3) = l_2[4][1];
    return l_6;
}
