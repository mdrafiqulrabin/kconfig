...
{ /* block id: 36 */
    ...
    int32_t l_43 = 0xD9D65FE9;
    int32_t l_44 = (-10);
    struct S0 l_45 = {0xBA7DA828};
    l_44 = (((((int16_t)1 << (int16_t)l_30) & (l_43 = (1U > (((int16_t)((((uint16_t)0xB09B >> (uint16_t)7) <= ((int16_t)(((__builtin_parity(l_37) || 7U) > (l_37 <= (((((int16_t)(((((uint32_t)(l_37 != (-3)) - (uint32_t)l_37) && l_37) > l_30) == l_42) >> (int16_t)1) | l_37) != 1) < 3))) && 65535U) >> (int16_t)l_42)) || l_42) - (int16_t)l_42) & l_30)))) >= l_42) , l_37);
    l_43 = l_37;
    return l_45;
}
