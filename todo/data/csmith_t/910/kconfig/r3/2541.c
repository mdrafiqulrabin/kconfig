...
inline static int32_t  func_28(void)
{ /* block id: 36 */
    int64_t l_29[1][10][1] = {{{(-3L)},{0xA5C54CD8D27FD735LL},{0xA5C54CD8D27FD735LL},{(-3L)},{0xA5C54CD8D27FD735LL},{0xA5C54CD8D27FD735LL},{(-3L)},{0xA5C54CD8D27FD735LL},{0xA5C54CD8D27FD735LL},{(-3L)}}};
    int i, j, k;
    return l_29[0][4][0];
}
