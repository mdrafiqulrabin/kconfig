...
{ /* block id: 0 */
    int32_t l_5 = 3;
    int32_t l_6 = 0x7EE39F3F;
    struct S1 l_7 = {0x3F60,4U,0x710DD013,0x0BB94D0F,1,-5,{1U,0U,0x39E0}};
    l_6 = ((int32_t)g_4 - (int32_t)(0xC8100C43 ^ l_5));
    return l_7;
}
