...
{ /* block id: 0 */
    int32_t l_2 = 1L;
    for (l_2 = 0; (l_2 > 17); l_2 = safe_add_func_int16_t_s_s(l_2, 6))
    { /* block id: 3 */
        int32_t *l_6[8][5] = {{&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2}};
        int32_t **l_5 = &l_6[3][4];
        int i, j;
        (*l_5) = (void*)0;
        /* statement id: 4 */
        //assert (l_6[0][0] == 0 || l_6[0][0] == &l_2);
        return l_2;
    }
    return l_2;
}
