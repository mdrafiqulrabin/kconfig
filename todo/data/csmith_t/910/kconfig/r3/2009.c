...
{ /* block id: 0 */
    ...
    int32_t **l_4 = (void*)0;
    int32_t **l_5 = &l_2[4];
    const float l_6 = 0xE.3F6085p-67;
    const uint8_t l_7 = 0x1AL;
    int i;
    (*l_5) = l_2[4];
    return l_7;
}
...
XXX percentage a fresh-made variable is used: 6.38
XXX percentage an existing variable is used: 93.6
********************* end of statistics **********************/
