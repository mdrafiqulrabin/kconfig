...
static volatile int32_t g_4 = 0xC3938DD4L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 9L;
static volatile float g_9 = 0x1.3p-1;/* VOLATILE GLOBAL g_9 */
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    for (g_5 = (-26); (g_5 < 18); g_5 = safe_add_func_int32_t_s_s(g_5, 1))
    { /* block id: 3 */
        volatile float *l_8 = &g_9;
        (*l_8) = g_2;
    }
    return g_3;
}
