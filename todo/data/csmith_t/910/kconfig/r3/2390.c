...
{ /* block id: 36 */
    int16_t l_38 = 0L;
    int32_t l_40 = 0x70B168F9L;
    int32_t *l_39 = &l_40;
    int32_t **l_41 = &l_39;
    (*l_39) ^= (safe_rshift_func_uint8_t_u_u((safe_mod_func_uint8_t_u_u(5UL, (safe_mod_func_uint32_t_u_u(((safe_lshift_func_uint8_t_u_s(l_38, 5)) > l_38), l_38)))), 2));
    (*l_41) = (void*)0;
    /* statement id: 38 */
    assert (l_39 == 0);
    return l_38;
