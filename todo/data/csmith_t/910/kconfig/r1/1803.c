...
{ /* block id: 36 */
    ...
    int32_t l_37 = 0;
    uint32_t l_38 = 7U;
    int32_t l_43 = 0xC295A527;
    uint32_t l_44 = 0U;
    uint16_t l_45 = 65535U;
    l_43 = (((((l_32 >= (((int16_t)l_32 + (int16_t)(l_37 &= ((uint16_t)1U - (uint16_t)l_32))) > l_32)) , l_38) < l_32) , ((int16_t)((uint16_t)((l_38 <= (l_37 ^= l_32)) > 65535U) << (uint16_t)l_32) << (int16_t)l_38)) < 0xD065835A);
    l_44 &= (-2);
    return l_45;
}
