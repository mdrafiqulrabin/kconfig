...
inline static float  func_1(void)
{ /* block id: 0 */
    int16_t l_2[2][6][5] = {{{0x23B1L,0L,0x90DAL,0L,0x90DAL},{0x2EACL,0x2EACL,0xC751L,0xED23L,0x54C3L},{0x23B1L,0x08CCL,(-7L),0x8F8FL,0x8F8FL},{0xED23L,(-8L),0xED23L,0xDDD1L,1L},{(-7L),0x08CCL,0x23B1L,0x38ECL,0L},{0xC751L,0x2EACL,0x2EACL,0xC751L,0xED23L}},{{0x90DAL,0L,0x23B1L,0L,0x08CCL},{0x126FL,0xCB13L,0xED23L,0xCB13L,0x126FL},{0L,0x38ECL,(-7L),0L,0L},{1L,0xC751L,0x2EACL,0x2EACL,0xC751L},{0x38ECL,0x2F76L,(-7L),0L,0L},{(-8L),0x2EACL,1L,0xCB13L,1L}}};
    int32_t l_3 = 8L;
    int i, j, k;
    l_3 = l_2[0][0][2];
    return l_2[0][5][4];
