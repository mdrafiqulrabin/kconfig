...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x9C63C407;
static int16_t g_6 = 0x3A4C;
static volatile int16_t g_7 = 0x7C57;/* VOLATILE GLOBAL g_7 */
static volatile uint16_t g_8 = 0x900B;/* VOLATILE GLOBAL g_8 */
static union U1 g_11 = {7};
