...
static int32_t  func_28(void)
{ /* block id: 36 */
    uint32_t l_32 = 0x27A4129B;
    struct S0 l_39 = {431,0x3BF1,0x8C84B7B8,3,0x6C4779D4};
    int32_t l_42 = 1;
    int32_t l_44 = (-8);
    int32_t l_45 = 1;
    int32_t l_46 = 0x736EAE11;
    l_46 ^= ((int16_t)__builtin_ffsl((((((~(l_32 > ((uint16_t)l_32 - (uint16_t)0x18C9))) ^ ((int16_t)(l_42 ^= ((uint16_t)0x7D02 << (uint16_t)(l_39 , ((int16_t)__builtin_ctz(l_32) << (int16_t)2)))) << (int16_t)(((-(uint32_t)__builtin_bswap32((l_45 = (l_44 = l_39.f2)))) != l_39.f1) && l_39.f0))) && 0x30B1) , l_39) , l_32)) % (int16_t)0xEC1E);
    return l_39.f2;
}
