...
{ /* block id: 36 */
    int32_t l_26 = (-1L);
    for (l_26 = 29; (l_26 >= (-18)); l_26 = safe_sub_func_uint32_t_u_u(l_26, 7))
    { /* block id: 39 */
        return l_26;
    }
    return l_26;
