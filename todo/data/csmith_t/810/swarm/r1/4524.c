 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --compound-assignment --consts --divs --embedded-assigns --pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --uint8 --no-float --no-math64 --inline-function --no-muls --no-safe-math --no-packed-struct --no-paranoid --pointers --structs --unions --no-volatiles --volatile-pointers --no-const-pointers --global-variabless --no-builtins
 * Seed:      3593129298
 */
...
static int8_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0x77B568BE;
    int32_t *l_3 = &g_4;
    const int32_t *l_7 = &g_4;
    const int32_t **l_6 = &l_7;
    (*l_3) ^= l_2;
    (*l_3) = ((l_3 == (void*)0) | (-(uint16_t)g_4));
    (*l_6) = (void*)0;
    return g_4;
}
