...
{ /* block id: 0 */
    int32_t l_2 = 7L;
    struct S1 l_6 = {-1,480,0,0L,0};
    for (l_2 = 0; (l_2 != 15); l_2 += 5)
    { /* block id: 3 */
        struct S1 l_5 = {-0,6330,0,0x9214A9BAL,-12};
        return l_5;
    }
    return l_6;
}
