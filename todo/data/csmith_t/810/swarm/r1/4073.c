...
/* --- GLOBAL VARIABLES --- */
static volatile uint16_t g_2 = 0x6318;/* VOLATILE GLOBAL g_2 */
static volatile float g_5 = 0xC.B0647Dp-82;/* VOLATILE GLOBAL g_5 */
static volatile float * volatile g_4 = &g_5;/* VOLATILE GLOBAL g_4 */
