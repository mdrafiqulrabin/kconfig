...
static int16_t  func_27(void)
{ /* block id: 36 */
    uint16_t l_30 = 0xAAE4;
    g_31 = ((uint32_t)g_5 - (uint32_t)(l_30 || l_30));
    return g_5;
}
