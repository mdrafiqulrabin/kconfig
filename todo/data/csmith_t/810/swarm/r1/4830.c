...
lbl_10:
    l_7 = ((safe_mod_func_uint16_t_u_u(0x7A4AL, l_4)) >= (safe_sub_func_uint32_t_u_u(l_4, l_4)));
    for (l_7 = (-12); (l_7 >= (-10)); l_7 = safe_add_func_int64_t_s_s(l_7, 8))
    { /* block id: 4 */
        if (l_4)
            break;
    }
