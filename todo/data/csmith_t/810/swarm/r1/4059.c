...
{ /* block id: 36 */
    int32_t l_32 = 1L;
    int32_t l_33[1];
    int16_t l_34[4] = {0x0198L,0x0198L,0x0198L,0x0198L};
    uint16_t l_35 = 0x3AE4L;
    int i;
    for (i = 0; i < 1; i = i + 1)
        l_33[i] = 0xA167C28CL;
    ++l_35;
