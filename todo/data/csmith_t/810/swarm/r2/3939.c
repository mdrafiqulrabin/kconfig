...
static uint32_t  func_28(void)
{ /* block id: 36 */
    uint16_t l_44 = 0xEBA4L;
    for (g_3 = (-3); (g_3 != 14); ++g_3)
    { /* block id: 39 */
        int32_t *l_32 = &g_33;
        int32_t *l_34 = &g_33;
        int32_t l_35 = (-8L);
