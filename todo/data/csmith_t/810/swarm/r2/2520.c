 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --no-bitfields --comma-operators --no-compound-assignment --consts --no-divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --int8 --uint8 --float --no-math64 --inline-function --muls --no-safe-math --packed-struct --no-paranoid --pointers --structs --no-unions --no-volatiles --no-volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      3318963410
 */
...
static struct S0 g_34 = {0xA52BL,0x4.5A9CEAp+55,0xA8CCEDB7L,0x58L,0x39D20578L,0xCAL};
...
static struct S0  func_25(void)
{ /* block id: 36 */
    int16_t l_26 = 0x244CL;
    int32_t *l_29 = &g_30;
lbl_33:
    (*l_29) = (__builtin_ffs(((l_26 <= l_26) | 0x8039L)) | __builtin_ctzll((l_26 | (g_3 || ((int16_t)g_3 % (int16_t)g_3)))));
    (*l_29) = ((uint32_t)4294967293UL % (uint32_t)g_3);
    if (l_26)
        goto lbl_33;
    return g_34;
}
