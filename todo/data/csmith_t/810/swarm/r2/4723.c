...
{ /* block id: 36 */
    int32_t l_31 = (-1);
    int32_t l_38 = 1;
    l_38 &= ((l_31 & l_31) == ((0xA8ED40A1 ^ (safe_mod_func_uint16_t_u_u(0U, (safe_mod_func_int16_t_s_s(l_31, (l_31 | 0xA82E)))))) ^ l_31));
    return l_31;
}
