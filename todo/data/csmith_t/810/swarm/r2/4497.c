...
static int16_t  func_31(void)
{ /* block id: 36 */
    int64_t l_34 = 0xEA63F3D54CDCAC19LL;
    float l_36 = 0x8.0p-1;
    float *l_35 = &l_36;
    (*l_35) = ((float)(-0x1.9p-1) - (float)l_34);
    return l_34;
}
