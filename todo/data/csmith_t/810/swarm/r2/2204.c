...
{ /* block id: 36 */
    ...
    int32_t l_35 = (-1L);
    int32_t *l_34 = &l_35;
    int16_t l_39 = 0xC0DEL;
    int16_t *l_38 = &l_39;
    uint32_t l_40 = 4294967290UL;
    (*l_34) = (l_30 != ((int64_t)2L + (int64_t)(!((__builtin_popcount(l_30) && l_30) >= l_30))));
    (*l_34) = (__builtin_clzl((*l_34)) & ((*l_38) &= ((int16_t)(*l_34) << (int16_t)10)));
    return l_40;
}
