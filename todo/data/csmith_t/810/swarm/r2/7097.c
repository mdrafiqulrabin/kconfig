...
static struct S3  func_1(void)
{ /* block id: 0 */
    struct S3 l_6 = {17,0,48,-116,0};
    for (g_2 = 0; (g_2 > 20); g_2 = safe_add_func_int32_t_s_s(g_2, 8))
    { /* block id: 3 */
        struct S3 l_5 = {22,0,112,232,0};
        return l_5;
    }
    return l_6;
}
