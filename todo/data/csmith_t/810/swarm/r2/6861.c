...
static uint32_t  func_31(void)
{ /* block id: 36 */
    int16_t l_32 = 0x19ADL;
    int32_t l_33 = (-8L);
    l_33 ^= l_32;
    l_33 = __builtin_ffsl((((0x91F6F49CL != (((uint32_t)l_32 - (uint32_t)l_32) && l_32)) == (((uint16_t)(((uint32_t)((uint16_t)l_33 << (uint16_t)6) + (uint32_t)((int16_t)(l_32 <= ((uint32_t)l_33 - (uint32_t)(l_32 > ((l_32 ^ l_33) && 0x8D679BDDL)))) * (int16_t)l_32)) == l_33) + (uint16_t)l_33) ^ 0xFD9AL)) == l_32));
    return l_33;
}
