...
/* --- GLOBAL VARIABLES --- */
static volatile uint16_t g_4 = 0xF4A8L;/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    ...
    (*l_8) = (((int16_t)g_4 % (int16_t)(g_5 | (((uint16_t)g_5 >> (uint16_t)14) <= g_5))) == (g_5 <= g_5));
    return l_10;
}
