...
/* --- GLOBAL VARIABLES --- */
static int16_t g_7 = 0xB674L;
static int32_t g_31 = 0x2E4145C1L;
static int32_t g_35 = 0xFF609D70L;
...
{ /* block id: 36 */
    ...
    int32_t *l_32 = &g_31;
    (*l_30) |= g_7;
    g_35 &= (((void*)0 != l_32) || ((safe_lshift_func_uint16_t_u_u(g_31, __builtin_parityll((*l_32)))) & g_7));
    return g_35;
}
