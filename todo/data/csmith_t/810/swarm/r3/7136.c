...
{ /* block id: 36 */
    ...
    int32_t l_33 = (-7L);
    for (l_30 = (-15); (l_30 != (-16)); l_30 = safe_sub_func_int16_t_s_s(l_30, 1))
    { /* block id: 39 */
        l_33 = (-0x1.7p-1);
    }
    return l_30;
