...
{ /* block id: 36 */
    int16_t l_32 = (-9L);
    int32_t l_33 = 0x29ACD409L;
    l_33 = ((uint16_t)(~__builtin_bswap32(l_32)) >> (uint16_t)4);
    ...
    l_33 = ((uint8_t)(-(uint8_t)l_33) >> (uint8_t)4);
    return l_32;
}
