...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0x38330377L;
    int16_t l_5 = 0xFA32L;
    int32_t *l_6 = (void*)0;
    int32_t l_8 = (-1L);
    int32_t *l_7 = &l_8;
    uint8_t l_9 = 0x6AL;
    (*l_7) ^= (((uint8_t)(0xC3L | l_4) >> (uint8_t)6) & l_5);
    return l_9;
}
