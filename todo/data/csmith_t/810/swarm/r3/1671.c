...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_7 = 0x36DEL;
static int16_t g_9 = 0x4F82L;
static int32_t g_11 = 0xBFB66FEBL;
static int32_t *g_10 = &g_11;
static union U2 g_13 = {-1L};/* VOLATILE GLOBAL g_13 */


/* --- FORWARD DECLARATIONS --- */
inline static union U2  func_1(void);
inline static int32_t * func_2(uint16_t  p_3, int32_t  p_4, int32_t  p_5);
...
inline static union U2  func_1(void)
{ /* block id: 0 */
    uint16_t l_6 = 0x4AD3L;
    int32_t **l_12 = &g_10;
    (*l_12) = func_2(l_6, g_7, g_7);
    return g_13;
}
