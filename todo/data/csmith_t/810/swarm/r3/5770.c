 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --int8 --uint8 --no-float --math64 --inline-function --no-muls --no-safe-math --no-packed-struct --no-paranoid --pointers --no-structs --no-unions --volatiles --volatile-pointers --const-pointers --global-variabless --builtins
 * Seed:      1019027626
 */
...
{ /* block id: 36 */
    int32_t l_30 = 8;
    int32_t l_37 = (-1);
    (*g_31) = (0xDF && (((uint16_t)l_30 % (uint16_t)0xC87A) != l_30));
    (*g_31) = __builtin_bswap32(g_6);
    (*g_33) = l_30;
    g_36 = ((uint8_t)(&l_30 != &g_32) >> (uint8_t)g_6);
    return l_37;
}
