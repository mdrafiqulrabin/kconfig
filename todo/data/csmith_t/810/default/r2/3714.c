...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[8] = {0x009CE456L,0xBF48C443L,0x009CE456L,0x009CE456L,0xBF48C443L,0x009CE456L,0x009CE456L,0xBF48C443L};
static int32_t *g_6 = &g_2[2];
static int32_t ** volatile g_5 = &g_6;/* VOLATILE GLOBAL g_5 */
static struct S0 g_7 = {86,103};/* VOLATILE GLOBAL g_7 */
