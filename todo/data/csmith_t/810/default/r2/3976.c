...
{ /* block id: 0 */
    ...
    for (i = 0; i < 9; i++)
        l_8[i] = 0x4B733C63L;
    (*l_14) = (g_12[1][7] = func_2((l_8[7] |= (safe_rshift_func_uint8_t_u_u(l_6, g_7)))));
    l_8[7] = (safe_lshift_func_uint16_t_u_s(g_13, 5));
    return g_7;
}
