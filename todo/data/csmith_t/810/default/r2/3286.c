...
static int32_t g_11 = 0xC10977A1L;
...
{ /* block id: 0 */
    ...
    int32_t *l_3 = &g_4;
    (*l_3) = l_2;
    for (l_2 = 0; (l_2 <= 11); l_2 = safe_add_func_uint16_t_u_u(l_2, 6))
    { /* block id: 4 */
        uint64_t l_7[5] = {0x9EDBDA7FE64FD9E2LL,0x9EDBDA7FE64FD9E2LL,0x9EDBDA7FE64FD9E2LL,0x9EDBDA7FE64FD9E2LL,0x9EDBDA7FE64FD9E2LL};
        int32_t *l_10 = &g_11;
        int i;
        ++l_7[1];
        (*l_10) &= (g_4 >= 0x34L);
