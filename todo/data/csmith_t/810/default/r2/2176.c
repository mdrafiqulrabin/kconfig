...
/* --- GLOBAL VARIABLES --- */
static volatile int8_t g_4[8] = {0xBEL,0xBEL,0xBEL,0xBEL,0xBEL,0xBEL,0xBEL,0xBEL};
static volatile int8_t *g_3 = &g_4[6];
...
static int16_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_5[8] = {0x16L,255UL,0x16L,0x16L,255UL,0x16L,0x16L,255UL};
    int32_t *l_6 = &g_7[0][0];
    int i;
    g_2 = (void*)0;
    (*l_6) &= (0UL | l_5[1]);
