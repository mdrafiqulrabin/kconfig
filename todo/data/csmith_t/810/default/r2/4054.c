...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[8][3] = {{(-1L),(-1L),(-1L)},{(-1L),(-8L),0L},{(-1L),1L,0xD6804445L},{(-1L),(-1L),(-1L)},{(-1L),(-8L),0L},{(-1L),1L,0xD6804445L},{(-1L),(-1L),(-1L)},{(-1L),(-8L),0L}};
static int32_t g_6 = 0L;
static volatile uint32_t g_10 = 0xEE39F3FAL;/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    int32_t l_8 = (-6L);
    for (g_2[5][1] = (-5); (g_2[5][1] >= (-2)); g_2[5][1]++)
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        int32_t *l_7[5];
        int16_t l_9 = (-6L);
