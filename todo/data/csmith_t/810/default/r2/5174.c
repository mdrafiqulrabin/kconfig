...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x02314AF1L;
static struct S0 g_6 = {2231,168,107,403,-5,18,0x578CCA69L,1185,289,268};/* VOLATILE GLOBAL g_6 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    int64_t l_2 = 0xC2184E5A945CB81ELL;
    int32_t *l_3[7] = {&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4};
    uint32_t l_5 = 0xCEA445A8L;
    int i;
    l_5 = l_2;
    return g_6;
}
