...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xD6C05BAFL;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 5; i++)
        l_9[i] = (void*)0;
    for (g_2 = 1; (g_2 >= (-27)); g_2 = safe_sub_func_uint16_t_u_u(g_2, 9))
    { /* block id: 3 */
        int32_t l_5[4] = {0xD03248C6L,0xD03248C6L,0xD03248C6L,0xD03248C6L};
        int32_t *l_8[9][2] = {{&g_2,&g_2},{&g_2,&g_2},{&g_2,&g_2},{&g_2,&g_2},{&g_2,&g_2},{&g_2,&g_2},{&g_2,&g_2},{&g_2,&g_2},{&g_2,&g_2}};
        int32_t **l_7[2];
        int i, j;
        for (i = 0; i < 2; i++)
            l_7[i] = &l_8[3][1];
