...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0xE2949F4FL;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x77278FA8L;
    (*g_3) ^= l_2;
    for (g_4 = 1; (g_4 != (-11)); g_4 = safe_sub_func_uint16_t_u_u(g_4, 3))
    { /* block id: 4 */
        int32_t l_7 = 0x9D60A221L;
        int32_t *l_8 = &l_7;
        int32_t *l_9[3][4] = {{(void*)0,&l_7,(void*)0,(void*)0},{&l_7,&l_7,&l_7,&l_7},{&l_7,(void*)0,(void*)0,&l_7}};
        int i, j;
        g_10++;
    }
    return g_4;
