...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2[7] = {0x98070ADEL,4294967295UL,0x98070ADEL,0x98070ADEL,4294967295UL,0x98070ADEL,0x98070ADEL};
static volatile int32_t g_3 = (-1L);/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = (-10L);
static int32_t g_8 = 0xD461E3FFL;
...
static int8_t  func_1(void)
{ /* block id: 0 */
    struct S0 l_5 = {0x24L,0x00011151C3C39BA0LL,0x5AL};
    struct S0 *l_6 = &l_5;
    int32_t *l_7 = &g_8;
