...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_5 = 0x1E19E95DL;/* VOLATILE GLOBAL g_5 */
static volatile int16_t g_10[4] = {0xB15EL,0xB15EL,0xB15EL,0xB15EL};
static int32_t g_12[10] = {0L,0L,0xCD430964L,0L,0L,0xCD430964L,0L,0L,0xCD430964L,0L};
...
{ /* block id: 0 */
    ...
    int32_t *l_21 = &g_12[0];
    int32_t *l_22[6];
    uint16_t l_23 = 0x8433L;
    int i;
    for (i = 0; i < 6; i++)
        l_22[i] = &g_12[5];
    l_4 = (safe_rshift_func_int16_t_s_u(7L, 12));
    ++l_23;
    return (*l_14);
}
