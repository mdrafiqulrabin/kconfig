...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[8] = {0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L};
...
{ /* block id: 0 */
    int32_t *l_3 = &g_4[7];
    int32_t **l_2[6];
    const uint64_t l_7[10] = {18446744073709551615UL,0UL,0UL,18446744073709551615UL,0UL,0UL,18446744073709551615UL,0UL,0UL,18446744073709551615UL};
    int i;
    for (i = 0; i < 6; i++)
        l_2[i] = &l_3;
    g_5 = (void*)0;
