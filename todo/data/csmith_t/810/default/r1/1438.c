...
{ /* block id: 0 */
    int32_t *l_5 = (void*)0;
    int32_t **l_6 = &l_5;
    int32_t l_7[8] = {0x272A7275L,0x272A7275L,0x272A7275L,0x272A7275L,0x272A7275L,0x272A7275L,0x272A7275L,0x272A7275L};
    int i;
    for (g_2 = (-14); (g_2 == (-28)); g_2 = safe_sub_func_int16_t_s_s(g_2, 2))
    { /* block id: 3 */
        if (g_2)
            break;
    }
