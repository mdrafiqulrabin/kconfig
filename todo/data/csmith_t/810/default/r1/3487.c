...
{ /* block id: 0 */
    ...
    int32_t *l_7 = (void*)0;
    int32_t l_8[4][2][2];
    int32_t *l_9[8] = {&l_8[3][0][1],&l_8[0][1][1],&l_8[3][0][1],&l_8[0][1][1],&l_8[3][0][1],&l_8[0][1][1],&l_8[3][0][1],&l_8[0][1][1]};
    int32_t l_10 = 0x13D0BB94L;
    int32_t l_11 = 0L;
    int8_t l_12 = 0L;
    uint64_t l_13 = 0x1450187E526954EBLL;
    int i, j, k;
    for (i = 0; i < 4; i++)
    {
        for (j = 0; j < 2; j++)
