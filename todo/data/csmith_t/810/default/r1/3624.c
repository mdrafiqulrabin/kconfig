...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[1] = {0x6B65720BL};
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_3[0];
    int32_t *l_7 = &g_3[0];
    int32_t *l_8[6][2] = {{&g_3[0],(void*)0},{&g_3[0],(void*)0},{&g_3[0],(void*)0},{&g_3[0],(void*)0},{&g_3[0],(void*)0},{&g_3[0],(void*)0}};
    int32_t l_9 = 0x1FA4C821L;
    uint8_t l_10 = 0x8DL;
    int16_t l_15 = 0L;
    int i, j;
    ++l_10;
    for (l_10 = 0; (l_10 != 57); l_10 = safe_add_func_int32_t_s_s(l_10, 3))
    { /* block id: 4 */
        return l_15;
    }
    return g_3[0];
