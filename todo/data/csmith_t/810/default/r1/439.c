...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_4 = 0x83C8FC55L;/* VOLATILE GLOBAL g_4 */
static int64_t g_6 = 0x405B40194DDBC370LL;
...
{ /* block id: 0 */
    int32_t l_5 = (-8L);
    int32_t *l_7 = &g_8;
    (*l_7) ^= (safe_sub_func_uint8_t_u_u((g_6 = ((0x0520L | g_4) , l_5)), l_5));
    return (*l_7);
}
