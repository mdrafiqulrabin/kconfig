...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_10 g_13 g_14
 * writes: g_2 g_10 g_14
 */
static int16_t  func_1(void)
{ /* block id: 0 */
    g_2--;
    for (g_2 = (-25); (g_2 <= 56); g_2++)
    { /* block id: 4 */
        return g_2;
    }
    for (g_2 = (-18); (g_2 < 56); ++g_2)
    { /* block id: 9 */
        int32_t *l_9 = &g_10;
        if (g_2)
            break;
        (*l_9) = g_2;
        (*g_13) ^= (safe_rshift_func_uint16_t_u_u(g_10, 4));
    }
    return g_10;
}
