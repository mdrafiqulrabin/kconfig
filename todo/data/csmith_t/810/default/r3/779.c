...
static int64_t g_16[2] = {0xBC7DCD66A07563FFLL,0xBC7DCD66A07563FFLL};
static uint64_t g_17 = 6UL;
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_3;
    ++g_7;
    for (g_3 = (-15); (g_3 < (-3)); g_3 = safe_add_func_int8_t_s_s(g_3, 1))
    { /* block id: 4 */
        uint16_t l_12 = 0x7BF4L;
        l_12 = (-1L);
