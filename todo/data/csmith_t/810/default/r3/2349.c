...
static int32_t g_3[3] = {0x49FE387FL,0x49FE387FL,0x49FE387FL};
...
{ /* block id: 0 */
    int32_t l_9 = (-1L);
    for (g_3[0] = (-9); (g_3[0] >= 25); g_3[0]++)
    { /* block id: 3 */
        int32_t *l_6[9][3] = {{&g_3[0],&g_3[0],&g_3[0]},{&g_3[0],&g_3[0],&g_7},{&g_7,&g_3[0],&g_7},{&g_3[0],&g_7,&g_7},{&g_3[0],&g_3[0],&g_3[0]},{&g_3[0],&g_3[0],&g_7},{&g_7,&g_3[0],&g_7},{&g_3[0],&g_7,&g_7},{&g_3[0],&g_3[0],&g_3[0]}};
        int i, j;
        g_2 |= 0x4B811476L;
        g_2 &= (+g_7);
    }
