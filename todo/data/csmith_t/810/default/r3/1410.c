...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[3] = {0x7B8F5F49L,0x7B8F5F49L,0x7B8F5F49L};
static int32_t * volatile g_2 = &g_3[0];/* VOLATILE GLOBAL g_2 */
static int32_t * volatile g_5 = &g_3[0];/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    ...
    int32_t *l_10 = &g_3[0];
    int32_t *l_11 = &g_3[0];
    int32_t l_12 = 0xE0980DB9L;
    int32_t *l_13[4][4];
    uint32_t l_14 = 0x5ADB51FDL;
    int i, j;
    for (i = 0; i < 4; i++)
    {
        for (j = 0; j < 4; j++)
