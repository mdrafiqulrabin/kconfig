...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_2 = 0x3FL;
static int32_t g_6[2][4] = {{0x79E672CAL,0x3E63E315L,0x79E672CAL,0x79E672CAL},{0x3E63E315L,0x3E63E315L,0x22A149CEL,0x3E63E315L}};
static int16_t g_20 = 0x5A4AL;
...
{ /* block id: 0 */
    ...
    int32_t *l_8 = &g_6[1][0];
    int32_t *l_9 = (void*)0;
    int32_t *l_10 = &g_6[1][1];
    int32_t l_11 = (-3L);
    int32_t *l_12[2][1][4] = {{{&l_11,&l_11,&l_11,&l_11}},{{&l_11,&l_11,&l_11,&l_11}}};
    uint16_t l_13 = 0xE735L;
    int32_t l_16 = 0x3778A82FL;
    uint8_t l_17 = 8UL;
    int i, j, k;
    g_2--;
    ++l_13;
