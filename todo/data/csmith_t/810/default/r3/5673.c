...
static int32_t *g_4 = &g_3[4];
static union U1 g_5[8][1] = {{{0x5CABFC3938DD44ADLL}},{{1UL}},{{0x5CABFC3938DD44ADLL}},{{1UL}},{{0x5CABFC3938DD44ADLL}},{{1UL}},{{0x5CABFC3938DD44ADLL}},{{1UL}}};
...
static union U1  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[1][8] = {{&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2]}};
    int i, j;
    g_4 = l_2[0][4];
    return g_5[3][0];
}
