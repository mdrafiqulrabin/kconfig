...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[7] = {0xEA2A3B3FL,0xEA2A3B3FL,0xEA2A3B3FL,0xEA2A3B3FL,0xEA2A3B3FL,0xEA2A3B3FL,0xEA2A3B3FL};
...
{ /* block id: 0 */
    ...
    int32_t *l_13 = (void*)0;
    int32_t *l_14[9];
    uint16_t l_15[8] = {0UL,0x19F2L,0UL,0x19F2L,0UL,0x19F2L,0UL,0x19F2L};
    int i;
    for (i = 0; i < 9; i++)
        l_14[i] = (void*)0;
    l_15[1]--;
