...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0xFB770A77L;/* VOLATILE GLOBAL g_3 */
static int32_t g_5 = 0x1D962EE6L;
static int32_t g_6 = 9L;
static volatile int16_t g_9 = 0xE9E8L;/* VOLATILE GLOBAL g_9 */
...
static struct S1  func_1(void)
{ /* block id: 0 */
    uint16_t l_2[4] = {0xB8C3L,0xB8C3L,0xB8C3L,0xB8C3L};
    int32_t *l_4 = &g_5;
    int32_t *l_7 = &g_5;
    int32_t *l_8[1][4] = {{&g_5,&g_5,&g_5,&g_5}};
    uint16_t l_10 = 5UL;
    struct S1 l_13 = {-6L};
    int i, j;
