...
static volatile uint32_t g_5 = 4294967286UL;/* VOLATILE GLOBAL g_5 */
static union U1 g_10 = {0};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 3; i++)
        l_3[i] = &g_4;
    g_5--;
    for (g_4 = (-10); (g_4 <= 17); g_4 = safe_add_func_int64_t_s_s(g_4, 4))
    { /* block id: 4 */
        return g_10;
    }
    return g_10;
