...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[4][1][1] = {{{0x176B0F73L}},{{0x94964A53L}},{{0x176B0F73L}},{{0x94964A53L}}};
...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &l_5;
    int32_t l_8[6][4] = {{(-1L),(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L),(-1L)}};
    int32_t *l_9 = (void*)0;
    int32_t *l_10[3];
    int32_t l_11 = (-1L);
    uint16_t l_12 = 0x3AA9L;
    int i, j;
    for (i = 0; i < 3; i++)
        l_10[i] = &l_8[1][1];
    --l_12;
