...
static volatile uint64_t g_9 = 0x10DEC53312A7FAD5LL;/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_3[0];
    int32_t *l_7[4];
    int8_t l_8[3][5][1] = {{{(-10L)},{0x7FL},{(-10L)},{0x7FL},{(-10L)}},{{0x7FL},{(-10L)},{0x7FL},{(-10L)},{0x7FL}},{{(-10L)},{0x7FL},{(-10L)},{0x7FL},{(-10L)}}};
    int i, j, k;
    for (i = 0; i < 3; i++)
        l_4[i] = 0x37A9A971L;
    for (i = 0; i < 4; i++)
