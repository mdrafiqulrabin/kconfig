...
/* --- GLOBAL VARIABLES --- */
static volatile struct S2 g_3 = {18446744073709551611UL,131,319};/* VOLATILE GLOBAL g_3 */
static volatile struct S2 * volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
static volatile struct S2 g_5 = {0UL,-173,224};/* VOLATILE GLOBAL g_5 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    volatile struct S2 * volatile l_4 = &g_5;/* VOLATILE GLOBAL l_4 */
    int32_t l_6[2];
    int i;
    for (i = 0; i < 2; i++)
        l_6[i] = 0x89226C31L;
