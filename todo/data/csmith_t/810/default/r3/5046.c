...
static int32_t g_6 = 0xCC14173BL;
static volatile int16_t g_11 = 0xAE50L;/* VOLATILE GLOBAL g_11 */
static uint16_t g_12 = 0xBFFBL;
static volatile uint64_t g_15[1] = {0UL};
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_12 g_15 g_6
 * writes: g_2 g_12 g_15 g_6
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_10 = 0x5F0B101AL;
    for (g_2 = 0; (g_2 >= (-17)); g_2--)
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        int32_t *l_7 = &g_6;
        int32_t *l_8 = &g_6;
        int32_t *l_9[7] = {&g_6,&g_6,&g_2,&g_6,&g_6,&g_2,&g_6};
        int i;
        g_12++;
        --g_15[0];
        for (g_6 = 0; (g_6 == 28); g_6 = safe_add_func_uint64_t_u_u(g_6, 2))
        { /* block id: 8 */
            if (g_6)
                break;
        }
