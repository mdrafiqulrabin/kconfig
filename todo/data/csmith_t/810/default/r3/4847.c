...
/* --- GLOBAL VARIABLES --- */
static volatile union U1 g_2 = {4294967295UL};/* VOLATILE GLOBAL g_2 */
static int8_t g_8 = (-1L);
static uint16_t g_10 = 0xEE39L;
static uint8_t g_12 = 0x07L;
static int16_t g_13 = 9L;
static uint8_t g_15 = 0xA1L;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_2.f0 g_8 g_12 g_16
 * writes: g_10 g_12 g_13 g_15
 */
static union U0  func_1(void)
{ /* block id: 0 */
    int8_t l_3 = 0L;
    ...
    for (i = 0; i < 1; i++)
        l_14[i] = 0L;
    g_15 = (((g_2 , (l_3 && (safe_lshift_func_uint8_t_u_s(0x7DL, ((safe_sub_func_uint64_t_u_u(g_2.f0, g_8)) , 0x18L))))) || (l_3 , (-1L))) < ((((g_13 = ((((*l_11) ^= (((*l_9) = g_8) >= 0x2F3FL)) < g_8) , (-1L))) || l_14[0]) ^ g_8) | 0xD7L));
    return g_16;
}
