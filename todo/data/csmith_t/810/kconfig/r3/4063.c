...
static uint32_t  func_3(int32_t  p_4, uint16_t  p_5, uint32_t  p_6, uint16_t  p_7, int16_t  p_8);
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x39BEB064;
    int32_t l_13 = 2;
    uint8_t l_15 = 1U;
    l_2 = 0xBCA63185;
    l_2 = (l_2 ^ ((-1) <= ((4294967290U ^ func_3(((func_9((l_13 > 0x7E4A), l_13, l_13) | (l_13 ^ l_15)) || l_13), l_2, l_2, l_15, l_13)) && l_2)));
    return l_13;
}
