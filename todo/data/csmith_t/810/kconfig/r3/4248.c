...
{ /* block id: 0 */
    ...
    int32_t *l_2 = &l_3;
    int32_t *l_4 = (void*)0;
    int32_t *l_5[2][7] = {{&l_3,&l_3,&l_3,&l_3,(void*)0,&l_3,(void*)0},{&l_3,&l_3,&l_3,&l_3,(void*)0,&l_3,(void*)0}};
    uint8_t l_6 = 255UL;
    int8_t l_11 = 6L;
    int8_t l_12 = 0xC0L;
    int16_t l_13 = 0x94B9L;
    int32_t l_14 = 1L;
    float l_15 = 0xF.56B76Ap-26;
    uint64_t l_16 = 0x1BBE26AF1C4852B1LL;
    int32_t **l_19 = (void*)0;
    int32_t **l_20 = &l_5[0][3];
    int32_t *l_21 = &l_3;
    int16_t l_22 = 0x7D2FL;
    int i, j;
    l_6++;
    for (l_6 = (-18); (l_6 < 19); l_6 = safe_add_func_uint32_t_u_u(l_6, 5))
    { /* block id: 4 */
        return l_11;
    }
    --l_16;
    (*l_21) ^= (((*l_20) = (void*)0) == l_21);
    return l_22;
}
...
XXX times a pointer is qualified to be dereferenced: 407
