...
{ /* block id: 36 */
    int16_t l_27 = 0xF80C;
    int32_t l_36 = 0;
    int32_t l_54 = 0xF81606DC;
    g_6 = l_27;
    g_6 = 0xE17C1097;
    l_54 = ((int32_t)((int32_t)func_32((-(uint16_t)__builtin_parityl(l_36)), ((uint16_t)((uint16_t)((g_6 ^ ((((int16_t)((__builtin_parityll(g_6) <= l_27) == g_6) >> (int16_t)((int16_t)((int16_t)g_6 + (int16_t)__builtin_ia32_crc32qi((((int32_t)((int32_t)(0x6DD3ED23 | g_6) + (int32_t)l_27) - (int32_t)1U) >= g_6), g_6)) >> (int16_t)7)) && g_6) <= l_27)) != 0U) + (uint16_t)g_6) << (uint16_t)15)) + (int32_t)l_36) + (int32_t)g_6);
    return l_54;
}
