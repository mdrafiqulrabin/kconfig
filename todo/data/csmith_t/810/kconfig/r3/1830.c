...
static const int32_t  func_25(void)
{ /* block id: 36 */
    const int8_t l_31 = 2L;
    uint16_t l_36 = 0x537CL;
    int32_t l_38 = 0x35900B08L;
    int32_t *l_37 = &l_38;
    const float l_39 = 0x3.F0EF2Fp-5;
    const int32_t l_40 = 0xD77FC7DFL;
    (*l_37) = (((safe_unary_minus_func_int8_t_s(((safe_sub_func_int64_t_s_s((safe_mul_func_uint16_t_u_u(l_31, l_31)), (0UL && (l_31 | (safe_mul_func_uint8_t_u_u((&l_31 != &l_31), (safe_div_func_int8_t_s_s(l_36, l_36)))))))) || l_31))) <= l_31) == 0L);
    return l_40;
}
