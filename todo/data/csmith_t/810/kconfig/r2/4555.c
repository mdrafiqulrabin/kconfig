...
{ /* block id: 0 */
    uint8_t l_2 = 0x1FL;
    int32_t l_4[1][3][2];
    int32_t *l_3[10][3] = {{&l_4[0][1][1],&l_4[0][2][1],&l_4[0][1][1]},{&l_4[0][0][0],&l_4[0][2][0],&l_4[0][0][0]},{&l_4[0][1][1],&l_4[0][2][1],&l_4[0][1][1]},{&l_4[0][0][0],&l_4[0][2][0],&l_4[0][0][0]},{&l_4[0][1][1],&l_4[0][2][1],&l_4[0][1][1]},{&l_4[0][0][0],&l_4[0][2][0],&l_4[0][0][0]},{&l_4[0][1][1],&l_4[0][2][1],&l_4[0][1][1]},{&l_4[0][0][0],&l_4[0][2][0],&l_4[0][0][0]},{&l_4[0][1][1],&l_4[0][2][1],&l_4[0][1][1]},{&l_4[0][0][0],&l_4[0][2][0],&l_4[0][0][0]}};
    int64_t l_5 = 0xE24B2E809B4AF7BDLL;
    int32_t l_6 = (-1L);
    uint32_t l_7[8];
    int i, j, k;
    for (i = 0; i < 1; i++)
