...
static volatile int32_t g_3 = 0x2FD41E55;/* VOLATILE GLOBAL g_3 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    volatile uint8_t l_7 = 0U;/* VOLATILE GLOBAL l_7 */
    int32_t l_11 = 3;
    for (g_4 = 0; (g_4 >= 15); g_4 += 9)
    { /* block id: 3 */
        int32_t l_10 = 1;
        l_7 = g_2;
        l_11 = ((int32_t)4 % (int32_t)l_10);
    }
    return l_11;
}
