...
/* --- GLOBAL VARIABLES --- */
static int8_t g_5 = 0xC6L;
static volatile uint64_t g_27 = 0xE219E4E412C2192BLL;/* VOLATILE GLOBAL g_27 */
...
static uint8_t  func_26(void)
{ /* block id: 36 */
    int64_t l_30[1][9][4] = {{{1L,(-1L),(-8L),(-8L)},{(-1L),(-1L),1L,(-8L)},{9L,(-1L),9L,1L},{9L,1L,1L,9L},{(-1L),1L,(-8L),1L},{1L,(-1L),(-8L),(-8L)},{(-1L),(-1L),1L,(-8L)},{9L,(-1L),9L,1L},{9L,1L,1L,9L}}};
    int i, j, k;
    --g_27;
    return l_30[0][3][2];
}
