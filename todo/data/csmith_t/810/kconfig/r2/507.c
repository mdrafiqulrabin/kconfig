...
{ /* block id: 0 */
    ...
    int8_t l_11 = 0L;
    int32_t l_13[6] = {7L,0L,7L,7L,0L,7L};
    uint32_t l_17 = 1UL;
    int32_t l_20 = (-1L);
    uint64_t l_21 = 0x9D2484370A8D4FF7LL;
    int i;
    for (l_2 = 0; (l_2 != 9); l_2 = safe_add_func_int64_t_s_s(l_2, 9))
    { /* block id: 3 */
        int32_t l_6[8] = {0xE08974B6L,(-1L),0xE08974B6L,0xE08974B6L,(-1L),0xE08974B6L,0xE08974B6L,(-1L)};
        int32_t *l_5 = &l_6[6];
        int32_t *l_7 = &l_6[6];
        int32_t *l_8 = &l_6[4];
        int32_t *l_9 = &l_6[6];
...
XXX percentage a fresh-made variable is used: 7.37
