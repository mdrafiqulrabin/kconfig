...
inline static int16_t  func_33(void)
{ /* block id: 36 */
    uint32_t l_36 = 0x66FEBFB2;
    int32_t l_41 = 0x0DE450BB;
    uint16_t l_44 = 0x55C0;
    int16_t l_50 = 0x6652;
    uint16_t l_51 = 65535U;
    int32_t l_52 = 0x09C821F9;
    l_52 = ((int16_t)__builtin_ia32_crc32qi((l_36 , 0x1AC3DC99), ((uint16_t)((((int16_t)(((l_41 = 0x996A5308) || 0) , ((uint16_t)((l_44 != (~(((uint16_t)l_44 << (uint16_t)l_44) , ((int32_t)(-9) % (int32_t)(l_50 = ((l_41 = (7 && l_41)) || l_41)))))) && 9U) * (uint16_t)l_44)) >> (int16_t)l_44) > l_44) != l_51) * (uint16_t)0x55BB)) << (int16_t)15);
    return l_36;
}
...
XXX percentage a fresh-made variable is used: 55.9
XXX percentage an existing variable is used: 44.1
********************* end of statistics **********************/
