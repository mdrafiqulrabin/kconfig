...
inline static int16_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[7][5] = {{255UL,0xC2L,255UL,0x07L,0xC2L},{1UL,0x7AL,0x07L,1UL,0x07L},{1UL,1UL,0x0FL,0xC2L,249UL},{255UL,249UL,0x07L,0x07L,249UL},{249UL,0x7AL,255UL,249UL,0x07L},{0xC2L,249UL,0x0FL,249UL,0xC2L},{255UL,1UL,0x7AL,0x07L,1UL}};
    int i, j;
    return l_2[2][2];
}
