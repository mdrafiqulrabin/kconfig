...
static float g_4 = (-0x9.6p+1);
static uint32_t g_12 = 0xDC5336DEL;
static volatile int32_t g_35[7] = {0L,0L,0L,0L,0L,0L,0L};
static volatile int32_t * volatile g_34[9] = {&g_35[4],&g_35[4],&g_35[4],&g_35[4],&g_35[4],&g_35[4],&g_35[4],&g_35[4],&g_35[4]};
...
inline static int32_t  func_33(void)
{ /* block id: 36 */
    volatile int32_t * volatile l_36 = &g_35[1];/* VOLATILE GLOBAL l_36 */
    l_36 = g_34[4];
    return (*l_36);
}
