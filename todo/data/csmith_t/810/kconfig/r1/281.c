...
{ /* block id: 36 */
    ...
    int32_t l_36 = (-7L);
    int32_t *l_35 = &l_36;
    uint16_t l_45 = 0xB09BL;
    float l_54 = 0x1.3p-1;
    uint16_t l_55 = 0x53A8L;
    int16_t l_56 = 1L;
    l_34 = 0x2.6B17B7p-14;
    l_35 = l_35;
    (*l_35) = ((uint16_t)((uint16_t)(((uint16_t)65532UL + (uint16_t)((uint16_t)l_45 - (uint16_t)((((int16_t)((*l_35) && ((((int16_t)((uint16_t)__builtin_ia32_crc32qi((*l_35), (*l_35)) >> (uint16_t)((0x353EL && (__builtin_popcountll((*l_35)) & (*l_35))) >= (*l_35))) >> (int16_t)11) <= 0xBB30L) > (*l_35))) % (int16_t)0xE8E5L) ^ 0L) != (*l_35)))) >= 4294967295UL) >> (uint16_t)(*l_35)) % (uint16_t)(*l_35));
    (*l_35) = l_55;
    return l_56;
}
