...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_6[3] = {0UL,0UL,0UL};
static float g_29[1][5] = {{0x1.Bp-1,0x1.Bp-1,0x1.Bp-1,0x1.Bp-1,0x1.Bp-1}};
...
{ /* block id: 36 */
    float *l_28 = &g_29[0][1];
    int32_t l_30[6] = {7L,0xD68F9855L,0xD68F9855L,7L,0xD68F9855L,0xD68F9855L};
    int i;
    (*l_28) = 0xF.F4981Fp-13;
    return l_30[0];
}
