...
{ /* block id: 0 */
    ...
    int32_t *l_9 = &l_10;
    int32_t l_11 = (-5);
    (*l_9) = ((uint32_t)(l_4 == ((uint32_t)((uint16_t)l_4 >> (uint16_t)10) % (uint32_t)l_4)) - (uint32_t)l_4);
    return l_11;
}
...
XXX percentage a fresh-made variable is used: 6.06
XXX percentage an existing variable is used: 93.9
********************* end of statistics **********************/
