...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_3 = 0x32A831D2L;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = (-1L);/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = (-1L);
static int32_t g_8 = 0x9C25B054L;
...
{ /* block id: 0 */
    float *l_2 = (void*)0;
    g_3 = 0x4.8999D9p+12;
    for (g_5 = 0; (g_5 == (-17)); g_5 = safe_sub_func_int8_t_s_s(g_5, 3))
    { /* block id: 4 */
        for (g_8 = 0; (g_8 != 1); ++g_8)
        { /* block id: 7 */
            uint32_t l_11 = 0xED4A55F0L;
            return l_11;
        }
    }
    return g_3;
