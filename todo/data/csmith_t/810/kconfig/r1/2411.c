...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_12[i] = 0x13D0BB94L;
    for (l_2[1] = 28; (l_2[1] == (-9)); l_2[1] = safe_sub_func_int64_t_s_s(l_2[1], 4))
    { /* block id: 3 */
        float *l_5 = (void*)0;
        float l_7 = 0x7.555950p+44;
        float *l_6 = &l_7;
        int32_t *l_9 = &l_2[1];
        int32_t **l_8[1][7] = {{&l_9,&l_9,&l_9,&l_9,&l_9,&l_9,&l_9}};
        int i, j;
        (*l_6) = l_2[3];
        l_10 = l_5;
        /* statement id: 5 */
