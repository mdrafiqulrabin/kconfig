...
{ /* block id: 0 */
    ...
    int32_t **l_11 = &l_9;
    int32_t l_12 = (-6L);
    (*l_9) = ((*l_8) = (safe_add_func_uint64_t_u_u((((*l_4) = 0x13638ECFL) == (l_6 = 4294967294UL)), l_7)));
    (*l_11) = (void*)0;
    /* statement id: 5 */
    assert (l_9 == 0);
    return l_12;
