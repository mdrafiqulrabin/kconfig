...
{ /* block id: 0 */
    ...
    int32_t *l_11 = &g_2;
    int32_t *l_12 = &g_2;
    for (g_2 = (-28); (g_2 < 21); g_2 += 7)
    { /* block id: 3 */
        int32_t *l_5 = (void*)0;
        g_6 &= 0L;
    }
    --g_13;
    (*l_7) |= ((&l_8 != &g_2) != (&g_2 == (g_10 , &g_2)));
    return (*l_7);
}
