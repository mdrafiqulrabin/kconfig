 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --consts --divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --no-longlong --int8 --uint8 --float --math64 --no-inline-function --muls --no-safe-math --packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --no-volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      585385359
 */
...
{ /* block id: 36 */
    ...
    int32_t l_41 = 0;
    int32_t *l_40 = &l_41;
    (*l_40) = (0x47 ^ (l_39 = (0x457D6700 == ((65535U <= ((int8_t)(l_31 | l_31) % (int8_t)((int16_t)((uint8_t)0xCA << (uint8_t)((uint8_t)(!0xEE) / (uint8_t)l_31)) - (int16_t)(l_31 || l_31)))) < l_31))));
    if ((*l_40))
    { /* block id: 39 */
        uint8_t l_42 = 0xB1;
        return l_42;
