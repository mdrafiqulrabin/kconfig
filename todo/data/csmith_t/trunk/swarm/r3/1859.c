...
static uint32_t g_18 = 0x4BF90EDC;
...
{ /* block id: 36 */
    uint32_t *l_33 = &g_18;
    int32_t *l_34 = &g_4;
    (*l_34) |= (3U == ((*l_33) ^= (safe_rshift_func_int8_t_s_u(g_6, 1))));
    return g_18;
}
