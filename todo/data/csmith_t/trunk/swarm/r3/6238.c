 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --compound-assignment --no-consts --divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --no-int8 --no-uint8 --float --math64 --inline-function --no-muls --no-safe-math --packed-struct --paranoid --pointers --structs --unions --volatiles --no-volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      2305823214
 */
...
static int32_t g_32 = 0xA329EF4A;
...
{ /* block id: 36 */
    ...
    int32_t *l_53 = &g_32;
    int32_t *l_54 = &g_32;
    uint32_t l_55 = 0x4B58FE4D;
    for (g_6 = 0; (g_6 > 43); g_6 += 1)
    { /* block id: 39 */
        float l_36 = 0x0.5F4326p-12;
        for (g_32 = 6; (g_32 < 24); g_32++)
        { /* block id: 42 */
            uint32_t l_35 = 0x94ABC248;
            return l_35;
        }
        if (g_6)
            continue;
