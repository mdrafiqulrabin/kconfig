...
/* --- GLOBAL VARIABLES --- */
static union U3 g_3 = {0x4307E4A9};
static struct S2 g_5 = {9479,-50,92,0x8.Ep+1,-13321,7907,1,4122};/* VOLATILE GLOBAL g_5 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_5.f3, sizeof(g_5.f3), "g_5.f3", print_hash_value);
