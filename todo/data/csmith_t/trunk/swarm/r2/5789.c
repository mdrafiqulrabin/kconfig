...
/* --- GLOBAL VARIABLES --- */
static volatile union U4 g_2 = {4294967295UL};/* VOLATILE GLOBAL g_2 */
static float g_6 = 0x3.Cp+1;
static union U0 g_8 = {18446744073709551609UL};
...
{ /* block id: 0 */
    ...
    int8_t l_4 = 0x2FL;
    float *l_5 = &g_6;
    int32_t l_7 = 0x166C1932L;
    l_7 = ((0xC.959C45p-39 < (g_2 , (l_3 != ((*l_5) = l_4)))) < (-0x1.Ap-1));
    return g_8;
}
