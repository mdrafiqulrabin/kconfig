...
{ /* block id: 0 */
    ...
    int32_t *l_3 = &g_4;
    (*l_3) &= ((void*)0 != l_2);
    (*l_3) = (((*l_3) , 0x4D9EL) & (safe_sub_func_int32_t_s_s(((((*l_3) > (l_3 == &g_4)) < ((*l_3) <= ((*l_3) >= (((((safe_mod_func_int32_t_s_s(g_4, (0x71A0L | g_4))) <= (*l_3)) , (-1L)) < (*l_3)) >= (*l_3))))) <= 0x7904L), 1UL)));
    return (*l_3);
}
