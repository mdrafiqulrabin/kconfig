...
{ /* block id: 36 */
    int8_t *l_29 = &g_30;
    int32_t l_33 = 0xDC5336DE;
    int32_t *l_34 = &l_33;
    (*l_34) = (((*l_29) = g_3) && (safe_lshift_func_int8_t_s_u(l_33, __builtin_clzl(l_33))));
    return g_30;
}
