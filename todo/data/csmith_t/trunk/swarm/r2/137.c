...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4[4] = {(-5L),(-5L),(-5L),(-5L)};
    int32_t *l_3[4][3] = {{&l_4[3],&l_4[3],&l_4[0]},{(void*)0,&l_4[0],&l_4[0]},{&l_4[0],&l_4[0],&l_4[0]},{(void*)0,&l_4[0],(void*)0}};
    int32_t **l_2 = &l_3[1][1];
    uint16_t l_5 = 0x265EL;
    int i, j;
    (*l_2) = (void*)0;
    return l_5;
}
