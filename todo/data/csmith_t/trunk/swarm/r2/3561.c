 ...
 * Git version: 30dccd7
 * Options:   --argc --arrays --bitfields --comma-operators --compound-assignment --consts --no-divs --embedded-assigns --pre-incr-operator --pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --uint8 --float --math64 --no-inline-function --muls --no-safe-math --packed-struct --paranoid --pointers --no-structs --unions --volatiles --volatile-pointers --no-const-pointers --no-global-variables --no-builtins
 * Seed:      425300806
 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0x76881957;
    int8_t l_5 = 0x8B;
    int8_t *l_4 = &l_5;
    int32_t l_12 = (-1);
    int32_t l_13[2];
    uint16_t l_14 = 0xDDBF;
    int i;
    for (i = 0; i < 2; i++)
        l_13[i] = 0xCEFBDE28;
    if (l_2)
    { /* block id: 1 */
        uint32_t l_3 = 0xE4B9A733;
        int8_t *l_6 = (void*)0;
        int32_t l_8 = 0xBA75A592;
        int32_t *l_7 = &l_8;
        (*l_7) |= (l_3 , (l_4 == l_6));
    }
    else
