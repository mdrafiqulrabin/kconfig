 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --no-compound-assignment --no-consts --no-divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --post-decr-operator --unary-plus-operator --jumps --no-longlong --int8 --uint8 --no-float --no-math64 --inline-function --no-muls --no-safe-math --packed-struct --no-paranoid --no-pointers --structs --unions --no-volatiles --no-volatile-pointers --const-pointers --global-variabless --no-builtins
 * Seed:      2500917680
 */
...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_3 = {0xBB,0x0A,0x08,0xBC9C3D06,0xF498,1U,0x9ACD,0x09,0x84CB8F6C};
...
inline static int16_t  func_1(void)
{ /* block id: 0 */
    struct S0 l_2 = {-4,0,0xAC,0,1U,0x263126FF,-1,7,0x65E08CCC};
    g_3 = l_2;
    l_2.f8 = g_3.f3;
    return g_3.f1;
}
