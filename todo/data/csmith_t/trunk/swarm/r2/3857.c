...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0xFB0B0297L;
static uint64_t g_6 = 18446744073709551615UL;
static int16_t g_8 = 0xEA2AL;
...
{ /* block id: 0 */
    ...
    int32_t l_9 = 0x374B1B05L;
lbl_10:
    g_3 = l_2;
    if (g_3)
    { /* block id: 2 */
        g_6 = (safe_add_func_uint64_t_u_u(18446744073709551610UL, 1L));
    }
    else
    { /* block id: 4 */
        int64_t l_7 = (-7L);
