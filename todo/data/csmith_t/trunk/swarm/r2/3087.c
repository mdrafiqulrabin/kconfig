...
{ /* block id: 0 */
    ...
    int32_t l_7 = 0;
    for (l_2 = 0; (l_2 <= 10); l_2 = safe_add_func_uint16_t_u_u(l_2, 7))
    { /* block id: 3 */
        int32_t l_6 = (-1);
        int32_t *l_5 = &l_6;
        (*l_5) |= l_2;
