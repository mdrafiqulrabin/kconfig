...
{ /* block id: 0 */
    uint8_t l_4 = 255UL;
    float l_14 = 0xA.229EDCp+54;
    float *l_13 = &l_14;
    uint32_t l_15 = 7UL;
    (*l_13) = (safe_sub_func_float_f_f(0xC.53AA9Ap-34, (l_4 == (safe_add_func_float_f_f((safe_sub_func_float_f_f(((safe_mul_func_float_f_f(l_4, l_4)) < 0x3.5CABFCp+91), (l_4 < (safe_add_func_float_f_f(0x3.8B0D19p-26, 0x1.6A9272p+30))))), 0x5.52F67Dp+91)))));
    return l_15;
}
