...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_4 = {24799,-1L,-1L,6L,0L};
...
static struct S0  func_1(void)
{ /* block id: 0 */
    const struct S1 l_2 = {4294967295UL,0x97L,0xA124L,4294967286UL,0x00L};
    struct S1 l_3 = {3UL,-3L,0xA32FL,0xF6085E07L,0x0DL};
    l_3 = l_2;
    return g_4;
}
