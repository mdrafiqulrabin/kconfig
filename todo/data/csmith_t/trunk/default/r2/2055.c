...
static volatile uint64_t g_7 = 0x5E13CD4FE93046AALL;/* VOLATILE GLOBAL g_7 */
...
/* ------------------------------------------ */
/* 
 * reads : g_7 g_5 g_3 g_4
 * writes: g_7 g_3 g_4 g_5
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[2][2][2] = {{{&g_3,(void*)0},{(void*)0,&g_3}},{{(void*)0,(void*)0},{&g_3,(void*)0}}};
    int i, j, k;
    --g_7;
    g_3 ^= g_5;
    for (g_4 = 0; (g_4 < 9); g_4 = safe_add_func_int8_t_s_s(g_4, 7))
    { /* block id: 5 */
        uint64_t l_12 = 0xCC41425452E2CC7BLL;
