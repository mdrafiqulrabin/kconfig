...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x8748AFA2L;/* VOLATILE GLOBAL g_2 */
...
static const uint32_t  func_1(void)
{ /* block id: 0 */
    int64_t l_6[7] = {(-2L),(-2L),(-2L),(-2L),(-2L),(-2L),(-2L)};
    int32_t l_9 = 0x905B8B78L;
    int i;
    for (g_3 = (-12); (g_3 < (-1)); g_3 = safe_add_func_int64_t_s_s(g_3, 1))
    { /* block id: 3 */
        int32_t *l_8 = &g_7;
