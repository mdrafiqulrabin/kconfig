...
static volatile uint64_t g_8 = 0xEE28FDEB77278FA8LL;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &l_4;
    int32_t *l_6 = &l_4;
    int32_t *l_7[8][3] = {{&l_4,&l_4,&l_4},{&g_3,&l_4,&g_3},{&g_3,&l_4,&l_4},{&g_3,&g_3,&l_4},{&l_4,&g_3,&g_3},{&l_4,&g_3,&l_4},{&l_4,&l_4,&g_3},{&l_4,&l_4,&l_4}};
    int i, j;
    --g_8;
    return g_3;
}
