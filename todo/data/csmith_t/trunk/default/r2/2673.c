...
/* --- GLOBAL VARIABLES --- */
static int32_t g_6 = 0x3099CFE0L;
static volatile int32_t g_9 = 0xFECAFE8BL;/* VOLATILE GLOBAL g_9 */
static uint8_t g_10 = 0x22L;
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_6;
    int32_t *l_7 = &g_6;
    int32_t *l_8[7] = {&g_6,(void*)0,&g_6,&g_6,(void*)0,&g_6,&g_6};
    int i;
    for (i = 0; i < 7; i++)
        l_4[i] = 1L;
    g_10--;
