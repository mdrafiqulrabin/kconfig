...
static uint8_t g_6[8][3] = {{0xDCL,0x68L,0xDCL},{0xDCL,0x68L,0xDCL},{0xDCL,0x68L,0xDCL},{0xDCL,0x68L,0xDCL},{0xDCL,0x68L,0xDCL},{0xDCL,0x68L,0xDCL},{0xDCL,0x68L,0xDCL},{0xDCL,0x68L,0xDCL}};
static int32_t g_9 = 0x83648BD9L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 3; i++)
        l_5[i] = &g_6[6][2];
    (*l_8) |= (safe_rshift_func_uint8_t_u_s((l_7 = g_4), 0));
    return (*l_8);
}
