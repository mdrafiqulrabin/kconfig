...
static uint8_t g_9 = 0x60L;
static const int32_t *g_17 = &g_6;
static const int32_t ** volatile g_16 = &g_17;/* VOLATILE GLOBAL g_16 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_9 g_6 g_16
 * writes: g_2 g_9 g_6 g_17
 */
static uint8_t  func_1(void)
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        int32_t *l_7[9] = {&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6};
        const int32_t **l_15 = (void*)0;
        int i;
        ++g_9;
        (*l_5) &= (safe_div_func_uint32_t_u_u(((void*)0 != l_14), 4294967295UL));
        (*g_16) = l_14;
    }
    return g_6;
}
