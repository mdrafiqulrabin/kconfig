...
static int32_t g_3 = 0x185299DAL;
...
static const uint32_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_6[3][1] = {{0x65AB3E90L},{0x65AB3E90L},{0x65AB3E90L}};
    int32_t *l_7[8] = {(void*)0,&g_3,(void*)0,(void*)0,&g_3,(void*)0,(void*)0,&g_3};
    int i, j;
    for (g_3 = (-4); (g_3 >= 2); g_3++)
    { /* block id: 3 */
        return l_6[2][0];
