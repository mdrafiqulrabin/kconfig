...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0x1124F01CL;
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    int16_t l_6[8] = {0x5912L,0x5912L,0x5912L,0x5912L,0x5912L,0x5912L,0x5912L,0x5912L};
    int i;
    for (g_2 = 0; (g_2 != 14); ++g_2)
    { /* block id: 3 */
        uint8_t l_5[1][5] = {{0x9CL,0x9CL,0x9CL,0x9CL,0x9CL}};
        int i, j;
        l_6[6] &= l_5[0][1];
        if (l_5[0][2])
            continue;
