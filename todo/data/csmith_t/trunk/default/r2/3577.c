...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xECC2443AL;
static volatile int64_t g_24 = 0x165F5C9B8DB370CCLL;/* VOLATILE GLOBAL g_24 */
...
{ /* block id: 0 */
    ...
    int32_t *l_21 = &l_10[0];
    int32_t *l_22 = &l_10[0];
    int32_t *l_23[2][1][3] = {{{(void*)0,(void*)0,(void*)0}},{{&l_10[0],&l_10[0],&l_10[0]}}};
    uint64_t l_25 = 0UL;
    int i, j, k;
    for (i = 0; i < 1; i++)
        l_10[i] = (-1L);
