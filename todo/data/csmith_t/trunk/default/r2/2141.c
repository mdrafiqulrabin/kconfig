...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_6[3][4] = {{0xF365653D42374B1BLL,0UL,0xF365653D42374B1BLL,0xF365653D42374B1BLL},{0UL,0UL,0x4276038591B68DEELL,0UL},{0UL,0xF365653D42374B1BLL,0xF365653D42374B1BLL,0UL}};
...
{ /* block id: 0 */
    int8_t l_2 = 0x2DL;
    uint32_t l_3 = 0x14768C0AL;
    uint64_t *l_4 = (void*)0;
    uint64_t *l_5 = &g_6[2][3];
    int32_t *l_7 = &g_8;
    (*l_7) ^= (l_2 >= ((*l_5) = l_3));
    return (*l_7);
}
