...
static int32_t g_8[5] = {0x73EE7637L,0x73EE7637L,0x73EE7637L,0x73EE7637L,0x73EE7637L};
static union U2 g_12 = {0};/* VOLATILE GLOBAL g_12 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4 = &g_3;
    int32_t l_5 = 0x54DBBE56L;
    int32_t *l_6[5] = {&l_5,&l_5,&l_5,&l_5,&l_5};
    uint16_t l_9 = 0x9333L;
    int i;
    --l_9;
    return g_12;
}
