...
static uint64_t g_6 = 0x7B8F5F4990069F30LL;
static int32_t g_7 = 1L;
static uint32_t g_10 = 3UL;
static uint64_t g_13 = 0x72B5725D36729694LL;
static union U1 g_14 = {-1L};/* VOLATILE GLOBAL g_14 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_4 g_10 g_14
 * writes: g_6 g_7 g_10 g_13
 */
static union U1  func_1(void)
{ /* block id: 0 */
    uint64_t *l_5[5];
    int64_t l_8 = 0xA8B35EDADE0980DBLL;
    uint32_t *l_9 = &g_10;
    int i;
    for (i = 0; i < 5; i++)
        l_5[i] = &g_6;
    g_13 = (+(((g_6 = ((void*)0 == g_3)) <= (((g_4 & (g_7 = 0x2391L)) ^ g_4) | l_8)) , ((*l_9)++)));
    return g_14;
}
