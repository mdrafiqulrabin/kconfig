...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x3B910207L;/* VOLATILE GLOBAL g_2 */
static int32_t g_3 = 0x8D4081C2L;
static int32_t g_9 = 0x9B8BC588L;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_9 g_2 g_17
 * writes: g_3 g_9 g_17 g_2
 */
static uint8_t  func_1(void)
{ /* block id: 0 */
    int64_t l_14[8];
    ...
    g_2 |= ((safe_add_func_uint64_t_u_u(g_3, l_14[2])) >= ((*l_16) = (l_14[4] != 0UL)));
