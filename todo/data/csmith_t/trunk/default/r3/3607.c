...
static int8_t * volatile g_3[3][3] = {{&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4}};
static int8_t * volatile * volatile g_2 = &g_3[1][2];/* VOLATILE GLOBAL g_2 */
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int8_t * volatile * volatile *l_5 = (void*)0;
    int8_t * volatile * volatile *l_6 = &g_2;
    (*l_6) = g_2;
    return g_4;
}
