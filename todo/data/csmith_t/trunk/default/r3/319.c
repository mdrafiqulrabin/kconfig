...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_4 = 0x0AA6E6F7L;/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    uint64_t l_5 = 0UL;
    int32_t l_6[9] = {(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L)};
    int i;
    g_7 = (l_6[8] &= ((safe_add_func_int16_t_s_s(0xC4C8L, (g_4 && 0L))) > l_5));
    return l_6[8];
}
