...
static int32_t g_6 = 0xE4D9EDBDL;
static int32_t * volatile g_5[10] = {&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6};
static union U2 g_8 = {0xA18E418AL};/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t *l_7 = &g_6;
    (*l_7) |= (safe_sub_func_int64_t_s_s(0L, g_4));
    return g_8;
}
