...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xD832937AL;
static int32_t g_5 = (-5L);
static volatile int32_t g_13 = 0xF8EE1D11L;/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        int32_t *l_10 = &g_5;
        int32_t *l_11 = (void*)0;
        int32_t *l_12[7] = {&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5};
        uint16_t l_14 = 0x78C0L;
        int i;
        l_14++;
    }
    return g_13;
