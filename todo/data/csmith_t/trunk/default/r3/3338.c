...
static int32_t g_3[1][4] = {{(-7L),(-7L),(-7L),(-7L)}};
static int32_t g_7 = 0xB2906C90L;
...
{ /* block id: 0 */
    ...
    {
        for (j = 0; j < 6; j++)
            l_8[i][j] = 0xA7084BC9C3D069F4LL;
    }
    for (g_3[0][1] = (-21); (g_3[0][1] >= (-18)); g_3[0][1] = safe_add_func_int32_t_s_s(g_3[0][1], 3))
    { /* block id: 3 */
        int32_t *l_6 = &g_7;
        (*l_6) = 1L;
        if (l_8[2][4])
