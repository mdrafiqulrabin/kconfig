...
static int32_t g_6 = 0xEDCAD208L;
static uint16_t g_14[9] = {0x0452L,1UL,1UL,0x0452L,1UL,1UL,0x0452L,1UL,1UL};
...
{ /* block id: 0 */
    ...
    for (g_2[4] = (-23); (g_2[4] <= 24); g_2[4] = safe_add_func_uint64_t_u_u(g_2[4], 8))
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        int32_t *l_7 = (void*)0;
        int32_t *l_8 = (void*)0;
