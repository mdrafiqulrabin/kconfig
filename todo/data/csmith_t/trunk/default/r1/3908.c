...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x008FB0B4L;/* VOLATILE GLOBAL g_2 */
static int32_t g_3 = 0x592758E9L;
static union U3 g_6 = {-1L};/* VOLATILE GLOBAL g_6 */
static union U3 g_7 = {0x05CEFD06L};/* VOLATILE GLOBAL g_7 */
...
static union U3  func_1(void)
{ /* block id: 0 */
    for (g_3 = (-28); (g_3 < (-9)); g_3 = safe_add_func_uint16_t_u_u(g_3, 2))
    { /* block id: 3 */
        return g_6;
    }
    return g_7;
