...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x9EDCA8FEL;
static volatile int32_t g_5 = 0L;/* VOLATILE GLOBAL g_5 */
static volatile uint32_t g_6[2] = {7UL,7UL};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4[2][9] = {{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3}};
    int i, j;
    --g_6[0];
    return g_6[1];
}
