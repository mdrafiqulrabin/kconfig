...
static volatile int32_t g_3 = 0x2A2C7C8AL;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4[1] = {0x50BA1BF2L};
static volatile int32_t g_5 = 0xDFCF09CCL;/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_6 = 7L;/* VOLATILE GLOBAL g_6 */
static int32_t g_7 = 1L;
static int32_t g_13 = 0x07CFAF42L;
...
/* ------------------------------------------ */
/* 
 * reads : g_7 g_4 g_12 g_13
 * writes: g_7 g_13
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    for (g_7 = 6; (g_7 <= 12); g_7 = safe_add_func_int32_t_s_s(g_7, 1))
    { /* block id: 3 */
        int64_t l_14 = 0x7CC4247706695998LL;
        (*g_12) = (safe_div_func_int8_t_s_s(g_4[0], 0x4EL));
        (*g_12) ^= l_14;
    }
    return (*g_12);
}
