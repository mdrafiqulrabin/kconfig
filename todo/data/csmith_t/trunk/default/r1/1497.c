...
static uint8_t g_5 = 0xB4L;
static int32_t g_6 = 0xC7747BB7L;
static volatile uint8_t g_8[5] = {0UL,0UL,0UL,0UL,0UL};
static volatile uint8_t * volatile g_7 = &g_8[2];/* VOLATILE GLOBAL g_7 */
static int32_t g_11 = (-1L);
static uint16_t g_12 = 0x4AC0L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 3; i++)
        l_10[i] = &g_11;
    g_12 &= (g_11 = ((g_6 = ((*l_4) = ((*l_2) = 0x56L))) | (g_7 == l_2)));
    return g_3;
}
