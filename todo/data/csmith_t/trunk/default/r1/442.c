...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2 = 0x885C6F1BL;/* VOLATILE GLOBAL g_2 */
static int32_t g_6 = 0x693E9323L;
...
{ /* block id: 0 */
    int32_t *l_5 = &g_6;
    int32_t *l_7 = &g_8;
    (*l_7) = (g_2 , ((*l_5) ^= (safe_div_func_int32_t_s_s(0xD94FE5F3L, 0x6DD8D130L))));
    return g_6;
}
