...
/* --- GLOBAL VARIABLES --- */
static struct S1 g_2 = {101,7L,31,1444,1L,411,8L,364,1,1028};/* VOLATILE GLOBAL g_2 */
static int32_t g_4 = 0xB89BDD77L;
static int32_t * volatile g_5 = (void*)0;/* VOLATILE GLOBAL g_5 */
static int32_t g_7 = 8L;
static int32_t * volatile g_6[10] = {&g_7,&g_4,&g_7,&g_7,&g_4,&g_7,&g_4,&g_7,&g_7,&g_4};
...
{ /* block id: 0 */
    int32_t *l_3 = &g_4;
    int32_t *l_8[5] = {&g_7,&g_7,&g_7,&g_7,&g_7};
    int32_t l_9 = 0x548E01AFL;
    int i;
    (*l_3) &= (g_2 , g_2.f4);
    l_9 ^= (*l_3);
    return g_2.f2;
...
XXX times a pointer is qualified to be dereferenced: 99
