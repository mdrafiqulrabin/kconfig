...
static volatile int32_t g_13 = 0xCBCB1A7AL;/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_3;
    int32_t *l_6 = &g_3;
    int32_t l_7[5][8] = {{0L,0L,0L,0L,0L,0L,0L,0L},{0L,0L,0L,0L,0L,0L,0L,0L},{0L,0L,(-1L),0L,0L,(-1L),0L,0L},{0L,0L,0L,0L,0L,0L,0L,0L},{0L,0L,0L,0L,0L,0L,0L,0L}};
    int32_t *l_8 = (void*)0;
    int32_t *l_9 = &g_3;
    int32_t *l_10 = &l_7[1][0];
    int32_t *l_11 = &l_7[4][5];
    int32_t *l_12[9];
    uint32_t l_18 = 0UL;
    int i, j;
    for (i = 0; i < 9; i++)
...
lbl_21:
    ...
    { /* block id: 2 */
lbl_22:
        for (g_15 = 0; (g_15 == 37); g_15 = safe_add_func_int16_t_s_s(g_15, 7))
        { /* block id: 5 */
            if (l_18)
                goto lbl_21;
        }
