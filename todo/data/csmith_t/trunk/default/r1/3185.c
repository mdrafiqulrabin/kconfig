...
{ /* block id: 0 */
    ...
    if (l_6)
    { /* block id: 2 */
        volatile int32_t * volatile * volatile **l_11 = &g_7;
        (*l_11) = g_7;
    }
    else
    { /* block id: 4 */
        (*g_9) = (safe_mul_func_uint16_t_u_u(1UL, g_10));
    }
    return g_10;
}
