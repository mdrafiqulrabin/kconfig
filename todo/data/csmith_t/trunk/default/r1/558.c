...
static volatile uint64_t g_9 = 0x32A17D0B0A3531F1LL;/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_3;
    int32_t *l_7 = (void*)0;
    int32_t *l_8[10][2] = {{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3}};
    int i, j;
    g_9++;
    return (*l_4);
}
