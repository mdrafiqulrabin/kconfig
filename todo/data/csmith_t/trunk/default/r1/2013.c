...
static int32_t g_10[2][3] = {{0L,0L,0L},{0L,0L,0L}};
...
{ /* block id: 0 */
    ...
    int32_t l_12 = (-4L);
    int32_t l_13 = 0x1213072CL;
    int32_t l_14[1];
    int i;
    for (i = 0; i < 1; i++)
        l_14[i] = 0x2A04F777L;
    for (g_5 = 0; (g_5 == 20); g_5 = safe_add_func_int8_t_s_s(g_5, 8))
    { /* block id: 3 */
        int32_t *l_8 = (void*)0;
        int32_t *l_9[6] = {&g_10[1][2],&g_10[1][2],&g_10[1][2],&g_10[1][2],&g_10[1][2],&g_10[1][2]};
        uint64_t l_16 = 1UL;
        int i;
        l_16++;
        l_13 |= (&g_10[1][1] == (void*)0);
    }
    return l_12;
}
