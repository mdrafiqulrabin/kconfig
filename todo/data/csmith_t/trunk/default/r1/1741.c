...
static const struct S1 g_10 = {-3862,22,342,-1132};/* VOLATILE GLOBAL g_10 */
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[4] = {0xA7525D2DL,0xA7525D2DL,0xA7525D2DL,0xA7525D2DL};
    int i;
    for (g_6 = 0; (g_6 <= 3); g_6 += 1)
    { /* block id: 3 */
        struct S1 **l_7 = (void*)0;
        const struct S1 *l_9[2][6];
        const struct S1 **l_8 = &l_9[1][3];
        int i, j;
        for (i = 0; i < 2; i++)
        {
            for (j = 0; j < 6; j++)
