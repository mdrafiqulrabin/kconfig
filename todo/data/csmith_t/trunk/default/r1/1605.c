...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_3 = {1238,417,24,7,177,9142,0};/* VOLATILE GLOBAL g_3 */
static volatile struct S0 * const  volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
static volatile struct S0 * volatile g_5 = &g_3;/* VOLATILE GLOBAL g_5 */
static volatile struct S0 * volatile * volatile g_4 = &g_5;/* VOLATILE GLOBAL g_4 */
static int32_t g_8 = 0x2215256EL;
static uint32_t g_10 = 0x1FB8EB5EL;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_4 g_10 g_8
 * writes: g_5 g_10
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_6[7] = {0L,0L,0L,0L,0L,0L,0L};
    int32_t *l_7 = &g_8;
    int32_t *l_9[3];
    int i;
    for (i = 0; i < 3; i++)
