...
static struct S0 g_26 = {3,0xE0D1B713L,7,7UL,162,18,-5,1,0x1.4p-1};/* VOLATILE GLOBAL g_26 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_26.f8, sizeof(g_26.f8), "g_26.f8", print_hash_value);
