...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_6 = {0x6EC79CF1};


/* --- FORWARD DECLARATIONS --- */
static struct S0  func_1(void);
static struct S0  func_2(struct S0  p_3, uint32_t  p_4, struct S0  p_5);
...
{ /* block id: 0 */
    int32_t l_11 = (-1);
    struct S0 l_23 = {1};
    g_6 = func_2(g_6, ((uint16_t)((uint32_t)l_11 - (uint32_t)(g_6.f0 == (((0xF978 && (((int32_t)g_6.f0 % (int32_t)((uint32_t)((((g_6.f0 >= ((int16_t)(((int16_t)(-1) % (int16_t)(~((int16_t)l_11 << (int16_t)g_6.f0))) > g_6.f0) + (int16_t)g_6.f0)) == 0x3E018EBD) ^ 0U) == l_11) % (uint32_t)0x22B60780)) <= (-4))) != g_6.f0) || g_6.f0))) >> (uint16_t)2), l_23);
    return g_6;
}
