...
static struct S1  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0xF5537C57;
    int32_t l_3 = 8;
    struct S1 l_4 = {{0x809B,-3,0xBDD48407,-10,65535U,0x28033590,0xB0881DDA},0xDB8846B5,0xF0EF,1,0xFC0336AE,0xD475,0xE4A6B2C4,{0xB0A1,0x7216,0x09E149CF,0x29C2,1U,9,0},9U};
    l_3 = l_2;
    return l_4;
}
