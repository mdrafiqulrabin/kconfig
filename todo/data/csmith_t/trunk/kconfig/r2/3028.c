...
static const struct S0 g_29[5] = {{0xB44ADCA1,-0x7.0p-1,0,0xE045,-1,-31},{0xB44ADCA1,-0x7.0p-1,0,0xE045,-1,-31},{0xB44ADCA1,-0x7.0p-1,0,0xE045,-1,-31},{0xB44ADCA1,-0x7.0p-1,0,0xE045,-1,-31},{0xB44ADCA1,-0x7.0p-1,0,0xE045,-1,-31}};
...
int main (int argc, char* argv[])
{
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        transparent_crc_bytes(&g_29[i].f1, sizeof(g_29[i].f1), "g_29[i].f1", print_hash_value);
