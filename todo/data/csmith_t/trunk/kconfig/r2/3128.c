...
{ /* block id: 36 */
    ...
    int32_t l_40 = 0x58AAE07E;
    int32_t l_41 = 0xC3F30B91;
    l_41 = ((int32_t)(l_40 = (((uint16_t)((1U != l_37) , ((int16_t)0x30DF + (int16_t)(l_37 > __builtin_parity(l_37)))) - (uint16_t)l_37) & l_37)) - (int32_t)(l_37 , l_37));
    return l_37;
}
