...
static int64_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_2[3] = {1L,1L,1L};
    float l_6 = 0xE.58A012p-16;
    float *l_5 = &l_6;
    uint16_t l_7[6] = {65535UL,65535UL,65535UL,65535UL,65535UL,65535UL};
    int i;
    (*l_5) = (l_2[0] >= (((safe_mul_func_float_f_f(0x4.29EA41p+26, l_2[0])) <= 0x1.0p+1) > l_2[0]));
    return l_7[2];
}
