...
static union U2 * func_28(union U0  p_29, union U2 * p_30);
...
inline static int16_t  func_27(void)
{ /* block id: 36 */
    union U0 l_31 = {0x92C6EED1L};
    union U2 *l_32 = (void*)0;
    union U2 **l_35 = &l_32;
    uint64_t l_36 = 0xAB06C0E2632C5B64LL;
    (*l_35) = func_28(l_31, l_32);
    return l_36;
}
