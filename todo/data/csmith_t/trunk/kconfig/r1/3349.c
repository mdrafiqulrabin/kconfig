...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3[3][6] = {{1L,0xACCBAD86L,0xACCBAD86L,1L,0x20E83C77L,0xD9532BB1L},{0xD9532BB1L,1L,(-7L),1L,0xD9532BB1L,0x831E42A4L},{1L,0xD9532BB1L,0x831E42A4L,0x831E42A4L,0xD9532BB1L,1L}};
    int32_t *l_2 = &l_3[1][2];
    float l_4 = 0x2.Dp+1;
    int16_t l_5 = 0x2BD4L;
    int i, j;
