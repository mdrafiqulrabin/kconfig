...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_6 = 0xE9D05BA7L;
    int32_t l_20 = 1L;
    int32_t *l_19 = &l_20;
    uint32_t l_30 = 0xEAC8E4C1L;
    (*l_19) = ((int32_t)func_4(l_6) - (int32_t)(0x40FC0272L != (l_6 > ((int16_t)((uint16_t)((((uint16_t)l_6 % (uint16_t)l_6) > func_4(((-(uint32_t)((l_6 <= (l_6 > ((uint16_t)(((uint32_t)(l_6 <= l_6) % (uint32_t)l_6) <= 0x2C59L) >> (uint16_t)l_6))) < l_6)) || l_6))) ^ l_6) % (uint16_t)l_6) >> (int16_t)13))));
    (*l_19) = (*l_19);
    for (l_20 = (-13); (l_20 > 11); l_20 += 1)
    { /* block id: 7 */
        int32_t *l_23 = &l_20;
        int32_t l_28 = (-10L);
        int32_t *l_27 = &l_28;
        int32_t l_29 = 4L;
        (*l_27) = ((l_23 != (void*)0) || func_24(&l_20));
        l_29 = (0xD860L & (*l_19));
        if ((*l_19))
            break;
    }
