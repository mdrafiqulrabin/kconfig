...
static int32_t  func_29(void)
{ /* block id: 36 */
    uint32_t l_34 = 0xA7B7E80D;
    int32_t l_54 = 0x4353EA3A;
    int32_t l_55 = 0xBE41B0CE;
    l_55 = ((int32_t)(l_54 = ((uint32_t)__builtin_ia32_crc32qi((l_34 ^ ((int16_t)(((uint16_t)1U % (uint16_t)((uint16_t)(func_41(l_34) | l_34) << (uint16_t)((uint16_t)(__builtin_bswap32(l_34) | ((uint32_t)4294967295U + (uint32_t)l_34)) >> (uint16_t)l_34))) >= l_34) % (int16_t)65535U)), l_34) + (uint32_t)l_34)) % (int32_t)l_34);
    l_55 = func_41(l_34);
    return l_34;
}
...
{ /* block id: 37 */
    int32_t l_47 = 0;
    uint32_t l_48 = 1U;
    int32_t l_49 = 0x9D44F4CC;
    l_48 = (65535U & (l_47 = ((int16_t)((uint16_t)l_47 << (uint16_t)l_47) + (int16_t)65535U)));
    return l_49;
}
