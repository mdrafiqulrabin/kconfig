...
{ /* block id: 0 */
    int32_t l_3[4];
    int32_t *l_2 = &l_3[3];
    int32_t *l_4[4][4][4] = {{{&l_3[1],&l_3[3],&l_3[3],&l_3[3]},{&l_3[0],&l_3[3],&l_3[3],&l_3[2]},{&l_3[0],&l_3[3],&l_3[3],&l_3[3]},{&l_3[1],&l_3[2],&l_3[2],&l_3[1]}},{{(void*)0,&l_3[2],&l_3[1],&l_3[3]},{&l_3[3],&l_3[3],(void*)0,&l_3[1]},{&l_3[3],&l_3[3],&l_3[3],&l_3[1]},{&l_3[2],&l_3[3],&l_3[3],&l_3[3]}},{{&l_3[3],&l_3[2],&l_3[3],&l_3[1]},{&l_3[3],&l_3[2],&l_3[0],&l_3[3]},{&l_3[1],&l_3[3],&l_3[3],&l_3[2]},{&l_3[3],&l_3[3],&l_3[0],(void*)0}},{{&l_3[3],&l_3[3],&l_3[1],&l_3[1]},{&l_3[3],&l_3[3],(void*)0,&l_3[2]},{(void*)0,&l_3[2],&l_3[3],&l_3[3]},{&l_3[3],&l_3[3],&l_3[3],&l_3[3]}}};
    uint8_t l_5 = 1UL;
    int32_t l_8 = 0L;
    int i, j, k;
    for (i = 0; i < 4; i++)
