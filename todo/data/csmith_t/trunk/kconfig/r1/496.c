...
inline static int32_t  func_4(uint8_t  p_5, uint32_t  p_6, uint32_t  p_7);
...
{ /* block id: 0 */
    int32_t l_3 = (-1L);
    int32_t *l_2 = &l_3;
    int32_t l_13 = 0xD487C759L;
    int16_t l_14 = 3L;
    (*l_2) &= (-6L);
    l_13 &= func_4((*l_2), (*l_2), (*l_2));
    return l_14;
}
...
inline static int32_t  func_4(uint8_t  p_5, uint32_t  p_6, uint32_t  p_7)
{ /* block id: 2 */
    int32_t l_11 = 0x5A80E358L;
    int32_t *l_10[4];
    int16_t l_12 = 0L;
    int i;
    for (i = 0; i < 4; i++)
        l_10[i] = &l_11;
    l_12 ^= (safe_mul_func_uint16_t_u_u((l_10[1] == (void*)0), (0xAFL < (-6L))));
    return p_6;
}
