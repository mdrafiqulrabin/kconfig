...
/* --- GLOBAL VARIABLES --- */
static union U11 g_3 = {0x00955205};
static union U11 *g_2[3][5] = {{&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,(void*)0,(void*)0,&g_3,(void*)0},{&g_3,&g_3,&g_3,&g_3,&g_3}};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    union U11 **l_4 = &g_2[0][3];
    int32_t l_5 = 0xBE26B5CF;
    (*l_4) = g_2[0][3];
    return l_5;
}
