...
{ /* block id: 36 */
    int8_t l_34 = 1;
    int32_t l_37 = 0xD68F9855;
    uint32_t l_46 = 0x68F62C4D;
    int32_t l_47 = (-4);
    int32_t l_48 = (-4);
    l_48 = ((uint32_t)((l_47 = ((uint16_t)((uint16_t)(l_34 , l_34) + (uint16_t)__builtin_parityll(((int16_t)(l_37 = 1) >> (int16_t)(((int32_t)(((((uint16_t)0xB857 * (uint16_t)l_34) , ((uint16_t)((((uint16_t)l_34 + (uint16_t)l_46) & (l_34 >= (((l_34 ^ l_46) ^ l_34) == 0))) , l_46) % (uint16_t)l_46)) , l_46) > l_34) % (int32_t)(-5)) , 0x7C29)))) >> (uint16_t)l_34)) , 1U) % (uint32_t)l_46);
    return l_46;
}
