...
static int32_t * volatile g_34 = &g_5;/* VOLATILE GLOBAL g_34 */
...
static const int8_t  func_28(void)
{ /* block id: 36 */
    float l_32[9] = {0x3.Bp+1,0x3.Bp+1,0x3.Bp+1,0x3.Bp+1,0x3.Bp+1,0x3.Bp+1,0x3.Bp+1,0x3.Bp+1,0x3.Bp+1};
    int32_t l_33 = 3L;
    int i;
    (*g_34) = ((int8_t)(!4294967286UL) >> (int8_t)l_33);
    return l_33;
}
