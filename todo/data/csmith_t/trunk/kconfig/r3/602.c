...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_3 = 9UL;
static uint64_t g_27 = 0x151C8B9BA5E0B2F6LL;
static float g_29 = (-0x1.2p+1);
...
inline static int32_t  func_26(void)
{ /* block id: 36 */
    int8_t l_30[6][6] = {{0L,9L,0L,0L,9L,0L},{0L,9L,0L,0L,9L,0L},{0L,9L,0L,0L,9L,0L},{0L,9L,0L,0L,9L,0L},{0L,9L,0L,0L,9L,0L},{0L,9L,0L,0L,9L,0L}};
    int i, j;
    (*g_28) = g_27;
    return l_30[1][5];
}
