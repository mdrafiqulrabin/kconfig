...
inline static uint16_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31 = 0xDBBE5689L;
    uint32_t l_40 = 1UL;
    int32_t *l_41 = (void*)0;
    int32_t l_42 = 0x5537C57FL;
    for (l_31 = 2; (l_31 == 19); ++l_31)
    { /* block id: 39 */
        float l_36 = (-0x9.4p-1);
        int32_t l_37 = 0x43836745L;
        l_37 &= (safe_div_func_int8_t_s_s((l_31 && l_31), l_31));
        l_40 |= (safe_rshift_func_int8_t_s_s(l_31, l_31));
    }
    l_42 ^= (0x0EBBL >= l_31);
    return l_42;
}
