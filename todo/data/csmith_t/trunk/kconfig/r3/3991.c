...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_2[1][4][5] = {{{0xC4B4L,0UL,0UL,0xC4B4L,0xC4B4L},{0x0647L,0xDADAL,0x0647L,0xDADAL,0x0647L},{0xC4B4L,0xC4B4L,0UL,0UL,0xC4B4L},{0x90A6L,0xDADAL,0x90A6L,0xDADAL,0x90A6L}}};
    int32_t l_3 = 0xEB9AE77AL;
    int i, j, k;
    l_3 &= l_2[0][0][0];
    return l_3;
}
