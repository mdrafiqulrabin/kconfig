...
m_path_input=""
m_path_output=""
m_path_csmith="/project/alipour/rabin/kconfig/data/csmith_t"
m_path_gcc="/project/alipour/rabin/kconfig/data/gcc_t"
m_args=""
m_version=""
m_run=""
m_tc=0
m_centroids=134 #by xmeans_centroids.py
m_limit=1*60*60*6 #hour in second
...
function init {
    m_path_input="$m_path_csmith/$m_version/$m_args/$m_run"
    mkdir -p "$m_path_input" 2> /dev/null
