...
max((df_6h[df_6h$ST == "swarm",])$TC)
max((df_6h[df_6h$ST == "kconfig",])$TC)

max((df_6h[df_6h$ST == "swarm",])$TT)
max((df_6h[df_6h$ST == "kconfig",])$TT)

max((df_6h[df_6h$ST == "swarm",])$MC)
...
max((df_10k[df_10k$ST == "swarm",])$TC)
max((df_10k[df_10k$ST == "kconfig",])$TC)

max((df_10k[df_10k$ST == "swarm",])$TT)
max((df_10k[df_10k$ST == "kconfig",])$TT)

max((df_10k[df_10k$ST == "swarm",])$MC)
