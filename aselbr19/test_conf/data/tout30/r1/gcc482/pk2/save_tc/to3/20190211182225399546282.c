...
static int32_t  func_26(void)
{ /* block id: 36 */
    for (g_8 = 0; (g_8 >= (-5)); g_8 = safe_sub_func_uint16_t_u_u(g_8, 1))
    { /* block id: 39 */
        int32_t l_29 = 0xB64B5C6F;
        l_29 = g_8;
    }
    return g_8;
}
