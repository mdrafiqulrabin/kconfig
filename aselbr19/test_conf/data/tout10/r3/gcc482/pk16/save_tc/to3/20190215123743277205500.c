...
static int32_t  func_25(void)
{ /* block id: 36 */
    int32_t l_33 = 0x6D21CD43;
    int32_t l_35 = 0xD64EA33A;
lbl_36:
    g_34 = ((g_26 |= g_4) & (safe_sub_func_uint16_t_u_u(((g_4 != 0x95D1C58B) > (safe_sub_func_uint16_t_u_u(((safe_lshift_func_uint16_t_u_s(65527U, 10)) , l_33), g_4))), g_4)));
    l_35 = 0xA20B2878;
    if (g_4)
        goto lbl_36;
    return g_26;
