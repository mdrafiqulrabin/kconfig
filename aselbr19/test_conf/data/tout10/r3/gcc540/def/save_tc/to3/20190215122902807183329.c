...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0xB546158DL;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0xFAB8C3ADL;
static volatile int32_t g_5 = 0x152C58FBL;/* VOLATILE GLOBAL g_5 */
static int32_t * const  volatile g_6[2][7] = {{&g_4,(void*)0,&g_4,&g_4,(void*)0,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4}};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        {
            for (k = 0; k < 5; k++)
                l_2[i][j][k] = 18446744073709551612UL;
        }
    }
lbl_11:
