...
{ /* block id: 0 */
    int32_t l_2 = (-7);
    int32_t l_6 = (-1);
    for (l_2 = 0; (l_2 > (-20)); l_2 = safe_sub_func_uint16_t_u_u(l_2, 3))
    { /* block id: 3 */
        uint32_t l_5 = 1U;
        l_6 = l_5;
    }
