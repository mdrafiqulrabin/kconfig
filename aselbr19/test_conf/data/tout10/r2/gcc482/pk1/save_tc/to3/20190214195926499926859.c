...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_12 = 0x3DE0;
    int32_t l_13 = 0;
    for (g_2 = 0; (g_2 >= 0); g_2 = safe_add_func_uint16_t_u_u(g_2, 1))
    { /* block id: 3 */
        g_6 = (g_5 = g_2);
    }
    for (g_5 = 1; (g_5 == (-18)); g_5 = safe_sub_func_int32_t_s_s(g_5, 7))
    { /* block id: 9 */
        for (g_6 = 0; (g_6 <= (-9)); g_6 = safe_sub_func_uint32_t_u_u(g_6, 6))
        { /* block id: 12 */
            g_2 ^= (!l_12);
        }
        return g_5;
