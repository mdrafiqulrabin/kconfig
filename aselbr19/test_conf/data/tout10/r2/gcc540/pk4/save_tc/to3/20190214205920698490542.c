...
/* --- GLOBAL VARIABLES --- */
static int32_t g_5 = 0xA049FE38;
static int32_t g_30 = 0x75158018;
static int32_t g_32 = 0x34EDF6B3;
...
lbl_34:
    (*l_29) = g_5;
    g_33 |= ((((*l_29) = 0x07647F1A) != ((*l_31) = g_30)) ^ 0x13E19F23);
    if (g_5)
        goto lbl_34;
    return l_35;
}
