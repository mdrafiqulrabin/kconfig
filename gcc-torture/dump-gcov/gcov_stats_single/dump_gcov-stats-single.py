...
#path_all_c_gcov_files = "gcov_stats_temp"

output_file = "gcov-stats-single.tsv"
...
#result_binary_2d = getBinary2d(path_all_c_gcov_files + "/t0.tsv")
result_binary_2d = getBinary2d("gcov_stats_zero.tsv")
#print result_binary_2d
