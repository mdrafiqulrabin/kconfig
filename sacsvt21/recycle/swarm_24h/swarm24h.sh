...
m_path_input=""
m_path_output=""
m_path_csmith="/project/alipour/rabin/kconfig/recycle/swarm_24h/csmith_24h"
m_path_gcc="/project/alipour/rabin/kconfig/recycle/swarm_24h/gcc_24h"
m_args=""
m_version=""
m_run=""
m_tc=0
m_centroids=134 #by xmeans_centroids.py
m_limit=1*60*60*2 #hour in second
...
function exec_csmith {
    ...
    if [ "$m_args" = "swarm" ]; then
        args=`python /project/alipour/rabin/kconfig/scripts/swarm_csmith_args.py`
        /project/alipour/rabin/scripts/csmith.sh $args > $m_path_input/$m_tc.c
    elif [ "$m_args" = "kconfig" ]; then
        c=$((m_tc % m_centroids - 1))
        args=`python /project/alipour/rabin/kconfig/scripts/kconfig_csmith_args.py $c`
        /project/alipour/rabin/scripts/csmith.sh $args > $m_path_input/$m_tc.c
    else
