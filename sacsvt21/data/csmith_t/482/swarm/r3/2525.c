...
{ /* block id: 0 */
    ...
    int32_t l_12 = 0L;
    for (l_2 = (-6); (l_2 < (-25)); l_2--)
    { /* block id: 3 */
        uint8_t l_5 = 0UL;
        int32_t l_6 = 0x12491E29L;
        l_6 = (l_5 , l_2);
        return l_2;
    }
    l_12 |= ((uint32_t)func_9(l_2) - (uint32_t)func_9(l_2));
    return l_12;
}
