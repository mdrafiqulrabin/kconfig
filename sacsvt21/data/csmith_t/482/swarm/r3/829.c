 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --no-consts --no-divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --no-longlong --int8 --uint8 --float --math64 --inline-function --no-muls --no-safe-math --no-packed-struct --paranoid --pointers --structs --no-unions --no-volatiles --no-volatile-pointers --const-pointers --global-variabless --no-builtins
 * Seed:      2397037976
 */
...
/* --- GLOBAL VARIABLES --- */
static struct S1 g_4 = {{0x67F5},{0xD9A9},246U,0xC.011151p+44,-764,0xBA09,0xA97963BA,1U,0x5AE649F6};
...
int main (void)
{
    ...
    transparent_crc_bytes (&g_4.f3, sizeof(g_4.f3), "g_4.f3", print_hash_value);
