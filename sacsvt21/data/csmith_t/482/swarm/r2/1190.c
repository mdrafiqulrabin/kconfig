...
{ /* block id: 0 */
    int32_t l_2 = 6L;
    float l_4 = 0x1.ED080Cp+9;
    float *l_3 = &l_4;
    union U1 l_6 = {0xA2A3L};
    union U1 *l_5 = &l_6;
    union U1 **l_7 = &l_5;
    (*l_3) = l_2;
    (*l_7) = l_5;
