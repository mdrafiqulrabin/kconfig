...
static int32_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_6 = 2L;
    union U3 l_7 = {1L};
    l_7.f0 = (((int16_t)(((uint32_t)l_6 - (uint32_t)l_6) || (0x49AAL < (l_7 , (-1L)))) << (int16_t)9) < l_6);
    return l_6;
}
