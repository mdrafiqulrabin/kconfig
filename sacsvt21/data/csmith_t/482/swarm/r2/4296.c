 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --no-bitfields --comma-operators --no-compound-assignment --consts --divs --embedded-assigns --pre-incr-operator --pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --no-float --no-math64 --no-inline-function --no-muls --safe-math --packed-struct --paranoid --pointers --no-structs --unions --no-volatiles --volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      1335439420
 */
...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_5 = 0xB22124F8;
static int16_t g_15 = 0x653D;
static int32_t g_36 = 0x09E71B35;
...
/* ------------------------------------------ */
/* 
 * reads : g_15 g_35 g_5 g_36
 * writes: g_15
 */
static int32_t  func_32(void)
{ /* block id: 36 */
    for (g_15 = 10; (g_15 != (-21)); g_15--)
    { /* block id: 39 */
        int32_t *l_37 = &g_36;
        l_37 = g_35;
        return g_5;
