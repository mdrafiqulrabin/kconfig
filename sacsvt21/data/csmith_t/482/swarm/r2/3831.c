...
inline static uint16_t  func_28(void)
{ /* block id: 36 */
    for (g_3 = 0; (g_3 == 12); g_3 = safe_add_func_int16_t_s_s(g_3, 8))
    { /* block id: 39 */
        return g_3;
    }
    return g_3;
