 ...
 * Git version: 30dccd7
 * Options:   --argc --arrays --bitfields --no-comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --uint8 --float --no-math64 --no-inline-function --no-muls --no-safe-math --packed-struct --no-paranoid --pointers --no-structs --no-unions --volatiles --no-volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      3113588224
 */
...
static int32_t g_34 = 0xFAA32F3F;
static int32_t *g_33 = &g_34;


/* --- FORWARD DECLARATIONS --- */
static uint8_t  func_25(void);
static int32_t * func_26(float  p_27, int8_t  p_28, int32_t * p_29, int8_t  p_30, int32_t  p_31);
...
{ /* block id: 36 */
    ...
    int32_t *l_37 = &g_34;
    int32_t **l_38 = &g_33;
    (*l_38) = func_26(l_32, g_3, g_33, ((int16_t)g_34 + (int16_t)g_34), ((void*)0 != l_37));
    return (*l_37);
}
