...
static volatile int32_t g_3 = 0x2B1CECB4L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0x02D149FEL;
static int32_t g_10 = 0xA29C1464L;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_11 = 0x7182ABBFL;
    int32_t *l_12[3];
    uint32_t l_13 = 1UL;
    int i;
    for (i = 0; i < 3; i++)
