...
static int32_t g_5 = 0xFDDD3F46L;
static int8_t g_14 = 0x89L;
static int32_t g_16 = 0xB6BC3EC3L;
...
/* 
 * reads : g_5 g_16 g_4
 * writes: g_5 g_14 g_16
 */
static uint64_t  func_1(void)
{ /* block id: 0 */
    for (g_5 = 0; (g_5 != (-27)); g_5 = safe_sub_func_int32_t_s_s(g_5, 9))
    { /* block id: 3 */
        uint16_t l_10 = 65528UL;
        int8_t *l_13 = &g_14;
        int32_t *l_15 = &g_16;
        (*l_15) |= (safe_mul_func_uint64_t_u_u(l_10, (g_5 > ((*l_13) = (safe_add_func_uint16_t_u_u(1UL, 65529UL))))));
        for (g_16 = (-2); (g_16 < (-27)); g_16--)
        { /* block id: 8 */
            return g_4;
        }
    }
