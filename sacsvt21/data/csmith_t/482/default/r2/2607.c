...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[3] = {0x43EB6069L,0x43EB6069L,0x43EB6069L};
static int32_t * volatile g_3[3][1] = {{&g_4[0]},{&g_4[0]},{&g_4[0]}};
static union U0 g_6 = {0x61C71BC7DCD66A07LL};/* VOLATILE GLOBAL g_6 */
