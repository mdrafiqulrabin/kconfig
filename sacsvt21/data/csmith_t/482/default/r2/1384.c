...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0x7FA5C62EL;
static int64_t g_12[4] = {(-1L),(-1L),(-1L),(-1L)};
static int8_t g_14[9] = {8L,8L,8L,8L,8L,8L,8L,8L,8L};
static volatile int8_t g_15 = (-7L);/* VOLATILE GLOBAL g_15 */
static uint64_t g_16 = 0xB66FEBFB2C41AC3DLL;
