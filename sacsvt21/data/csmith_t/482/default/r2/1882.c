...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x4B25B3B9L;
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_3;
    int32_t *l_6 = &g_3;
    int32_t *l_7[10] = {(void*)0,&g_3,(void*)0,(void*)0,&g_3,(void*)0,&g_3,(void*)0,(void*)0,&g_3};
    uint16_t l_11 = 0xD6B9L;
    uint16_t l_12[4];
    int i;
    for (i = 0; i < 4; i++)
        l_12[i] = 65535UL;
    ++g_8;
    l_12[2] &= ((((l_11 || 0xD6L) > g_3) != 0x84E5A945L) , 0L);
    return g_8;
}
