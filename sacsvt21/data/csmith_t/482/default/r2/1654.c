...
/* --- GLOBAL VARIABLES --- */
static int8_t g_5[4][1][9] = {{{0xAAL,0xDDL,5L,5L,0xDDL,0xAAL,0xF1L,7L,5L}},{{0L,0xEFL,0xAAL,5L,0x38L,0L,0L,0x38L,5L}},{{1L,0xDDL,1L,0xAAL,0x38L,1L,0xF1L,0x9CL,0xAAL}},{{1L,0x38L,0xAAL,1L,0xDDL,1L,0xAAL,0x38L,1L}}};
static int8_t g_8 = (-1L);
static uint32_t g_9 = 0xDAD5A519L;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int8_t *l_4 = &g_5[1][0][4];
    int32_t l_6 = 0L;
    int32_t *l_7 = (void*)0;
    int32_t *l_10 = &l_6;
    (*l_10) = (g_9 ^= (g_8 = ((safe_div_func_int8_t_s_s((l_4 != l_4), g_5[1][0][5])) != l_6)));
    g_11[1] = (void*)0;
    (*l_10) &= 1L;
    return g_5[0][0][3];
}
