...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[3] = {0xED065768L,0xED065768L,0xED065768L};
...
{ /* block id: 0 */
    ...
    int64_t l_7 = 0L;
    int8_t l_8 = 0x46L;
    int32_t l_9 = 0x77D98A9AL;
    int8_t l_10 = 0xBEL;
    uint32_t l_11 = 0x1695EA98L;
    int i;
    for (i = 0; i < 3; i++)
        l_6[i] = (void*)0;
    l_11--;
...
XXX times a pointer is qualified to be dereferenced: 183
