...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x3C39BA09L;
static int8_t g_7 = 0xC5L;
static volatile int32_t g_8 = 0xA065C2DDL;/* VOLATILE GLOBAL g_8 */
static int16_t g_9 = 0L;
static volatile uint32_t g_11 = 0x6BE856DFL;/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    int16_t l_10[7] = {0xB2C4L,0xB2C4L,0xB2C4L,0xB2C4L,0xB2C4L,0xB2C4L,0xB2C4L};
    int i;
    g_11--;
    return g_8;
}
