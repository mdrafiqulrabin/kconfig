...
static int32_t g_6 = 0xBF8F0AA6L;
...
{ /* block id: 0 */
    ...
    for (g_2 = 0; (g_2 > (-26)); g_2 = safe_sub_func_int8_t_s_s(g_2, 4))
    { /* block id: 3 */
        for (g_6 = 20; (g_6 >= (-27)); g_6 = safe_sub_func_uint16_t_u_u(g_6, 7))
        { /* block id: 6 */
            int32_t *l_9 = &g_10;
            int32_t *l_11[7] = {&g_10,&g_10,&g_10,&g_10,&g_10,&g_10,&g_10};
            int i;
            ++g_12;
        }
    }
