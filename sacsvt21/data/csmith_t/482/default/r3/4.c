...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_2 = {0xB5C6EFF3L,0xE036L,0xBD697E78L,0xCA9F8D19L,0x92L,0x4A9BL};/* VOLATILE GLOBAL g_2 */
static union U2 g_4 = {65534UL};/* VOLATILE GLOBAL g_4 */
...
static union U2  func_1(void)
{ /* block id: 0 */
    volatile struct S0 *l_3[4] = {&g_2,&g_2,&g_2,&g_2};
    int i;
    g_2 = g_2;
    return g_4;
}
