...
static int32_t g_7 = 0xCE96B779L;
static int32_t *g_6[9] = {&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7};
static int32_t *g_8[10] = {&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[9] = {0UL,0UL,0xEF72D4EAL,0UL,0UL,0xEF72D4EAL,0UL,0UL,0xEF72D4EAL};
    int i;
