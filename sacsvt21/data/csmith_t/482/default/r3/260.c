...
{ /* block id: 0 */
    ...
    int32_t *l_13 = &l_11;
    int32_t *l_14 = &l_11;
    int32_t *l_15[10] = {&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4,&g_4};
    int16_t l_16 = 0xCF45L;
    uint32_t l_18 = 18446744073709551608UL;
    int i;
    (*l_6) &= l_2;
    for (g_4 = 0; (g_4 > (-17)); g_4 = safe_sub_func_int8_t_s_s(g_4, 1))
    { /* block id: 4 */
        return (*l_6);
    }
    l_18--;
...
XXX times a pointer is qualified to be dereferenced: 286
