...
static struct S0 g_20 = {208,1,8113,3210,0xE483BBB6L,0};/* VOLATILE GLOBAL g_20 */
...
{ /* block id: 0 */
    ...
    int32_t *l_12 = &g_6;
    int32_t *l_13 = &g_6;
    int32_t *l_14[6][4] = {{&g_6,&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6,&g_6}};
    int32_t l_15 = (-2L);
    int i, j;
    (*l_5) ^= (safe_rshift_func_uint8_t_u_u(g_4, 0));
    g_17++;
    return g_20;
}
