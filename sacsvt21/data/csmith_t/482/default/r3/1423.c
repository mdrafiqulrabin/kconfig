...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_4 = {1UL,0xE0L};
static struct S0 * volatile g_3[5] = {&g_4,&g_4,&g_4,&g_4,&g_4};
static struct S0 * volatile g_5[2] = {(void*)0,(void*)0};
static struct S0 * const  volatile g_6 = &g_4;/* VOLATILE GLOBAL g_6 */
