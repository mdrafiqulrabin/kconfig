...
static int32_t g_10 = 0x2A2B3B7BL;
static int32_t *g_9[2] = {&g_10,&g_10};
...
{ /* block id: 0 */
    int32_t *l_7 = &g_4;
    for (g_4 = 0; (g_4 != (-28)); g_4 = safe_sub_func_int32_t_s_s(g_4, 4))
    { /* block id: 3 */
        int32_t **l_8[1][3][9] = {{{&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7},{&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7},{&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7}}};
        int i, j, k;
        g_9[1] = l_7;
    }
    return g_3;
