...
static int16_t g_8 = 0xD5DEL;
static volatile uint16_t g_10 = 0x199EL;/* VOLATILE GLOBAL g_10 */
static const union U1 g_13 = {0};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4 = &g_3;
    int32_t *l_5[3][7] = {{&g_3,&g_3,(void*)0,(void*)0,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,(void*)0,&g_3,&g_3,&g_3}};
    int32_t l_6 = 0L;
    int32_t l_9 = 0L;
    int i, j;
    ++g_10;
