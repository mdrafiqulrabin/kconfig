...
/* --- GLOBAL VARIABLES --- */
static volatile int64_t g_2[4] = {0x3B4E1A3622BA3946LL,0x3B4E1A3622BA3946LL,0x3B4E1A3622BA3946LL,0x3B4E1A3622BA3946LL};
...
{ /* block id: 0 */
    ...
    int32_t *l_8 = &l_6;
    int32_t *l_9 = (void*)0;
    int32_t *l_10[5] = {&l_6,&l_6,&l_6,&l_6,&l_6};
    int32_t l_11 = 6L;
    uint32_t l_12 = 0x4F9A325CL;
    int i;
    l_12--;
    return g_2[0];
}
