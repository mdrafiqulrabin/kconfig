...
static int64_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[3][10] = {{1UL,0xF4L,0x82L,0x82L,0xF4L,1UL,0x95L,2UL,0x82L,0x95L},{1UL,0xF4L,255UL,2UL,0xF4L,255UL,0xF4L,2UL,255UL,0xF4L},{1UL,0x95L,0x82L,2UL,0x95L,1UL,0xF4L,0x82L,0x82L,0xF4L}};
    int32_t l_4 = (-9L);
    int32_t *l_8 = &l_4;
    int32_t *l_9 = &l_4;
    int32_t *l_10 = &l_4;
    ...
    int i, j;
    l_4 ^= l_2[1][0];
    for (l_4 = (-19); (l_4 != 8); l_4 = safe_add_func_int8_t_s_s(l_4, 1))
    { /* block id: 4 */
        uint16_t l_7 = 0x1A9CL;
        if (l_7)
            break;
    }
    g_13++;
