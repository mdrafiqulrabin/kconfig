...
/* --- GLOBAL VARIABLES --- */
static int32_t g_10 = 0x89226C31L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_8 = 0xDFE0091DL;
    int32_t *l_9[8] = {&g_10,&g_10,&g_10,&g_10,&g_10,&g_10,&g_10,&g_10};
    int i;
    g_10 = (safe_rshift_func_uint8_t_u_s((safe_mul_func_int8_t_s_s(2L, (safe_rshift_func_uint8_t_u_u(l_8, 0)))), 5));
    g_10 = g_10;
    return g_10;
}
