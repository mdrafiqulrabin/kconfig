...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_2[10] = {0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL,0xC45CL};
static int32_t g_5 = 0x5DE05DAEL;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_3 = 0x318D5816210B999FLL;
    int32_t *l_4 = &g_5;
    (*l_4) |= (l_3 = g_2[4]);
    (*l_4) &= 0xD00585B7L;
    return (*l_4);
