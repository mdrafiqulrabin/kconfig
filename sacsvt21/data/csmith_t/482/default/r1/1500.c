...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x37400631L;/* VOLATILE GLOBAL g_2 */
static int32_t g_3 = 0xCAFE8B0DL;
static union U3 g_6 = {18446744073709551613UL};
...
static union U3  func_1(void)
{ /* block id: 0 */
    for (g_3 = (-5); (g_3 < (-7)); g_3 = safe_sub_func_uint32_t_u_u(g_3, 1))
    { /* block id: 3 */
        return g_6;
    }
    return g_6;
