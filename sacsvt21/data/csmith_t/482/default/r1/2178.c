...
/* --- GLOBAL VARIABLES --- */
static int32_t g_6[3] = {0x33037736L,0x33037736L,0x33037736L};
static int16_t g_7 = 0x2FD2L;
...
{ /* block id: 0 */
    int32_t *l_4 = (void*)0;
    int32_t *l_5 = &g_6[0];
    struct S0 l_8 = {0x38EC3268L,679,0xBEL,0x6D238E48L};
    g_7 &= ((*l_5) = (safe_lshift_func_int8_t_s_u((0L == 0L), 0)));
