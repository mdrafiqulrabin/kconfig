...
/* --- GLOBAL VARIABLES --- */
static const volatile uint32_t g_4 = 0xDAE5A60DL;/* VOLATILE GLOBAL g_4 */
static const uint32_t g_5 = 5UL;
static int32_t g_8 = 0xAD9BACC5L;
...
{ /* block id: 0 */
    int32_t *l_6 = (void*)0;
    int32_t *l_7 = &g_8;
    (*l_7) ^= (safe_mod_func_int32_t_s_s(g_4, (g_5 , 0x4CCB63E8L)));
    return (*l_7);
}
