...
static int16_t  func_31(void)
{ /* block id: 36 */
    int32_t l_36 = 0x20B28787;
    int32_t l_39 = 0xCC5C6A3F;
    int32_t l_40 = 0xE1D4595A;
    l_40 |= __builtin_parityl((l_39 = ((4294967294U || ((int16_t)((uint16_t)l_36 >> (uint16_t)((l_36 != (((int16_t)0x4465 << (int16_t)15) & l_36)) | l_36)) + (int16_t)l_36)) == (-8))));
    return l_40;
}
