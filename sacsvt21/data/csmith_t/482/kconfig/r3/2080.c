...
/* --- GLOBAL VARIABLES --- */
static int8_t g_3 = 1;
static int32_t g_5 = 0xD62E6525;
static int32_t g_6[2] = {0xBC35240C,0xBC35240C};
...
inline static uint16_t  func_1(void)
{ /* block id: 0 */
    int8_t *l_2[1][2][8] = {{{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3}}};
    int32_t *l_4[7];
    int i, j, k;
    for (i = 0; i < 7; i = i + 1)
        l_4[i] = &g_5;
    g_5 = ((void*)0 == l_2[0][1][4]);
    for (g_3 = 0; g_3 < 1; g_3 += 1)
    {
        for (g_5 = 0; g_5 < 2; g_5 += 1)
        {
            for (g_6[0] = 0; g_6[0] < 8; g_6[0] += 1)
            {
                l_2[g_3][g_5][g_6[0]] = &g_3;
            }
        }
    }
    for (g_5 = 0; g_5 < 2; g_5 += 1)
