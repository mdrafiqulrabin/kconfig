...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2[3] = {0UL,0UL,0UL};
static volatile float g_5 = 0x0.7p-1;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    ...
    volatile float *l_4[5][2] = {{&g_5,&g_5},{&g_5,&g_5},{&g_5,&g_5},{&g_5,&g_5},{&g_5,&g_5}};
    int i, j;
    g_5 = g_2[2];
    return g_2[2];
}
