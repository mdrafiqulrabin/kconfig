...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0x432A2768L;
    int32_t *l_14 = &l_4;
    int32_t **l_15 = &l_14;
    int64_t l_16 = (-1L);
    (*l_14) = ((uint16_t)(l_4 < ((int8_t)l_4 >> (int8_t)4)) - (uint16_t)(l_4 | (((int8_t)(-(uint64_t)(((uint8_t)(0x81A7ECC2L || 0x3AC46DDCL) << (uint8_t)((uint16_t)(l_4 == 0UL) - (uint16_t)(l_4 == 0xB2L))) , l_4)) >> (int8_t)7) ^ 0xA6EDL)));
    (*l_14) = (*l_14);
    (*l_15) = (void*)0;
    return l_16;
}
