...
static uint16_t g_15 = 0x9A80;
static union U2 g_29 = {{0x6.D1B713p-96}};/* VOLATILE GLOBAL g_29 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_29.f0.f0, sizeof(g_29.f0.f0), "g_29.f0.f0", print_hash_value);
