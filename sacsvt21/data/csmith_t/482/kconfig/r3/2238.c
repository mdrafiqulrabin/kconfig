...
{ /* block id: 0 */
    int32_t l_2 = 3L;
    for (l_2 = (-11); (l_2 > (-20)); l_2 = safe_sub_func_int64_t_s_s(l_2, 9))
    { /* block id: 3 */
        const int32_t *l_5[2][7] = {{&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2}};
        const int32_t **l_6 = &l_5[1][0];
        int i, j;
        (*l_6) = l_5[1][0];
    }
    return l_2;
