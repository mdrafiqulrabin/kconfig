...
static struct S4 g_30 = {250UL,0x88L,0xDFL,0xAB2BC8F9L,18446744073709551615UL,6UL,{0x38B4B72BL,0x0.Cp-1,1UL,0x6CL,0x53L,0x770CL,0x404D4644688D239BLL,0x99B96BC7L},9UL,1L,0x9EA4087BL};/* VOLATILE GLOBAL g_30 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_30.f6.f1, sizeof(g_30.f6.f1), "g_30.f6.f1", print_hash_value);
    ...
    transparent_crc(g_30.f6.f6, "g_30.f6.f6", print_hash_value);
    transparent_crc(g_30.f6.f7, "g_30.f6.f7", print_hash_value);
