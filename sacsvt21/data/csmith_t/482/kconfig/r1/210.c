...
static int8_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[5][8] = {{4UL,252UL,0UL,0UL,252UL,4UL,252UL,0UL},{2UL,252UL,2UL,4UL,4UL,2UL,252UL,2UL},{0x1FL,4UL,0UL,4UL,0x1FL,0x1FL,4UL,0UL},{0x1FL,0x1FL,4UL,0UL,4UL,0x1FL,0x1FL,4UL},{2UL,4UL,4UL,2UL,252UL,2UL,4UL,4UL}};
    int i, j;
    return l_2[1][0];
}
