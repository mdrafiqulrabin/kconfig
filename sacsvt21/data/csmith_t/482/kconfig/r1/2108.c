...
{ /* block id: 0 */
    uint8_t l_14 = 1UL;
    int16_t l_21 = 0xD24BL;
    int8_t l_22[3];
    int32_t *l_23 = (void*)0;
    int32_t *l_24 = (void*)0;
    int32_t l_25 = 0xB0881DDAL;
    int i;
    for (i = 0; i < 3; i++)
        l_22[i] = 1L;
    l_25 = (((((safe_rshift_func_int16_t_s_u(((safe_rshift_func_uint16_t_u_s((safe_div_func_int32_t_s_s((safe_add_func_uint8_t_u_u(((-1L) != (l_14 != ((l_14 < l_14) == ((safe_div_func_uint8_t_u_u(l_14, 0x68L)) < l_14)))), (((safe_rshift_func_uint16_t_u_s((l_14 ^ ((safe_lshift_func_int16_t_s_s(l_14, 3)) ^ l_21)), l_21)) == 0xBEL) < l_22[0]))), l_21)), 3)) < l_22[2]), 8)) >= l_22[0]) >= 0L) || 0xE809L) > l_21);
    return l_14;
}
