...
static int16_t  func_27(void)
{ /* block id: 36 */
    uint32_t l_32 = 0x266D210E;
    int32_t *l_37 = (void*)0;
    int32_t l_39 = 0;
    int32_t *l_38 = &l_39;
    int32_t l_41 = 1;
    int32_t *l_40 = &l_41;
    uint16_t l_42 = 0xEE49;
    (*l_40) = ((*l_38) = ((int32_t)((uint16_t)l_32 << (uint16_t)3) - (int32_t)(((int16_t)__builtin_popcount(l_32) >> (int16_t)l_32) >= ((int16_t)(-9) << (int16_t)14))));
    return l_42;
}
