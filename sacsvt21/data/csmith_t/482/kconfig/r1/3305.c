...
{ /* block id: 36 */
    ...
    int32_t l_60 = 0xB4AB19F8L;
    int32_t l_61 = (-7L);
    uint32_t l_62[9] = {4294967292UL,4294967292UL,4294967292UL,4294967292UL,4294967292UL,4294967292UL,4294967292UL,4294967292UL,4294967292UL};
    float l_65[6];
    int8_t l_66 = 0L;
    int i;
    for (i = 0; i < 6; i++)
