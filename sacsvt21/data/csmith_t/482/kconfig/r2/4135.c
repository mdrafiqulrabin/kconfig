...
/* --- GLOBAL VARIABLES --- */
static const float g_6 = (-0x10.4p+1);
...
static int16_t  func_1(void)
{ /* block id: 0 */
    const int64_t l_11 = 5L;
    int32_t *l_12 = &g_13;
    (*l_12) ^= ((safe_rshift_func_int8_t_s_u((safe_mod_func_int32_t_s_s(g_7, (safe_sub_func_uint32_t_u_u(g_10, g_10)))), 0)) >= l_11);
    return g_10;
}
