...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_7 = 0xB02971C1EC2DB221LL;
static const uint64_t g_17 = 0x653D42374B1B055CLL;
static float g_36 = 0x0.Ep+1;
static float * volatile g_35 = &g_36;/* VOLATILE GLOBAL g_35 */
...
inline static uint32_t  func_31(void)
{ /* block id: 36 */
    for (g_7 = 24; (g_7 != 42); g_7 = safe_add_func_uint16_t_u_u(g_7, 9))
    { /* block id: 39 */
        int8_t l_34 = (-10L);
        (*g_35) = l_34;
    }
