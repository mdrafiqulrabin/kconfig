...
{ /* block id: 0 */
    ...
    int i;
    for (i = 0; i < 1; i++)
        l_2[i] = 0x3.FAA32Fp-51;
    for (g_3 = 0; (g_3 <= 0); g_3 += 1)
    { /* block id: 3 */
        int8_t l_4[4][10] = {{(-1L),(-4L),(-4L),(-1L),0xFFL,0L,0xFFL,(-1L),(-4L),(-4L)},{0xFFL,(-4L),(-1L),(-5L),(-5L),(-1L),(-4L),0xFFL,(-4L),(-1L)},{0L,(-1L),(-5L),(-1L),0L,(-1L),(-1L),0L,(-1L),(-5L)},{0xFFL,0xFFL,(-5L),0L,0xA1L,0L,(-5L),0xFFL,0xFFL,(-5L)}};
        int i, j;
        if (g_3)
            break;
        return l_4[3][4];
