...
static volatile int16_t g_29 = 1;/* VOLATILE GLOBAL g_29 */
static volatile int16_t g_30 = (-3);/* VOLATILE GLOBAL g_30 */
static volatile uint8_t g_32 = 0xB9;/* VOLATILE GLOBAL g_32 */
...
{ /* block id: 36 */
    int32_t l_26[3];
    int32_t l_27 = 0xF1F13B01;
    int32_t l_28 = 0xC619A80B;
    int32_t l_31 = (-1);
    int i;
    for (i = 0; i < 3; i++)
        l_26[i] = 3;
