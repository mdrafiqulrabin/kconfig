...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2 = 0x4C506D44;/* VOLATILE GLOBAL g_2 */
static int32_t g_4 = 0x7C8A6B95;
static union U0 g_8 = {4294967295U};/* VOLATILE GLOBAL g_8 */
...
static union U0  func_1(void)
{ /* block id: 0 */
    volatile uint32_t l_3 = 1U;/* VOLATILE GLOBAL l_3 */
    l_3 = g_2;
    for (g_4 = 0; (g_4 < 17); g_4 += 7)
    { /* block id: 4 */
        volatile int16_t l_7 = 0x9D78;/* VOLATILE GLOBAL l_7 */
        l_7 = g_2;
        if (l_7)
            break;
    }
