...
static uint8_t  func_34(void)
{ /* block id: 36 */
    int32_t l_37 = 0xDE9829CBL;
    int32_t *l_36[5][4] = {{&l_37,&l_37,&l_37,&l_37},{&l_37,&l_37,&l_37,&l_37},{&l_37,&l_37,&l_37,&l_37},{&l_37,&l_37,&l_37,&l_37},{&l_37,&l_37,&l_37,&l_37}};
    int32_t l_38 = 0x07B3925BL;
    int32_t l_39[3];
    int i, j;
    for (i = 0; i < 3; i++)
        l_39[i] = 0L;
    l_38 &= ((safe_unary_minus_func_int16_t_s(0x2A0CL)) ^ 1UL);
    return l_39[0];
}
