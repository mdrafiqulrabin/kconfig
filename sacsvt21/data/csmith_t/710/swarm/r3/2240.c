...
static int32_t  func_1(void)
{ /* block id: 0 */
    const uint32_t l_2 = 0x87DF2F4AL;
    int32_t *l_3 = (void*)0;
    int32_t l_5[7] = {0xAC488899L,0xC3EEE2FDL,0xAC488899L,0xAC488899L,0xC3EEE2FDL,0xAC488899L,0xAC488899L};
    int32_t *l_4 = &l_5[4];
    uint32_t l_6 = 0x6890C544L;
    int i;
    (*l_4) ^= ((l_2 < l_2) , 0L);
    return l_6;
}
