...
/* --- GLOBAL VARIABLES --- */
static int16_t g_4 = 0x838AL;
static float g_6 = 0xF.C3099Cp+92;
...
{ /* block id: 0 */
    uint32_t l_5 = 4UL;
    int32_t l_8 = 0x845D811FL;
    l_8 &= ((int16_t)g_4 % (int16_t)l_5);
    return l_8;
}
