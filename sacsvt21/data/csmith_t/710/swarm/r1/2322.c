...
/* --- GLOBAL VARIABLES --- */
static float g_2[2] = {0x4.7862FDp-27,0x4.7862FDp-27};
static uint8_t g_3[8] = {0x57L,0x57L,0x57L,0x57L,0x57L,0x57L,0x57L,0x57L};
