...
{ /* block id: 0 */
    uint8_t l_2 = 0UL;
    (*g_3) = l_2;
    for (l_2 = (-30); (l_2 != 2); l_2 = safe_add_func_int32_t_s_s(l_2, 8))
    { /* block id: 4 */
        return g_7;
    }
    return g_7;
