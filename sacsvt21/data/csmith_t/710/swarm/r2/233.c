...
inline static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3 = 0x19C5A654;
    int32_t *l_2 = &l_3;
    const int32_t *l_5 = &l_3;
    const int32_t **l_4 = &l_5;
    int32_t l_6 = 0xDF82D83D;
    (*l_4) = l_2;
    return l_6;
}
