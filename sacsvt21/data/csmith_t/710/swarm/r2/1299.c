...
static uint32_t  func_33(void)
{ /* block id: 36 */
    int32_t l_34 = 0x44CF5927L;
    int32_t l_36 = 0L;
    int32_t *l_35 = &l_36;
    uint32_t l_37 = 0x64F6CBCBL;
    (*l_35) = l_34;
    (*l_35) = ((*l_35) >= (*l_35));
    return l_37;
}
