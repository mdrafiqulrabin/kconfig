...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_4 = {0UL,-1L,0x310FL,0L,-10L};
...
static struct S0  func_1(void)
{ /* block id: 0 */
    struct S0 l_2 = {0x845D811FL,0L,6UL,0L,5L};
    struct S0 *l_3 = &l_2;
    (*l_3) = l_2;
    return g_4;
}
