...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2 = 0x5BAF43B7L;/* VOLATILE GLOBAL g_2 */
static volatile float g_5 = (-0x10.Ep-1);/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_8 = (-4L);/* VOLATILE GLOBAL g_8 */
static int32_t g_9 = 0xA9C4C8D3L;
static volatile uint32_t g_15 = 18446744073709551607UL;/* VOLATILE GLOBAL g_15 */
static volatile int32_t *g_16 = &g_8;
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    volatile float *l_3 = (void*)0;
    volatile float *l_4 = &g_5;
    ...
    { /* block id: 5 */
        uint16_t l_12 = 8UL;
        (*l_4) = ((-0x1.1p+1) != (l_12 < ((float)l_12 / (float)g_15)));
        g_16 = &g_8;
    }
    return g_2;
}
...
XXX percentage of non-volatile access: 68.8
