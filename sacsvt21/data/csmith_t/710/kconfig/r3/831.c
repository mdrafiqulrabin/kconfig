...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xC62E0897;/* VOLATILE GLOBAL g_2 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3 = 0x56A3367F;
    uint16_t l_11 = 65535U;
    l_3 = (g_2 <= l_3);
    l_11 = (func_4(g_2, l_3) <= 7U);
    g_2 = 0x065C2DD7;
    return g_2;
}
...
static int16_t  func_4(uint32_t  p_5, uint32_t  p_6)
{ /* block id: 2 */
    int32_t l_10 = 0x4AD38DC5;
    for (p_5 = 0; (p_5 > 14); p_5 += 4)
    { /* block id: 5 */
        volatile int32_t l_9 = 2;/* VOLATILE GLOBAL l_9 */
        l_9 = g_2;
    }
    return l_10;
}
...
XXX percentage of non-volatile access: 53.8
