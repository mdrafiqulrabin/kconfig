...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_3 = 0x67;
static uint32_t g_46[4][1][2] = {{{0xC4EA3C91,0xC4EA3C91}},{{0xC4EA3C91,0xC4EA3C91}},{{0xC4EA3C91,0xC4EA3C91}},{{0xC4EA3C91,0xC4EA3C91}}};
...
{ /* block id: 36 */
    uint16_t l_38 = 6U;
    int32_t l_47 = 0x24FF2426;
    int32_t l_48 = 0x8A5F0362;
    for (g_3 = 0; (g_3 <= 17); g_3++)
    { /* block id: 39 */
        int32_t l_45[8] = {(-7),(-7),(-7),(-7),(-7),(-7),(-7),(-7)};
        int i;
        l_48 |= (safe_sub_func_int16_t_s_s((~(((((safe_rshift_func_uint16_t_u_u(7U, 10)) != 0x12) | (65535U ^ ((l_38++) < ((__builtin_ctzll(g_3) > ((safe_lshift_func_int8_t_s_s(g_3, 1)) ^ 6)) && g_3)))) == (g_46[1][0][1] ^= (safe_add_func_uint32_t_u_u(g_3, l_45[6])))) <= g_3)), l_47));
    }
    return g_46[1][0][1];
}
