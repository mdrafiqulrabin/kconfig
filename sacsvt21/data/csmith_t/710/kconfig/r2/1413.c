...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0x8B108F82L;
static int32_t g_23 = 0xC25B054DL;
static volatile union U0 g_29 = {0x741311E2L};/* VOLATILE GLOBAL g_29 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_23 g_29 g_29.f1 g_32 g_34
 * writes: g_32 g_34
 */
inline static int64_t  func_28(void)
{ /* block id: 36 */
    const float l_30 = 0x1.6p-1;
    uint16_t *l_31 = &g_32;
    int32_t *l_33 = &g_34;
    (*l_33) |= ((((__builtin_bswap32((g_3 >= g_23)) || g_3) && 0x36745799333C7D24LL) , ((g_29 , g_29.f1) > 0UL)) == (((*l_31) ^= g_23) > 1L));
    return (*l_33);
}
