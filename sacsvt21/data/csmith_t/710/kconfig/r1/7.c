...
{ /* block id: 36 */
    ...
    int32_t **l_30 = &l_31;
    int32_t l_43 = (-1);
    uint32_t l_44 = 0x8C245E32;
    uint16_t l_45 = 0U;
    (*l_30) = (void*)0;
    l_45 = (((void*)0 == &l_31) & ((int32_t)0xB2C41AC3 % (int32_t)((int16_t)l_32 >> (int16_t)(((uint16_t)((int16_t)l_32 + (int16_t)l_32) + (uint16_t)((l_32 < l_32) | __builtin_bswap64((((int16_t)((((l_43 < l_43) != l_32) ^ 6U) , l_43) - (int16_t)l_32) , 9U)))) ^ l_44))));
    return l_45;
}
