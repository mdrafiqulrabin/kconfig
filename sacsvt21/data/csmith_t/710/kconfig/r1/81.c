...
{ /* block id: 36 */
    int32_t l_33 = 1L;
    float l_35[4][4] = {{(-0x5.9p+1),0xF.F3B8CFp-23,0x1.Ap-1,0x1.Ap-1},{0xA.F9031Ep-6,0xA.F9031Ep-6,(-0x5.9p+1),0x1.Ap-1},{0x1.7p-1,0xF.F3B8CFp-23,0x1.7p-1,(-0x5.9p+1)},{0x1.7p-1,(-0x5.9p+1),(-0x5.9p+1),0x1.7p-1}};
    float *l_34 = &l_35[2][2];
    uint16_t l_36[2];
    int i, j;
    for (i = 0; i < 2; i++)
        l_36[i] = 0x7C6DL;
    (*l_34) = (safe_add_func_float_f_f(l_33, l_33));
    return l_36[1];
}
