...
{ /* block id: 36 */
    int32_t l_30 = (-2L);
    uint16_t l_33 = 0x00C4L;
    int32_t *l_38 = &l_30;
    int32_t l_39 = 0x55FFF839L;
    for (l_30 = 0; (l_30 <= 2); l_30 = safe_add_func_int8_t_s_s(l_30, 1))
    { /* block id: 39 */
        int32_t l_35 = 0x611BC383L;
        int32_t *l_34 = &l_35;
        (*l_34) &= l_33;
        for (l_35 = (-20); (l_35 != 24); l_35 = safe_add_func_int32_t_s_s(l_35, 1))
        { /* block id: 43 */
            if (l_30)
                break;
        }
    }
    (*l_38) ^= __builtin_ctzl(l_33);
    return l_39;
}
