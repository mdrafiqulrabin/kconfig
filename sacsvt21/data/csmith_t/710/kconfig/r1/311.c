...
{ /* block id: 0 */
    ...
    l_2 = 0x77862FD4;
    l_3 = 3;
    l_3 = (l_2 || ((int32_t)l_2 - (int32_t)((((uint16_t)l_2 << (uint16_t)0) && (((int32_t)0x3FF14EB4 % (int32_t)((uint32_t)l_3 + (uint32_t)((~l_2) & ((uint32_t)l_3 + (uint32_t)l_2)))) || ((((((l_2 <= l_3) & l_2) && 0U) && l_3) & l_3) ^ 0x6AC3))) || 0x0813)));
    return l_3;
}
