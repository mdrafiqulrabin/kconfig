...
inline static uint32_t  func_26(void)
{ /* block id: 36 */
    int32_t l_27 = 0xF6D4A0D4;
    int32_t l_30 = (-1);
    int32_t l_40 = 1;
    for (l_27 = (-9); (l_27 != 4); l_27 += 1)
    { /* block id: 39 */
        int32_t l_31 = 0x9CB0BEFC;
        int32_t l_41 = 0x05300CE3;
        int32_t l_42 = 4;
        l_42 = (l_41 = (((l_30 = (0xAF5BFB66 >= l_27)) && l_31) != (((int16_t)((uint16_t)l_31 * (uint16_t)((int16_t)(l_31 > ((int16_t)l_31 % (int16_t)(l_40 = __builtin_ctzl(l_27)))) << (int16_t)l_31)) % (int16_t)l_31) > 0x1883)));
    }
    l_30 = 0xBBE26B5C;
    return l_40;
}
