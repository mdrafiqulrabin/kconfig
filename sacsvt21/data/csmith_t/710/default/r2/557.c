...
static union U4 g_11[1] = {{0x65L}};
static volatile union U4 *g_12 = (void*)0;
...
{ /* block id: 0 */
    ...
    union U4 **l_5 = (void*)0;
    union U4 **l_6 = (void*)0;
    const union U4 **l_7 = (void*)0;
    union U4 **l_8 = (void*)0;
    union U4 *l_10 = &g_11[0];
    union U4 **l_9[8] = {&l_10,&l_10,&l_10,&l_10,&l_10,&l_10,&l_10,&l_10};
    int i;
    (*g_3) = (0xAEL > l_2);
    g_12 = (void*)0;
    return g_11[0].f0;
