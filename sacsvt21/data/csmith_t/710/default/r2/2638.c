...
static uint16_t g_7 = 0xEDEDL;
static int64_t g_11 = 0xB6DAD816F93BD5DELL;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_2 g_7 g_11 g_12
 * writes: g_3 g_7 g_11 g_13
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_10 = 4294967293UL;
    for (g_3 = (-17); (g_3 > (-10)); g_3 = safe_add_func_int8_t_s_s(g_3, 2))
    { /* block id: 3 */
        uint16_t *l_6[4];
        int32_t *l_9[3];
        int i;
