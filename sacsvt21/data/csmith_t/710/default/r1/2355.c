...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_3 = 0x56L;
static int32_t g_8 = 0xEAD9BACCL;
...
{ /* block id: 0 */
    ...
    int32_t l_4[7] = {(-5L),0x6318D581L,(-5L),(-5L),0x6318D581L,(-5L),(-5L)};
    int i;
    g_3 = l_2;
    ...
    { /* block id: 4 */
        int32_t *l_7 = &g_8;
        int i;
        (*l_7) ^= (l_4[g_3] = ((safe_rshift_func_int8_t_s_s(l_4[g_3], 6)) , l_4[g_3]));
