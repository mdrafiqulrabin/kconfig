...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_4[2] = {0xFB6318D5L,0xFB6318D5L};
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint8_t *l_5[7][3] = {{&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6},{(void*)0,(void*)0,&g_6},{&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6}};
    int32_t l_9 = (-8L);
    int i, j;
    (*g_7) = (safe_lshift_func_uint8_t_u_s((g_6 ^= g_4[0]), 6));
    return l_9;
}
