...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_2[7] = {0xE28FDEB77278FA8FLL,0xE28FDEB77278FA8FLL,0xE28FDEB77278FA8FLL,0xE28FDEB77278FA8FLL,0xE28FDEB77278FA8FLL,0xE28FDEB77278FA8FLL,0xE28FDEB77278FA8FLL};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 7; i++)
        l_5[i] = 0x41720348L;
    l_14 = ((g_2[3] & (0xF33F23E93D0B5486LL && ((l_5[5] != (((safe_sub_func_uint32_t_u_u(g_2[5], ((*l_8) = 1L))) , (safe_add_func_int16_t_s_s(0x94ABL, (&l_5[5] == &g_9)))) , (safe_add_func_int16_t_s_s(((((((void*)0 == &l_5[1]) || 1L) && g_9) != 65535UL) || g_2[3]), 0x920BL)))) > g_2[3]))) && g_2[3]);
    return g_9;
}
