...
static volatile int32_t g_4 = 0x43B7C7CEL;/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        if (l_8)
            break;
        (*l_10) = ((0x0AA6E6F7FBF2121FLL >= 0xEF307D7C1188E17BLL) , l_9);
        for (l_8 = 0; (l_8 == 19); ++l_8)
        { /* block id: 8 */
            uint32_t l_13 = 0xAB1943C6L;
            return l_13;
        }
        if ((*l_9))
            continue;
