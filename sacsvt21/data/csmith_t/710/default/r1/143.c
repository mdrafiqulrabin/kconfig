...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3[10][2][1] = {{{0L},{(-1L)}},{{(-1L)},{0L}},{{(-1L)},{(-1L)}},{{0L},{(-1L)}},{{(-1L)},{0L}},{{(-1L)},{(-1L)}},{{0L},{(-1L)}},{{(-1L)},{0L}},{{(-1L)},{(-1L)}},{{0L},{(-1L)}}};
static const union U0 g_4 = {-2L};/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_2[i] = 8L;
    for (g_3[5][1][0] = 0; g_3[5][1][0] < 1; g_3[5][1][0] += 1)
    {
        l_2[g_3[5][1][0]] = 0x4CCB63E8L;
    }
    return g_4;
}
