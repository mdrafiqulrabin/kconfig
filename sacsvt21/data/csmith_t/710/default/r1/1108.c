...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_4 = 0xD09EA983L;/* VOLATILE GLOBAL g_4 */
static int32_t g_7 = 0xE8588D0DL;
...
{ /* block id: 0 */
    uint32_t l_5 = 0UL;
    int64_t l_8[10] = {(-1L),0L,6L,6L,0L,(-1L),0L,6L,6L,0L};
    int i;
    (*g_6) = ((safe_rshift_func_int8_t_s_u(((-10L) <= g_4), 1)) >= l_5);
