...
static volatile int32_t g_5 = 0xB02971C1L;/* VOLATILE GLOBAL g_5 */
static int32_t g_6 = 0xDB22124FL;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_9 = 0x170CL;
    for (g_6 = 18; (g_6 == 1); g_6 = safe_sub_func_int32_t_s_s(g_6, 7))
    { /* block id: 3 */
        return g_4;
    }
    return l_9;
