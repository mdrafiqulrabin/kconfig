...
static volatile int16_t g_15[5][4] = {{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L}};
static volatile int32_t g_17 = 0x3A065C2DL;/* VOLATILE GLOBAL g_17 */
...
{ /* block id: 0 */
    ...
    int32_t *l_10 = &g_3;
    int32_t l_11[8];
    uint32_t l_12 = 0x7963BA20L;
    int32_t *l_16[5] = {&l_11[3],&l_11[3],&l_11[3],&l_11[3],&l_11[3]};
    int i;
    for (i = 0; i < 8; i++)
        l_11[i] = 3L;
    l_12++;
