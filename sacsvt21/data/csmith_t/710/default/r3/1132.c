...
/* --- GLOBAL VARIABLES --- */
static int16_t g_2 = 0xEDEDL;
static struct S1 g_4[3] = {{246UL,0xD374L,0L,0,0x0FL,4294967288UL,0xE8B0D193L},{246UL,0xD374L,0L,0,0x0FL,4294967288UL,0xE8B0D193L},{246UL,0xD374L,0L,0,0x0FL,4294967288UL,0xE8B0D193L}};
