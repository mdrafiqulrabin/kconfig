...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[5] = {0x32FD2D1AL,0x32FD2D1AL,0x32FD2D1AL,0x32FD2D1AL,0x32FD2D1AL};
static int32_t g_6 = 0xB6478C38L;
static union U3 g_7 = {0x6874L};/* VOLATILE GLOBAL g_7 */
