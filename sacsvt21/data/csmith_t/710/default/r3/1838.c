...
static int8_t g_4 = 0x1BL;
static int32_t g_6 = 0L;
static int32_t g_9 = 0x83DC0E3EL;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_4 g_6 g_9
 * writes: g_2 g_4 g_6 g_9
 */
static uint64_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_3 = &g_2;
    int32_t *l_5 = &g_6;
    uint64_t l_7 = 0x7182B4746A1C17C7LL;
    int32_t *l_8 = &g_9;
    (*l_8) = (((*l_5) |= (g_4 ^= ((*l_3) = g_2))) == l_7);
    return g_9;
}
