...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[10] = {1L,7L,1L,1L,7L,1L,1L,7L,1L,1L};
...
static const int64_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t *l_3 = &g_2[6];
    int32_t *l_4[2];
    uint8_t l_6[9][4] = {{0x71L,0x71L,1UL,0x71L},{0x71L,0xDBL,0xDBL,0x71L},{0xDBL,0x71L,0xDBL,0xDBL},{0x71L,0x71L,1UL,0x71L},{0x71L,0xDBL,0xDBL,0x71L},{0xDBL,0x71L,0xDBL,0xDBL},{0x71L,0x71L,1UL,0x71L},{0x71L,0xDBL,0xDBL,0x71L},{0xDBL,0x71L,0xDBL,0xDBL}};
    int i, j;
    for (i = 0; i < 2; i++)
        l_4[i] = &g_5;
    (*l_3) = g_2[5];
