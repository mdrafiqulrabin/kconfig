...
static volatile int32_t g_5[7] = {(-2L),(-2L),(-2L),(-2L),(-2L),(-2L),(-2L)};
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[2][2][5] = {{{&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3}},{{&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3}}};
    int64_t l_6 = 0x440874B28ED4A55FLL;
    uint32_t l_7[1];
    int i, j, k;
    for (i = 0; i < 1; i++)
        l_7[i] = 0x76373A4CL;
