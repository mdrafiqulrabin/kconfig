...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0xFB023ED1L;/* VOLATILE GLOBAL g_3 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_5 g_10 g_16 g_6
 * writes: g_6 g_10 g_16
 */
static const uint8_t  func_1(void)
{ /* block id: 0 */
    int8_t l_4 = 4L;
    int32_t *l_7 = &g_6;
    int32_t *l_8 = &g_6;
    int32_t *l_9[4][7] = {{&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6},{&g_6,&g_6,&g_6,&g_6,(void*)0,&g_6,&g_6},{&g_6,&g_6,&g_6,(void*)0,(void*)0,&g_6,&g_6}};
    uint32_t l_13 = 0xCDF8ABFFL;
    int i, j;
    (*g_5) = (((safe_unary_minus_func_int16_t_s(g_3)) , g_3) != l_4);
    ++g_10;
    l_13--;
    ++g_16;
    return g_6;
