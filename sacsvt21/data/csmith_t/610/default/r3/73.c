...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xF2C29A3DL;
static int32_t * volatile g_8 = (void*)0;/* VOLATILE GLOBAL g_8 */
static int32_t * volatile g_10[4] = {(void*)0,(void*)0,(void*)0,(void*)0};
...
static int8_t  func_1(void)
{ /* block id: 0 */
    int64_t l_7[9] = {0L,0L,0xEA41449C9FB37B04LL,0L,0L,0xEA41449C9FB37B04LL,0L,0L,0xEA41449C9FB37B04LL};
    int i;
    for (g_2 = 0; (g_2 > 8); g_2 = safe_add_func_int8_t_s_s(g_2, 9))
    { /* block id: 3 */
        int32_t *l_9 = (void*)0;
        int32_t *l_11 = &g_12;
        (*l_11) |= (safe_lshift_func_int8_t_s_u(l_7[1], 6));
        (*l_11) = l_7[8];
    }
    return g_2;
}
