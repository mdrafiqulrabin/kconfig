...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x47C9D5FAL;
static const int32_t *g_5[4] = {&g_3,&g_3,&g_3,&g_3};
static const int32_t ** volatile g_4 = &g_5[0];/* VOLATILE GLOBAL g_4 */
static struct S0 g_6[1][1] = {{{0UL,-10L,0x4E76AB2AEE5A9864LL,65530UL,0x35EDADE0L}}};
