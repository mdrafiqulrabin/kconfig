...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_6 g_8 g_7
 * writes: g_4
 */
static int16_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_5 = 0x253A34C865B49D58LL;
    int32_t *l_9[5] = {&g_4,&g_4,&g_4,&g_4,&g_4};
    int i;
    g_4 = (safe_mul_func_int8_t_s_s(g_4, (0xC633843046B6EB6BLL ^ (((0L < 0xB483L) & (l_5 != ((void*)0 == g_6))) , (&g_7 != g_8)))));
    return g_7;
}
