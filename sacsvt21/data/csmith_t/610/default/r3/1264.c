...
static volatile uint64_t g_16 = 0x31C587C7AB89BDD7LL;/* VOLATILE GLOBAL g_16 */
...
{ /* block id: 0 */
    ...
    int32_t l_19 = (-1L);
    (*g_4) &= ((void*)0 == l_2);
    for (g_5 = 3; (g_5 > (-4)); g_5 = safe_sub_func_int16_t_s_s(g_5, 4))
    { /* block id: 4 */
        int32_t l_14 = (-6L);
        for (g_3 = (-11); (g_3 <= 11); g_3 = safe_add_func_uint32_t_u_u(g_3, 2))
        { /* block id: 7 */
            int32_t *l_10 = &g_11;
            int32_t *l_12 = &g_11;
            int32_t *l_13[10] = {&g_11,&g_11,&g_11,&g_11,&g_11,&g_11,&g_11,&g_11,&g_11,&g_11};
            int i;
            ++g_16;
            return l_19;
        }
