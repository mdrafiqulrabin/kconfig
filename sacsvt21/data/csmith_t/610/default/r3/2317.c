...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_7 = 0x5CC25BFCL;/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    uint16_t l_4 = 1UL;
    if ((safe_div_func_uint64_t_u_u(l_4, (safe_rshift_func_uint16_t_u_s(4UL, g_7)))))
    { /* block id: 1 */
        return g_7;
    }
    else
    { /* block id: 3 */
        const uint8_t l_8 = 0x76L;
        return l_8;
    }
}
