...
static int32_t g_9 = 0x44D4E2B7L;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_3 g_9 g_10
 * writes: g_4 g_3 g_9 g_10
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[9][1] = {{(void*)0},{&g_3},{(void*)0},{&g_3},{(void*)0},{&g_3},{(void*)0},{&g_3},{(void*)0}};
    int32_t l_11 = 0xF47073E7L;
    uint32_t l_15[1];
    int i, j;
    for (i = 0; i < 1; i++)
        l_15[i] = 5UL;
    g_4++;
    for (g_3 = (-5); (g_3 <= 14); g_3 = safe_add_func_int8_t_s_s(g_3, 7))
    { /* block id: 4 */
