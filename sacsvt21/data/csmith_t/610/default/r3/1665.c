...
static int32_t g_5 = 0x09978F3CL;
static int32_t g_6 = 0xFC88EB98L;
static uint64_t g_7[1][1][7] = {{{8UL,8UL,8UL,8UL,8UL,8UL,8UL}}};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4[3][3] = {{&g_3,&g_3,&g_3},{(void*)0,(void*)0,(void*)0},{&g_3,&g_3,&g_3}};
    uint32_t l_10 = 0x969AC54CL;
    int i, j;
    g_7[0][0][0]++;
    return l_10;
}
