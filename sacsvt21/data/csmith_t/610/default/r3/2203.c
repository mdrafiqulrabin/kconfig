...
static int32_t g_6 = 0xF759609CL;
static int32_t * volatile g_5 = &g_6;/* VOLATILE GLOBAL g_5 */
static uint16_t g_16 = 0x4CF5L;
static uint8_t g_18 = 0x8EL;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_5 g_4 g_6 g_18
 * writes: g_4 g_6 g_2 g_16 g_18
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_3 = &g_4[3];
    ...
    { /* block id: 11 */
        ...
        for (i = 0; i < 5; i++)
            l_17[i] = &g_18;
        (*l_3) = (g_4[5] > (safe_mod_func_int8_t_s_s((safe_add_func_int16_t_s_s(g_4[3], (((g_16 = (safe_lshift_func_uint16_t_u_s((l_15 = ((void*)0 != &g_6)), 0))) , (void*)0) != (void*)0))), (g_18++))));
    }
    return (*l_3);
}
