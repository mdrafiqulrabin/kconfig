...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_4 = {8172};
static volatile struct S0 g_7 = {7444};/* VOLATILE GLOBAL g_7 */
static volatile struct S0 *g_6 = &g_7;
static volatile struct S0 * volatile *g_5 = &g_6;
...
{ /* block id: 0 */
    ...
    struct S0 **l_2 = &l_3;
    (*l_2) = (void*)0;
    (*g_8) = ((0xED080C17L <= 1UL) , ((void*)0 != g_5));
    return g_4.f0;
}
