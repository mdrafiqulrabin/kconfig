...
{ /* block id: 0 */
    ...
    int32_t *l_8 = &l_4[9];
    int32_t *l_9 = &l_4[9];
    uint64_t l_10[7] = {0x1DFE0091DF82D83DLL,0xB04800FA72C25FCCLL,0x1DFE0091DF82D83DLL,0x1DFE0091DF82D83DLL,0xB04800FA72C25FCCLL,0x1DFE0091DF82D83DLL,0x1DFE0091DF82D83DLL};
    uint8_t l_13 = 0x30L;
    int i;
    for (i = 0; i < 10; i++)
        l_4[i] = 0x29A3DF60L;
