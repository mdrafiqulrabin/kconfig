...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        { /* block id: 6 */
            int i, j;
            return l_2[g_8][(g_8 + 1)];
        }
        for (g_8 = 0; (g_8 >= 0); g_8 -= 1)
        { /* block id: 11 */
            int32_t *l_9 = &l_2[0][0];
            int32_t *l_10 = &l_2[0][0];
            int32_t *l_11 = &l_2[0][0];
            int32_t *l_12 = &l_2[g_8][(g_8 + 1)];
            int32_t *l_14 = &l_2[g_8][(g_8 + 1)];
            int32_t *l_15 = &l_2[g_8][(g_8 + 1)];
            int32_t *l_16 = &l_2[g_8][(g_8 + 1)];
            int32_t *l_17 = &l_2[g_8][(g_8 + 1)];
            int32_t *l_18 = &l_2[g_8][(g_8 + 1)];
            int32_t *l_19[10] = {&l_2[0][1],&l_2[0][1],&l_2[0][1],&l_2[0][1],&l_2[0][1],&l_2[0][1],&l_2[0][1],&l_2[0][1],&l_2[0][1],&l_2[0][1]};
            int16_t l_20 = (-9L);
            int i, j;
            l_22--;
        }
