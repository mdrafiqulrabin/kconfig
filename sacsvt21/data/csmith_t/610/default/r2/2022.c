...
static struct S1 g_6 = {33,460,0x6BC657E3B6F9B691LL,3,-10};/* VOLATILE GLOBAL g_6 */
...
static struct S1  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[5] = {0xD193E056L,0xD193E056L,0xD193E056L,0xD193E056L,0xD193E056L};
    int64_t l_3 = 0xBAEF6E229EDCA8FELL;
    int i;
    (*g_4) = (l_2[3] ^ l_3);
    return g_6;
}
