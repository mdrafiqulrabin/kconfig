...
static int64_t g_4 = 0xC8FC558BAC04EE7DLL;
static uint8_t g_5[6] = {5UL,5UL,5UL,5UL,5UL,5UL};
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[2][7] = {{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3}};
    int i, j;
    ++g_5[1];
    return g_5[1];
}
