...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x6917AB6DL;
static int32_t *g_5 = (void*)0;
static int32_t *g_6[2] = {&g_4,&g_4};
static struct S1 g_7 = {0L,4UL,7L,0xBD850270L,0x9E3DL,-6L,{0xF5L,112,0x5DL,13071,-6,375,4},0x7AD53A38L,0x06L};/* VOLATILE GLOBAL g_7 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc(g_7.f6.f0, "g_7.f6.f0", print_hash_value);
    transparent_crc(g_7.f6.f1, "g_7.f6.f1", print_hash_value);
    transparent_crc(g_7.f6.f2, "g_7.f6.f2", print_hash_value);
    transparent_crc(g_7.f6.f3, "g_7.f6.f3", print_hash_value);
    transparent_crc(g_7.f6.f4, "g_7.f6.f4", print_hash_value);
    transparent_crc(g_7.f6.f5, "g_7.f6.f5", print_hash_value);
    transparent_crc(g_7.f6.f6, "g_7.f6.f6", print_hash_value);
