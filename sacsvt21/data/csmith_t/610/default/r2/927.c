...
static int32_t * const  volatile g_6[8] = {&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_5 = 0x6F9B2CFBL;
    int32_t l_8 = 0xDE05DAE5L;
    l_8 = (~(safe_lshift_func_uint8_t_u_s(l_5, l_5)));
    for (g_7 = 0; (g_7 >= 6); g_7++)
    { /* block id: 4 */
        int16_t l_11 = 6L;
        if (l_11)
