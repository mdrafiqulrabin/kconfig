...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[4] = {0x9FE387FBL,0x9FE387FBL,0x9FE387FBL,0x9FE387FBL};
...
static int64_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[8] = {&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2]};
    uint32_t l_4 = 0x7647F1A9L;
    int i;
    ++l_4;
    return g_3[1];
}
