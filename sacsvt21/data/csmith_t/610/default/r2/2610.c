...
static volatile int32_t g_3 = 0xB37B0480L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4[9] = {0L,0x72C25FCCL,0L,0L,0x72C25FCCL,0L,0L,0x72C25FCCL,0L};
static int32_t g_8 = (-1L);
static int32_t g_11 = 0x3672D714L;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_2 g_8 g_11
 * writes: g_4 g_8 g_11
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_7 = &g_4[2];
    for (g_4[2] = (-26); (g_4[2] <= (-26)); g_4[2] = safe_add_func_uint16_t_u_u(g_4[2], 5))
    { /* block id: 3 */
        return g_2;
    }
    (*l_7) ^= 1L;
