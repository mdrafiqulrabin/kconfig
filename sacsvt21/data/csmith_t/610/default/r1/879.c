...
static int32_t g_8[3][4] = {{0xBEFA1E1CL,0xAF0A9B27L,0xBEFA1E1CL,0xBEFA1E1CL},{0xAF0A9B27L,0xAF0A9B27L,(-3L),0xAF0A9B27L},{0xAF0A9B27L,0xBEFA1E1CL,0xBEFA1E1CL,0xAF0A9B27L}};
static int32_t * const  volatile g_7 = &g_8[0][0];/* VOLATILE GLOBAL g_7 */
static int32_t *g_10 = &g_8[0][0];
...
/* 
 * reads : g_3 g_7 g_9
 * writes: g_3 g_5 g_8 g_10
 */
static struct S0  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[4];
    struct S0 l_11[4][3] = {{{14},{0},{14}},{{14},{0},{14}},{{14},{0},{14}},{{14},{0},{14}}};
    int i, j;
    for (i = 0; i < 4; i++)
        l_2[i] = 0x4A754320L;
