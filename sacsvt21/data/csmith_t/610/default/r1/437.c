...
static int32_t g_6[1][2][3] = {{{(-1L),(-1L),(-1L)},{0xCFE04822L,0xCFE04822L,0xCFE04822L}}};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        int32_t *l_7 = &g_6[0][1][2];
        int32_t *l_8 = (void*)0;
        int32_t *l_9 = &g_6[0][0][1];
        int32_t *l_10 = &g_6[0][1][2];
        int32_t *l_11 = &g_6[0][1][0];
        uint32_t l_12 = 7UL;
        ++l_12;
    }
    return g_6[0][1][2];
