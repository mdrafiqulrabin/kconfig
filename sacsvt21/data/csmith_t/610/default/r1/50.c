...
/* --- GLOBAL VARIABLES --- */
static volatile uint64_t g_2 = 0x838A1F94964A53AALL;/* VOLATILE GLOBAL g_2 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_3 g_7 g_6
 * writes: g_6 g_8
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_4 = 0xBC662A2B3B7BEDEDLL;
    int32_t *l_5 = &g_6;
    (*g_7) = ((g_2 , (g_2 & (g_3 , 0UL))) , ((*l_5) = l_4));
    return (*l_5);
}
