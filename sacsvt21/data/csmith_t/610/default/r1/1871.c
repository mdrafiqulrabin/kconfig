...
static int64_t g_11 = 0xE8E1B88146CDEAD9LL;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_11 g_14 g_15 g_16
 * writes: g_2 g_11 g_12 g_15
 */
static union U0  func_1(void)
{ /* block id: 0 */
    int8_t *l_8 = &g_9;
    int64_t *l_10[7][1][3] = {{{&g_11,&g_11,&g_11}},{{&g_11,(void*)0,&g_11}},{{&g_11,&g_11,&g_11}},{{&g_11,&g_11,(void*)0}},{{&g_11,&g_11,&g_11}},{{(void*)0,(void*)0,&g_11}},{{&g_11,&g_11,&g_11}}};
    int32_t l_13[3];
    int i, j, k;
    for (i = 0; i < 3; i++)
        l_13[i] = 0L;
    --g_2;
    (*g_14) ^= (safe_sub_func_uint16_t_u_u(0UL, (safe_unary_minus_func_uint64_t_u(((g_12 = (g_11 ^= (l_8 == (void*)0))) > l_13[1])))));
    return g_16;
}
