...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[4][3] = {{0xC12265E3L,4L,0xC12265E3L},{(-1L),0xDFA831EBL,(-1L)},{0xC12265E3L,4L,0xC12265E3L},{(-1L),0xDFA831EBL,(-1L)}};
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[1][4][1] = {{{&g_3[2][0]},{&g_3[0][1]},{&g_3[2][0]},{&g_3[0][1]}}};
