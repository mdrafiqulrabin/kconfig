...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_4 = 0xECC2443A;
static float g_31[8] = {0xC.EBF0A0p+87,0xC.EBF0A0p+87,0xC.EBF0A0p+87,0xC.EBF0A0p+87,0xC.EBF0A0p+87,0xC.EBF0A0p+87,0xC.EBF0A0p+87,0xC.EBF0A0p+87};
...
{ /* block id: 36 */
    uint32_t l_30 = 0U;
    int32_t l_32 = 5;
    l_32 = (!(safe_lshift_func_int8_t_s_u((l_30 < g_4), 6)));
    return l_30;
}
