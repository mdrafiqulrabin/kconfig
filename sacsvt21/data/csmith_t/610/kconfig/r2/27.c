...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_31 = 0xF36A5B5C;/* VOLATILE GLOBAL g_31 */
static uint32_t g_32 = 0x462A77B6;
...
{ /* block id: 0 */
    int32_t l_16 = (-5);
    g_31 = ((uint16_t)((uint16_t)((int16_t)((uint16_t)(~((int16_t)(((int16_t)1 << (int16_t)14) || (8 | (!(l_16 & (l_16 || ((uint32_t)((uint32_t)((uint16_t)((uint32_t)l_16 - (uint32_t)((int16_t)((int32_t)((uint16_t)g_31 >> (uint16_t)(g_32 ^ (((((l_16 != g_32) != g_32) >= g_32) | 0x30BC) && 0xCC33BAB7))) + (int32_t)g_32) >> (int16_t)g_32)) << (uint16_t)g_32) - (uint32_t)l_16) % (uint32_t)g_32)))))) << (int16_t)g_32)) >> (uint16_t)11) >> (int16_t)l_16) >> (uint16_t)l_16) % (uint16_t)g_32);
    return g_32;
}
