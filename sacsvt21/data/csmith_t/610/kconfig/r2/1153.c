...
static uint64_t  func_28(void)
{ /* block id: 36 */
    int32_t l_31 = 0x7606E82AL;
    int32_t *l_32 = (void*)0;
    int32_t l_34[7] = {0x45C761B8L,0x45C761B8L,0x45C761B8L,0x45C761B8L,0x45C761B8L,0x45C761B8L,0x45C761B8L};
    int32_t *l_33 = &l_34[3];
    uint32_t l_35 = 1UL;
    int i;
    (*l_33) &= (safe_rshift_func_uint8_t_u_u(0x7DL, l_31));
    return l_35;
}
