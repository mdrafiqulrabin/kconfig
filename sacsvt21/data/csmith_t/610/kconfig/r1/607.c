...
inline static int64_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_2 = 0xA77C8748AFA2FAFDLL;
    int32_t l_3 = 0x2EE6D058L;
    int32_t l_7 = 0x0CA9F8D1L;
    l_3 = l_2;
    for (l_3 = 24; (l_3 != (-18)); l_3 = safe_sub_func_uint16_t_u_u(l_3, 6))
    { /* block id: 4 */
        const uint8_t l_6 = 0UL;
        l_7 ^= l_6;
    }
    return l_7;
}
