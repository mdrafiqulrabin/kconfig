...
static float g_15 = 0x9.D562B9p+78;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 3; i++)
        l_7[i] = 0xD7L;
    (*l_14) = (safe_sub_func_float_f_f((((safe_sub_func_float_f_f(g_6, ((g_6 > l_7[2]) > 0x5.59B8BCp-92))) == (0x9.5p+1 < (((safe_sub_func_float_f_f((((safe_div_func_float_f_f((g_6 > (((l_7[1] < 0x0.554671p+25) >= (((safe_sub_func_float_f_f(g_6, l_7[2])) != g_6) <= 0x0.Cp+1)) > g_6)), l_7[2])) != l_7[2]) < g_6), l_7[2])) == l_7[1]) >= l_7[2]))) != l_7[2]), l_7[2]));
    return l_7[2];
}
