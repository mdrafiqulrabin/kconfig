...
inline static int16_t  func_34(uint32_t  p_35, uint32_t  p_36);
...
{ /* block id: 36 */
    ...
    int32_t *l_44 = &l_45;
    int16_t l_46 = 1L;
    (*l_44) |= ((__builtin_ctzll((safe_add_func_int32_t_s_s(((safe_add_func_int8_t_s_s(l_31, (((0x29L == 0xA0L) ^ (l_31 | ((((safe_rshift_func_int16_t_s_s(func_34(l_31, l_31), (func_34(((void*)0 == l_40), (*l_40)) || (*l_40)))) <= (*l_40)) <= (*l_40)) != (*l_40)))) >= (*l_40)))) > l_42), (*l_40)))) && (*l_40)) | l_43);
    (*l_40) = ((1L && (*l_40)) == (*l_44));
    return l_46;
}
