...
static uint32_t g_6[6] = {0x10F7A73D,0x10F7A73D,0x10F7A73D,0x10F7A73D,0x10F7A73D,0x10F7A73D};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0x351F2000;
    g_6[1] = (9 == (safe_rshift_func_int8_t_s_u(l_4, g_5)));
    return g_6[1];
}
