...
static uint16_t  func_38(uint16_t  p_39, uint16_t  p_40, int32_t  p_41, int16_t  p_42);
...
{ /* block id: 36 */
    ...
    int32_t l_44 = 0x121589AF;
    l_44 = ((int16_t)(((((((1U && 65534U) , (((((l_33 = ((l_33 & l_33) <= l_33)) || (((uint16_t)(((uint32_t)((l_33 = (func_38((l_33 || l_33), (l_33 >= l_33), l_33, l_33) == 65530U)) <= l_44) + (uint32_t)l_44) > 4294967295U) * (uint16_t)0x2CAE) , (-6))) | 0xC6EB81F9) && l_44) , l_44)) < l_44) , l_33) , 4294967295U) <= l_44) && 0x3C10B42B) >> (int16_t)15);
    return l_33;
}
