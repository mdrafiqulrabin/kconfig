...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_4 = 0x6D4F2887L;
    int64_t l_5 = (-1L);
    uint32_t l_13 = 0x8D963785L;
    int32_t l_16 = (-2L);
    int32_t *l_15 = &l_16;
    int32_t l_21 = 0xA9F4F9A0L;
    (*l_15) = ((int32_t)((((l_4 && l_5) == l_4) <= 0x2285FAAFL) , ((!(0xA5B7L >= ((int16_t)((((int16_t)((uint64_t)l_13 - (uint64_t)0L) % (int16_t)l_5) , (!l_13)) || l_4) + (int16_t)l_4))) ^ l_13)) + (int32_t)l_13);
    (*l_15) = (((int16_t)(-7L) % (int16_t)(*l_15)) <= ((*l_15) ^ ((int32_t)(*l_15) + (int32_t)(*l_15))));
    return l_21;
}
