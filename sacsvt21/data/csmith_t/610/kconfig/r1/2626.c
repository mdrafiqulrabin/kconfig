...
static volatile uint16_t g_34 = 0x18EB;/* VOLATILE GLOBAL g_34 */
...
{ /* block id: 36 */
    ...
    int8_t l_33 = 0x02;
lbl_37:
    l_33 &= (l_28 <= ((((((!g_3) < (g_3 < (l_30 = g_3))) < (__builtin_ctzl(g_3) != (safe_mod_func_uint32_t_u_u(__builtin_ffsl((__builtin_ffs(g_3) <= 0x52)), g_3)))) | g_3) && g_3) >= l_28));
    ++g_34;
    if (l_33)
        goto lbl_37;
    return g_34;
