...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_3 = 0xB6;
static volatile int32_t g_30 = 0x6B6FEB9E;/* VOLATILE GLOBAL g_30 */
static int32_t g_31 = 0x0A221525;
...
{ /* block id: 36 */
    ...
    { /* block id: 39 */
        ...
        for (i = 0; i < 5; i++)
            l_34[i] = 0x07A329EF;
        for (g_31 = 12; (g_31 <= (-12)); --g_31)
        { /* block id: 42 */
            int32_t l_35 = 0xA85F88E1;
            ++l_36;
        }
    }
    return l_36;
