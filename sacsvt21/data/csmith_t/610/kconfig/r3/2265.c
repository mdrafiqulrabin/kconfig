...
/* --- GLOBAL VARIABLES --- */
static const uint64_t g_6 = 0x4DE6F885EA6EDAD9LL;
static int32_t g_30 = 0xBF0A0CD9L;
static uint32_t g_31 = 0xD4A79744L;
...
{ /* block id: 36 */
    int32_t *l_29 = &g_30;
    g_31--;
    for (g_31 = (-19); (g_31 == 2); g_31 += 9)
    { /* block id: 40 */
        if (g_6)
            break;
    }
    (*l_29) = __builtin_clzll((*l_29));
    return g_30;
}
