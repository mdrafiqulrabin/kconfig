...
{ /* block id: 0 */
    ...
    int32_t l_5 = 3L;
    for (l_2 = (-14); (l_2 > 13); l_2 += 6)
    { /* block id: 3 */
        int64_t l_8 = (-8L);
        l_5 = l_2;
        l_8 = ((int16_t)l_2 - (int16_t)0x59D5L);
    }
    return l_5;
}
