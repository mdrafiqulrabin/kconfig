...
static int32_t g_28[8] = {0x303F0244L,0x303F0244L,0x303F0244L,0x303F0244L,0x303F0244L,0x303F0244L,0x303F0244L,0x303F0244L};
static int32_t g_30 = 0x1EC2184EL;
...
{ /* block id: 36 */
    ...
    int32_t *l_29 = &g_30;
lbl_33:
    (*l_29) = ((*l_27) = 0x57257EA0L);
    for (g_3 = 0; (g_3 >= (-22)); g_3 = safe_sub_func_uint8_t_u_u(g_3, 5))
    { /* block id: 41 */
        if (g_3)
            goto lbl_33;
    }
