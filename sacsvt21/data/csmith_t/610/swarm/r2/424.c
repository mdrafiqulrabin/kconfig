...
{ /* block id: 0 */
    int16_t l_4 = (-9);
    float *l_15[2];
    int32_t l_16 = 0x2B5F7919;
    int i;
    for (i = 0; i < 2; i++)
        l_15[i] = (void*)0;
    l_16 = ((float)(0x0.DB5052p+34 != l_4) + (float)(((float)l_4 * (float)((float)0x6.Dp+1 + (float)(l_4 == l_4))) != ((-0x1.8p+1) == ((float)((((float)(((float)l_4 * (float)(l_4 <= l_4)) != l_4) + (float)0xB.5A9864p-94) < l_4) <= l_4) - (float)0x1.59C45Cp+13))));
    return l_16;
}
