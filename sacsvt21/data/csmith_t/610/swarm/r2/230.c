 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --comma-operators --compound-assignment --no-consts --no-divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --no-uint8 --no-float --math64 --no-inline-function --muls --no-safe-math --no-packed-struct --paranoid --pointers --no-structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      1306967094
 */
...
{ /* block id: 36 */
    uint32_t l_34 = 1U;
    int32_t l_36 = 0x2DB785B6;
    int32_t *l_35 = &l_36;
    int16_t l_44 = (-3);
    (*l_35) = l_34;
    for (l_34 = 9; (l_34 < 37); ++l_34)
    { /* block id: 40 */
        int32_t *l_39 = (void*)0;
        int32_t *l_40 = (void*)0;
        int32_t *l_41 = (void*)0;
