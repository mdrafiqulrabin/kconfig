 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --compound-assignment --consts --no-divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --no-int8 --no-uint8 --no-float --no-math64 --inline-function --no-muls --safe-math --no-packed-struct --paranoid --pointers --no-structs --unions --volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      2194993908
 */
...
inline static uint16_t  func_29(void)
{ /* block id: 36 */
    const int32_t l_32 = 0x7F191253;
    uint32_t l_34 = 4294967292U;
    uint32_t *l_33 = &l_34;
    int32_t l_36 = 0x039EE491;
    int32_t *l_35 = &l_36;
    int32_t l_38 = (-6);
    int32_t *l_37 = &l_38;
    int16_t l_39 = 1;
    (*l_35) &= (safe_lshift_func_uint16_t_u_u((l_32 > ((*l_33) |= l_32)), 4));
    (*l_37) &= (*l_35);
    return l_39;
}
