...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0x2BA39464L;
static int32_t g_37 = 0x06BDE64FL;


/* --- FORWARD DECLARATIONS --- */
static uint16_t  func_24(void);
static const int32_t  func_25(uint32_t  p_26, uint32_t  p_27, uint32_t  p_28, const uint32_t  p_29, uint32_t  p_30);
...
{ /* block id: 36 */
    int64_t l_31 = (-3L);
    int32_t l_38 = 4L;
    l_38 ^= func_25(g_3, g_3, l_31, ((safe_sub_func_int64_t_s_s(__builtin_parityll(g_3), (-1L))) >= (safe_lshift_func_uint16_t_u_s(g_3, 10))), g_3);
    return l_31;
}
