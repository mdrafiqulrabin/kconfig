...
inline static uint8_t  func_32(void)
{ /* block id: 36 */
    int32_t l_33 = 0x884CB8F6L;
    for (l_33 = (-16); (l_33 < (-29)); l_33 = safe_sub_func_int8_t_s_s(l_33, 7))
    { /* block id: 39 */
        int16_t l_38 = 0x68F9L;
        int32_t l_40 = 0x7C7AB89BL;
        int32_t *l_39 = &l_40;
        int32_t * const l_41 = (void*)0;
        int32_t **l_42 = &l_39;
        (*l_39) ^= (safe_div_func_int32_t_s_s(l_38, l_38));
        (*l_42) = l_41;
        /* statement id: 41 */
        assert (l_39 == 0);
        if (l_33)
