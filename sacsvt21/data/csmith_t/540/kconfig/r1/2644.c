...
inline static int32_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[10] = {9UL,9UL,9UL,9UL,9UL,9UL,9UL,9UL,9UL,9UL};
    float l_4 = 0x4.37831Ep-91;
    float *l_3 = &l_4;
    uint8_t l_9 = 0x9FL;
    int32_t l_11 = 0x372BA29FL;
    int i;
lbl_12:
    (*l_3) = l_2[9];
    if ((safe_lshift_func_int16_t_s_u(l_2[7], 13)))
    { /* block id: 2 */
        ...
        int i;
        for (i = 0; i < 1; i++)
            l_8[i] = 0x2.A92BD4p+15;
        l_11 = ((((void*)0 != l_7) && l_2[3]) && ((l_9 || l_10) >= l_2[9]));
    }
    else
    { /* block id: 4 */
        uint64_t l_13 = 0xA00D0E75D5F8D9A2LL;
        int32_t *l_14 = &l_11;
        if (l_9)
            goto lbl_12;
        (*l_14) = l_13;
