...
{ /* block id: 36 */
    uint16_t l_32 = 0UL;
    float l_36 = 0x3.304677p-71;
    float *l_35 = &l_36;
    (*l_35) = ((safe_mul_func_float_f_f((safe_div_func_float_f_f((l_32 > (l_32 == ((safe_add_func_float_f_f(0x6.7p-1, (l_32 >= 0xB.6C12A7p+38))) >= ((0x6.0p-1 >= l_32) >= l_32)))), l_32)), l_32)) <= l_32);
    return l_32;
}
