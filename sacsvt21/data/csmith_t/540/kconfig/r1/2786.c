...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_9 = 0x23E86F8CL;
static int32_t g_26 = 0x858905B8L;
static volatile int16_t g_33 = 0L;/* VOLATILE GLOBAL g_33 */
static uint8_t g_34[5] = {250UL,250UL,250UL,250UL,250UL};
...
{ /* block id: 36 */
    ...
    int32_t *l_30 = &g_26;
    int32_t l_31 = 0L;
    int32_t *l_32[8] = {&l_31,&g_26,&g_26,&l_31,&g_26,&g_26,&l_31,&g_26};
    int i;
    g_34[3]++;
    return g_34[3];
}
