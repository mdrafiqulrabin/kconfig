...
{ /* block id: 36 */
    int16_t l_38 = 1;
    int32_t l_39 = (-1);
    int32_t l_50 = 0x02DFCE95;
    int32_t l_53 = 0xC8F43836;
    int32_t l_54 = (-2);
    int32_t l_55 = 0x0C63704B;
    int32_t l_56 = 1;
    union U3 l_57 = {65531U};
    l_56 = (((uint32_t)((l_55 = ((int16_t)((l_54 = (((l_39 = (l_38 | (0x1920B245 < (l_38 <= l_38)))) & (l_53 &= __builtin_ffsll(((uint16_t)func_42(((int16_t)(__builtin_popcountl(l_38) >= l_38) * (int16_t)(((uint32_t)(!(l_38 | l_38)) - (uint32_t)4294967295U) && 0x422F8DC7)), l_50) % (uint16_t)0x34D8)))) >= (-2))) > l_50) >> (int16_t)l_38)) && l_39) - (uint32_t)l_38) & l_50);
    return l_57;
}
...
XXX percentage a fresh-made variable is used: 56.1
XXX percentage an existing variable is used: 43.9
