...
/* --- GLOBAL VARIABLES --- */
static int64_t g_6 = 0x043C4AB274BF90EDLL;
static int8_t g_30 = 0xD5L;
static int8_t * volatile g_29[6] = {&g_30,&g_30,&g_30,&g_30,&g_30,&g_30};
static int32_t g_33 = 0xB2F14481L;
...
{ /* block id: 36 */
    if (g_6)
    { /* block id: 37 */
        int8_t * const l_31 = &g_30;
        int32_t *l_32 = &g_33;
        (*l_32) ^= (((uint32_t)(g_29[1] == l_31) % (uint32_t)g_6) ^ 2UL);
    }
    else
    { /* block id: 39 */
        return g_33;
