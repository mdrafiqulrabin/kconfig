...
static uint16_t  func_27(void)
{ /* block id: 36 */
    for (g_5 = 0; (g_5 < 12); g_5 = safe_add_func_uint64_t_u_u(g_5, 4))
    { /* block id: 39 */
        uint32_t l_33[8] = {0x4431FADAL,0x4431FADAL,0x4431FADAL,0x4431FADAL,0x4431FADAL,0x4431FADAL,0x4431FADAL,0x4431FADAL};
        int i;
        (*g_32) = g_30;
        if (l_33[5])
            continue;
