...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x8F0AA6E6;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 0xBF2121F9;/* VOLATILE GLOBAL g_3 */
...
{ /* block id: 0 */
    ...
    g_2 = ((uint16_t)(l_14 = ((g_10 = g_2) <= ((uint32_t)0x203BD652 % (uint32_t)l_13))) >> (uint16_t)2);
    return g_3;
}
