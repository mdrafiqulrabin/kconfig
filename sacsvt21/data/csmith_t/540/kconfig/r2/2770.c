...
/* --- GLOBAL VARIABLES --- */
static int32_t g_9 = 0x4074DD03L;
...
static uint8_t  func_27(void)
{ /* block id: 36 */
    int32_t l_28 = 0x65256810L;
    uint32_t *l_37 = &g_38;
    g_9 = (((g_9 != l_28) >= l_28) | ((safe_div_func_float_f_f(l_28, ((g_9 >= ((((*l_37) = (__builtin_popcount(l_28) > (safe_sub_func_uint8_t_u_u((((safe_rshift_func_int8_t_s_u((safe_sub_func_int64_t_s_s((((__builtin_ffsll(l_28) <= l_28) == l_28) ^ l_28), 0x0866193FE6966EF3LL)), g_9)) > g_9) > g_9), g_9)))) , g_9) != l_28)) <= l_28))) , 0x2D50FA8FAD7494DFLL));
    return g_9;
}
