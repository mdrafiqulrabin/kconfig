...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_2[5] = {{9L,0x6.Fp+1,0x4210E164L,0xAFL},{9L,0x6.Fp+1,0x4210E164L,0xAFL},{9L,0x6.Fp+1,0x4210E164L,0xAFL},{9L,0x6.Fp+1,0x4210E164L,0xAFL},{9L,0x6.Fp+1,0x4210E164L,0xAFL}};
...
int main (int argc, char* argv[])
{
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        transparent_crc_bytes(&g_2[i].f1, sizeof(g_2[i].f1), "g_2[i].f1", print_hash_value);
