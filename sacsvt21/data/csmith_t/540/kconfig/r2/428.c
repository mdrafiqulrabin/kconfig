...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xF37D45DB;/* VOLATILE GLOBAL g_2 */
static volatile union U1 g_5 = {-7};/* VOLATILE GLOBAL g_5 */
...
static int8_t  func_1(void)
{ /* block id: 0 */
    volatile uint32_t l_3 = 0x2887CF2E;/* VOLATILE GLOBAL l_3 */
    int8_t l_4 = 0;
    int16_t l_6 = 9;
    int16_t l_7 = 0xCF4C;
    l_3 = g_2;
    g_5.f1 = (l_4 , (g_5 , (g_2 | l_6)));
    return l_7;
}
