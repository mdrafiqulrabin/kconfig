...
{ /* block id: 36 */
    ...
    int32_t *l_41 = &l_42;
    float l_43 = 0x0.Ep-1;
    uint16_t l_44 = 0x0FA1L;
    (*l_41) ^= ((safe_unary_minus_func_uint16_t_u(func_32(l_34))) || (safe_unary_minus_func_int32_t_s(func_32(l_34))));
    return l_44;
}
...
{ /* block id: 37 */
    int32_t l_37 = (-7L);
    for (p_33 = 0; (p_33 <= 28); p_33 = safe_add_func_uint8_t_u_u(p_33, 4))
    { /* block id: 40 */
        int32_t l_39 = 0xAA8E55A4L;
        int32_t *l_38 = &l_39;
        (*l_38) ^= ((l_37 >= 0x6370L) < l_37);
    }
    return p_33;
}
