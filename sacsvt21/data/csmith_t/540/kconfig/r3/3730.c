...
static uint32_t  func_33(void)
{ /* block id: 36 */
    int32_t l_34 = 0x1516EA3DL;
    int8_t *l_43 = (void*)0;
    uint16_t l_45 = 0xB96BL;
    uint16_t *l_44 = &l_45;
    if (((((l_34 || (safe_div_func_uint32_t_u_u(((safe_unary_minus_func_int8_t_s((safe_rshift_func_uint16_t_u_u(((l_34 <= l_34) > (safe_rshift_func_uint8_t_u_s(((0xCA4B38B4L < (~((*l_44) &= (l_43 != l_43)))) ^ (safe_sub_func_uint8_t_u_u((safe_rshift_func_int8_t_s_u(l_34, 5)), __builtin_bswap32(l_34)))), 2))), l_34)))) <= l_34), 0xE69D0863L))) == l_34) && l_34) || l_34))
    { /* block id: 38 */
        uint8_t l_50 = 0x1CL;
        return l_50;
    }
