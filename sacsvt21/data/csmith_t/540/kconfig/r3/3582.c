...
{ /* block id: 0 */
    int64_t l_2 = 1L;
    int32_t l_4[9] = {7L,7L,7L,7L,7L,7L,7L,7L,7L};
    int32_t *l_3[4][7] = {{(void*)0,&l_4[2],&l_4[2],&l_4[7],&l_4[2],&l_4[7],&l_4[2]},{&l_4[5],&l_4[7],&l_4[7],&l_4[5],(void*)0,&l_4[7],(void*)0},{(void*)0,&l_4[7],(void*)0,&l_4[5],&l_4[7],&l_4[7],&l_4[5]},{&l_4[2],&l_4[7],&l_4[2],&l_4[7],&l_4[2],&l_4[2],(void*)0}};
    int32_t l_5 = 1L;
    uint8_t l_6 = 0x3DL;
    int i, j;
    l_5 = l_2;
