...
/* --- GLOBAL VARIABLES --- */
static int32_t g_10 = 0x74006310;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_13 = 0xF6E2;
    int32_t l_14 = 0x18BD8502;
    l_14 = (0xF73838A1 != (-(uint32_t)(((((int16_t)(~((uint16_t)((uint16_t)g_10 % (uint16_t)0xCAFE) << (uint16_t)11)) - (int16_t)((((uint16_t)l_13 << (uint16_t)(l_13 || (-1))) <= g_10) ^ ((g_10 < l_13) != l_13))) <= g_10) < (-1)) >= l_13)));
    return l_14;
}
