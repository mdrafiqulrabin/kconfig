...
{ /* block id: 36 */
    int32_t l_42 = 1;
    g_43 = ((uint16_t)7U + (uint16_t)((int16_t)((uint16_t)((uint16_t)(1 ^ 0xDAD816F9) << (uint16_t)11) << (uint16_t)5) % (int16_t)((int32_t)__builtin_bswap64((5 & g_6)) + (int32_t)l_42)));
    return g_6;
}
