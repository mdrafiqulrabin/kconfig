...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_14 = 0x464F16EF;
    for (g_2 = (-11); (g_2 > 18); g_2 += 2)
    { /* block id: 3 */
        int32_t l_9 = 0;
        g_20 = ((uint16_t)((uint16_t)l_9 >> (uint16_t)12) + (uint16_t)((uint32_t)((int16_t)l_14 << (int16_t)4) + (uint32_t)((uint32_t)(((g_2 >= (l_14 || ((l_9 && g_2) ^ (-(int16_t)g_2)))) > (g_2 <= ((int32_t)(g_2 != l_14) % (int32_t)g_2))) && g_2) - (uint32_t)l_14)));
    }
    l_14 = (l_14 != l_14);
    return l_14;
}
