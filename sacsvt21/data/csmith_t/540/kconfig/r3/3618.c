...
/* --- GLOBAL VARIABLES --- */
static float g_7 = (-0x6.3p-1);
static uint8_t g_15 = 0xFCL;
static int32_t g_37 = 0xD9A2B82CL;
...
/* ------------------------------------------ */
/* 
 * reads : g_15 g_37 g_39
 * writes: g_37 g_39
 */
static float  func_31(void)
{ /* block id: 36 */
    uint32_t l_35 = 0xBDB979CDL;
    int32_t * const l_38 = &g_39;
    int32_t * const l_40 = &g_39;
    (*l_40) &= (func_32(l_35, g_15) != (l_38 == l_40));
    return g_37;
}
