...
{ /* block id: 0 */
    uint8_t l_23 = 3U;
    int32_t l_25 = 9;
    l_25 = (0x9C5A > ((int16_t)g_4 << (int16_t)(g_4 && ((g_4 && ((int16_t)g_4 >> (int16_t)((((uint32_t)func_9(g_4, ((uint16_t)(g_4 || ((uint16_t)((int32_t)(!func_20(g_4)) + (int32_t)l_23) - (uint16_t)2U)) << (uint16_t)g_4), g_4) % (uint32_t)l_23) <= 0U) <= l_23))) <= l_23))));
    g_4 = ((int16_t)g_22 << (int16_t)5);
    g_4 = g_22;
    return g_4;
}
