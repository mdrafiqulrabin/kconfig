...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xBF390197;/* VOLATILE GLOBAL g_2 */
static union U0 g_5 = {1U};/* VOLATILE GLOBAL g_5 */
...
static union U0  func_1(void)
{ /* block id: 0 */
    volatile uint8_t l_3 = 252U;/* VOLATILE GLOBAL l_3 */
    volatile int32_t l_4 = 0;/* VOLATILE GLOBAL l_4 */
    l_3 = g_2;
    l_4 = l_3;
    return g_5;
}
