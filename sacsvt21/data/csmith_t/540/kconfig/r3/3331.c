...
/* --- GLOBAL VARIABLES --- */
static const struct S2 g_2 = {0x3F126C7FL,1UL,0xA.260389p+55,18446744073709551613UL,-0x10.Ap-1};/* VOLATILE GLOBAL g_2 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_2.f2, sizeof(g_2.f2), "g_2.f2", print_hash_value);
    transparent_crc(g_2.f3, "g_2.f3", print_hash_value);
    transparent_crc_bytes (&g_2.f4, sizeof(g_2.f4), "g_2.f4", print_hash_value);
