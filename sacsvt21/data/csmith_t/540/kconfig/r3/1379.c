...
static int16_t  func_27(void)
{ /* block id: 36 */
    for (g_3 = 0; (g_3 > (-11)); g_3 -= 3)
    { /* block id: 39 */
        uint16_t l_37 = 0xA014;
        int32_t l_38 = 0;
        l_38 = (((((4294967287U == ((int32_t)0xA2F3817D % (int32_t)((uint16_t)g_3 << (uint16_t)8))) ^ 0x3403CA95) || (~(((uint16_t)(3 > g_3) << (uint16_t)((((__builtin_popcountll(l_37) < g_3) > g_3) < l_37) <= 0x0797)) <= g_3))) ^ 0xD9AE) && g_3);
    }
    return g_3;
}
