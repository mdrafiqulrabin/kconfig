...
/* --- GLOBAL VARIABLES --- */
static int64_t g_3 = 0x324EC2E0CF5720E8LL;
static int32_t g_30 = 0x9A56718EL;
...
inline static uint16_t  func_26(void)
{ /* block id: 36 */
    uint64_t l_31[2][2] = {{0x59BB7A1405524872LL,0x59BB7A1405524872LL},{0x59BB7A1405524872LL,0x59BB7A1405524872LL}};
    int i, j;
    for (g_3 = (-30); (g_3 <= 6); g_3++)
    { /* block id: 39 */
        int32_t *l_29 = &g_30;
        (*l_29) &= g_3;
    }
