...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_2 = {24,-1170,2784,290,207,4,17};/* VOLATILE GLOBAL g_2 */
static const union U5 g_6 = {{0x50,7}};/* VOLATILE GLOBAL g_6 */
...
static const union U5  func_1(void)
{ /* block id: 0 */
    int32_t l_3 = 0xDFE936BE;
    int32_t l_4 = 0xC9B996A5;
    int32_t l_5 = (-1);
    l_5 = (l_4 &= (g_2 , (l_3 = 1)));
    return g_6;
    /* statement id: 4 */
