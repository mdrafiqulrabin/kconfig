...
/* --- GLOBAL VARIABLES --- */
static int32_t g_8[10] = {0L,0x9978F3C3L,0x0C170CD5L,0x0C170CD5L,0x9978F3C3L,0L,0x9978F3C3L,0x0C170CD5L,0x0C170CD5L,0x9978F3C3L};
...
inline static uint16_t  func_31(void)
{ /* block id: 36 */
    float l_32[5][2] = {{(-0x1.5p-1),0x1.Ap-1},{0x4.5D5697p+99,(-0x1.5p-1)},{0x8.16B5B3p+87,0x8.16B5B3p+87},{0x8.16B5B3p+87,(-0x1.5p-1)},{0x4.5D5697p+99,0x1.Ap-1}};
    int32_t l_33 = (-1L);
    int i, j;
    return l_33;
}
