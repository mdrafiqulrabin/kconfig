...
/* --- GLOBAL VARIABLES --- */
static int8_t g_2 = 0x98;
static int32_t g_6 = 0x6AEBA4D3;
static uint16_t g_7 = 6U;
static struct S1 g_8 = {{-20,2398,704,151},1,0,1,0xF92E6C0B,0U,{-8,2150,22,88},1U};
...
inline static struct S1  func_1(void)
{ /* block id: 0 */
    uint32_t l_4 = 0xEC326874;
    int32_t *l_5[9] = {&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6,&g_6};
    int i;
    g_7 = (g_6 = (g_2 > (((-(uint32_t)1U) & l_4) > 0x76D2)));
    return g_8;
}
...
int main (void)
{
    ...
    transparent_crc(g_8.f6.f1, "g_8.f6.f1", print_hash_value);
    transparent_crc(g_8.f6.f2, "g_8.f6.f2", print_hash_value);
    transparent_crc(g_8.f6.f3, "g_8.f6.f3", print_hash_value);
