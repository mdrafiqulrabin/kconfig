...
static int32_t g_5 = 0x9A695768L;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2[9] = {0xA162C9CCL,0xA162C9CCL,0xA162C9CCL,0xA162C9CCL,0xA162C9CCL,0xA162C9CCL,0xA162C9CCL,0xA162C9CCL,0xA162C9CCL};
    int i;
    (*g_6) ^= l_2[7];
    return l_2[7];
}
