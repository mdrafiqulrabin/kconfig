...
static volatile int16_t g_5 = 0xAAEBL;/* VOLATILE GLOBAL g_5 */
static uint8_t g_6 = 0x39L;
static uint16_t g_13 = 0xA814L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 2; i++)
        l_4[i] = &g_3;
    g_6++;
    (*l_2) = (((l_4[0] != l_4[0]) < g_3) , g_5);
    (*l_2) = ((*l_2) && (safe_mul_func_uint8_t_u_u((((*l_12) = (!g_5)) , 0UL), (-7L))));
    return g_13;
}
