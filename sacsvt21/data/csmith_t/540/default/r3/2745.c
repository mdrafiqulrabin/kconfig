...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_4[5][3] = {{6UL,0x38L,6UL},{0UL,1UL,0UL},{6UL,0x38L,6UL},{0UL,1UL,0UL},{6UL,0x38L,6UL}};
...
{ /* block id: 0 */
    int32_t l_10 = (-5L);
    int32_t *l_11 = &g_12;
    (*l_11) ^= (g_4[1][2] >= ((safe_sub_func_int16_t_s_s((safe_lshift_func_int8_t_s_u(g_9, 4)), (l_10 || 0xBFC3938DD44AD374LL))) <= g_9));
    return (*l_11);
}
