...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_10.f0 g_10.f1
 * writes: g_3
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_8[7] = {8UL,0x8B8AE505B0BB8BFFLL,8UL,8UL,0x8B8AE505B0BB8BFFLL,8UL,8UL};
    struct S2 *l_9 = &g_10;
    int i;
    for (g_3 = 0; (g_3 != 14); g_3 = safe_add_func_uint16_t_u_u(g_3, 1))
    { /* block id: 3 */
        l_9 = ((safe_rshift_func_int8_t_s_u(l_8[2], 6)) , (void*)0);
        return g_10.f0;
    }
    return g_10.f1;
}
