...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[9] = {(-5L),0xDDBC3707L,(-5L),(-5L),0xDDBC3707L,(-5L),(-5L),0xDDBC3707L,(-5L)};
static int16_t g_6[6][3] = {{(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L)},{(-1L),(-1L),(-1L)}};
static uint32_t g_8 = 0x4E76AB2AL;
...
static const uint64_t  func_1(void)
{ /* block id: 0 */
    int32_t l_5 = 0xBA86BA47L;
    for (g_2[7] = (-2); (g_2[7] >= 16); ++g_2[7])
    { /* block id: 3 */
        int32_t *l_7 = (void*)0;
        --g_8;
    }
