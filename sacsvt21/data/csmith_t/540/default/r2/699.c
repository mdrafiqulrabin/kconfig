...
/* --- GLOBAL VARIABLES --- */
static int64_t g_8 = 0x42374B1B055CC25BLL;
static struct S0 g_13 = {10};
...
{ /* block id: 0 */
    ...
    int32_t l_3 = 6L;
    int32_t l_10 = 0x1AFA9B64L;
    int32_t *l_11 = (void*)0;
    int32_t *l_12 = &l_3;
    l_3 &= l_2;
    (*l_12) = (safe_lshift_func_uint8_t_u_u(((safe_mod_func_int64_t_s_s(g_8, (l_2 & (~l_10)))) , 0xA7L), 7));
    return g_13;
}
