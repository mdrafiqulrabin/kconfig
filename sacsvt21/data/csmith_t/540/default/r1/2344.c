...
static uint32_t g_5[3][3][2] = {{{1UL,0x6B5CFDA6L},{1UL,1UL},{1UL,0x6B5CFDA6L}},{{1UL,1UL},{1UL,0x6B5CFDA6L},{1UL,1UL}},{{1UL,0x6B5CFDA6L},{1UL,1UL},{1UL,0x6B5CFDA6L}}};
static struct S1 g_6 = {29,1,969,-2,2583,-27058,22,-102,0,4752};
...
static struct S1  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0x5C0C8FBFL;
    int32_t *l_3[5];
    int i;
    for (i = 0; i < 5; i++)
        l_3[i] = (void*)0;
    g_5[0][2][0] = ((g_4 = l_2) <= (l_3[4] == l_3[4]));
    return g_6;
}
