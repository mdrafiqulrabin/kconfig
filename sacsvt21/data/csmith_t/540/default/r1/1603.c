...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_3 = {-101,-2,-541,390,-773};/* VOLATILE GLOBAL g_3 */
static struct S0 * const g_2 = &g_3;
static struct S0 g_5 = {-110,2,-378,-81,-1904};/* VOLATILE GLOBAL g_5 */
static struct S0 *g_4[3] = {&g_5,&g_5,&g_5};
