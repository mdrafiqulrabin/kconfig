...
/* --- GLOBAL VARIABLES --- */
static const volatile struct S0 g_2 = {7UL,19118,18446744073709551615UL};/* VOLATILE GLOBAL g_2 */
static volatile struct S0 g_3 = {0xDE2BL,14459,0xF7D65121L};/* VOLATILE GLOBAL g_3 */
static uint16_t g_4 = 0xCE96L;
