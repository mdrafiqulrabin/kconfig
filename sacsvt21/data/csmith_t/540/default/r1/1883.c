...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_6[8] = {0xA20B95AEL,0x1151C3C3L,0xA20B95AEL,0xA20B95AEL,0x1151C3C3L,0xA20B95AEL,0xA20B95AEL,0x1151C3C3L};
static volatile int32_t * volatile g_5 = &g_6[6];/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    int32_t l_2 = 0L;
    int32_t *l_3 = &l_2;
    int32_t l_4 = 0x2167FA5CL;
    l_4 |= ((*l_3) = l_2);
    (*l_3) = ((g_5 == &l_4) && ((((*l_3) & (safe_add_func_int8_t_s_s(g_6[4], (*l_3)))) || g_6[0]) | 65535UL));
    return g_6[6];
}
