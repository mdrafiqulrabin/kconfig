...
static volatile struct S6 g_3 = {737};/* VOLATILE GLOBAL g_3 */
static volatile struct S6 * const  volatile g_4 = &g_3;/* VOLATILE GLOBAL g_4 */
static struct S3 g_5 = {-21,1380,0,3516,0,1UL,0x75L,1,54};/* VOLATILE GLOBAL g_5 */
