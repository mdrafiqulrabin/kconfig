...
{ /* block id: 36 */
    int32_t l_32 = 1L;
    int32_t *l_31 = &l_32;
    const int32_t l_35[2][5][3] = {{{(-1L),0x44D4E2B7L,0x44D4E2B7L},{2L,(-1L),2L},{(-1L),(-1L),0x44D4E2B7L},{0x2A6F9A4DL,(-1L),0x2A6F9A4DL},{(-1L),0x44D4E2B7L,0x44D4E2B7L}},{{2L,(-1L),2L},{(-1L),(-1L),0x44D4E2B7L},{0x2A6F9A4DL,(-1L),0x2A6F9A4DL},{(-1L),0x44D4E2B7L,0x44D4E2B7L},{2L,(-1L),2L}}};
    const int32_t *l_34 = &l_35[0][3][1];
    const int32_t **l_33 = &l_34;
    const int32_t *l_37 = &l_32;
    const int32_t **l_36 = &l_37;
    int32_t l_38 = 0x57218670L;
    int i, j, k;
    (*l_36) = ((*l_33) = l_31);
    /* statement id: 38 */
    assert (l_34 == &l_32);
