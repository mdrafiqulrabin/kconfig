...
{ /* block id: 0 */
    ...
    int32_t l_5 = (-1L);
    for (l_2 = 2; (l_2 >= (-3)); l_2 = safe_sub_func_uint8_t_u_u(l_2, 1))
    { /* block id: 3 */
        return l_2;
    }
    l_5 |= (l_2 < 8L);
