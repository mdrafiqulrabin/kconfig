...
static uint8_t  func_33(void)
{ /* block id: 36 */
    float l_36 = 0x5.A3DFADp-39;
    float *l_35 = &l_36;
    int32_t l_37 = 0xD7F19125;
    int32_t l_39 = 0xB5CF1C94;
    int32_t *l_38 = &l_39;
    int32_t l_40 = 0x717F4039;
    int32_t l_41 = 2;
    (*l_35) = (-(float)0x8.CD4959p+4);
    l_40 ^= ((*l_38) &= l_37);
    return l_41;
}
