...
static volatile uint32_t g_30 = 0x5C829ED8L;/* VOLATILE GLOBAL g_30 */
...
lbl_33:
    (*l_4) = g_2;
    for (g_3 = 0; (g_3 >= (-14)); g_3 = safe_sub_func_uint8_t_u_u(g_3, 9))
    { /* block id: 4 */
        int32_t *l_7 = &g_8;
        int32_t *l_9 = &g_8;
        int32_t *l_10 = &g_8;
