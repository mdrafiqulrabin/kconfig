...
inline static uint8_t  func_1(void)
{ /* block id: 0 */
    volatile uint16_t l_3 = 0x061F;/* VOLATILE GLOBAL l_3 */
    l_3 = g_2;
    return g_2;
}
