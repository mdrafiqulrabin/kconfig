...
static struct S0  func_1(void)
{ /* block id: 0 */
    struct S0 l_2 = {0x51C3C39BL,-5L,0xA97963BAL,0x0B95AE64L,0xF6D4A0D4L};
    struct S0 *l_3 = (void*)0;
    struct S0 *l_4 = &l_2;
    struct S0 l_5 = {0x56DFC9B9L,-4L,1UL,0x6335C0DEL,-2L};
    (*l_4) = l_2;
    return l_5;
}
