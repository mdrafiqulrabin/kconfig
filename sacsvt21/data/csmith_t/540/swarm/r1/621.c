 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --compound-assignment --no-consts --no-divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --no-longlong --no-int8 --no-uint8 --float --math64 --inline-function --muls --no-safe-math --packed-struct --no-paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      188241474
 */
...
static int32_t  func_30(void)
{ /* block id: 36 */
    uint16_t l_31 = 0x5B8B;
    float l_33 = 0x1.90C6D2p-58;
    float *l_32 = &l_33;
    int32_t l_34 = 0xAB9C279A;
    l_34 = (((*l_32) = (l_31 >= (0x1.C7008Bp+59 < l_31))) <= l_31);
    l_34 = 0xD.7D6364p+52;
    return l_34;
}
