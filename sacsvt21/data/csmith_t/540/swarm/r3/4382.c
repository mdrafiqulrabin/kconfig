...
/* 
 * reads : g_30
 * writes: g_31 g_30 g_35
 */
static uint32_t  func_28(void)
{ /* block id: 36 */
    int32_t *l_29 = &g_30;
    g_31 = l_29;
    for (g_30 = 6; (g_30 != 6); g_30 = safe_add_func_uint16_t_u_u(g_30, 9))
    { /* block id: 40 */
        int32_t *l_34 = &g_35;
        (*l_34) = 1L;
    }
