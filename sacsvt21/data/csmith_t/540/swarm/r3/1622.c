...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x2FD41E55L;/* VOLATILE GLOBAL g_2 */
...
static const uint16_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t l_3 = 0x57A7C203L;/* VOLATILE GLOBAL l_3 */
    l_3 = g_2;
    return g_2;
}
