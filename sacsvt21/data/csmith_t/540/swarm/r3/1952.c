...
{ /* block id: 36 */
    float l_30 = 0x6.7p+1;
    const int32_t l_31 = 3L;
    int32_t l_33 = (-6L);
    int32_t *l_32 = &l_33;
    uint32_t l_34 = 9UL;
    (*l_32) &= ((l_31 <= l_31) , 0xED1E12AAL);
    return l_34;
}
