...
static int16_t  func_26(void)
{ /* block id: 36 */
    int64_t l_30 = 0x12AA53F0D3ECF04BLL;
    for (g_4 = (-28); (g_4 > (-1)); g_4 = safe_add_func_int64_t_s_s(g_4, 1))
    { /* block id: 39 */
        uint64_t l_29 = 0x7104272BA75A592CLL;
        return l_29;
    }
    return l_30;
}
