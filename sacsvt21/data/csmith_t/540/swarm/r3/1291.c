...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_4[6] = {{0x1.8p-1,3UL},{0xD.969161p+15,4294967287UL},{0x1.8p-1,3UL},{0x1.8p-1,3UL},{0xD.969161p+15,4294967287UL},{0x1.8p-1,3UL}};
...
int main (void)
{
    ...
    for (i = 0; i < 6; i = i + 1)
    {
        transparent_crc_bytes(&g_4[i].f0, sizeof(g_4[i].f0), "g_4[i].f0", print_hash_value);
