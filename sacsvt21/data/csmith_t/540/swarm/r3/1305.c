...
inline static union U1  func_30(void)
{ /* block id: 36 */
    int32_t l_31 = 0xCBCB1A7AL;
    int32_t l_34 = (-1L);
    union U1 l_35 = {0L};
    for (l_31 = 11; (l_31 > 16); l_31 += 6)
    { /* block id: 39 */
        l_34 = (-1L);
    }
    return l_35;
