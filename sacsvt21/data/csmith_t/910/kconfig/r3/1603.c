...
static volatile uint64_t g_29 = 0x551B32E26595AD33LL;/* VOLATILE GLOBAL g_29 */
static const volatile int8_t g_33 = 5L;/* VOLATILE GLOBAL g_33 */
...
/* ------------------------------------------ */
/* 
 * reads : g_26 g_29 g_32 g_34 g_27 g_3 g_33
 * writes: g_27 g_29 g_34 g_3
 */
inline static int8_t  func_25(void)
{ /* block id: 36 */
    int32_t *l_28[2];
    int8_t **l_36[5] = {&g_34,&g_34,&g_34,&g_34,&g_34};
    int i;
    for (i = 0; i < 2; i++)
        l_28[i] = &g_3;
    (*g_26) = &g_3;
