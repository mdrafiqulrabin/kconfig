...
inline static float  func_1(void)
{ /* block id: 0 */
    int16_t l_2[4][9] = {{0x1115L,0x4C00L,0x4C00L,0x1115L,0x666AL,0xD9A9L,0x666AL,0x1115L,0x4C00L},{0x666AL,0x666AL,(-1L),0xD9A9L,(-7L),0xD9A9L,(-1L),0x666AL,0x666AL},{0x4C00L,0x1115L,0x666AL,0xD9A9L,0x666AL,0x1115L,0x4C00L,0x4C00L,0x1115L},{0xD9A9L,0x1115L,(-1L),0x1115L,0xD9A9L,3L,3L,0xD9A9L,0x1115L}};
    int i, j;
    return l_2[0][8];
}
