...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_3 = 0xC5440874L;
static int16_t g_34 = (-1L);
static union U3 g_36 = {-10L};
...
{ /* block id: 36 */
    ...
    int16_t *l_32 = (void*)0;
    int16_t *l_33 = &g_34;
    int32_t l_35 = 0x52280335L;
    l_35 = (safe_lshift_func_int16_t_s_s(((*l_33) ^= (safe_mul_func_uint16_t_u_u(1UL, l_31))), 13));
    return g_36;
    /* statement id: 39 */
    }
