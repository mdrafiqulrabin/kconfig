...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_10 = 0x16542076;
    int32_t l_27 = 0x6971DB95;
    l_27 = func_2(((int16_t)((uint16_t)((uint16_t)((l_10 | (0x54C9 >= (((uint32_t)l_10 % (uint32_t)((uint16_t)l_10 << (uint16_t)(3 || (-1)))) <= ((uint16_t)(-(uint32_t)((uint16_t)l_10 - (uint16_t)(((((1 | ((int32_t)((~l_10) >= l_10) - (int32_t)l_10)) == 0U) >= l_10) >= l_10) != l_10))) >> (uint16_t)l_10)))) && l_10) >> (uint16_t)1) + (uint16_t)1) + (int16_t)l_10));
    return l_10;
}
...
static int32_t  func_2(uint32_t  p_3)
{ /* block id: 1 */
    uint32_t l_25 = 0x8D08F492;
    int32_t l_26 = 0x42796A45;
    l_26 = l_25;
    return l_26;
}
