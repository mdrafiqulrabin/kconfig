...
static float g_30 = 0x9.209C39p+31;
static int32_t g_32[3] = {1L,1L,1L};
static volatile uint16_t g_33 = 0x4739L;/* VOLATILE GLOBAL g_33 */
...
{ /* block id: 36 */
    float *l_29 = &g_30;
    int32_t *l_31[10] = {&g_32[1],(void*)0,&g_32[1],(void*)0,&g_32[1],(void*)0,&g_32[1],(void*)0,&g_32[1],(void*)0};
    int i;
    (*l_29) = g_6;
    g_33++;
    return g_32[1];
