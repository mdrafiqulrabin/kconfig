...
inline static int64_t  func_30(void)
{ /* block id: 36 */
    uint32_t l_31 = 0xB8F6C218L;
    int32_t l_37 = 0xF62C4DF8L;
    int32_t *l_36 = &l_37;
    uint32_t l_38 = 0UL;
    (*l_36) ^= (l_31 != ((safe_mul_func_int8_t_s_s(((0x587C7AB89BDD7770LL >= l_31) >= l_31), (l_31 > ((safe_mod_func_int64_t_s_s(l_31, l_31)) >= l_31)))) || 0xCDA7209C3997B09BLL));
    return l_38;
}
