...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_11 = 0x6A9E;
static int32_t g_33 = 3;
static int32_t g_37 = 0xBD4856CD;
...
/* 
 * reads : g_11 g_33
 * writes: g_11 g_33 g_37
 */
static int32_t  func_29(void)
{ /* block id: 36 */
    uint32_t l_32 = 0U;
    for (g_11 = 0; (g_11 > 33); g_11 += 1)
    { /* block id: 39 */
        int32_t l_36 = 1;
        g_33 = l_32;
        if (g_33)
            break;
        g_37 = (__builtin_ffs(g_33) | ((int32_t)g_33 + (int32_t)l_36));
    }
    return g_33;
}
