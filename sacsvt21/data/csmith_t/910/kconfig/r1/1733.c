...
/* --- GLOBAL VARIABLES --- */
static int64_t g_7 = 0x5AB3E90A624CDB8FLL;
static float g_29[8] = {0x7.1p+1,0x7.1p+1,0x7.1p+1,0x7.1p+1,0x7.1p+1,0x7.1p+1,0x7.1p+1,0x7.1p+1};
static float * volatile g_28 = &g_29[3];/* VOLATILE GLOBAL g_28 */
static union U1 g_30 = {0UL};
