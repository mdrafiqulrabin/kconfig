...
static struct S1 g_27 = {669,58,-1L,0x1.3p+1,0xE.335C0Dp+86,0UL,0x101EB64DL};/* VOLATILE GLOBAL g_27 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_27.f3, sizeof(g_27.f3), "g_27.f3", print_hash_value);
    transparent_crc_bytes (&g_27.f4, sizeof(g_27.f4), "g_27.f4", print_hash_value);
