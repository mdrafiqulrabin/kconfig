...
/* --- GLOBAL VARIABLES --- */
static int32_t g_7[1][5] = {{0x151C3C39L,0x151C3C39L,0x151C3C39L,0x151C3C39L,0x151C3C39L}};
...
{ /* block id: 36 */
    int8_t l_30 = 0xA5L;
    int32_t l_35 = 0x5300CE3DL;
    l_35 = (~(((l_30 != (0xE4L >= (g_7[0][2] , 0x4DL))) | g_7[0][0]) | (safe_sub_func_int16_t_s_s((-1L), (safe_mod_func_uint64_t_u_u(__builtin_popcount(__builtin_parity(g_7[0][0])), 0x5DAA08BBD1883800LL))))));
    return g_7[0][0];
}
