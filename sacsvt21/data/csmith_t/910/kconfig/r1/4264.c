...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3 = 0x2F4A8B10L;
    int32_t l_4 = 0x2D4EA680L;
    l_4 = ((safe_unary_minus_func_uint16_t_u(l_3)) == 8L);
    return l_3;
}
