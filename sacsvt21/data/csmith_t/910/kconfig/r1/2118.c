...
/* --- GLOBAL VARIABLES --- */
static float g_5 = 0x1.0p+1;
static uint8_t g_6[5][4] = {{0x31L,0x8FL,0UL,0UL},{1UL,1UL,0x31L,0UL},{0xDDL,0x8FL,0xDDL,0x31L},{0xDDL,0x31L,0x31L,0xDDL},{1UL,0x31L,0UL,0x31L}};
static union U2 g_27 = {0x7.5p-1};/* VOLATILE GLOBAL g_27 */
