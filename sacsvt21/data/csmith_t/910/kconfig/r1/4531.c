...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_5 = 18446744073709551613UL;
static int32_t g_33[4][7] = {{0x97B09B37L,0x9BA5F27AL,0x9BA5F27AL,0x97B09B37L,0x31C587C7L,7L,0x31C587C7L},{4L,0xDA7209C3L,0xDA7209C3L,4L,(-5L),(-1L),(-5L)},{0x97B09B37L,0x9BA5F27AL,0x9BA5F27AL,0x97B09B37L,0x31C587C7L,7L,0x31C587C7L},{4L,0xDA7209C3L,0xDA7209C3L,4L,(-5L),(-1L),(-5L)}};
...
inline static int16_t  func_29(void)
{ /* block id: 36 */
    const int16_t l_30 = 0xA7B7L;
    int32_t *l_32 = &g_33[2][6];
    (*l_32) = (l_30 || (safe_unary_minus_func_uint8_t_u(7UL)));
    for (g_5 = (-12); (g_5 > 5); g_5 = safe_add_func_int16_t_s_s(g_5, 9))
    { /* block id: 40 */
        (*l_32) = 0x831966C4L;
    }
    return g_5;
