...
static uint32_t  func_29(void)
{ /* block id: 36 */
    int32_t l_31 = 0xC6FE23A2;
    int32_t *l_30 = &l_31;
    int32_t **l_32 = &l_30;
    uint32_t l_40 = 0x197E7C14;
    uint32_t l_41 = 0x21046671;
    int32_t l_42 = 0;
    (*l_30) = 7;
    (*l_32) = &l_31;
    (*l_32) = (void*)0;
    l_42 = (-(uint16_t)(((uint16_t)((int16_t)((int16_t)l_31 >> (int16_t)10) << (int16_t)11) - (uint16_t)l_31) != (l_40 <= l_41)));
    return l_41;
}
