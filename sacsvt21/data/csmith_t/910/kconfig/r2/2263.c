...
/* --- GLOBAL VARIABLES --- */
static float g_7 = 0x0.7p+1;
static float g_9 = 0xF.A7FE64p+93;
static int32_t g_10 = 0x8D3A18E4L;
...
{ /* block id: 0 */
    ...
    uint32_t l_8 = 0x707DFE4DL;
    l_2 = (-0x1.Bp+1);
    l_8 = (safe_add_func_uint32_t_u_u(((safe_mul_func_int16_t_s_s(0x624CL, l_2)) != l_2), 0x21DED680L));
    return g_10;
}
