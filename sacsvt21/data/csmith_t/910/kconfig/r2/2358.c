...
static union U1 g_30 = {0U};/* VOLATILE GLOBAL g_30 */
...
inline static union U1  func_26(void)
{ /* block id: 36 */
    int32_t l_27[7] = {0xC9C3D069,0xC9C3D069,0xC9C3D069,0xC9C3D069,0xC9C3D069,0xC9C3D069,0xC9C3D069};
    uint32_t l_28 = 0U;
    int32_t l_29 = 0x34B0B4EF;
    int i;
    l_28 = (l_27[0] = g_3);
    l_29 = g_3;
    return g_30;
