...
inline static int32_t  func_28(void)
{ /* block id: 36 */
    int32_t l_33 = 0x2F67D50F;
    int32_t l_39 = 0x1FC65786;
    const uint32_t l_50 = 1U;
    int32_t l_51 = 9;
    int32_t l_52 = 0x6F0D4A7C;
    uint32_t l_53 = 0U;
    int32_t l_55 = 1;
    int32_t *l_54 = &l_55;
    int32_t l_56 = 0xFD90538E;
    (*l_54) = ((int16_t)func_31(l_33) + (int16_t)((((int16_t)5 - (int16_t)(((l_39 = l_33) , ((uint16_t)__builtin_parityl((((int16_t)0xA38D << (int16_t)((((((((((int16_t)l_39 - (int16_t)((uint32_t)(0xB314 && (l_39 >= (l_39 >= l_50))) % (uint32_t)(-7))) & l_51) <= (-8)) , l_51) ^ l_52) >= l_52) || l_50) | l_39) ^ l_52)) >= l_39)) << (uint16_t)9)) <= 0x7BAA9D70)) >= 0xEB7B) || l_53));
    (*l_54) ^= 0x6DCB0C7B;
    return l_56;
}
