...
static uint8_t g_33 = 0x11L;
static int32_t g_35[4] = {0xEE39F3FAL,0xEE39F3FAL,0xEE39F3FAL,0xEE39F3FAL};
static int32_t * volatile g_34 = &g_35[3];/* VOLATILE GLOBAL g_34 */
...
static float  func_26(void)
{ /* block id: 36 */
    int32_t l_36 = 0x5E0710DDL;
    for (g_3 = 0; (g_3 != (-24)); g_3 = safe_sub_func_int8_t_s_s(g_3, 3))
    { /* block id: 39 */
        int32_t l_31[5];
        uint8_t *l_32 = &g_33;
        int i;
        for (i = 0; i < 5; i = i + 1)
            l_31[i] = (-6L);
        (*g_34) = (safe_mod_func_uint8_t_u_u(l_31[4], ((*l_32) = g_3)));
    }
    return l_36;
}
