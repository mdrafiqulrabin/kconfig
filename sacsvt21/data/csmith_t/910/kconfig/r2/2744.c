...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[1] = {0xA624CDB8};
static volatile int32_t g_3[3] = {0x9AE77AB3,0x9AE77AB3,0x9AE77AB3};
static volatile int32_t g_4 = 1;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0x55595070;
static int8_t g_9 = 0x82;
...
/* ------------------------------------------ */
/* 
 * reads : g_5 g_8 g_12 g_3
 * writes: g_5 g_13 g_14
 */
static const int16_t  func_1(void)
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t *l_11 = (void*)0;
        uint16_t l_15 = 0xEE39;
        (*g_12) = ((void*)0 == g_8);
        g_14 = &g_2[0];
        /* statement id: 5 */
        assert ((g_14 >= &g_2[0] && g_14 <= &g_2[0]));
        if (l_15)
            continue;
    }
    /* facts after for loop */
    assert ((g_14 >= &g_2[0] && g_14 <= &g_2[0]) || g_14 == 0);
    return g_3[2];
}
