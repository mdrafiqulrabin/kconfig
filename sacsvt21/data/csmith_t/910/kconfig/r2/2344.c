...
/* --- GLOBAL VARIABLES --- */
static const int64_t g_9 = 0x4D9EDBDA7FE64FD9LL;
static int64_t g_11[1] = {6L};
static int32_t g_30 = 0xD0BB94D0L;
static volatile uint64_t g_35[3][1] = {{9UL},{9UL},{9UL}};
...
{ /* block id: 36 */
    ...
    int32_t *l_32 = &g_30;
    int32_t *l_33 = &g_30;
    int32_t *l_34[5] = {&g_30,&g_30,&g_30,&g_30,&g_30};
    int32_t **l_38[6] = {&l_34[4],&l_34[4],&l_34[4],&l_34[4],&l_34[4],&l_34[4]};
    int i;
    g_35[2][0]++;
    g_39 = l_34[0];
    return g_9;
