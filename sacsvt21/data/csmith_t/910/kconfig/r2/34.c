...
{ /* block id: 36 */
    ...
    int32_t l_41 = (-1);
    int32_t l_42 = 0;
    l_41 ^= (func_29(l_31) <= ((int16_t)((int32_t)(((int16_t)(l_31 || l_31) << (int16_t)(((l_31 && l_31) == (65526U == (((uint16_t)0xF58A - (uint16_t)65533U) >= l_31))) > l_31)) != l_31) + (int32_t)l_31) * (int16_t)l_31));
    l_41 = (0xDBCABEBF == l_41);
    l_42 &= l_41;
    l_41 = l_42;
    return l_41;
}
