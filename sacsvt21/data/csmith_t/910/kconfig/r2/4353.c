...
static struct S1  func_28(void)
{ /* block id: 36 */
    uint32_t l_31 = 0x1E2DB80E;
    int32_t l_32 = 0xDD484073;
    struct S1 l_33 = {6,0xB8846B51,0,5U,1U,0x0336,-3};
    l_32 = ((uint32_t)__builtin_parityll(l_31) - (uint32_t)((g_9 & (g_7 <= l_31)) && 1U));
    g_7 = 0x28033590;
    return l_33;
}
