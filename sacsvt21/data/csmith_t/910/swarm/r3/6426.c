 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --no-consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --no-uint8 --float --math64 --no-inline-function --no-muls --no-safe-math --no-packed-struct --paranoid --no-pointers --no-structs --no-unions --no-volatiles --volatile-pointers --const-pointers --global-variabless --builtins
 * Seed:      1128679678
 */
...
static uint16_t  func_28(void)
{ /* block id: 36 */
    for (g_3 = (-18); (g_3 >= 44); ++g_3)
    { /* block id: 39 */
        int64_t l_36 = 8L;
        for (g_31 = (-27); (g_31 != (-26)); g_31 += 1)
        { /* block id: 42 */
            l_36 = (((uint16_t)65535UL << (uint16_t)14) == 1L);
        }
    }
    return g_31;
}
