...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_2 = 0xE7D8A87013DCE9D0LL;
static int32_t g_8 = 0L;
static int32_t g_10 = 0x60E704F3L;
...
inline static uint64_t  func_1(void)
{ /* block id: 0 */
    int64_t l_5 = 0x73FF82FF40FC0272LL;
    int32_t *l_6 = (void*)0;
    int32_t *l_7 = &g_8;
    int32_t *l_9 = &g_10;
    (*l_9) = (g_2 && ((*l_7) = ((uint16_t)l_5 % (uint16_t)l_5)));
    for (g_2 = 0; (g_2 != 59); g_2 += 1)
    { /* block id: 5 */
        (*l_7) &= g_10;
        g_10 ^= g_2;
    }
