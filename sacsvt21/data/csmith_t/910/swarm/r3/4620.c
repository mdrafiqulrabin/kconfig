 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --compound-assignment --consts --no-divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --uint8 --float --no-math64 --no-inline-function --muls --no-safe-math --packed-struct --paranoid --pointers --no-structs --unions --no-volatiles --no-volatile-pointers --const-pointers --global-variabless --builtins
 * Seed:      1675686864
 */
...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_5 = 0xEAC45307L;
static int32_t g_31 = 0x4EF66B17L;
static int16_t g_33 = 0x0D68L;
...
{ /* block id: 36 */
    int32_t *l_30 = &g_31;
    int32_t *l_32 = (void*)0;
    g_33 = ((*l_30) = ((int16_t)g_5 >> (int16_t)9));
    return g_5;
}
