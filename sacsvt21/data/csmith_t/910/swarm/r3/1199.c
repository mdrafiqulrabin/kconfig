 ...
 * Git version: 30dccd7
 * Options:   --no-argc --arrays --bitfields --no-comma-operators --no-compound-assignment --no-consts --divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --unary-plus-operator --jumps --longlong --int8 --uint8 --float --math64 --inline-function --muls --no-safe-math --packed-struct --no-paranoid --no-pointers --no-structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      2643105186
 */
...
static int32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31[5][3] = {{(-10L),0x905B8B78L,(-10L)},{(-2L),0L,(-2L)},{(-10L),0x905B8B78L,(-10L)},{(-2L),0L,(-2L)},{(-10L),0x905B8B78L,(-10L)}};
    int8_t l_32 = 0L;
    int i, j;
    l_32 = l_31[3][2];
    return l_31[3][2];
