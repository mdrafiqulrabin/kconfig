...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0xE31551DAL;
    l_4 = ((safe_div_func_uint8_t_u_u(l_4, 0x2AL)) > l_4);
    return l_4;
}
