...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_6;
    int32_t **l_9 = &g_8;
    (*l_5) = (safe_sub_func_uint8_t_u_u(l_4, 5UL));
    (*l_5) = (g_6 >= (*l_5));
    l_9 = g_7;
    return (*l_5);
}
