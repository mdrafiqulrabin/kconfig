 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --compound-assignment --no-consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --no-int8 --uint8 --no-float --math64 --inline-function --muls --safe-math --no-packed-struct --no-paranoid --no-pointers --structs --no-unions --volatiles --volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      1633407002
 */
...
inline static int16_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31 = 0x0EA0C8D4;
    int32_t l_32 = 0x56EC7E43;
    uint32_t l_35 = 1U;
    struct S1 l_36 = {-3,3168,7,2,-561,111,137,-3,{3,0x49BC,164,0xEADD5D08,0x18,0x6FBD,6U,1},41};
    l_32 &= l_31;
    l_35 = (safe_mod_func_int32_t_s_s(l_32, l_32));
    l_36 = l_36;
    return l_36.f4;
}
