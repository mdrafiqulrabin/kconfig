...
inline static uint32_t  func_1(void)
{ /* block id: 0 */
    float l_2 = 0x3.8A8701p+33;
    int32_t l_3 = (-3L);
    float l_5 = 0xF.73FF82p+20;
    l_2 = 0x2.40D7F8p-29;
    g_4 = l_3;
    return g_4;
}
