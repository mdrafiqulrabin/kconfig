 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --compound-assignment --consts --no-divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --no-int8 --no-uint8 --no-float --math64 --inline-function --no-muls --safe-math --no-packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      271813122
 */
...
static int32_t g_34 = 0x314A5EA9L;
...
{ /* block id: 36 */
    int32_t *l_35 = (void*)0;
    int32_t *l_36 = &g_34;
    for (g_8 = (-29); (g_8 >= 25); g_8 = safe_add_func_uint16_t_u_u(g_8, 5))
    { /* block id: 39 */
        int32_t *l_33 = &g_34;
        (*l_33) = (g_8 <= g_8);
    }
