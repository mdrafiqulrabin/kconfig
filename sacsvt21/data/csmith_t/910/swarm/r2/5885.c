 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --no-compound-assignment --consts --no-divs --no-embedded-assigns --no-pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --longlong --int8 --uint8 --float --no-math64 --inline-function --no-muls --no-safe-math --no-packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      479069060
 */
...
static int32_t  func_34(void)
{ /* block id: 36 */
    uint32_t l_35 = 0x5C1D1022L;
    int32_t l_37 = (-7L);
    int32_t *l_36 = &l_37;
    int32_t **l_38 = (void*)0;
    const int32_t *l_40 = (void*)0;
    const int32_t **l_39 = &l_40;
    int32_t l_41 = 0x9BF5E4D8L;
    (*l_36) = l_35;
    (*l_39) = &l_37;
    /* statement id: 38 */
    assert (l_40 == &l_37);
