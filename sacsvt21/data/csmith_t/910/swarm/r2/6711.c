...
static union U0  func_1(void)
{ /* block id: 0 */
    const uint16_t l_2 = 0x85B7;
    int32_t l_3 = 4;
    union U0 l_4 = {0x1B88146C};
    l_3 = (l_2 != l_2);
    return l_4;
}
