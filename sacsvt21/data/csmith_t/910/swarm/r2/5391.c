...
static uint32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31 = 0x73672D71L;
    for (l_31 = 0; (l_31 >= 21); l_31 = safe_add_func_int16_t_s_s(l_31, 1))
    { /* block id: 39 */
        uint16_t l_36 = 0xC326L;
        int32_t *l_37 = (void*)0;
        int32_t l_39 = 0xAEBA4D3EL;
        int32_t *l_38 = &l_39;
        (*l_38) = (safe_lshift_func_uint16_t_u_s(l_31, l_36));
        return l_31;
    }
    return l_31;
}
