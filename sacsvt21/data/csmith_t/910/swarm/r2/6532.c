 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --compound-assignment --no-consts --divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --no-int8 --uint8 --no-float --no-math64 --inline-function --no-muls --safe-math --packed-struct --paranoid --pointers --structs --unions --volatiles --volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      1294926434
 */
...
{ /* block id: 36 */
    ...
    int32_t l_34 = (-1);
    int32_t *l_33 = &l_34;
    int32_t l_39 = 0x309642E4;
    int32_t l_41 = 0x787D6364;
    int32_t *l_40 = &l_41;
    int32_t l_42 = 0xEDFA90EF;
    (*l_33) = ((*l_32) = l_31);
    (*l_40) &= (safe_rshift_func_int16_t_s_u((safe_mod_func_uint32_t_u_u((*l_32), l_39)), (*l_33)));
    return l_42;
}
