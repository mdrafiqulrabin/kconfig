...
static int32_t  func_1(void)
{ /* block id: 0 */
    float l_6 = 0xD.AE5A60p-61;
    int32_t l_7 = 0xB7F37C04L;
    for (g_2 = 2; (g_2 != (-16)); g_2 = safe_sub_func_int16_t_s_s(g_2, 9))
    { /* block id: 3 */
        uint32_t l_5 = 0xFB023ED1L;
        l_5 = g_2;
    }
    return l_7;
}
