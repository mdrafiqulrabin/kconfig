...
static int8_t  func_32(void)
{ /* block id: 36 */
    int64_t l_35 = 0xBB4F5AC3D6C1DFE9LL;
    int32_t *l_36 = (void*)0;
    int32_t *l_37 = &g_3;
    for (g_3 = 0; (g_3 > (-17)); g_3 = safe_sub_func_int64_t_s_s(g_3, 3))
    { /* block id: 39 */
        return g_3;
    }
    (*l_37) = l_35;
