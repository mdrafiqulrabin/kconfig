 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --compound-assignment --no-consts --no-divs --no-embedded-assigns --pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --longlong --int8 --uint8 --float --math64 --no-inline-function --muls --safe-math --no-packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      891265720
 */
...
static int64_t  func_28(void)
{ /* block id: 36 */
    int32_t l_29 = 0xF0D0714AL;
    int32_t *l_48 = &l_29;
    int32_t **l_47 = &l_48;
    int32_t l_49 = (-8L);
    for (l_29 = 0; (l_29 > (-3)); l_29 = safe_sub_func_int8_t_s_s(l_29, 1))
    { /* block id: 39 */
        float l_35 = 0xF.B66FEBp-31;
        int32_t *l_44 = &l_29;
        int32_t **l_43 = &l_44;
        int32_t ***l_46 = &l_43;
        int32_t ****l_45 = &l_46;
