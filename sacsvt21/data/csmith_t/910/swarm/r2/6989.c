 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --compound-assignment --no-consts --divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --no-float --no-math64 --no-inline-function --no-muls --no-safe-math --no-packed-struct --paranoid --pointers --no-structs --unions --volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      664151202
 */
...
{ /* block id: 36 */
    ...
    { /* block id: 39 */
        ...
        int32_t *l_50 = &l_51;
        (*l_36) = l_35;
        (*l_50) = ((uint32_t)0x64A90C6D + (uint32_t)(l_32 & ((((int32_t)(((int16_t)(*l_35) - (int16_t)(&l_32 == &l_32)) < func_43((*l_35))) - (int32_t)(((int16_t)l_32 + (int16_t)((((__builtin_ffsl((*l_35)) == l_32) && l_32) && l_32) < 0xFB6F85A0)) < 1)) < 0x18A88ACC) | (**l_36))));
    }
    return l_32;
}
