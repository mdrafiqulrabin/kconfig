...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_25 = 0x3C61C71BL;
static const int32_t g_38 = 0L;
static int32_t g_40 = 0xF6A191A8L;
...
{ /* block id: 36 */
    uint8_t l_35 = 0UL;
    int32_t *l_39 = &g_40;
    (*l_39) = (safe_rshift_func_uint16_t_u_u(g_25, __builtin_ffsl((g_25 ^ (((safe_lshift_func_uint16_t_u_u(((__builtin_parityl(l_35) > ((safe_sub_func_uint32_t_u_u(l_35, ((g_38 || (0UL >= g_25)) <= l_35))) < g_38)) <= 0x3AE4C7BAL), g_38)) | l_35) >= 0L)))));
    return g_40;
}
