...
inline static uint32_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_6 = 0x58BAC04EE7D214C4LL;
    for (g_2 = 0; (g_2 > (-19)); g_2 -= 9)
    { /* block id: 3 */
        uint64_t l_5 = 5UL;
        if (g_2)
            break;
