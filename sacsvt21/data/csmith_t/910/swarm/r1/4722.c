...
{ /* block id: 0 */
    int8_t l_4[6];
    int32_t l_6 = 0xC07E17F7L;
    int32_t *l_5 = &l_6;
    int32_t l_9 = 0x49CEC79EL;
    int i;
    for (i = 0; i < 6; i = i + 1)
        l_4[i] = (-5L);
    (*l_5) = (safe_lshift_func_uint16_t_u_u(l_4[4], 9));
    for (l_6 = 2; (l_6 > 7); l_6 = safe_add_func_int8_t_s_s(l_6, 1))
    { /* block id: 4 */
        if ((*l_5))
            break;
    }
