...
static int32_t g_8 = 0x9B4E94F9;
static union U1 g_12 = {5};/* VOLATILE GLOBAL g_12 */
static union U1 *g_11 = &g_12;
static int32_t * volatile g_14 = &g_12.f3;/* VOLATILE GLOBAL g_14 */
static union U0 g_20 = {9U};/* VOLATILE GLOBAL g_20 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_11 g_14 g_12.f3 g_20
 * writes: g_2 g_8 g_12.f3 g_11
 */
static union U0  func_1(void)
{ /* block id: 0 */
    ...
    int32_t *l_19 = &g_2;
    int32_t **l_18 = &l_19;
    for (g_2 = (-25); (g_2 < (-12)); g_2 += 4)
    { /* block id: 3 */
        uint32_t l_5 = 1U;
        l_5 = 0x5DAE5A60;
        for (l_5 = 26; (l_5 < 16); --l_5)
        { /* block id: 7 */
            g_8 = g_2;
        }
    }
