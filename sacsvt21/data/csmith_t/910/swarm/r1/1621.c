 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --comma-operators --no-compound-assignment --consts --divs --embedded-assigns --pre-incr-operator --pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --no-longlong --no-int8 --uint8 --no-float --no-math64 --no-inline-function --muls --no-safe-math --no-packed-struct --no-paranoid --pointers --structs --unions --no-volatiles --no-volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      2275882530
 */
...
static uint32_t  func_31(void)
{ /* block id: 36 */
    int32_t l_36 = 0x0C18AB9C;
    int16_t l_39 = 0x4D1B;
    int16_t *l_38 = &l_39;
    int32_t l_43 = 0x2044653F;
    int32_t *l_42 = &l_43;
    int32_t l_44 = (-10);
    (*l_42) = (l_36 = (((int16_t)((int16_t)(l_36 , (!l_36)) + (int16_t)((*l_38) = (-2))) * (int16_t)((int16_t)l_36 << (int16_t)2)) | l_36));
    return l_44;
}
