...
static int32_t g_6[2][9] = {{0x5D1C58BDL,7L,0x5D1C58BDL,0x5D1C58BDL,7L,0x5D1C58BDL,0x5D1C58BDL,7L,0x5D1C58BDL},{6L,0xADF62858L,6L,6L,0xADF62858L,6L,6L,0xADF62858L,6L}};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4[7];
    uint32_t l_7 = 0xB6062CF9L;
    int32_t l_10 = 0x95EF2B5DL;
    int i;
    for (i = 0; i < 7; i++)
        l_4[i] = &g_3;
    l_7--;
