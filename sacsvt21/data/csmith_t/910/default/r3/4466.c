...
static int32_t g_4 = 0xE0FC36FEL;
static uint32_t g_5 = 0x83BC1B0FL;
static struct S3 g_10 = {0,-46,-0,36,13,-1115,0x28L,-9,0};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    int i;
    ++g_5;
    g_4 = (g_5 < (safe_lshift_func_int16_t_s_s(((g_10 , g_10.f2) || g_10.f4), (safe_div_func_int16_t_s_s(0x14BAL, ((*l_13) = (-2L)))))));
    return g_4;
}
