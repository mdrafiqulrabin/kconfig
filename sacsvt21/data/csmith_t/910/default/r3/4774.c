...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_3 = 0xCEC79E672CA3C0BFLL;
static int32_t g_6 = 0x8EDFE012L;
static int32_t * volatile g_5[5][3] = {{&g_6,&g_6,&g_6},{&g_6,&g_6,(void*)0},{&g_6,&g_6,(void*)0},{&g_6,&g_6,(void*)0},{&g_6,&g_6,(void*)0}};
...
{ /* block id: 0 */
    uint64_t *l_2 = &g_3;
    int32_t l_4[3];
    int32_t * volatile l_7 = (void*)0;/* VOLATILE GLOBAL l_7 */
    int i;
    for (i = 0; i < 3; i++)
        l_4[i] = 0x71247ADFL;
    l_4[0] = (18446744073709551609UL || ((*l_2) = 0xCE3E63E31551DA62LL));
    l_7 = g_5[3][0];
    return g_6;
}
