...
static const uint32_t g_6 = 0x594D0357L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_5 = 0x2456L;
    int32_t *l_8[3][5] = {{&g_9,&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,(void*)0,&g_9,&g_9}};
    int i, j;
    g_9 |= ((g_2 != ((safe_div_func_uint8_t_u_u(l_5, (g_6 ^ (9L <= g_6)))) | (((l_5 >= (!1UL)) > (-8L)) < (l_5 , 0x31L)))) || (-6L));
    return g_9;
}
