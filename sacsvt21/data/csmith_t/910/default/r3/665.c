...
/* ------------------------------------------ */
/* 
 * reads : g_6 g_13 g_15 g_14
 * writes: g_6 g_14 g_16
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    uint64_t *l_4 = (void*)0;
    ...
    for (i = 0; i < 1; i++)
        l_11[i] = 0xB054DBBEL;
    (*g_13) = ((safe_add_func_uint64_t_u_u((l_11[0] = (--(*l_5))), 0xC5440874B28ED4A5LL)) < (4294967295UL || l_12));
    (*g_15) = &l_5;
    return (*g_13);
}
