...
static volatile uint32_t g_20[4] = {0xEC3203BDL,0xEC3203BDL,0xEC3203BDL,0xEC3203BDL};
...
{ /* block id: 0 */
    ...
    int32_t *l_17 = &g_3;
    int32_t *l_18 = (void*)0;
    int32_t *l_19[4][4] = {{&l_4,&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4,&l_4}};
    int i, j;
    g_20[1]++;
    return g_3;
}
