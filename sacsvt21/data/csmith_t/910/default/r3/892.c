...
static int32_t g_8 = 0x90C6D21CL;
...
{ /* block id: 0 */
    int16_t l_4 = 0L;
    int32_t l_5 = (-1L);
    int32_t *l_7[9][4] = {{(void*)0,&g_8,(void*)0,&g_8},{&g_8,&g_8,&g_8,&g_8},{&g_8,&g_8,&g_8,&g_8},{(void*)0,&g_8,&g_8,&g_8},{&g_8,&g_8,&g_8,&g_8},{&g_8,&g_8,(void*)0,&g_8},{(void*)0,&g_8,&g_8,&g_8},{&g_8,&g_8,&g_8,&g_8},{&g_8,&g_8,&g_8,&g_8}};
    int32_t **l_9 = (void*)0;
    int32_t **l_10[5];
    int i, j;
    for (i = 0; i < 5; i++)
        l_10[i] = (void*)0;
    g_8 |= (safe_div_func_int8_t_s_s((l_5 = l_4), g_6));
    g_11 = &l_5;
    return g_8;
}
