...
/* --- GLOBAL VARIABLES --- */
static const volatile int16_t g_6[5] = {0L,0L,0L,0L,0L};
static uint16_t g_7 = 0x383CL;
static int64_t g_9 = 0x65C829ED890FC520LL;
...
{ /* block id: 0 */
    int32_t *l_8 = (void*)0;
    int32_t *l_10 = &g_11;
    (*l_10) ^= (g_9 = (safe_rshift_func_int8_t_s_s((safe_mul_func_int16_t_s_s((g_6[1] ^ g_7), 65531UL)), g_7)));
    (*l_10) ^= g_6[1];
    return g_6[1];
}
