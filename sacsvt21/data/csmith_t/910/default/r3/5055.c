...
/* --- GLOBAL VARIABLES --- */
static volatile union U1 * volatile g_2 = (void*)0;/* VOLATILE GLOBAL g_2 */
static volatile union U1 g_4 = {-2L};/* VOLATILE GLOBAL g_4 */
...
static const int64_t  func_1(void)
{ /* block id: 0 */
    volatile union U1 * volatile l_3 = &g_4;/* VOLATILE GLOBAL l_3 */
    l_3 = g_2;
    return g_4.f0;
}
