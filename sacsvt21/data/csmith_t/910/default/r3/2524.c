...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_4 = 0x3009CE4562513244LL;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    const uint32_t l_3 = 0xD526D2E8L;
    uint32_t *l_11 = (void*)0;
    uint32_t *l_12 = &g_13;
    int16_t l_17 = 0xD700L;
    (*g_18) &= ((((safe_unary_minus_func_uint64_t_u(l_3)) < ((g_4 <= (safe_mod_func_uint8_t_u_u(g_4, 3L))) < (l_3 & (((safe_div_func_uint64_t_u_u(((l_3 >= func_9(((*l_12) = g_4))) >= (safe_lshift_func_int16_t_s_s(func_9((l_3 , l_17)), g_4))), g_4)) != g_4) ^ 0x234AC0198AB79AE4LL)))) < g_4) <= l_3);
    return g_19;
}
