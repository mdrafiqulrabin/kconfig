...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2 = 0x733C6338L;
static int32_t g_5[3] = {0x6B9DD952L,0x6B9DD952L,0x6B9DD952L};
...
{ /* block id: 0 */
    int32_t *l_3 = (void*)0;
    int32_t *l_4[1][10] = {{&g_5[0],&g_5[2],&g_5[0],&g_5[2],&g_5[0],&g_5[2],&g_5[0],&g_5[2],&g_5[0],&g_5[2]}};
    int i, j;
    g_6 = (g_5[2] = g_2);
    return g_5[1];
}
