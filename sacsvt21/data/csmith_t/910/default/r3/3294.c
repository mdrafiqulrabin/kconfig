...
{ /* block id: 0 */
    int32_t *l_13 = &g_7[5];
    int32_t l_16 = 0x10977A12L;
    int32_t *l_17 = &g_3;
    int32_t *l_18[1];
    int32_t l_19 = 0x4CA77904L;
    int16_t l_20 = 0x1D4CL;
    uint32_t l_21[1][5] = {{0xB545435DL,0xB545435DL,0xB545435DL,0xB545435DL,0xB545435DL}};
    int i, j;
    for (i = 0; i < 1; i++)
        l_18[i] = (void*)0;
