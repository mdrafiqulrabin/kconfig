...
static struct S0 g_10[1][8] = {{{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958},{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958},{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958},{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958},{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958},{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958},{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958},{36,-9L,0x7C28CAE2L,-1215,-760,-7,208,26103,56,-1958}}};
...
int main (int argc, char* argv[])
{
    ...
    for (i = 0; i < 1; i++)
    {
        for (j = 0; j < 8; j++)
        {
            ...
            transparent_crc(g_10[i][j].f8, "g_10[i][j].f8", print_hash_value);
            transparent_crc(g_10[i][j].f9, "g_10[i][j].f9", print_hash_value);
