...
/* --- GLOBAL VARIABLES --- */
static volatile int16_t g_8[2][7] = {{0x8B8AL,0xFBEFL,1L,1L,0xFBEFL,0x8B8AL,0xFBEFL},{5L,0x8B8AL,0x8B8AL,5L,0xFBEFL,5L,0x8B8AL}};
static int32_t g_11 = 0x2AA53F0DL;
...
{ /* block id: 0 */
    ...
    (*l_10) |= ((l_2 > (safe_mul_func_int16_t_s_s(l_5[0][2], (safe_sub_func_uint32_t_u_u(g_8[1][6], l_5[0][3]))))) == 0L);
    return g_8[1][6];
}
