...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x4CF59275L;
static volatile uint32_t g_6[4] = {4294967290UL,4294967290UL,4294967290UL,4294967290UL};
static struct S5 g_9 = {-3365,78,14054};/* VOLATILE GLOBAL g_9 */
...
static struct S5  func_1(void)
{ /* block id: 0 */
    uint64_t l_2 = 0x3A6C9CD49FCFBCE0LL;
    int32_t *l_3 = &g_4;
    int32_t *l_5[1];
    int i;
    for (i = 0; i < 1; i++)
