...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0xDD3F4672L;
static volatile int8_t g_8 = 0x00L;/* VOLATILE GLOBAL g_8 */
static volatile uint64_t g_9 = 0x226C312FBB6BC3ECLL;/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    ...
    union U0 l_12[5] = {{0L},{0L},{0L},{0L},{0L}};
    int i;
    --g_9;
    return l_12[0];
}
