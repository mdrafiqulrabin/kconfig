...
static volatile uint32_t g_14 = 3UL;/* VOLATILE GLOBAL g_14 */
static uint16_t g_15 = 0xEBA4L;
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_3[0][0];
    int32_t *l_7 = (void*)0;
    int32_t *l_8[7][3] = {{&g_3[0][0],(void*)0,&g_3[0][0]},{&g_3[0][0],&g_3[0][0],&g_3[0][0]},{&g_3[0][0],(void*)0,&g_3[0][0]},{&g_3[0][0],&g_3[0][0],&g_3[0][0]},{&g_3[0][0],(void*)0,&g_3[0][0]},{&g_3[0][0],&g_3[0][0],&g_3[0][0]},{&g_3[0][0],(void*)0,&g_3[0][0]}};
    uint32_t l_9 = 18446744073709551615UL;
    int i, j;
    l_9++;
    g_15 &= ((g_3[0][0] == (safe_lshift_func_uint8_t_u_u(0xC3L, 4))) > g_14);
    return g_15;
}
