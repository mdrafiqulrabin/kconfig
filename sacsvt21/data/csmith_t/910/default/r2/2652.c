...
static volatile int32_t g_6 = 0x45625132L;/* VOLATILE GLOBAL g_6 */
static volatile int32_t g_7 = 0x513C61C7L;/* VOLATILE GLOBAL g_7 */
static int32_t g_8 = 0x7DCD66A0L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_2[i] = (void*)0;
    --g_3;
    for (g_8 = 0; (g_8 > (-25)); g_8 = safe_sub_func_int8_t_s_s(g_8, 3))
    { /* block id: 4 */
        return g_3;
    }
    return g_8;
