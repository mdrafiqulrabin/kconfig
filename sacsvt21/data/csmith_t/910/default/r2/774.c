...
static const int64_t  func_1(void)
{ /* block id: 0 */
    int8_t l_2[3][1][8] = {{{0x27L,0x3FL,0x3FL,0x27L,0x27L,0x3FL,0x3FL,0x27L}},{{0x27L,0x3FL,0x3FL,0x27L,0x27L,0x3FL,0x3FL,0x27L}},{{0x27L,0x3FL,0x3FL,0x27L,0x27L,0x3FL,0x3FL,0x27L}}};
    int i, j, k;
    (*g_4) ^= (g_3 = l_2[1][0][0]);
    return g_3;
}
