...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[9] = {0x73BF38C0L,0x73BF38C0L,0x73BF38C0L,0x73BF38C0L,0x73BF38C0L,0x73BF38C0L,0x73BF38C0L,0x73BF38C0L,0x73BF38C0L};
static struct S1 g_4 = {0,0UL,0x4B9A733EL};/* VOLATILE GLOBAL g_4 */
...
static struct S1  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[8] = {&g_3[2],&g_3[0],&g_3[2],&g_3[0],&g_3[2],&g_3[0],&g_3[2],&g_3[0]};
    int i;
    g_3[2] &= (-1L);
    return g_4;
}
