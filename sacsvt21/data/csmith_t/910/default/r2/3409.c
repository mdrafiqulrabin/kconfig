...
static volatile int32_t g_4 = 0x653D4237L;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = (-1L);/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_6 = 0xC25BFC88L;/* VOLATILE GLOBAL g_6 */
...
static const uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_11 = 0x70A3267EL;
    for (g_7 = 2; (g_7 <= (-8)); g_7 = safe_sub_func_int32_t_s_s(g_7, 1))
    { /* block id: 3 */
        int32_t *l_10 = (void*)0;
        l_11++;
    }
