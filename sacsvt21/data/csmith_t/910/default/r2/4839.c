...
static int32_t g_10 = 0xBDE64F6CL;
static int32_t * const  volatile g_9 = &g_10;/* VOLATILE GLOBAL g_9 */
static struct S1 g_11 = {2,534,-320,-10};/* VOLATILE GLOBAL g_11 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_8 g_9 g_11
 * writes: g_10
 */
static struct S1  func_1(void)
{ /* block id: 0 */
    uint32_t l_5 = 4294967295UL;
    (*g_9) = (((g_2 || (((safe_mul_func_uint16_t_u_u(g_2, l_5)) || g_2) , (safe_sub_func_int8_t_s_s((l_5 < ((g_2 && ((l_5 == g_2) <= (l_5 >= l_5))) >= 0x8ED4L)), g_8)))) == 2UL) <= l_5);
    return g_11;
}
