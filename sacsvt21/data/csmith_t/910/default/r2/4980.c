...
static uint16_t g_13 = 0x3BD6L;
static union U2 g_16 = {{4294967295UL,0x53L,-1L,0xCD49598AL,2UL}};/* VOLATILE GLOBAL g_16 */
...
{ /* block id: 0 */
    ...
    int32_t *l_8 = &g_3;
    int32_t *l_9 = &g_3;
    int32_t l_10 = 0x32CF415DL;
    int32_t *l_11 = &l_7;
    int32_t *l_12[10] = {&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7,&l_7};
    int i;
    g_13--;
    return g_16;
}
