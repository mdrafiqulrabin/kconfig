...
/* --- GLOBAL VARIABLES --- */
static int32_t g_6 = 0x369BD697L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_4[5][6] = {{(-1L),(-1L),(-1L),(-1L),(-1L),0x35A2L},{(-1L),(-3L),(-1L),(-1L),(-3L),(-1L)},{(-1L),0x2EE6L,0x35A2L,(-1L),0x2EE6L,(-1L)},{(-1L),(-1L),(-1L),(-1L),(-1L),0x35A2L},{(-1L),(-3L),(-1L),(-1L),(-3L),(-1L)}};
    int32_t *l_8 = (void*)0;
    int32_t **l_7 = &l_8;
    int i, j;
    (*l_7) = func_2(l_4[3][4]);
