...
/* --- GLOBAL VARIABLES --- */
static int64_t g_3 = 0xFE0091DF82D83D78LL;
static union U3 g_4 = {4UL};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        uint16_t l_5[8] = {0xBC3EL,0xBC3EL,0xBC3EL,0xBC3EL,0xBC3EL,0xBC3EL,0xBC3EL,0xBC3EL};
        int i;
        for (g_3 = 0; (g_3 <= 7); g_3 += 1)
        { /* block id: 6 */
            union U3 l_6 = {0xD714F98CL};
            return l_6;
        }
    }
    return g_4;
