...
static volatile struct S0 g_12 = {-641};/* VOLATILE GLOBAL g_12 */
static volatile struct S0 * volatile g_11 = &g_12;/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_4;
    int32_t *l_7[5];
    volatile struct S0 * volatile *l_13 = &g_11;
    int i;
    for (i = 0; i < 5; i++)
        l_7[i] = &g_4;
    g_8--;
