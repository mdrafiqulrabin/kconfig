...
static volatile int32_t g_8 = 0x12491E29L;/* VOLATILE GLOBAL g_8 */
static volatile uint16_t g_10 = 0xA72CL;/* VOLATILE GLOBAL g_10 */
static volatile int32_t g_15 = 0x2FD2D1A4L;/* VOLATILE GLOBAL g_15 */
...
{ /* block id: 0 */
    ...
    int i;
    g_10++;
    for (l_4 = 0; (l_4 >= 0); l_4 = safe_add_func_int64_t_s_s(l_4, 1))
    { /* block id: 4 */
        ++g_16;
    }
    return l_19;
