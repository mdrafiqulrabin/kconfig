...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_3 = 0x7FB0B029L;/* VOLATILE GLOBAL g_3 */
...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t l_6[1][6][2] = {{{0x22124F84L,(-1L)},{0L,0x22124F84L},{0x70CD5099L,0x70CD5099L},{0x70CD5099L,0x22124F84L},{0L,(-1L)},{0x22124F84L,(-1L)}}};
    int i, j, k;
    g_3--;
    return l_6[0][0][1];
}
