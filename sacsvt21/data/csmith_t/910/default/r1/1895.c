...
static int32_t g_3[1][2] = {{0xC176B0F7L,0xC176B0F7L}};
static int32_t g_10 = 0x3B7BEDEDL;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_6 = 0xCFE0L;
    for (g_3[0][1] = 0; (g_3[0][1] < (-29)); --g_3[0][1])
    { /* block id: 3 */
        int32_t l_7 = 0xF845D811L;
        int32_t *l_8 = (void*)0;
        int32_t *l_9 = &g_10;
        if (l_6)
            break;
