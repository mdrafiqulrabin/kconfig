...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_2 = 0x4FL;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_5[4] = {0xA3DF603FL,0xA3DF603FL,0xA3DF603FL,0xA3DF603FL};
static int32_t g_7 = 0x491E29EAL;
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_7;
    int32_t *l_8[8] = {&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7};
    uint32_t l_9 = 0x2978D8EFL;
    int i;
    (*l_4) = g_2;
    l_9--;
    return (*l_6);
