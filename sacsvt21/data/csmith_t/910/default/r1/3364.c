...
static int16_t g_10[2] = {0L,0L};
static uint8_t g_11 = 0x32L;
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    int32_t l_9 = 0xF7FBF212L;
    for (g_2 = (-22); (g_2 <= (-22)); g_2 = safe_add_func_int64_t_s_s(g_2, 8))
    { /* block id: 3 */
        int32_t *l_6 = &g_7;
        int32_t *l_8[10] = {&g_2,&g_7,&g_2,&g_7,&g_2,&g_7,&g_2,&g_7,&g_2,&g_7};
        int i;
        g_11--;
    }
    return l_9;
