...
static volatile int32_t g_9[8] = {(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L)};
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3;
    int32_t *l_5 = &g_3;
    int64_t l_6 = 0x0A50B5F0B101AAE4LL;
    int32_t *l_7 = &g_3;
    int32_t *l_8 = &g_3;
    int16_t l_10 = 0x1042L;
    int32_t *l_11 = &g_3;
    int32_t *l_12 = (void*)0;
    int32_t *l_13[7] = {&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3};
    int32_t l_14 = 0x30971CF7L;
    uint32_t l_15 = 0xC9C6C2CFL;
    int i;
    l_15--;
    return (*l_2);
}
