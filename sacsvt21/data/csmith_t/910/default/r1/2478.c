...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t l_3[6][10] = {{3L,1L,0x7A1245C8L,1L,3L,(-8L),(-1L),0x4FD9E2A8L,1L,(-10L)},{(-1L),1L,(-10L),(-8L),7L,(-1L),(-1L),7L,(-8L),(-10L)},{(-8L),(-8L),0x18A52733L,(-10L),3L,0L,7L,0x7A1245C8L,0L,0x80C3414BL},{0x7A1245C8L,0L,7L,1L,1L,1L,7L,0L,0x7A1245C8L,(-8L)},{1L,(-8L),0L,3L,0x80C3414BL,3L,0x18A52733L,(-8L),(-8L),0x18A52733L},{1L,0L,0L,0L,0L,1L,3L,(-10L),0x4FD9E2A8L,(-1L)}};
    int32_t *l_4 = &l_3[1][6];
    int32_t *l_5 = &l_3[1][6];
    int32_t *l_6[2][8];
    int i, j;
