...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x91509CF1L;
static const union U4 g_4 = {0xE008L};
...
static const union U4  func_1(void)
{ /* block id: 0 */
    int16_t l_2[2][9] = {{7L,(-10L),1L,1L,(-10L),7L,(-10L),1L,1L},{0x7A75L,0x7A75L,7L,1L,7L,0x7A75L,0x7A75L,7L,1L}};
    const union U4 l_5 = {65535UL};
    int i, j;
