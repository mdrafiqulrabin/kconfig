...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2[4] = {5UL,5UL,5UL,5UL};
static int32_t g_3 = (-2L);
static volatile uint32_t g_4 = 0x18D58162L;/* VOLATILE GLOBAL g_4 */
...
static int64_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_12 = 0xB77278FA8F90A3CFLL;
    for (g_3 = 0; (g_3 <= 3); g_3 += 1)
    { /* block id: 3 */
        int32_t *l_7[2][6] = {{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3}};
        int32_t **l_8 = (void*)0;
        int i, j;
        g_4++;
        g_9 = l_7[0][5];
