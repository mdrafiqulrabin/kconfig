...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3[9] = {0xD1E1E87DL,0xD1E1E87DL,0xD1E1E87DL,0xD1E1E87DL,0xD1E1E87DL,0xD1E1E87DL,0xD1E1E87DL,0xD1E1E87DL,0xD1E1E87DL};
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t * volatile *l_4[9];
    uint32_t l_5 = 3UL;
    int i;
    for (i = 0; i < 9; i++)
        l_4[i] = (void*)0;
...
XXX percentage of non-volatile access: 14.3
