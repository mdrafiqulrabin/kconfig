...
static volatile int32_t g_3[9] = {0x8D327CB3L,0x8D327CB3L,0x8D327CB3L,0x8D327CB3L,0x8D327CB3L,0x8D327CB3L,0x8D327CB3L,0x8D327CB3L,0x8D327CB3L};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    for (g_4 = 7; (g_4 < (-25)); g_4 = safe_sub_func_uint16_t_u_u(g_4, 2))
    { /* block id: 3 */
        return g_2;
    }
    return g_2;
