...
static uint64_t g_15 = 0x073E70D28E487928LL;
...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &g_3[3];
    int32_t *l_8 = (void*)0;
    int32_t *l_9[8] = {&g_3[2],&g_3[2],(void*)0,&g_3[2],&g_3[2],(void*)0,&g_3[2],&g_3[2]};
    uint32_t l_10 = 1UL;
    int i;
    l_10++;
    for (l_10 = (-26); (l_10 != 28); l_10 = safe_add_func_uint8_t_u_u(l_10, 3))
    { /* block id: 4 */
        return g_3[2];
    }
    g_15 ^= (g_3[2] < (*l_7));
