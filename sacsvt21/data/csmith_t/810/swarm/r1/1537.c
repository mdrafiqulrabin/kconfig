...
{ /* block id: 0 */
    int32_t l_2 = (-1L);
    for (l_2 = 0; (l_2 <= (-24)); l_2 = safe_sub_func_int64_t_s_s(l_2, 1))
    { /* block id: 3 */
        int16_t l_5 = (-1L);
        return l_5;
    }
