...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xC0AA39EDL;
static int32_t * volatile g_10 = (void*)0;/* VOLATILE GLOBAL g_10 */
static int32_t g_12 = 0xEE21AFA9L;
...
inline static int64_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_8 = 0xB055CC25L;
    int32_t l_9 = (-4L);
    for (g_2 = 6; (g_2 < 10); g_2 = safe_add_func_uint64_t_u_u(g_2, 5))
    { /* block id: 3 */
        (*g_11) = (safe_add_func_uint64_t_u_u((safe_unary_minus_func_int16_t_s(l_8)), l_9));
    }
    return g_2;
}
