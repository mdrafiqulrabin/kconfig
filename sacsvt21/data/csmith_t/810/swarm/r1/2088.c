...
static int32_t  func_26(void)
{ /* block id: 36 */
    int32_t l_27 = 0x0A7084BCL;
    int32_t l_30 = 0xF985589BL;
    int32_t *l_31 = &l_27;
    (*l_31) = ((l_27 && (l_27 & g_4)) , (((((int8_t)((l_30 , l_30) || ((l_30 >= ((l_30 || (0x9A01L & ((l_30 && 0L) & l_27))) ^ g_4)) & g_4)) - (int8_t)g_4) <= 0x4B7BL) , 65535UL) == g_4));
    return g_4;
}
