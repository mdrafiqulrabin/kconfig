 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --consts --no-divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --no-longlong --int8 --no-uint8 --float --no-math64 --inline-function --muls --safe-math --packed-struct --no-paranoid --pointers --no-structs --no-unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --no-builtins
 * Seed:      2438757238
 */
...
{ /* block id: 0 */
    ...
    for (l_2 = (-18); (l_2 == 13); l_2 = safe_add_func_uint32_t_u_u(l_2, 1))
    { /* block id: 3 */
        uint32_t l_7 = 0x54FDDD3F;
        float *l_8 = (void*)0;
        float l_10 = 0x7.4800FAp+40;
        float *l_9 = &l_10;
        float l_12 = (-0x1.Dp+1);
        float *l_11 = &l_12;
        (*l_11) = ((*l_9) = (safe_sub_func_float_f_f(l_7, (l_7 == l_2))));
        if (l_2)
            break;
    }
    return l_2;
