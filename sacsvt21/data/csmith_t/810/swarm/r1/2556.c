 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --comma-operators --no-compound-assignment --no-consts --no-divs --embedded-assigns --pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --no-longlong --no-int8 --no-uint8 --no-float --math64 --inline-function --no-muls --safe-math --packed-struct --paranoid --pointers --structs --no-unions --no-volatiles --volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      2796104220
 */
...
static int32_t  func_28(void)
{ /* block id: 36 */
    int32_t l_30 = 0xE6AA1654;
    int32_t *l_29 = &l_30;
    int32_t **l_31 = &l_29;
    int32_t **l_32 = (void*)0;
    int32_t *l_34 = &l_30;
    int32_t **l_33 = &l_34;
    int32_t l_35 = 0xAF8716B5;
    (*l_33) = ((*l_31) = l_29);
    return l_35;
}
