...
{ /* block id: 0 */
    ...
    int32_t l_10 = (-3);
    int32_t l_11 = (-6);
    struct S0 l_12 = {9U,0xACB8,0x2BA1,0x7C,6,0xE2FE8172,-1,4294967295U,0x86D6,0xBC};
    l_11 = (l_10 = ((uint32_t)(l_4 && (!0xC7)) - (uint32_t)(~(l_9 = ((uint8_t)0xE7 / (uint8_t)l_4)))));
    return l_12;
}
