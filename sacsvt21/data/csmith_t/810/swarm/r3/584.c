...
{ /* block id: 0 */
    uint8_t l_2[1];
    int32_t *l_3 = (void*)0;
    int32_t *l_4[7] = {&g_5,(void*)0,&g_5,&g_5,(void*)0,&g_5,&g_5};
    int i;
    for (i = 0; i < 1; i++)
        l_2[i] = 248UL;
    g_5 = l_2[0];
