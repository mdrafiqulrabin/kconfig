 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --compound-assignment --consts --no-divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --no-int8 --no-uint8 --no-float --math64 --inline-function --muls --no-safe-math --no-packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      1819002670
 */
...
static int32_t g_37 = 0x91023F12;
...
inline static int32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31 = 0x41720348;
    int32_t *l_36 = &g_37;
    (*l_36) &= ((l_31 | l_31) == (l_31 && ((int32_t)((uint16_t)g_4 << (uint16_t)1) + (int32_t)0x5E53494A)));
    (*l_36) = ((*l_36) == (*l_36));
    return (*l_36);
}
