 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --no-bitfields --no-comma-operators --no-compound-assignment --no-consts --no-divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --longlong --int8 --no-uint8 --float --math64 --inline-function --muls --no-safe-math --packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      560461216
 */
...
{ /* block id: 36 */
    ...
    int32_t **l_41 = (void*)0;
    int32_t l_44 = 0xC5706B37L;
    int32_t *l_43 = &l_44;
    int32_t **l_42 = &l_43;
    (*l_32) = (0xE.0C4307p+56 != l_31);
    (*l_42) = func_34(l_36);
    /* statement id: 41 */
    assert (l_43 == 0);
    return l_44;
