...
/* --- GLOBAL VARIABLES --- */
static volatile int8_t g_2 = 0x92L;/* VOLATILE GLOBAL g_2 */
static volatile float g_3 = (-0x1.1p+1);/* VOLATILE GLOBAL g_3 */
