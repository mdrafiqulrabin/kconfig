...
{ /* block id: 0 */
    ...
    (*l_11) |= (safe_div_func_uint16_t_u_u((0U || ((*l_6) = (((*l_4) = 0x6A3367F5) < (l_4 != l_4)))), (safe_mod_func_int32_t_s_s(l_10, l_10))));
    l_15 |= (safe_mul_func_int16_t_s_s((*l_11), (*l_4)));
    return l_16;
}
