 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --no-compound-assignment --consts --no-divs --no-embedded-assigns --pre-incr-operator --pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --int8 --uint8 --no-float --math64 --no-inline-function --no-muls --no-safe-math --no-packed-struct --paranoid --pointers --structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --no-builtins
 * Seed:      3903354238
 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x3AE35568L;
    int32_t *l_8 = (void*)0;
    uint16_t l_9 = 0UL;
    for (l_2 = 10; (l_2 == 7); l_2 -= 8)
    { /* block id: 3 */
        int32_t *l_5 = (void*)0;
        int32_t l_7 = 0x111738ABL;
        int32_t *l_6 = &l_7;
        (*l_6) = l_2;
        if ((*l_6))
            continue;
