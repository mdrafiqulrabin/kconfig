 ...
 * Git version: 30dccd7
 * Options:   --no-argc --arrays --no-bitfields --comma-operators --compound-assignment --consts --divs --embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --int8 --uint8 --float --math64 --no-inline-function --muls --safe-math --no-packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --volatile-pointers --const-pointers --no-global-variables --no-builtins
 * Seed:      4177830104
 */
...
static int64_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3[4] = {0xE5596960L,0xE5596960L,0xE5596960L,0xE5596960L};
    int32_t *l_2 = &l_3[3];
    int32_t **l_4 = &l_2;
    int32_t l_5 = 1L;
    int8_t l_9[4] = {0x14L,0x14L,0x14L,0x14L};
    int i;
    (*l_4) = l_2;
    for (l_5 = 0; (l_5 == (-2)); l_5 = safe_sub_func_int64_t_s_s(l_5, 3))
    { /* block id: 4 */
        int32_t *l_8 = &l_3[3];
        (*l_4) = l_8;
        if ((*l_8))
