...
static uint64_t  func_1(void)
{ /* block id: 0 */
    struct S0 l_2 = {-120,3,189};
    struct S0 *l_3 = &l_2;
    struct S0 l_5 = {0,4,-366};
    struct S0 *l_4 = &l_5;
    uint32_t l_6 = 0x069F30CCL;
    (*l_4) = ((*l_3) = l_2);
    return l_6;
}
