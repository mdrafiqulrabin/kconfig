 ...
 * Git version: 30dccd7
 * Options:   --argc --arrays --no-bitfields --no-comma-operators --no-compound-assignment --no-consts --divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --uint8 --float --no-math64 --no-inline-function --no-muls --no-safe-math --packed-struct --no-paranoid --pointers --no-structs --no-unions --volatiles --volatile-pointers --const-pointers --global-variabless --builtins
 * Seed:      827250292
 */
...
static float g_32 = 0xF.0A9B27p-79;
static float * volatile g_31[8][2] = {{&g_32,&g_32},{&g_32,&g_32},{&g_32,&g_32},{&g_32,&g_32},{&g_32,&g_32},{&g_32,&g_32},{&g_32,&g_32},{&g_32,&g_32}};
...
{ /* block id: 36 */
    uint32_t l_37 = 5U;
    for (g_3 = 21; (g_3 == (-13)); g_3 -= 8)
    { /* block id: 39 */
        float *l_33 = &g_32;
        int32_t l_34 = 0x912530A9;
        int32_t *l_36 = &l_34;
        int32_t **l_35 = &l_36;
        (*l_33) = g_3;
        if (l_34)
