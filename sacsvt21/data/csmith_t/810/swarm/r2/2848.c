...
{ /* block id: 0 */
    int16_t l_4 = 1L;
    uint32_t l_5 = 0xFC07E17FL;
    int32_t l_6 = (-1L);
    l_5 = (safe_add_func_float_f_f(0x6.2BA394p-90, l_4));
    l_6 = l_4;
    return l_4;
}
