...
/* --- GLOBAL VARIABLES --- */
static const int16_t g_4[2][4] = {{(-8),(-8),(-8),(-8)},{(-8),(-8),(-8),(-8)}};
static int32_t g_6 = 0x822B1658;
static int32_t g_10 = 0xEDEDB5CA;
