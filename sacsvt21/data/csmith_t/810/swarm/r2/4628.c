 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --bitfields --no-comma-operators --compound-assignment --consts --divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --jumps --no-longlong --int8 --uint8 --float --math64 --inline-function --no-muls --safe-math --packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --volatile-pointers --const-pointers --no-global-variables --no-builtins
 * Seed:      2698144256
 */
...
{ /* block id: 0 */
    ...
    { /* block id: 7 */
        ...
        uint8_t *l_13 = &l_14;
        int32_t l_15 = 0;
        (*l_4) ^= (safe_unary_minus_func_uint32_t_u((safe_lshift_func_int16_t_s_s(0x3358, (((*l_13) &= 1U) >= l_15)))));
        (*l_4) = l_14;
    }
    return l_16;
}
