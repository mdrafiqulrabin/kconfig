 ...
 * Git version: 30dccd7
 * Options:   --no-argc --arrays --bitfields --no-comma-operators --no-compound-assignment --no-consts --divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --post-incr-operator --no-post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --no-uint8 --no-float --math64 --inline-function --no-muls --no-safe-math --packed-struct --no-paranoid --no-pointers --no-structs --unions --volatiles --no-volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      3118319716
 */
...
inline static uint16_t  func_30(void)
{ /* block id: 36 */
    int16_t l_31[7] = {5,5,5,5,5,5,5};
    int32_t l_32 = 0xA9864BA8;
    int32_t l_34 = (-1);
    int i;
    for (l_32 = 0; (l_32 <= 6); l_32 += 1)
    { /* block id: 39 */
        int i;
        l_34 = (-(int16_t)l_31[l_32]);
    }
    return l_31[3];
}
