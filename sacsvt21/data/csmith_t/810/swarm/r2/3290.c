...
{ /* block id: 0 */
    uint16_t l_7 = 65532U;
    for (g_2 = 2; (g_2 > 9); g_2 = safe_add_func_uint32_t_u_u(g_2, 2))
    { /* block id: 3 */
        int32_t l_5 = 0xD09EA983;
        g_6 = l_5;
        return l_5;
    }
    return l_7;
