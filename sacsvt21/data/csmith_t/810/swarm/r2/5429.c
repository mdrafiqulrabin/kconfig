...
static uint64_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0x38ECF54CL;
    int32_t l_5 = 1L;
    int32_t l_6 = 2L;
    l_5 = (safe_rshift_func_int16_t_s_s(l_4, 12));
    return l_6;
}
