...
/* --- GLOBAL VARIABLES --- */
static int32_t g_7 = 0xD21F1EB3L;
static int32_t g_43 = 0x6AE3D475L;
...
{ /* block id: 36 */
    ...
    for (i = 0; i < 1; i++)
        l_41[i] = 0x900BL;
    (*l_42) &= (((uint16_t)(~0x45799333C7D24B5ELL) >> (uint16_t)9) | ((uint32_t)((((int32_t)((int16_t)(-1L) - (int16_t)__builtin_popcountll((65528UL == ((uint64_t)((int8_t)g_7 - (int8_t)__builtin_ffsl(g_7)) % (uint64_t)l_41[0])))) + (int32_t)g_7) && l_41[0]) > g_7) / (uint32_t)l_41[0]));
    g_7 = g_7;
    for (g_7 = 0; (g_7 >= 0); g_7 -= 1)
    { /* block id: 41 */
        int i;
        (*l_42) &= ((uint16_t)l_41[g_7] >> (uint16_t)8);
        return g_7;
    }
    return g_7;
}
