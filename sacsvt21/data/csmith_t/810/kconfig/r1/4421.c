...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int16_t l_2[6][7] = {{(-1L),0L,0L,0L,0L,(-1L),0L},{0xDADAL,(-1L),(-1L),0xDADAL,0L,0xDADAL,(-1L)},{0x647DL,0x647DL,(-1L),0L,(-1L),0x647DL,0x647DL},{0x647DL,(-1L),0L,(-1L),0x647DL,0x647DL,(-1L)},{0xDADAL,0L,0xDADAL,(-1L),(-1L),0xDADAL,0L},{(-1L),0L,0L,0L,0L,(-1L),0L}};
    int32_t l_3 = (-1L);
    uint8_t l_4 = 0x4CL;
    int i, j;
    l_3 = l_2[4][5];
