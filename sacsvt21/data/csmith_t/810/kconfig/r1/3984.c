...
static int64_t  func_1(void)
{ /* block id: 0 */
    float l_3[2][9] = {{0xD.1E1E87p+61,0xD.1E1E87p+61,0xD.1E1E87p+61,0xD.1E1E87p+61,0xD.1E1E87p+61,0xD.1E1E87p+61,0xD.1E1E87p+61,0xD.1E1E87p+61,0xD.1E1E87p+61},{(-0x1.0p+1),(-0x1.0p+1),(-0x1.0p+1),(-0x1.0p+1),(-0x1.0p+1),(-0x1.0p+1),(-0x1.0p+1),(-0x1.0p+1),(-0x1.0p+1)}};
    float *l_2 = &l_3[1][6];
    int32_t l_4[6] = {0xBBEF7D65L,0x72D4EA68L,0xBBEF7D65L,0xBBEF7D65L,0x72D4EA68L,0xBBEF7D65L};
    int i, j;
    (*l_2) = (-0x1.Fp+1);
    return l_4[1];
}
