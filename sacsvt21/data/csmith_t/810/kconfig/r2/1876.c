...
/* --- GLOBAL VARIABLES --- */
static int64_t g_3 = 0xB0647DC4B4E1265ALL;
...
inline static const uint32_t  func_29(void)
{ /* block id: 36 */
    const uint64_t l_30[1][6] = {{0xE4A90611BC383C67LL,0xE4A90611BC383C67LL,0xE4A90611BC383C67LL,0xE4A90611BC383C67LL,0xE4A90611BC383C67LL,0xE4A90611BC383C67LL}};
    int i, j;
    return l_30[0][2];
}
