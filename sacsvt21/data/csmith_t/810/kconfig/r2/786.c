...
inline static int32_t  func_34(void)
{ /* block id: 36 */
    uint64_t l_36 = 0x9B85755261FC42FFLL;
    int32_t l_50 = 8L;
    int32_t *l_49 = &l_50;
    float l_52 = 0xC.28C040p+0;
    float *l_51 = &l_52;
    uint32_t l_53 = 0UL;
    (*l_49) = ((+(l_36 & (l_36 != (l_36 < ((int16_t)((int16_t)2L - (int16_t)(l_36 >= l_36)) << (int16_t)__builtin_ffs(((uint32_t)(((((((((int16_t)2L - (int16_t)l_36) | (((int16_t)((((((int64_t)1L + (int64_t)1UL) <= l_36) || l_36) <= l_36) <= (-1L)) >> (int16_t)1) | l_36)) <= 0xF6EDL) && l_36) & l_36) ^ l_36) != 0UL) || l_36) - (uint32_t)l_36))))))) | l_36);
    (*l_51) = (*l_49);
    return l_53;
}
