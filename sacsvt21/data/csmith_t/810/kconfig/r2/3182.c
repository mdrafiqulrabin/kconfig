...
static float g_4[3] = {0x4.2E0897p+2,0x4.2E0897p+2,0x4.2E0897p+2};
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_5[2][10] = {{246UL,255UL,246UL,246UL,255UL,246UL,246UL,255UL,246UL,246UL},{255UL,255UL,255UL,255UL,255UL,255UL,255UL,255UL,255UL,255UL}};
    int i, j;
    g_3 = (1UL ^ g_2);
    g_4[0] = g_2;
    return l_5[0][6];
