...
inline static uint16_t  func_30(const uint16_t  p_31, uint32_t  p_32);
...
static const struct S0  func_27(void)
{ /* block id: 36 */
    const int32_t l_33 = 0xF15CC7C4;
    uint16_t l_37 = 0x0A7C;
    uint16_t *l_36 = &l_37;
    int32_t l_39 = 0xAD058BBE;
    int32_t *l_38 = &l_39;
    const struct S0 l_40 = {75,22,0,0x23D37F4A,0xD2DAFFA8,3053,0xCBDB62B2};
    (*l_38) ^= ((uint16_t)((*l_36) &= func_30(l_33, l_33)) >> (uint16_t)13);
    return l_40;
}
