...
static struct S0  func_30(void)
{ /* block id: 36 */
    struct S1 l_31 = {0x846B51F0,1U,7839,0x7FC0336A,4294967295U,0x752E4A6B};
    struct S1 l_32 = {0xECDC0F1F,1U,4454,0xEEDA781B,0xF7A0D7C8,4294967288U};
    struct S0 l_33 = {0xC5533F2A,95,-237,17,13};
    l_32 = l_31;
    return l_33;
}
