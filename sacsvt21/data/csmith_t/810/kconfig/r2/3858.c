...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0x4B4E1265L;
static volatile int32_t g_32 = 0x77904128L;/* VOLATILE GLOBAL g_32 */
static volatile int32_t * volatile g_31[3][2] = {{&g_32,&g_32},{&g_32,&g_32},{&g_32,&g_32}};
...
static int16_t  func_30(void)
{ /* block id: 36 */
    volatile int32_t * volatile *l_33 = &g_31[0][0];
    (*l_33) = g_31[0][0];
    return (**l_33);
}
