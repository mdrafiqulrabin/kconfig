...
/* --- GLOBAL VARIABLES --- */
static int32_t g_5[4] = {0x5252CB13L,0x5252CB13L,0x5252CB13L,0x5252CB13L};
...
{ /* block id: 36 */
    int32_t *l_29 = &g_5[2];
    int32_t *l_30[1][10] = {{&g_5[2],&g_5[2],&g_5[2],&g_5[2],&g_5[2],&g_5[2],&g_5[2],&g_5[2],&g_5[2],&g_5[2]}};
    int32_t l_31 = 1L;
    uint32_t l_32 = 0x49CF94A2L;
    int i, j;
    --l_32;
    return g_5[0];
}
...
XXX times a pointer is qualified to be dereferenced: 170
