...
static union U3 g_29 = {0xD8339896L};/* VOLATILE GLOBAL g_29 */
static union U3 g_30 = {0x8F5537C5L};/* VOLATILE GLOBAL g_30 */
...
static union U3  func_26(void)
{ /* block id: 36 */
    for (g_6 = 3; (g_6 > 15); g_6 = safe_add_func_int16_t_s_s(g_6, 5))
    { /* block id: 39 */
        return g_29;
        /* statement id: 40 */
            }
