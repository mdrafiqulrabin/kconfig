...
static int32_t g_6[7] = {0x5C62E089,0x5C62E089,0x5C62E089,0x5C62E089,0x5C62E089,0x5C62E089,0x5C62E089};
...
{ /* block id: 0 */
    ...
    assert (g_5 == &g_2 || (g_5 >= &g_6[0] && g_5 <= &g_6[6]));
    return l_7;
}
