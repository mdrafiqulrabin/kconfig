...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_13 = 0xFC3A065CL;
static int32_t g_15 = 6L;
static int32_t g_22 = 1L;
static int32_t * const  volatile g_21 = &g_22;/* VOLATILE GLOBAL g_21 */
...
{ /* block id: 0 */
    uint32_t l_9 = 0UL;
    uint32_t l_12 = 1UL;
    if (func_2(((safe_sub_func_int8_t_s_s((safe_sub_func_int16_t_s_s((l_9 ^ l_9), l_9)), (safe_div_func_uint8_t_u_u((0UL != l_9), l_9)))) < 3L), l_12))
    { /* block id: 6 */
        int64_t l_20 = 0x6AC3A60813C27F35LL;
        (*g_21) &= (g_13 ^ func_2(g_15, l_20));
        return l_9;
    }
    else
    { /* block id: 9 */
        int64_t l_25 = (-4L);
        (*g_21) ^= (safe_rshift_func_uint16_t_u_u(l_9, 3));
        return l_25;
    }
}
...
{ /* block id: 1 */
    ...
    int32_t **l_19 = &l_14;
    (*l_14) = g_13;
    (*l_14) = ((l_14 != l_16) && (safe_lshift_func_uint8_t_u_s(((void*)0 == &g_15), 5)));
    (*l_19) = (void*)0;
    return p_3;
}
