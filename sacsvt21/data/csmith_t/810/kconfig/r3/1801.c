...
static int32_t g_34 = 0xC0DE450BL;
...
static uint32_t  func_24(void)
{ /* block id: 36 */
    uint32_t l_25 = 0xBA20B95AL;
    uint64_t *l_26 = (void*)0;
    uint64_t *l_27 = &g_28;
    int32_t *l_32 = (void*)0;
    int32_t *l_33 = &g_34;
    (*l_33) = (l_25 >= ((((__builtin_clz((0UL < (g_3 <= g_3))) != 18446744073709551612UL) <= ((*l_27) = 0xD78F4F823AAF5BFBLL)) , __builtin_parityll(((safe_mul_func_uint16_t_u_u((~0xCDF11BBB4F5AC3D6LL), g_28)) , l_25))) ^ l_25));
    return g_28;
}
