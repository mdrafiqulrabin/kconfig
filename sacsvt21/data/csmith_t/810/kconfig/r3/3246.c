...
static uint64_t  func_11(uint32_t  p_12, int64_t  p_13);
...
{ /* block id: 0 */
    int32_t l_2 = (-2L);
    int64_t l_14 = 6L;
    uint32_t l_21 = 0xDFDDAE97L;
    for (l_2 = 17; (l_2 > 1); l_2 -= 2)
    { /* block id: 3 */
        int32_t l_6 = 1L;
        int32_t *l_5 = &l_6;
        (*l_5) = 1L;
        (*l_5) = ((-8L) && (0xB9AE77ABL && ((65529UL != (*l_5)) > ((*l_5) == (l_2 || (((uint64_t)func_11(l_2, l_14) - (uint64_t)l_14) > (*l_5)))))));
    }
    l_21 = ((uint16_t)3UL % (uint16_t)l_14);
    return l_14;
}
