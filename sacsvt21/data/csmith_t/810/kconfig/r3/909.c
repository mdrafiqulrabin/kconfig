...
{ /* block id: 0 */
    ...
    int32_t l_3 = 0x4B666A75L;
    int64_t l_5 = 0L;
    int64_t *l_4 = &l_5;
    int32_t l_7[10];
    int32_t *l_6 = &l_7[9];
    int16_t l_8[7][3] = {{0x14EBL,0x1E3FL,0x1E3FL},{0x0B95L,0x1E3FL,8L},{(-6L),0x14EBL,0L},{0x0B95L,0x0B95L,0L},{0x14EBL,(-6L),8L},{0x1E3FL,0x0B95L,0x1E3FL},{0x1E3FL,0x14EBL,0x0B95L}};
    int i, j;
    for (i = 0; i < 10; i++)
        l_7[i] = 0x011151C3L;
    (*l_6) = ((l_2 ^ l_2) & ((*l_4) = l_3));
