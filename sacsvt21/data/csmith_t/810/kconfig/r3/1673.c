...
{ /* block id: 36 */
    ...
    int32_t l_47 = 5;
    int32_t l_48 = 3;
    uint32_t l_55 = 0x6B4AB19F;
    l_48 = __builtin_parity(((uint16_t)((((int16_t)(((((uint16_t)(((((int16_t)((int16_t)(g_5 != (g_5 > l_38)) % (int16_t)g_5) << (int16_t)((((int32_t)(-1) % (int32_t)((uint16_t)((((int16_t)(0xDBCABEBF ^ ((-1) == ((uint32_t)0xA7C6DD3E % (uint32_t)l_38))) % (int16_t)g_5) <= l_38) & g_5) >> (uint16_t)g_5)) ^ 0xB2FA) ^ l_47)) || l_47) > g_5) <= l_47) << (uint16_t)l_47) && g_5) != 0xF93F8DE9) != l_38) % (int16_t)l_47) != l_38) <= l_38) - (uint16_t)l_38));
    g_56 = (((uint16_t)g_5 >> (uint16_t)4) & ((int32_t)l_38 - (int32_t)((int32_t)(l_48 < l_55) - (int32_t)g_5)));
    return l_38;
}
