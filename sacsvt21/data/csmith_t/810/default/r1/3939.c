...
static const volatile int32_t g_7 = 0x3C8FC558L;/* VOLATILE GLOBAL g_7 */
static int32_t g_9[4] = {0xE7D214C4L,0xE7D214C4L,0xE7D214C4L,0xE7D214C4L};
...
{ /* block id: 0 */
    ...
    int8_t *l_5 = &g_6;
    int32_t *l_8 = &g_9[3];
    (*l_8) &= (safe_lshift_func_int8_t_s_u(((*l_5) = l_4), g_7));
    return g_6;
}
