...
static volatile int32_t g_6 = 0x665683C8L;/* VOLATILE GLOBAL g_6 */
static int32_t g_7[1][9] = {{6L,6L,6L,6L,6L,6L,6L,6L,6L}};
...
{ /* block id: 0 */
    ...
    int i;
    for (i = 0; i < 1; i++)
        l_13[i] = 0x7B8F5F4990069F30LL;
    for (g_3 = (-22); (g_3 <= 29); g_3 = safe_add_func_int8_t_s_s(g_3, 2))
    { /* block id: 3 */
        int32_t *l_12 = &g_7[0][6];
        int32_t **l_11 = &l_12;
        for (g_7[0][6] = 0; (g_7[0][6] <= 17); g_7[0][6] = safe_add_func_int8_t_s_s(g_7[0][6], 5))
        { /* block id: 6 */
            int8_t l_10 = 1L;
            return l_10;
        }
