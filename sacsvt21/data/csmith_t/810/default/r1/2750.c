...
static volatile uint16_t g_17[6][5] = {{0UL,1UL,0UL,0UL,1UL},{6UL,8UL,8UL,6UL,8UL},{1UL,1UL,0xBD65L,1UL,1UL},{8UL,6UL,8UL,8UL,6UL},{1UL,0UL,0UL,1UL,0UL},{6UL,6UL,0x6D21L,6UL,6UL}};
