...
static int32_t g_3 = 0x40C18AB9L;
...
{ /* block id: 0 */
    ...
    int32_t l_13 = (-6L);
    int32_t l_14 = 0L;
    struct S2 l_18 = {0xF0C3DA55L,0xE8L,1L};
    for (g_3 = (-24); (g_3 >= (-11)); g_3 = safe_add_func_int64_t_s_s(g_3, 4))
    { /* block id: 3 */
        int32_t **l_6 = (void*)0;
        int32_t *l_8 = &g_3;
        int32_t **l_7[7] = {&l_8,&l_8,&l_8,&l_8,&l_8,&l_8,&l_8};
        uint32_t l_15 = 0xEF874ACCL;
        int i;
        g_9 = (void*)0;
        --l_15;
    }
