...
static volatile int32_t g_3 = 0x7963BA20L;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 0xAE649F6DL;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = (-10L);
static struct S0 g_10 = {-12,1290,15908,1020,114,1,2UL};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t *l_8[5] = {&g_5,&g_5,&g_5,&g_5,&g_5};
        int32_t **l_9 = &l_8[1];
        int i;
        (*l_9) = l_8[0];
    }
