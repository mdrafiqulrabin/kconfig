...
{ /* block id: 0 */
    int32_t *l_2[1][3];
    uint32_t l_4 = 0UL;
    const uint32_t l_9 = 0x3CB5AF9FL;
    int32_t l_14 = 0x1B76E1EEL;
    int i, j;
    for (i = 0; i < 1; i++)
    {
        for (j = 0; j < 3; j++)
    ...
    l_4++;
    l_14 ^= (((safe_mod_func_uint64_t_u_u((g_3 && l_9), g_3)) >= (safe_rshift_func_uint8_t_u_u((safe_sub_func_int64_t_s_s(4L, g_3)), 5))) > (l_2[0][1] != l_2[0][0]));
    return g_3;
}
