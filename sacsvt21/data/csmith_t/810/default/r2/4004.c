...
static int32_t g_6[5] = {(-6L),(-6L),(-6L),(-6L),(-6L)};
static int32_t *g_5 = &g_6[4];
static int32_t ** volatile g_4 = &g_5;/* VOLATILE GLOBAL g_4 */
static volatile uint64_t g_14 = 0xC2FE0EC928903759LL;/* VOLATILE GLOBAL g_14 */
...
{ /* block id: 0 */
    ...
    int32_t *l_9[6];
    int16_t l_10 = 0L;
    int32_t l_11 = 0x39170055L;
    int8_t l_12 = (-9L);
    int8_t l_13 = (-5L);
    uint16_t l_17 = 0x8985L;
    int i;
    for (i = 0; i < 6; i++)
        l_9[i] = &l_8;
    (*g_4) = l_2;
