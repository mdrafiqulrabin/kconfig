...
static int32_t g_7[5][2] = {{1L,0L},{0x4888999DL,1L},{0xF1EB32A8L,0xF1EB32A8L},{0xF1EB32A8L,1L},{0x4888999DL,0L}};
...
{ /* block id: 0 */
    ...
    int32_t l_10 = 0x741311E2L;
    int32_t l_11[6] = {0xBD4856CDL,0xBD4856CDL,0xBD4856CDL,0xBD4856CDL,0xBD4856CDL,0xBD4856CDL};
    int32_t l_13 = 0x19116590L;
    int i;
    for (g_3 = 0; (g_3 > 0); ++g_3)
    { /* block id: 3 */
        int32_t *l_6 = &g_7[2][1];
