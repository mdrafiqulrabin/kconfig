...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_2 = {6,-1,-51,0,0x82L};/* VOLATILE GLOBAL g_2 */
static struct S0 * volatile g_3[4][3] = {{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2}};
static struct S0 * volatile g_4[4] = {&g_2,&g_2,&g_2,&g_2};
static struct S0 g_5 = {7,-1,-1350,0,255UL};/* VOLATILE GLOBAL g_5 */
