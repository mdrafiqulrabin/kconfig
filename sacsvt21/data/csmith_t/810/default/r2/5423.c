...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[8] = {0xCB3F4F46L,0xCB3F4F46L,0xCB3F4F46L,0xCB3F4F46L,0xCB3F4F46L,0xCB3F4F46L,0xCB3F4F46L,0xCB3F4F46L};
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    const int8_t l_6 = 0xBCL;
    for (g_2[5] = (-14); (g_2[5] < (-11)); g_2[5] = safe_add_func_int8_t_s_s(g_2[5], 3))
    { /* block id: 3 */
