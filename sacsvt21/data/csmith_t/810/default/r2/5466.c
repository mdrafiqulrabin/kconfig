...
static volatile int32_t g_9 = 0xF9ACF257L;/* VOLATILE GLOBAL g_9 */
static volatile int32_t *g_8 = &g_9;
static volatile int32_t ** volatile g_10 = &g_8;/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    uint8_t *l_6 = &g_7;
    (*g_10) = (((*l_6) = ((safe_rshift_func_uint8_t_u_s(g_4, 5)) , l_5)) , g_8);
    return g_4;
}
