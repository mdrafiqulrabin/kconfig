...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x960F57A7L;/* VOLATILE GLOBAL g_2 */
...
/* ------------------------------------------ */
/* 
 * reads : g_6 g_10 g_3 g_5 g_2 g_4
 * writes: g_6 g_10
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t *l_12[8][1] = {{&g_2},{&g_4},{&g_2},{&g_4},{&g_2},{&g_4},{&g_2},{&g_4}};
    volatile int32_t **l_11 = &l_12[0][0];
    int i, j;
    for (g_6 = (-8); (g_6 >= (-12)); g_6 = safe_sub_func_int16_t_s_s(g_6, 2))
    { /* block id: 3 */
        int32_t *l_9 = &g_10;
        (*l_9) = (-1L);
        if ((*l_9))
