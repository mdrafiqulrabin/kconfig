...
/* --- GLOBAL VARIABLES --- */
static union U2 g_3 = {0x357257EA0D018D30LL};/* VOLATILE GLOBAL g_3 */
static union U2 * volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
static union U2 g_5 = {0L};/* VOLATILE GLOBAL g_5 */
static union U3 g_6 = {0L};/* VOLATILE GLOBAL g_6 */
...
static union U3  func_1(void)
{ /* block id: 0 */
    union U2 * volatile l_4 = &g_5;/* VOLATILE GLOBAL l_4 */
    l_4 = g_2;
    return g_6;
}
