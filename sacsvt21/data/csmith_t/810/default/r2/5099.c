...
static uint16_t g_12 = 0x70A5L;
static volatile int32_t g_17 = 0xB64B5C6FL;/* VOLATILE GLOBAL g_17 */
static volatile int32_t *g_16 = &g_17;
static volatile int32_t ** volatile g_15[2] = {&g_16,&g_16};
...
{ /* block id: 0 */
    ...
    volatile int32_t ** volatile *l_18 = &g_15[1];
    int i;
    --g_12;
    (*l_18) = g_15[0];
    return (*l_9);
