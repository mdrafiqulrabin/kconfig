...
static uint8_t g_5[5] = {0x13L,0x13L,0x13L,0x13L,0x13L};
...
static int64_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_3[1][2][6] = {{{&g_4,&g_4,&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4,&g_4,&g_4}}};
    int16_t l_8[9] = {(-1L),0x4F88L,(-1L),0x4F88L,(-1L),0x4F88L,(-1L),0x4F88L,(-1L)};
    int i, j, k;
    g_2 ^= 0L;
    g_5[4]--;
    g_4 = g_4;
