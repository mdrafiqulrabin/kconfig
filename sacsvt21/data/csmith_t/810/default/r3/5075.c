...
static int32_t g_16 = 0x9A9B8FA4L;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_9 g_15 g_16
 * writes: g_9 g_14 g_16
 */
static uint64_t  func_1(void)
{ /* block id: 0 */
    int8_t l_2 = 8L;
    int16_t *l_8 = &g_9;
    (*g_15) &= ((l_2 ^ (g_3[1] | func_4(((safe_mod_func_uint16_t_u_u(0x8146L, ((*l_8) &= 0x9BACL))) || (g_3[2] == (safe_sub_func_int32_t_s_s(((void*)0 != l_8), (g_9 || ((g_9 > g_3[1]) || 0x2034L))))))))) >= g_3[1]);
    return g_3[0];
}
...
static uint64_t  func_4(uint32_t  p_5)
{ /* block id: 2 */
    int16_t l_12[8] = {(-10L),1L,(-10L),(-10L),1L,(-10L),(-10L),1L};
    int i;
