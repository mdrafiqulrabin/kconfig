...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[1][2][5] = {{{0xA50B5F0BL,(-1L),0L,0L,(-1L)},{0xA50B5F0BL,(-1L),0L,0L,(-1L)}}};
static struct S1 g_15 = {-3L,0x9457720F84B0F4F2LL,-5L,0x88L};/* VOLATILE GLOBAL g_15 */
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_4[0][0][4];
    int32_t l_6 = 0xFFBEFA5FL;
    int32_t *l_7 = (void*)0;
    int32_t *l_8 = &l_6;
    int32_t *l_9 = &g_4[0][1][4];
    int32_t *l_10 = &l_6;
    int32_t *l_11[4];
    uint64_t l_12 = 0x8CE9B8A514227F44LL;
    int i;
    for (i = 0; i < 4; i++)
        l_11[i] = &g_4[0][0][4];
    --l_12;
    if ((g_4[0][0][4] < g_4[0][0][4]))
    { /* block id: 2 */
        return g_15;
    }
    else
