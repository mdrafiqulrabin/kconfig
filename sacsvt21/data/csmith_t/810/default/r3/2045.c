...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[5][2] = {{1L,0xF6AF1124L},{0xF6AF1124L,1L},{0xF6AF1124L,0xF6AF1124L},{1L,0xF6AF1124L},{0xF6AF1124L,1L}};
static volatile int32_t g_3 = 0xFA75C19CL;/* VOLATILE GLOBAL g_3 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int64_t l_10 = 0xC58A012E1DFE0091LL;
    int32_t *l_11 = &g_6;
    int32_t **l_12 = &l_11;
    for (g_6 = 0; (g_6 > (-9)); --g_6)
    { /* block id: 3 */
