...
static int32_t g_6 = 0xCEFA9D19L;
...
static int8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_9[5] = {0x44D0L,0x44D0L,0x44D0L,0x44D0L,0x44D0L};
    int i;
    for (g_2 = 0; (g_2 == (-28)); g_2 = safe_sub_func_int8_t_s_s(g_2, 9))
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        int32_t *l_7 = &g_6;
        int32_t *l_8[8];
        const int64_t l_12[9][1] = {{(-1L)},{(-1L)},{(-1L)},{(-1L)},{(-1L)},{(-1L)},{(-1L)},{(-1L)},{(-1L)}};
        int i, j;
        for (i = 0; i < 8; i++)
            l_8[i] = &g_6;
        ++l_9[4];
