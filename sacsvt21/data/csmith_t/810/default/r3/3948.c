...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t l_3[9];
    int64_t l_7[9] = {0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL,0xF3C34EEA2A3B3F36LL};
    int i;
    for (i = 0; i < 9; i++)
        l_3[i] = 0x84B81147L;
    g_4++;
