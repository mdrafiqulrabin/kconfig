...
/* --- GLOBAL VARIABLES --- */
static const volatile int64_t g_3 = 0x6E58D020BD2AB60ELL;/* VOLATILE GLOBAL g_3 */
static uint16_t g_5 = 0x0591L;
static int8_t g_6 = 0x45L;
static uint16_t g_8 = 5UL;
static int32_t g_11 = 0xC3F4F880L;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_5 g_6 g_10 g_11
 * writes: g_5 g_11
 */
static uint64_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0xC0272A72L;
    uint16_t *l_4 = &g_5;
    uint16_t *l_7[9] = {&g_8,&g_8,&g_8,&g_8,&g_8,&g_8,&g_8,&g_8,&g_8};
    int32_t l_9 = (-1L);
    int i;
    (*g_10) = (((*l_4) &= (l_2 == (g_3 , (l_2 == (g_3 && 0L))))) <= (l_9 = g_6));
    return g_11;
}
