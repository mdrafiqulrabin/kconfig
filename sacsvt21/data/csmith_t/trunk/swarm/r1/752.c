...
{ /* block id: 0 */
    int32_t *l_5 = &g_2;
    for (g_2 = (-29); (g_2 < 27); g_2 = safe_add_func_int16_t_s_s(g_2, 8))
    { /* block id: 3 */
        int32_t **l_6 = &l_5;
        (*l_6) = l_5;
    }
