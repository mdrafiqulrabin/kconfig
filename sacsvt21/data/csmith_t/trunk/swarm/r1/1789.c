...
static struct S0 g_7 = {27,354,94,-14115,506};/* VOLATILE GLOBAL g_7 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_2[4][9] = {{0x9978L,65527UL,0x2A3BL,0x2A3BL,65527UL,0x9978L,65527UL,0x2A3BL,0x2A3BL},{0xFC88L,0xFC88L,0x4237L,65534UL,0x4237L,0xFC88L,0xFC88L,0x4237L,65534UL},{0xB1B0L,65527UL,0xB1B0L,0x9978L,0x9978L,0xB1B0L,65527UL,0xB1B0L,0x9978L},{1UL,0x4237L,0x4237L,1UL,0xF365L,1UL,0x4237L,0x4237L,1UL}};
    int32_t *l_3 = &g_4;
    struct S0 *l_6[10] = {&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7};
    struct S0 **l_5 = &l_6[5];
    int i, j;
    (*l_3) = l_2[2][7];
    (*l_5) = (void*)0;
    /* statement id: 2 */
    //assert (l_6[0] == 0 || l_6[0] == &g_7);
    return g_7.f2;
}
