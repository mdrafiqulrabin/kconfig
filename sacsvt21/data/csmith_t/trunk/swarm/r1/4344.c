...
{ /* block id: 0 */
    union U0 *l_2 = &g_3;
    union U0 **l_4[10] = {&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2};
    union U0 *l_5 = &g_3;
    int32_t *l_7 = &g_3.f3;
    int32_t **l_6 = &l_7;
    int32_t *l_8 = &g_3.f1;
