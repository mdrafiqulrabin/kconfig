...
/* --- GLOBAL VARIABLES --- */
static float g_3 = 0xE.C03342p+6;
...
static int64_t  func_31(void)
{ /* block id: 36 */
    uint32_t l_36 = 0x4B0B4EF6L;
    int32_t l_51 = (-9L);
    l_51 = ((float)(-0x8.Cp-1) / (float)((float)__builtin_parityll(l_36) + (float)((float)l_36 - (float)((float)(((float)g_3 - (float)((float)func_45(g_6) / (float)((float)(0x6.9p+1 > l_36) + (float)0xF.F62C4Dp-68))) > g_6) - (float)0x0.9p-1))));
    return g_6;
}
