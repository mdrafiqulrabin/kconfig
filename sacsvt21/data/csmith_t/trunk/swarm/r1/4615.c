...
{ /* block id: 0 */
    uint32_t l_4 = 1UL;
    int32_t l_7 = 8L;
    l_4 = ((int16_t)0xB0F7L >> (int16_t)8);
    l_7 = ((int16_t)l_4 << (int16_t)0);
    l_7 = l_4;
    return l_4;
}
