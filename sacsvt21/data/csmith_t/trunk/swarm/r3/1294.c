...
static int32_t  func_29(void)
{ /* block id: 36 */
    int32_t l_30 = 0x6F97812AL;
    int32_t l_33 = 1L;
    for (l_30 = 10; (l_30 != 18); l_30 += 1)
    { /* block id: 39 */
        l_33 = l_30;
    }
    l_30 = 0x378F1E0CL;
