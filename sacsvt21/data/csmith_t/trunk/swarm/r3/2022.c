 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --no-compound-assignment --no-consts --no-divs --embedded-assigns --pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --int8 --no-uint8 --no-float --math64 --no-inline-function --no-muls --no-safe-math --packed-struct --paranoid --no-pointers --structs --unions --volatiles --volatile-pointers --no-const-pointers --no-global-variables --no-builtins
 * Seed:      1368051474
 */
...
static struct S2  func_2(uint16_t  p_3, struct S2  p_4);
...
{ /* block id: 0 */
    int8_t l_5 = 0x9C;
    struct S2 l_6 = {39,0xDC86695C,4294967295U,0xA6F9,0x4D91F06E,0x5FCB,4};
    l_6 = func_2(l_5, l_6);
    return l_6.f6;
}
...
static struct S2  func_2(uint16_t  p_3, struct S2  p_4)
{ /* block id: 1 */
    struct S1 l_7 = {1U,0x4489BE67,{0x784B52DD,0x60,0xF47073E7,4U},0xE4879289,0xF433C8A0};
    l_7 = l_7;
    return p_4;
}
