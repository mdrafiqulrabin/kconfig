 ...
 * Git version: 30dccd7
 * Options:   --argc --arrays --no-bitfields --comma-operators --no-compound-assignment --consts --divs --embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --longlong --no-int8 --no-uint8 --float --math64 --inline-function --muls --no-safe-math --no-packed-struct --paranoid --pointers --structs --no-unions --no-volatiles --no-volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      2861968615
 */
...
inline static uint16_t  func_35(void)
{ /* block id: 36 */
    int32_t l_36 = 0x51162F63L;
    int32_t l_38 = (-8L);
    int32_t *l_37 = &l_38;
    int32_t **l_39 = &l_37;
    int64_t l_40 = 0x71639956A218F0EDLL;
    (*l_37) = l_36;
    (*l_39) = &l_38;
    return l_40;
}
