...
{ /* block id: 36 */
    ...
    float l_37 = 0xF.BE856Dp+6;
    float *l_36 = &l_37;
    (*l_36) = (safe_mul_func_float_f_f(0x1.7p-1, (!__builtin_popcountll(l_35))));
    return l_35;
}
