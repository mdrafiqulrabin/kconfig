 ...
 * Git version: 30dccd7
 * Options:   --argc --arrays --bitfields --comma-operators --compound-assignment --consts --no-divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --no-jumps --no-longlong --int8 --uint8 --no-float --math64 --no-inline-function --no-muls --safe-math --no-packed-struct --paranoid --pointers --structs --unions --volatiles --volatile-pointers --no-const-pointers --no-global-variables --no-builtins
 * Seed:      3659729816
 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3 = 0x649F6D4A;
    int32_t *l_2 = &l_3;
    int32_t *l_4 = (void*)0;
    int32_t l_5 = 0xF0D0714A;
    int32_t l_6 = (-1);
    int32_t *l_7 = &l_5;
    int32_t *l_8[3];
    uint32_t l_9 = 0x9C77509C;
    uint32_t l_13 = 0x64D07DDB;
    int i;
    for (i = 0; i < 3; i++)
        l_8[i] = &l_6;
    l_9--;
