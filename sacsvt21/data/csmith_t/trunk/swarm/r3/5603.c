...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_8 = 0x5286E871;
static uint16_t g_34 = 0x76DF;
static int32_t g_36 = 0x93C1DE6F;
...
/* 
 * reads : g_8 g_35
 * writes: g_8 g_34 g_36
 */
static uint32_t  func_28(void)
{ /* block id: 36 */
    uint16_t *l_38 = (void*)0;
    uint16_t **l_37 = &l_38;
    for (g_8 = 0; (g_8 == 27); g_8 += 1)
    { /* block id: 39 */
        uint16_t *l_33 = &g_34;
        uint16_t ***l_39 = (void*)0;
        uint16_t ***l_40 = &l_37;
        (*g_35) = (g_8 != ((uint16_t)((*l_33) = 0x6F1F) << (uint16_t)14));
        (*l_40) = l_37;
    }
    return g_8;
}
