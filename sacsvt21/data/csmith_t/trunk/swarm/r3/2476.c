...
{ /* block id: 36 */
    int16_t l_29 = 0xACFF;
    int32_t l_30 = 0x89A278C0;
    l_30 = (((int32_t)(l_29 >= l_29) / (int32_t)l_29) , (-2));
    l_30 = (0U < 7);
    g_33 = ((uint16_t)0x7B09 << (uint16_t)5);
    return g_33;
}
