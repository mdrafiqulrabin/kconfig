...
inline static uint64_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x647DC4B4L;
    for (l_2 = (-1); (l_2 == 0); l_2 += 8)
    { /* block id: 3 */
        int32_t **l_5 = (void*)0;
        int32_t *l_7 = &l_2;
        int32_t **l_6 = &l_7;
