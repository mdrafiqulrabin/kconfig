 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --compound-assignment --no-consts --divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --jumps --no-longlong --int8 --uint8 --no-float --math64 --inline-function --muls --safe-math --no-packed-struct --paranoid --pointers --structs --no-unions --no-volatiles --no-volatile-pointers --const-pointers --global-variabless --no-builtins
 * Seed:      199318220
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x2B165808;
static int32_t g_10 = 0xCAFE8B0D;
...
inline static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x70C3099C;
    int32_t *l_3 = &g_4;
lbl_7:
    (*l_3) &= l_2;
    for (l_2 = 0; (l_2 > (-22)); l_2 = safe_sub_func_int8_t_s_s(l_2, 1))
    { /* block id: 4 */
        int16_t l_8 = 0xB5CA;
        int32_t *l_9 = &g_10;
        if (l_2)
