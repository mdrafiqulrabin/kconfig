...
{ /* block id: 36 */
    int16_t l_34 = 1;
    int32_t l_37 = 0x0710DD01;
    l_37 = ((safe_add_func_int16_t_s_s(l_34, (safe_lshift_func_int16_t_s_u(4, 3)))) < (-1));
    return l_34;
}
