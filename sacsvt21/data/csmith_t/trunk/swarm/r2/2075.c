...
{ /* block id: 0 */
    ...
    volatile int32_t l_4 = 0x39BEB064L;/* VOLATILE GLOBAL l_4 */
    uint32_t l_5 = 0x1265AB3EL;
    l_4 = g_2;
    return l_5;
}
