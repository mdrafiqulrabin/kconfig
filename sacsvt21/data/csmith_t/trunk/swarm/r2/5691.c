...
{ /* block id: 1 */
    int16_t l_6 = 0xE2FD;
    int32_t l_9 = (-2);
    l_9 = ((l_6 >= 0xBBEF7D65) > (safe_add_func_int16_t_s_s((&g_5 != &g_5), 0x32A8)));
    return &g_5;
}
