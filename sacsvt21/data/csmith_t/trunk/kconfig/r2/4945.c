...
static volatile int32_t g_32[2] = {(-5L),(-5L)};
static int32_t g_33 = 1L;
static union U1 g_38[2] = {{0xE64F6CBCL},{0xE64F6CBCL}};
static struct S0 g_41 = {-637,13678};/* VOLATILE GLOBAL g_41 */
...
{ /* block id: 36 */
    struct S0 *l_40 = &g_41;
    struct S0 **l_39 = &l_40;
    for (g_5 = 7; (g_5 != 7); g_5 += 5)
    { /* block id: 39 */
        for (g_33 = 0; (g_33 > (-2)); --g_33)
        { /* block id: 42 */
            union U1 *l_37 = &g_38[1];
            union U1 **l_36 = &l_37;
            (*l_36) = (void*)0;
        }
    }
