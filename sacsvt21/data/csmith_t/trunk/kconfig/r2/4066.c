...
inline static uint32_t  func_31(void)
{ /* block id: 36 */
    uint32_t l_32 = 0xDF6F9781;
    int32_t l_33 = 0x92EA21E1;
    int32_t l_34 = 0xC863CC1D;
    uint32_t l_47 = 0x95EE35D5;
    uint16_t l_48 = 0xF90B;
    l_33 = (l_32 = 0x6C619A80);
    l_47 = ((l_34 > l_33) <= ((-(uint16_t)((uint32_t)l_34 - (uint32_t)((((int16_t)((~(((uint16_t)l_34 << (uint16_t)l_33) < l_32)) > (((((((int16_t)0 << (int16_t)(1U != ((int16_t)(0x7716 >= l_33) % (int16_t)l_33))) <= l_32) >= l_34) >= l_34) , l_34) & l_33)) - (int16_t)l_32) | l_33) > l_33))) , l_33));
    return l_48;
}
