...
static volatile uint32_t g_48 = 0xB06D9E96L;/* VOLATILE GLOBAL g_48 */
...
{ /* block id: 36 */
    ...
    int32_t *l_45 = &l_38[3];
    int32_t *l_46 = &g_40;
    int32_t *l_47[7] = {&g_40,&g_40,&g_40,&g_40,&g_40,&g_40,&g_40};
    int i;
    for (i = 0; i < 8; i++)
        l_37[i] = &g_5;
    (*l_39) = (safe_mod_func_int8_t_s_s(l_32, ((l_38[1] = (safe_lshift_func_uint8_t_u_s((g_5 , (safe_unary_minus_func_uint8_t_u(0x9CL))), 7))) & l_32)));
    g_48++;
    return g_48;
}
