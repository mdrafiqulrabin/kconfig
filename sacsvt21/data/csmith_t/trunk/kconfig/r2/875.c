...
/* --- GLOBAL VARIABLES --- */
static float g_3[10] = {0x1.2p+1,0x1.2p+1,0x1.2p+1,0x1.2p+1,0x1.2p+1,0x1.2p+1,0x1.2p+1,0x1.2p+1,0x1.2p+1,0x1.2p+1};
static int8_t g_4[5][6][1] = {{{0x3FL},{0xB7L},{0x28L},{0x90L},{0x28L},{0xB7L}},{{0x3FL},{0x3FL},{0xB7L},{0x28L},{0x90L},{0x28L}},{{0xB7L},{0x3FL},{0x3FL},{0xB7L},{0x28L},{0x90L}},{{0x28L},{0xB7L},{0x3FL},{0x3FL},{0xB7L},{0x28L}},{{0x90L},{0x28L},{0xB7L},{0x3FL},{0x3FL},{0xB7L}}};
