...
static volatile int32_t g_31 = 0xF2C9A130L;/* VOLATILE GLOBAL g_31 */
static volatile int32_t g_32[2] = {4L,4L};
...
{ /* block id: 36 */
    ...
    {
        for (g_32[0] = 0; g_32[0] < 6; g_32[0] += 1)
        {
            l_30[g_31][g_32[0]] = 0x8.790412p+51;
        }
    }
    return l_33;
}
