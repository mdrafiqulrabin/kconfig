...
static int32_t  func_32(void)
{ /* block id: 36 */
    int32_t l_33 = 0x9D3388A0L;
    float l_43 = (-0x1.Bp-1);
    float *l_42 = &l_43;
    float *l_44[3][2] = {{&l_43,&l_43},{&l_43,&l_43},{&l_43,&l_43}};
    int32_t *l_45 = &l_33;
    int32_t l_46 = 0x2820A3D5L;
    int i, j;
    for (l_33 = 23; (l_33 > (-19)); l_33 = safe_sub_func_int32_t_s_s(l_33, 4))
    { /* block id: 39 */
        uint32_t l_39 = 0x3EAA3E8FL;
        float l_41 = (-0x1.6p+1);
        float *l_40 = &l_41;
        (*l_40) = (safe_sub_func_float_f_f(((+__builtin_parityll(l_39)) >= l_33), l_33));
    }
    (*l_45) |= (l_42 != l_44[1][0]);
    return l_46;
}
