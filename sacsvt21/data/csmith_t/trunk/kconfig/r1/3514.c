...
{ /* block id: 0 */
    ...
    int32_t *l_14 = &l_15;
    int16_t l_16 = 0xBE36L;
    (*l_14) = (((l_2 & ((int16_t)((int16_t)((uint16_t)(((l_2 != 0x1F1EB32A831D26ECLL) , l_2) > (-1L)) >> (uint16_t)14) >> (int16_t)(l_2 || ((int16_t)func_11(l_2) << (int16_t)3))) >> (int16_t)14)) | 0x373AL) ^ l_2);
    (*l_14) = (*l_14);
    return l_16;
}
