...
static uint32_t g_28 = 0xCE3051EBL;
static uint32_t g_30 = 0xACD7D393L;
...
/* 
 * reads : g_4 g_28
 * writes: g_4 g_30 g_35 g_38
 */
static int32_t  func_25(void)
{ /* block id: 36 */
    int8_t l_36 = 0xEAL;
    int32_t l_37 = 0x1320F2D6L;
    for (g_4 = 21; (g_4 < (-16)); --g_4)
    { /* block id: 39 */
        int8_t l_29 = 0L;
        g_30 = (g_28 | l_29);
        g_35 = (safe_add_func_uint64_t_u_u(9UL, (safe_lshift_func_uint8_t_u_u(g_4, 6))));
    }
    g_38 = (l_37 = l_36);
    return l_37;
}
