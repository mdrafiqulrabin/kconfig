...
{ /* block id: 36 */
    ...
    int32_t l_44 = 1;
    l_44 = (((((uint16_t)((((0x7684593F != 0x08376FBF) && l_36) <= 0) | g_3) + (uint16_t)l_36) <= ((!(((int16_t)((int32_t)g_3 + (int32_t)9U) << (int16_t)((uint32_t)__builtin_bswap32(__builtin_bswap32((1 | g_3))) + (uint32_t)0xFCA86293)) ^ l_36)) ^ l_36)) >= 4294967295U) && l_36);
    return g_3;
}
