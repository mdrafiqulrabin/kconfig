...
inline static uint32_t  func_26(void)
{ /* block id: 36 */
    float l_27[6][6] = {{0x1.2p+1,0x0.0p-1,0x1.2p+1,0x1.2p+1,0x0.0p-1,0x1.2p+1},{0x1.2p+1,0x0.0p-1,0x1.2p+1,0x1.2p+1,0x0.0p-1,0x1.2p+1},{0x1.2p+1,0x0.0p-1,0x1.2p+1,0x1.2p+1,0x0.0p-1,0x1.2p+1},{0x1.2p+1,0x0.0p-1,0x1.2p+1,0x1.2p+1,0x0.0p-1,0x1.2p+1},{0x1.2p+1,0x0.0p-1,0x1.2p+1,0x1.2p+1,0x0.0p-1,0x1.2p+1},{0x1.2p+1,0x0.0p-1,0x1.2p+1,0x1.2p+1,0x0.0p-1,0x1.2p+1}};
    int32_t l_28 = 0x3773672DL;
    int i, j;
    return l_28;
}
