...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xF6D4A0D4L;/* VOLATILE GLOBAL g_2 */
...
{ /* block id: 0 */
lbl_9:
    for (g_4 = 0; (g_4 < (-2)); g_4 = safe_sub_func_uint16_t_u_u(g_4, 6))
    { /* block id: 3 */
        return g_4;
    }
    for (g_4 = (-5); (g_4 > (-28)); g_4 = safe_sub_func_int64_t_s_s(g_4, 6))
    { /* block id: 8 */
        if (g_4)
            goto lbl_9;
    }
