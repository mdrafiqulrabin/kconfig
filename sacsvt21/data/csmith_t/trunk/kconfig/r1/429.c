...
{ /* block id: 0 */
    uint16_t l_5 = 0x5A9C;
    int32_t l_18 = (-2);
    l_18 = (((int16_t)(-(int16_t)l_5) << (int16_t)((uint16_t)l_5 >> (uint16_t)((int16_t)g_10 >> (int16_t)((int32_t)((0xED6B && func_13(l_5)) || (g_10 == (((0x7FA3 == (-(int32_t)(!0xD7F1))) | g_10) < 7U))) - (int32_t)0xA7B5CF1C)))) >= g_10);
    return g_10;
}
