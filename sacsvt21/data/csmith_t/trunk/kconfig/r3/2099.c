...
inline static float  func_30(void)
{ /* block id: 36 */
    int16_t l_31[1][3][10] = {{{0L,0L,0L,0L,0L,0L,0L,0L,0L,0L},{0L,0L,0L,0L,0L,0L,0L,0L,0L,0L},{0L,0L,0L,0L,0L,0L,0L,0L,0L,0L}}};
    float l_33 = 0x8.Ep-1;
    float *l_32 = &l_33;
    int32_t l_34 = 0xAFEC1E18L;
    int i, j, k;
    (*l_32) = l_31[0][2][3];
    l_34 = ((*l_32) = 0xE.7D3709p+63);
    return l_31[0][2][3];
}
