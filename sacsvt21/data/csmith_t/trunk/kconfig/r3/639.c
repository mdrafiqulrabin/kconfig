...
/* --- GLOBAL VARIABLES --- */
static float g_7[2] = {0x2.Cp+1,0x2.Cp+1};
static uint64_t g_8 = 0UL;
static int32_t g_33[2] = {0x2FF18C9AL,0x2FF18C9AL};
...
{ /* block id: 36 */
    int32_t *l_32 = &g_33[1];
    int32_t *l_34[10][2][8];
    int16_t l_35[5] = {(-1L),(-1L),(-1L),(-1L),(-1L)};
    int32_t l_36[6] = {0xC9AA6F57L,0xC9AA6F57L,0xC9AA6F57L,0xC9AA6F57L,0xC9AA6F57L,0xC9AA6F57L};
    int16_t l_37 = 0xC76BL;
    uint8_t l_38 = 0x38L;
    uint64_t l_41 = 1UL;
    int i, j, k;
    for (i = 0; i < 10; i++)
