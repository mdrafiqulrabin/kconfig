...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_3[4][3] = {{4294967286UL,4294967286UL,4294967286UL},{0x654FDDD3L,0x654FDDD3L,0x654FDDD3L},{4294967286UL,4294967286UL,4294967286UL},{0x654FDDD3L,0x654FDDD3L,0x654FDDD3L}};
    int i, j;
    g_2 = (0x1.0p+1 == (-0x1.0p+1));
    return l_3[3][1];
}
