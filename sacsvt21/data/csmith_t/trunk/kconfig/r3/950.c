...
{ /* block id: 36 */
    ...
    uint16_t l_43 = 0xF2A6;
    uint16_t *l_42 = &l_43;
    int32_t *l_44 = &l_40;
    int32_t l_46 = (-1);
    int32_t *l_45 = &l_46;
    uint32_t l_47 = 0xCC9E520C;
    int32_t l_48 = 0xD3CC114F;
    for (l_27 = (-10); (l_27 != 8); l_27 += 1)
    { /* block id: 39 */
        int32_t l_30 = 0xBE56890C;
        if (l_30)
            break;
    }
    l_47 |= (((((*l_45) &= (l_27 & ((*l_44) = ((~(0xB5E4 >= (l_27 , l_27))) | (((int16_t)(-(uint16_t)(l_35 = 0x8F55)) >> (int16_t)12) ^ ((((*l_42) ^= (((*l_38) ^= ((4294967295U && ((l_27 || ((uint16_t)(l_27 > (__builtin_popcountll(l_27) , l_27)) - (uint16_t)l_27)) || 0xA6F63EED)) != (-1))) >= l_40)) > l_40) >= l_40)))))) >= 0U) == l_27) == 0x95921BA5);
    return l_48;
}
