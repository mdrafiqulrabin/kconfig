...
inline static uint32_t  func_33(void)
{ /* block id: 36 */
    int32_t l_35 = 0xFA318711;
    int32_t *l_34 = &l_35;
    int32_t **l_36 = &l_34;
    uint16_t l_46 = 0x7A83;
    (*l_36) = l_34;
    (*l_34) = ((int16_t)((int16_t)((&l_34 != &l_34) | 0xB382E580) >> (int16_t)((int16_t)(((*l_36) != (*l_36)) && (func_43((**l_36)) < func_43((*l_34)))) % (int16_t)(*l_34))) >> (int16_t)(**l_36));
    return l_46;
}
