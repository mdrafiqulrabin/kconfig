...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x7A7C2039L;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 4L;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 0L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0x5C62E089L;
static int32_t g_8 = 0xC0001115L;
...
/* ------------------------------------------ */
/* 
 * reads : g_5 g_8 g_4 g_2
 * writes: g_5 g_8
 */
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_12 = 0x336DL;
    for (g_5 = (-10); (g_5 > 29); g_5 = safe_add_func_int16_t_s_s(g_5, 2))
    { /* block id: 3 */
        uint32_t l_11 = 0xD461E3FFL;
        for (g_8 = 0; (g_8 >= 18); g_8 = safe_add_func_uint16_t_u_u(g_8, 3))
        { /* block id: 6 */
            l_11 = 0x0B95AE64L;
            return g_4;
        }
        l_12--;
        g_8 = (safe_sub_func_int32_t_s_s((-6L), g_5));
    }
