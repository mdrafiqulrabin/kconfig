...
static int8_t  func_33(void)
{ /* block id: 36 */
    int32_t l_34 = 0xF6E229EDL;
    for (l_34 = 16; (l_34 != 22); l_34 = safe_add_func_uint32_t_u_u(l_34, 2))
    { /* block id: 39 */
        int32_t l_37 = (-9L);
        for (l_37 = 3; (l_37 == (-26)); l_37 = safe_sub_func_uint8_t_u_u(l_37, 1))
        { /* block id: 42 */
            int32_t l_40 = 0L;
            int32_t *l_44 = &l_40;
            for (l_40 = 0; (l_40 != 0); l_40 = safe_add_func_uint16_t_u_u(l_40, 3))
            { /* block id: 45 */
                int16_t l_43 = 0xE1FCL;
                if (l_43)
                    break;
            }
            (*l_44) ^= l_37;
