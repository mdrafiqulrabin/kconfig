...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0x8EE41B66L;
static uint16_t g_6 = 65534UL;
static uint16_t g_8 = 0xDFBAL;
static int32_t g_10[6] = {0x8753E1E0L,0x8753E1E0L,0x8753E1E0L,0x8753E1E0L,0x8753E1E0L,0x8753E1E0L};
...
{ /* block id: 0 */
    uint16_t *l_7 = &g_8;
    int32_t l_11 = 3L;
    for (g_2 = 0; (g_2 <= 4); g_2 = safe_add_func_int32_t_s_s(g_2, 1))
    { /* block id: 3 */
        uint16_t *l_5 = &g_6;
        (*g_9) |= ((((*l_5) = g_2) > ((void*)0 != l_7)) < 0xE974A520274952F3LL);
        if (l_11)
            break;
        if (l_11)
            break;
