...
static volatile uint32_t g_6 = 0x1B68DEE2L;/* VOLATILE GLOBAL g_6 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4 = &g_3;
    int32_t *l_5[6][2][1] = {{{(void*)0},{&g_3}},{{&g_3},{(void*)0}},{{&g_3},{&g_3}},{{(void*)0},{&g_3}},{{&g_3},{(void*)0}},{{&g_3},{&g_3}}};
    const uint32_t l_9 = 0UL;
    int i, j, k;
    --g_6;
    return l_9;
}
