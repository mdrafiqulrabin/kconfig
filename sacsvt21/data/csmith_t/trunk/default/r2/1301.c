...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0xCCB03629L;
static volatile int64_t g_5 = 0x613717BE9FB1C038LL;/* VOLATILE GLOBAL g_5 */
static volatile uint32_t g_7 = 4294967293UL;/* VOLATILE GLOBAL g_7 */
static volatile uint32_t g_10[3][1][2] = {{{9UL,0x187110E6L}},{{0x187110E6L,9UL}},{{0x187110E6L,0x187110E6L}}};
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int64_t l_2 = 0x9F4288A137B1891FLL;
    int32_t *l_3[9];
    int64_t l_6 = (-10L);
    int i;
    for (i = 0; i < 9; i++)
