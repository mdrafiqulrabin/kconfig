...
static volatile int64_t g_5 = 0xA4E665969A22DB78LL;/* VOLATILE GLOBAL g_5 */
static int64_t g_7 = (-1L);
static volatile uint64_t g_8 = 0x3876A47CDEDFC3E8LL;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    ...
    int32_t l_4[7] = {0x012E1DFEL,0x2D83D783L,0x2D83D783L,0x012E1DFEL,0x2D83D783L,0x2D83D783L,0x012E1DFEL};
    int16_t l_6[5];
    int i;
    for (i = 0; i < 5; i++)
        l_6[i] = 0x8EC3L;
