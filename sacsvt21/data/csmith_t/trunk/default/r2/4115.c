...
static uint64_t g_7 = 7UL;
static int32_t g_9 = 0x1031C36BL;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0x40CA7005L;
    struct S0 l_6[2] = {{0x077045B3L,0L,0xA4L},{0x077045B3L,0L,0xA4L}};
    int32_t *l_8[1][1];
    int i, j;
    for (i = 0; i < 1; i++)
    {
    ...
    g_9 = ((l_2 , (safe_sub_func_uint32_t_u_u(g_5, l_2))) , ((g_5 & (l_6[0] , l_6[0].f0)) == g_7));
    return g_5;
}
