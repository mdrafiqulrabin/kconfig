...
/* --- GLOBAL VARIABLES --- */
static const struct S1 g_2 = {0x14L,0xCDL,0xAD9BACC5L,5,6L,65535UL};/* VOLATILE GLOBAL g_2 */
static struct S1 * volatile g_3 = (void*)0;/* VOLATILE GLOBAL g_3 */
static struct S1 g_5 = {0x33L,9L,18446744073709551613UL,5,0xB5486B6FL,7UL};/* VOLATILE GLOBAL g_5 */
