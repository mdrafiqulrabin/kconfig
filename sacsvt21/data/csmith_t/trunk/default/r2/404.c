...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_4 = 0xA70051EFL;/* VOLATILE GLOBAL g_4 */
static uint64_t g_6 = 0xB57A67D926128F3BLL;
static uint64_t g_11 = 5UL;
static int32_t g_13 = 0x077045B3L;
...
{ /* block id: 0 */
    ...
    uint64_t *l_10 = &g_11;
    int32_t *l_12 = &g_13;
    (*l_12) &= (safe_add_func_int64_t_s_s(g_4, ((*l_10) = (--(*l_5)))));
    return g_6;
}
