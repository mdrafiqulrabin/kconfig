...
static struct S0 g_8 = {91,14,25,117,2,12};/* VOLATILE GLOBAL g_8 */
static struct S0 *g_7 = &g_8;


/* --- FORWARD DECLARATIONS --- */
static uint32_t  func_1(void);
static struct S0 * func_2(int64_t  p_3, struct S0 * p_4, int32_t  p_5);


/* --- FUNCTIONS --- */
/* ------------------------------------------ */
/* 
 * reads : g_6 g_7 g_8.f2 g_8.f3
 * writes: g_7 g_8.f3
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_9 = 0x964A90C6L;
    struct S0 **l_10 = &g_7;
    (*l_10) = func_2(g_6, g_7, l_9);
    g_8.f3 &= g_8.f2;
    (*l_10) = (*l_10);
    return g_8.f2;
}
