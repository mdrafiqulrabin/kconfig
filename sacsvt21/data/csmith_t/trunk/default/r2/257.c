...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[5][2] = {{1L,0x00FE1CA2L},{0x00FE1CA2L,1L},{0x00FE1CA2L,0x00FE1CA2L},{1L,0x00FE1CA2L},{0x00FE1CA2L,1L}};
...
{ /* block id: 0 */
    ...
    int32_t *l_15 = &g_3[0][0];
    int32_t l_16 = 0xF1FDBD01L;
    int32_t *l_17[10];
    int16_t l_18 = 0x5849L;
    uint64_t l_19 = 0UL;
    int i;
    for (i = 0; i < 10; i++)
        l_17[i] = &l_16;
