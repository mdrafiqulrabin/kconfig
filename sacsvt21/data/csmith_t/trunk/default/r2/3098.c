...
static int32_t g_6 = 0x1F13B01DL;
static union U4 g_7[9] = {{0x1DL},{0xCCL},{0x1DL},{0x1DL},{0xCCL},{0x1DL},{0x1DL},{0xCCL},{0x1DL}};
...
static union U4  func_1(void)
{ /* block id: 0 */
    const int64_t l_2 = 0x73292C5EB2006887LL;
    int32_t *l_3 = (void*)0;
    int32_t *l_5[10] = {&g_6,&g_6,&g_6,(void*)0,&g_6,&g_6,&g_6,&g_6,(void*)0,&g_6};
    int i;
    g_6 &= l_2;
    return g_7[8];
}
