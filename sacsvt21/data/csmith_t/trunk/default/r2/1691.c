...
/* --- GLOBAL VARIABLES --- */
static int8_t g_2[4][6] = {{(-1L),0x31L,0x31L,(-1L),(-1L),0x31L},{(-1L),(-1L),0x31L,0x31L,(-1L),(-1L)},{(-1L),0x31L,0x31L,(-1L),(-1L),0x31L},{(-1L),(-1L),0x31L,0x31L,(-1L),(-1L)}};
static int32_t g_4 = 3L;
static int32_t * const  volatile g_3 = &g_4;/* VOLATILE GLOBAL g_3 */
static volatile uint64_t g_8 = 0x74BE76D238E486AELL;/* VOLATILE GLOBAL g_8 */
static struct S1 g_11 = {65526UL,4294967294UL,0x254292978D8EF068LL};
