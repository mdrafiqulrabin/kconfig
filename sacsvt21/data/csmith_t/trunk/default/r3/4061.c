...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_2 = 65534UL;
static uint32_t g_3 = 7UL;
static int32_t * const  volatile g_4 = (void*)0;/* VOLATILE GLOBAL g_4 */
static int32_t g_7[6][1] = {{1L},{(-3L)},{1L},{(-3L)},{1L},{(-3L)}};
static int32_t *g_12 = &g_7[1][0];
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_5 = 0xB28EL;
    int32_t *l_6 = &g_7[3][0];
    int32_t **l_8 = (void*)0;
    int32_t **l_9 = &l_6;
    int32_t * const l_10 = &g_7[3][0];
    l_5 &= (g_3 = ((0x79C63C40L || 2UL) , g_2));
    (*l_9) = l_6;
    (*g_11) = l_10;
    return (*l_10);
}
