...
/* --- GLOBAL VARIABLES --- */
static volatile uint16_t g_5 = 0x5559L;/* VOLATILE GLOBAL g_5 */
...
/* 
 * reads : g_5 g_11
 * writes: g_5 g_10 g_11
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t l_3 = 0x8FAAAEB9L;
    int32_t *l_4[10] = {&l_3,&l_3,&l_3,&l_3,&l_3,&l_3,&l_3,&l_3,&l_3,&l_3};
    int i;
    ++g_5;
    for (l_3 = (-17); (l_3 < (-23)); l_3 = safe_sub_func_uint64_t_u_u(l_3, 1))
    { /* block id: 4 */
        return g_5;
    }
    g_11 ^= (g_10 = 0xD3A18E41L);
    return g_11;
}
