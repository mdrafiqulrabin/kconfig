...
/* --- GLOBAL VARIABLES --- */
static const volatile union U1 g_3 = {0};/* VOLATILE GLOBAL g_3 */
static const volatile union U1 *g_2 = &g_3;
static const volatile union U1 ** volatile g_4 = &g_2;/* VOLATILE GLOBAL g_4 */
static union U2 g_5 = {0x31EBL};
