...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_2[i] = 0x08L;
    g_4 = l_2[0];
    g_16 |= (!(((safe_rshift_func_int16_t_s_u(1L, 13)) && ((&g_4 == &g_4) , ((g_8 &= g_4) , ((safe_sub_func_int8_t_s_s(g_4, (l_3[8][0] != (void*)0))) , g_8)))) , (safe_lshift_func_uint16_t_u_s((safe_div_func_int16_t_s_s((~g_8), 1UL)), g_8))));
    return g_8;
}
