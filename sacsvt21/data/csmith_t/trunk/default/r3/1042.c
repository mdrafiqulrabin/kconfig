...
static volatile uint16_t g_7 = 0x5950L;/* VOLATILE GLOBAL g_7 */
static int32_t g_13 = 0xB58E17C1L;
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = (void*)0;
    int32_t *l_5 = &l_3;
    int32_t *l_6[3][4] = {{(void*)0,&l_3,&l_3,&l_3},{&l_3,&l_3,(void*)0,&l_3},{&l_3,&l_3,&l_3,(void*)0}};
    const int32_t *l_15[3];
    const int32_t **l_14[7];
    int i, j;
    for (i = 0; i < 3; i++)
        l_15[i] = &g_13;
    for (i = 0; i < 7; i++)
