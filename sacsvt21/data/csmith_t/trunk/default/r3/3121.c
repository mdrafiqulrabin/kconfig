...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[1][3] = {{0x2E0CF572L,0x2E0CF572L,0x2E0CF572L}};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_5[i] = (void*)0;
    for (g_2[0][2] = 0; (g_2[0][2] < 13); g_2[0][2] = safe_add_func_int16_t_s_s(g_2[0][2], 7))
    { /* block id: 3 */
        return g_2[0][1];
    }
    g_2[0][2] = ((-10L) | (g_2[0][1] , 0x23L));
    return g_2[0][0];
}
