...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x5AE649F6L;
static volatile uint32_t g_7 = 0xD78F4F82L;/* VOLATILE GLOBAL g_7 */
static struct S0 g_10 = {4175,10,0x6FEBFB2CL,-1,506};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    int32_t l_4 = (-1L);
    int32_t *l_5 = (void*)0;
    int32_t *l_6[8] = {&l_4,&l_4,&l_4,&l_4,&l_4,&l_4,&l_4,&l_4};
    int i;
    g_7++;
    return g_10;
}
