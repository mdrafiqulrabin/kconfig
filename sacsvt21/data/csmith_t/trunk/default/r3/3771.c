...
static volatile uint32_t g_5 = 0x72D50FA8L;/* VOLATILE GLOBAL g_5 */
static const struct S1 g_8 = {-1L,0xFD99L,1UL,{-3L,1044,0x4A3A6D7DL,0,-8},0x9CL,0xB05EL,0x13550E352601C8D5LL,4294967291UL,18446744073709551615UL,-5L};/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4[1][2][8] = {{{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3}}};
    int i, j, k;
    g_5--;
    return g_8;
}
