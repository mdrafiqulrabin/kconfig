...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x938DD44AL;/* VOLATILE GLOBAL g_2 */
...
{ /* block id: 0 */
    ...
    { /* block id: 4 */
        uint32_t l_6[9] = {0UL,0x0F82BAEFL,0UL,0UL,0x0F82BAEFL,0UL,0UL,0x0F82BAEFL,0UL};
        int i;
        return l_6[4];
    }
}
