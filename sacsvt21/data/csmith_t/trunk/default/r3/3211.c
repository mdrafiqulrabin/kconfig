...
/* --- GLOBAL VARIABLES --- */
static volatile int16_t g_4 = 0xBFC3L;/* VOLATILE GLOBAL g_4 */
static uint64_t g_10 = 0xF82BAEF6E229EDCALL;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 3; i++)
        l_8[i] = &l_3;
    ++g_10;
    for (g_10 = (-9); (g_10 >= 15); g_10 = safe_add_func_int64_t_s_s(g_10, 7))
    { /* block id: 4 */
        return g_4;
    }
    return g_10;
