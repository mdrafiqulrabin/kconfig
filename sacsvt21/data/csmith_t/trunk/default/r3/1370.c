...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x20002526L;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 1L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4[4] = {0x795010F7L,0x795010F7L,0x795010F7L,0x795010F7L};
static struct S0 g_7 = {-322,5298,115};
...
static struct S0  func_1(void)
{ /* block id: 0 */
    for (g_4[1] = 0; (g_4[1] <= 13); g_4[1] = safe_add_func_uint64_t_u_u(g_4[1], 3))
    { /* block id: 3 */
        if (g_4[1])
            break;
    }
