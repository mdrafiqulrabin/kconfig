...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_7 = 0xE7D2L;
static uint16_t g_16 = 0UL;
static uint16_t *g_15[8] = {&g_16,&g_16,&g_16,&g_16,&g_16,&g_16,&g_16,&g_16};
...
/* ------------------------------------------ */
/* 
 * reads : g_7 g_15 g_16 g_20 g_22
 * writes: g_7 g_20 g_22
 */
static uint64_t  func_1(void)
{ /* block id: 0 */
    uint16_t *l_6 = &g_7;
    int8_t *l_19 = &g_20;
    int32_t *l_21 = &g_22;
    (*l_21) |= (safe_div_func_uint16_t_u_u((safe_add_func_uint16_t_u_u(((*l_6)--), ((safe_unary_minus_func_int8_t_s((-1L))) > (safe_rshift_func_int16_t_s_s(0x7186L, 11))))), (safe_add_func_int8_t_s_s(((void*)0 != g_15[2]), ((*l_19) |= ((safe_div_func_int8_t_s_s(0xEBL, 0x91L)) , g_16))))));
    (*l_21) |= 0x35EDADE0L;
    return g_7;
}
