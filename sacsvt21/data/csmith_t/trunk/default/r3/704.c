...
static uint32_t g_12 = 0x438E2136L;
...
{ /* block id: 0 */
    ...
    int i;
    for (g_2 = (-28); (g_2 > 14); g_2 = safe_add_func_uint8_t_u_u(g_2, 3))
    { /* block id: 3 */
        int32_t *l_6 = &g_2;
        int32_t **l_5 = &l_6;
        int32_t *l_8[2][1][8] = {{{&g_9[0],&g_9[0],&g_9[2],&g_9[0],&g_9[0],&g_9[2],&g_9[0],&g_9[0]}},{{(void*)0,&g_9[0],(void*)0,(void*)0,&g_9[0],(void*)0,(void*)0,&g_9[0]}}};
        int i, j, k;
        (*l_5) = (void*)0;
        g_12--;
        return g_9[0];
