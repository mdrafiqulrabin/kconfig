...
static volatile int32_t g_5[3][3][4] = {{{0L,0x83C67EE3L,0x2733582FL,6L},{(-2L),2L,(-2L),6L},{0x2733582FL,0x83C67EE3L,0L,(-6L)}},{{0x7E4A9061L,1L,0x83C67EE3L,0x83C67EE3L},{(-7L),(-7L),0x83C67EE3L,(-2L)},{0x7E4A9061L,0x7C10977AL,0L,1L}},{{0x2733582FL,0L,(-2L),0L},{(-2L),0L,0x2733582FL,1L},{0L,0x7C10977AL,0x7E4A9061L,(-2L)}}};
static int32_t g_6 = 0x32F3F608L;
...
{ /* block id: 6 */
    ...
    for (i = 0; i < 2; i++)
        l_12[i] = &g_6;
    (*l_11) = p_8;
    for (g_6 = 3; (g_6 != 14); g_6++)
    { /* block id: 10 */
        uint64_t l_15 = 0x3799040C3F30B91ELL;
        l_15 = (-7L);
    }
    return l_16;
}
