...
static volatile int64_t g_9 = 0xCB8F6C218E9934B0LL;/* VOLATILE GLOBAL g_9 */
static volatile uint64_t g_10[8] = {0UL,0UL,0UL,0UL,0UL,0UL,0UL,0UL};
static const union U1 g_13 = {-1L};/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_3;
    int32_t *l_6 = &g_3;
    int32_t *l_7[10] = {(void*)0,&g_3,&g_3,(void*)0,&g_3,&g_3,(void*)0,&g_3,&g_3,(void*)0};
    int i;
    --g_10[7];
    (*l_4) = g_8;
    return g_13;
