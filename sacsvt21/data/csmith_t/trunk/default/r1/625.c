...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_4[3] = {0x89L,0x89L,0x89L};
static int32_t g_6 = 0x5F432603L;
static union U5 g_7 = {0x9B8FA48A2B8EA2C3LL};
...
{ /* block id: 0 */
    int32_t *l_5 = &g_6;
    (*l_5) |= (safe_rshift_func_int8_t_s_u(g_4[1], 1));
    return g_7;
}
