...
/* --- GLOBAL VARIABLES --- */
static volatile struct S1 g_3 = {7UL,0x6F08L,18446744073709551607UL,0x0591L,-1L,0xC2132456160CBEB9LL,1L,-1L,1UL,1};/* VOLATILE GLOBAL g_3 */
static volatile struct S1 * volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
...
static int16_t  func_1(void)
{ /* block id: 0 */
    volatile struct S1 * volatile *l_4 = &g_2;
    int32_t l_5 = 0xA6C84902L;
    (*l_4) = g_2;
    return l_5;
}
