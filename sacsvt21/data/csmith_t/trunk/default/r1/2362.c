...
static volatile uint32_t g_17 = 0x08531D14L;/* VOLATILE GLOBAL g_17 */
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_3;
    int32_t *l_7 = &g_3;
    int32_t l_8 = 0x66F5A9C4L;
    int32_t *l_9 = &l_8;
    int32_t *l_10 = &g_3;
    int32_t *l_12 = &g_3;
    int32_t l_13 = 0xC1188E17L;
    int32_t *l_14[6] = {&l_13,&l_8,&l_13,&l_13,&l_8,&l_13};
    int32_t l_15 = (-1L);
    int i;
    --g_17;
    return g_11;
