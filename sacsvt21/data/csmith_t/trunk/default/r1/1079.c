...
/* --- GLOBAL VARIABLES --- */
static int64_t g_6 = 0xBBF9ACF2579253A3LL;
static int32_t g_9 = 0L;
static int32_t g_19 = 0xE434392FL;
static int32_t g_20 = 0x20A6FF60L;
static struct S1 g_21 = {89,3621};
...
/* 
 * reads : g_6 g_9 g_21
 * writes: g_6 g_9 g_19 g_20
 */
static struct S1  func_1(void)
{ /* block id: 0 */
    uint32_t l_4 = 0xB9DD952EL;
    int64_t *l_5 = &g_6;
    int32_t l_7 = 2L;
    int32_t *l_8 = &g_9;
    (*l_8) = ((safe_div_func_uint64_t_u_u(l_4, ((*l_5) = 0x1464F16EFA42B483LL))) != (l_7 = l_4));
    for (g_6 = 0; (g_6 != 4); g_6++)
    { /* block id: 6 */
        for (g_9 = 0; (g_9 != 27); ++g_9)
        { /* block id: 9 */
            for (l_7 = 0; (l_7 != 13); l_7 = safe_add_func_uint64_t_u_u(l_7, 1))
            { /* block id: 12 */
                uint64_t l_18[1][7] = {{0UL,0x9ED890FC520EA0C8LL,0UL,0UL,0x9ED890FC520EA0C8LL,0UL,0UL}};
                int i, j;
                for (l_4 = 0; (l_4 != 4); l_4++)
                { /* block id: 15 */
