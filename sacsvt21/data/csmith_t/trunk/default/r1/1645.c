...
/* --- GLOBAL VARIABLES --- */
static int64_t g_2 = 0xAB8C3AD3B3152C58LL;
static int32_t g_4 = 2L;
static int8_t g_5[7][7][3] = {{{1L,0x96L,5L},{0xF8L,1L,0L},{(-10L),(-10L),5L},{7L,1L,7L},{(-10L),0x96L,0x96L},{0xF8L,1L,0L},{1L,(-10L),0x96L}},{{7L,1L,7L},{1L,0x96L,5L},{0xF8L,1L,0L},{(-10L),(-10L),5L},{7L,1L,7L},{(-10L),0x96L,0x96L},{0xF8L,1L,0L}},{{1L,(-10L),0x96L},{7L,1L,7L},{1L,0x96L,5L},{0xF8L,1L,0L},{(-10L),(-10L),5L},{7L,1L,7L},{(-10L),0x96L,0x96L}},{{0xF8L,1L,0L},{1L,(-10L),0x96L},{7L,1L,7L},{1L,0x96L,5L},{0xF8L,1L,0L},{(-10L),(-10L),5L},{7L,1L,7L}},{{(-10L),0x96L,0x96L},{0xF8L,1L,0L},{1L,(-10L),0x96L},{7L,1L,7L},{1L,0x96L,5L},{0xF8L,1L,0L},{(-10L),(-10L),5L}},{{7L,1L,7L},{(-10L),0x96L,0x96L},{0xF8L,1L,0L},{1L,(-10L),0x96L},{7L,1L,7L},{1L,0x96L,5L},{0xF8L,1L,0L}},{{(-10L),(-10L),5L},{7L,1L,7L},{(-10L),0x96L,0x96L},{0xF8L,1L,0L},{1L,(-10L),0x96L},{7L,1L,7L},{1L,0x96L,5L}}};
