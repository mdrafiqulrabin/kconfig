...
static int32_t g_4 = 0x7A4BEDCCL;
static union U1 g_5[5][1] = {{{7L}},{{7L}},{{7L}},{{7L}},{{7L}}};
...
static union U1  func_1(void)
{ /* block id: 0 */
    int8_t l_2[4][5] = {{(-1L),0xC1L,0L,0L,0xC1L},{(-1L),0L,0xA1L,0xA1L,0L},{(-1L),0xC1L,0L,0L,0xC1L},{(-1L),0L,0xA1L,0xA1L,0L}};
    int i, j;
