...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[4][4] = {{0x08F8256AL,9L,9L,0x08F8256AL},{9L,0x08F8256AL,(-4L),(-10L)},{9L,(-4L),9L,1L},{0x08F8256AL,(-10L),1L,1L}};
...
{ /* block id: 0 */
    ...
    int32_t *l_10[2];
    int8_t l_11 = 0xC5L;
    int64_t l_12 = 0x33ECDC0F1FA6F63ELL;
    uint16_t l_13 = 0x140AL;
    volatile int32_t **l_16 = &l_3;
    int i;
    for (i = 0; i < 2; i++)
        l_10[i] = (void*)0;
    (*l_3) = g_2[3][2];
