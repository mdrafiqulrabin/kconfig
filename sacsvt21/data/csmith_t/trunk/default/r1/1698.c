...
/* --- GLOBAL VARIABLES --- */
static int64_t g_6[1][6] = {{(-9L),(-9L),(-9L),(-9L),(-9L),(-9L)}};
...
{ /* block id: 0 */
    ...
    { /* block id: 4 */
        int32_t *l_8 = &g_9;
        int32_t **l_7[4][6] = {{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8},{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8},{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8},{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8}};
        int i, j;
        l_10 = (void*)0;
    }
    (*g_12) ^= l_11;
