...
static int8_t g_12 = (-10L);
static volatile int8_t g_13 = 8L;/* VOLATILE GLOBAL g_13 */
static volatile int32_t g_14 = 0L;/* VOLATILE GLOBAL g_14 */
static volatile uint8_t g_15 = 0x05L;/* VOLATILE GLOBAL g_15 */
...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &g_4;
    int32_t *l_8 = &g_4;
    int32_t *l_9[6] = {&g_4,&g_4,&g_4,&g_4,&g_4,&g_4};
    int32_t l_11 = 0xA3CFCE29L;
    int i;
    g_15--;
    return g_4;
}
