...
static volatile uint16_t g_13 = 0x4675L;/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4 = &g_3;
    int32_t l_5 = 0x843046B6L;
    int32_t *l_6 = (void*)0;
    int32_t l_7 = 0x29C1464FL;
    int32_t l_8 = 1L;
    int32_t *l_9 = &l_7;
    int32_t *l_10[9] = {&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3};
    int i;
    g_13++;
    for (l_7 = 0; (l_7 == (-23)); l_7 = safe_sub_func_int8_t_s_s(l_7, 9))
    { /* block id: 4 */
        int32_t **l_19 = &l_6;
