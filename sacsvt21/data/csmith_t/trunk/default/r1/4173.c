...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[10][1] = {{0x3A4A9BDBL},{0xBECBA2AFL},{0x3A4A9BDBL},{0xBECBA2AFL},{0x3A4A9BDBL},{0xBECBA2AFL},{0x3A4A9BDBL},{0xBECBA2AFL},{0x3A4A9BDBL},{0xBECBA2AFL}};
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &g_3[2][0];
    int32_t *l_6 = (void*)0;
    int32_t *l_7[5] = {&g_3[9][0],&g_3[9][0],&g_3[9][0],&g_3[9][0],&g_3[9][0]};
    uint16_t l_8 = 0x644AL;
    int i;
    l_8--;
    return g_3[0][0];
}
