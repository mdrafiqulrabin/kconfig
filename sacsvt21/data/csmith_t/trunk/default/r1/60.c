...
{ /* block id: 0 */
    int64_t l_6 = (-1L);
    int32_t *l_15[8] = {&g_11,&g_11,&g_11,&g_11,&g_11,&g_11,&g_11,&g_11};
    int i;
    (*g_10) = (func_2(g_5, l_6) , (0x62DB8E9646B8D963LL < g_11));
    return (*g_10);
}
...
static int64_t  func_2(uint8_t  p_3, int8_t  p_4)
{ /* block id: 1 */
    int32_t l_14 = 0xE7CCC895L;
    (*g_10) &= (safe_mul_func_uint8_t_u_u((~p_3), g_5));
