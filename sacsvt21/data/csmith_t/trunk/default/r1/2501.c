...
static volatile int32_t g_4 = 0x9822CB3AL;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = 0x4B03E386L;/* VOLATILE GLOBAL g_5 */
static int32_t g_6[1] = {0x3DDA37BBL};
static volatile int64_t g_12 = 0x6A37BD55FD0A3205LL;/* VOLATILE GLOBAL g_12 */
...
{ /* block id: 0 */
    int32_t l_2[1];
    int8_t l_11 = 0x22L;
    uint32_t l_14 = 0x74BDBAF9L;
    int i;
    for (i = 0; i < 1; i++)
        l_2[i] = 9L;
    for (g_6[0] = 0; (g_6[0] <= 0); g_6[0] += 1)
    { /* block id: 3 */
        int32_t *l_7 = &l_2[g_6[0]];
        int32_t *l_8 = &l_2[g_6[0]];
        int32_t *l_9 = &l_2[0];
        int32_t *l_10[1];
        int i;
        for (i = 0; i < 1; i++)
