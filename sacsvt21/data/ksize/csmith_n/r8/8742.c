...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_11 = 0x978F3C34L;
...
static int32_t  func_27(void)
{ /* block id: 36 */
    uint8_t l_29[4][3][2] = {{{255UL,1UL},{255UL,255UL},{1UL,255UL}},{{0x15L,255UL},{1UL,255UL},{255UL,1UL}},{{255UL,0x15L},{255UL,1UL},{255UL,255UL}},{{1UL,255UL},{0x15L,255UL},{1UL,255UL}}};
    int i, j, k;
    l_29[2][2][0] |= g_11;
    return g_11;
}
