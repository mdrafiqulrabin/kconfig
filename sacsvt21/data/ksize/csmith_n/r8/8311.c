...
static float g_52 = 0xC.30F888p-61;
...
/* 
 * reads : g_3 g_33
 * writes: g_3 g_33 g_53
 */
inline static uint64_t  func_29(void)
{ /* block id: 36 */
    uint16_t l_47 = 65535UL;
    for (g_3 = (-12); (g_3 != 2); g_3 = safe_add_func_int8_t_s_s(g_3, 7))
    { /* block id: 39 */
        int32_t *l_32 = &g_33;
        int32_t *l_34 = &g_33;
        int32_t *l_35 = &g_33;
        ...
        int32_t *l_46 = (void*)0;
        --l_47;
        g_53 = (g_33 = (g_3 == ((safe_lshift_func_uint8_t_u_u(((*l_35) <= g_33), 2)) >= (*l_37))));
    }
    return g_33;
}
