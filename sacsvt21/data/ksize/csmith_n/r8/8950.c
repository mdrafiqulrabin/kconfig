...
/* --- GLOBAL VARIABLES --- */
static int8_t g_3 = 0x54L;
static int32_t g_35 = 0x1C5860BCL;
...
{ /* block id: 36 */
    int16_t l_33 = 2L;
    int32_t *l_34 = &g_35;
    (*g_37) ^= ((&g_3 == &g_3) == (((safe_div_func_int32_t_s_s(__builtin_ffsl(g_3), (((*l_34) = l_33) ^ (!__builtin_popcount(__builtin_popcount(g_3)))))) == (((g_3 && 0x1826L) >= 0x48E6L) > 0xE0L)) != g_3));
    return g_38;
}
