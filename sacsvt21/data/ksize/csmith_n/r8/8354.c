...
static struct S1 g_40 = {0xBEL,0x9BL,0x6BC7L,0x2BADL,65531UL,0xA408L};/* VOLATILE GLOBAL g_40 */
...
{ /* block id: 36 */
    ...
    int32_t *l_37 = (void*)0;
    int32_t *l_38 = &g_39;
    (*g_35) ^= ((255UL | ((*l_27) = g_6)) || (safe_div_func_uint64_t_u_u((l_31 || ((void*)0 == &g_28)), (safe_sub_func_int8_t_s_s(l_31, (!0xC8F9611CA4B38B4BLL))))));
    (*l_38) ^= (*g_35);
    (*l_38) ^= (*g_35);
    return g_40;
}
