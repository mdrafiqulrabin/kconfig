...
static volatile int32_t g_32[1] = {0xABC24891L};
static volatile int32_t * volatile g_31 = &g_32[0];/* VOLATILE GLOBAL g_31 */
...
static const uint8_t  func_30(void)
{ /* block id: 36 */
    volatile int32_t * volatile *l_33[2];
    volatile int32_t * volatile l_34 = &g_32[0];/* VOLATILE GLOBAL l_34 */
    int i;
    for (i = 0; i < 2; i++)
        l_33[i] = &g_31;
    l_34 = g_31;
