...
/* --- GLOBAL VARIABLES --- */
static const int64_t g_4 = (-5L);
static float g_27[1][5][2] = {{{(-0x1.Dp-1),0x9.1p+1},{0x9.1p+1,(-0x1.Dp-1)},{0x9.1p+1,0x9.1p+1},{(-0x1.Dp-1),0x9.1p+1},{0x9.1p+1,(-0x1.Dp-1)}}};
