...
static int32_t g_33 = 0x4E4A53E8L;
...
{ /* block id: 36 */
    int32_t *l_32[2];
    float l_34[3];
    uint32_t l_35[2][2][7] = {{{0xAC6AA04DL,1UL,18446744073709551615UL,18446744073709551615UL,1UL,0xAC6AA04DL,1UL},{0xCDE333B8L,0xAC6AA04DL,0xAC6AA04DL,0xCDE333B8L,1UL,0xCDE333B8L,0xAC6AA04DL}},{{1UL,1UL,0xAC6AA04DL,18446744073709551615UL,0xAC6AA04DL,1UL,1UL},{1UL,0xAC6AA04DL,18446744073709551615UL,0xAC6AA04DL,1UL,1UL,0xAC6AA04DL}}};
    int i, j, k;
    for (i = 0; i < 2; i++)
        l_32[i] = &g_33;
    for (i = 0; i < 3; i++)
