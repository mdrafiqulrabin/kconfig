...
static int32_t g_28 = 0x1E124DC4L;
static union U0 g_31 = {0x9.7E3B6Fp+81};/* VOLATILE GLOBAL g_31 */
static union U0 g_32 = {0x6.6DAD81p-71};/* VOLATILE GLOBAL g_32 */
...
/* ------------------------------------------ */
/* 
 * reads : g_28 g_31 g_32
 * writes: g_28
 */
static union U0  func_27(void)
{ /* block id: 36 */
    for (g_28 = 0; (g_28 <= 29); g_28 = safe_add_func_uint16_t_u_u(g_28, 7))
    { /* block id: 39 */
        return g_31;
        /* statement id: 40 */
            }
