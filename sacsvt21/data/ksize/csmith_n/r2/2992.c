...
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2 = 0xFEBB6748;
    int32_t l_5 = 1;
    int32_t l_6 = 0x182ABBF9;
    int32_t l_7 = (-1);
    int32_t l_8 = 1;
    int32_t l_11 = 0x758E356E;
    uint16_t l_12 = 8U;
    l_11 = (((l_2 = 0xCECB4571) | ((((int32_t)(l_5 = 0x6B9DD952) - (int32_t)8) >= (l_6 = l_6)) , (l_8 = (((l_7 = (l_6 = (((l_5 = l_5) , l_6) , l_5))) >= l_8) , ((int16_t)(l_5 = 0x061A) - (int16_t)l_7))))) , l_5);
    l_12 = l_11;
    return l_6;
}
