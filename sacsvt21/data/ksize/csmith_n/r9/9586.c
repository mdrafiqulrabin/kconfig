...
{ /* block id: 36 */
    ...
    float l_45 = 0x0.1p+1;
    float *l_44 = &l_45;
    (*l_44) = (__builtin_ctzl(l_32) == ((safe_sub_func_float_f_f(l_32, (!(((0x2.088B92p-46 < (safe_div_func_float_f_f(l_32, (safe_sub_func_float_f_f(((l_32 != ((safe_mul_func_float_f_f(l_32, l_32)) <= (safe_sub_func_float_f_f(l_32, l_32)))) == l_32), l_32))))) >= 0x9.424B96p+16) < l_32)))) <= l_32));
    return l_32;
}
