...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_3 = 0x0E60F951L;
static int8_t g_42[9] = {0L,(-3L),0L,0L,(-3L),0L,0L,(-3L),0L};
static int32_t g_46[2] = {1L,1L};
static int32_t g_48 = 0x86AE2AD2L;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_46 g_47 g_48
 * writes: g_3 g_42 g_46 g_48
 */
static uint32_t  func_24(void)
{ /* block id: 36 */
    int32_t l_40 = (-1L);
    int32_t l_43 = 0x6983C17AL;
    for (g_3 = 0; (g_3 <= 21); g_3 = safe_add_func_int8_t_s_s(g_3, 2))
    { /* block id: 39 */
        uint64_t l_31[1][1];
        float l_38[6] = {0x3.1p-1,0x3.1p-1,0x3.1p-1,0x3.1p-1,0x3.1p-1,0x3.1p-1};
        int8_t *l_41 = &g_42[6];
        int i, j;
        for (i = 0; i < 1; i++)
        {
        ...
        g_46[0] |= (safe_add_func_int16_t_s_s((l_31[0][0] || ((g_3 , (safe_mod_func_uint64_t_u_u(l_31[0][0], (safe_lshift_func_int8_t_s_s((((*l_41) = (safe_add_func_uint16_t_u_u((l_31[0][0] != (~l_40)), l_40))) != 0x82L), ((l_43 = l_31[0][0]) < (safe_mul_func_uint16_t_u_u(65529UL, l_40)))))))) < 3UL)), l_31[0][0]));
    }
    (*g_47) ^= l_40;
    return l_43;
}
