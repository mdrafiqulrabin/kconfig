...
static int32_t  func_31(void)
{ /* block id: 36 */
    union U1 l_33 = {0xFAD5L};
    union U1 *l_32 = &l_33;
    uint8_t l_34 = 8UL;
    int64_t l_37 = 0xC5051DD2E91C8413LL;
    float *l_38 = (void*)0;
    float l_40 = 0x8.2D50FAp-19;
    float *l_39 = &l_40;
    l_32 = (void*)0;
    /* statement id: 37 */
    assert (l_32 == 0);
    (*l_39) = (((__builtin_bswap32((__builtin_ffsll(l_33.f1) > ((251UL <= l_33.f2) ^ (l_34 ^ ((safe_mod_func_uint16_t_u_u(((void*)0 == &l_33), l_33.f1)) >= 4294967294UL))))) <= l_37) == l_33.f1) > l_33.f2);
    return l_37;
}
