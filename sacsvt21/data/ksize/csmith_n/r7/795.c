...
static struct S1  func_1(void)
{ /* block id: 0 */
    struct S0 l_2 = {0x68451F1E,0x83D1,0x0DFBC43C,65535U,-1,1};
    struct S0 l_3 = {0xF23E4692,0x9A48,-1,1U,-9,1};
    struct S1 l_4 = {{0,0xA1EF,1,0x3782,-6,0x0C63B882},1,{-1,0x4A21,6,1U,0x3D4C4698,3},{0xA3F0AEAC,0x2D50,0xBC98072F,65535U,0x6FD0FE1F,-10},0x56BF,65535U};
    l_3 = (l_2 = l_2);
    return l_4;
}
