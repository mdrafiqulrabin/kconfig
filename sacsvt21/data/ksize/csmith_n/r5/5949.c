...
{ /* block id: 36 */
    ...
    int32_t *l_33 = (void*)0;
    int32_t *l_34[7] = {&l_32[0][2],&l_32[0][3],&l_32[0][2],&l_32[0][2],&l_32[0][3],&l_32[0][2],&l_32[0][2]};
    float l_35 = 0x0.25AC95p-15;
    uint32_t l_36 = 1UL;
    uint16_t l_42[8];
    int i, j;
    for (i = 0; i < 1; i++)
    ...
    for (i = 0; i < 8; i++)
        l_42[i] = 0x59FAL;
    l_36--;
    for (l_36 = 0; (l_36 > 25); l_36 = safe_add_func_int8_t_s_s(l_36, 1))
    { /* block id: 40 */
        int16_t l_41 = 1L;
        return l_41;
    }
...
XXX times a pointer is qualified to be dereferenced: 196
