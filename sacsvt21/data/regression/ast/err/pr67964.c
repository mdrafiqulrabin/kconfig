...
extern int fn0 (void) __attribute__ ((const const));  
extern int fn1 (void) __attribute__ ((const, const));
extern int fn2 (void) __attribute__ ((optimize (0) const));  
...
int i;
int ii;
extern int a __attribute__ ((alias ("i") unused));  
extern int a2 __attribute__ ((alias ("i" "i")));
struct A { char p[6]; } __attribute__((__packed__ packed));  
