...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0x51DA622AL;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0L;
static int32_t g_7 = (-1L);
static struct S0 g_8 = {-10L,-5L};/* VOLATILE GLOBAL g_8 */
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_3 g_7 g_8
 * writes: g_3 g_4 g_7
 */
static struct S0  func_1(void)
{ /* block id: 0 */
    int64_t l_2[6] = {0xB4EBB0CB8CE3E63ELL,0L,0xB4EBB0CB8CE3E63ELL,0xB4EBB0CB8CE3E63ELL,0L,0xB4EBB0CB8CE3E63ELL};
    int i;
