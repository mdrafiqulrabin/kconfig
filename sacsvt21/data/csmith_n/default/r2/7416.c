...
/* --- GLOBAL VARIABLES --- */
static volatile struct S1 g_3 = {0xD2L,0x4C405B40194DDBC3LL,0x07822E6EL,0xF737L};/* VOLATILE GLOBAL g_3 */
static volatile struct S1 *g_2[1][5] = {{&g_3,&g_3,&g_3,&g_3,&g_3}};
static volatile struct S1 ** volatile g_4 = (void*)0;/* VOLATILE GLOBAL g_4 */
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    volatile struct S1 **l_5 = &g_2[0][1];
    (*l_5) = g_2[0][3];
    return g_3.f3;
}
