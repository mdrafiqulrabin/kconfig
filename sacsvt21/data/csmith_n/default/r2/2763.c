...
static int32_t g_6[6][1][1] = {{{0x0091DF82L}},{{0L}},{{0L}},{{0x0091DF82L}},{{0L}},{{0L}}};
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_7 g_4 g_6
 * writes: g_4 g_6 g_7
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t *l_3 = &g_4;
    int32_t *l_5[6] = {&g_6[5][0][0],&g_6[5][0][0],&g_6[5][0][0],&g_6[5][0][0],&g_6[5][0][0],&g_6[5][0][0]};
    int i;
    g_7 = (g_6[5][0][0] = ((((*l_3) = g_2) || g_2) , ((-7L) && 18446744073709551615UL)));
    for (g_7 = 5; (g_7 > 9); g_7 = safe_add_func_uint8_t_u_u(g_7, 6))
    { /* block id: 6 */
        g_6[5][0][0] |= g_4;
    }
    return g_7;
