...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_4 = 0xB023ED15L;
static int32_t g_7 = 1L;
static int32_t * volatile g_6[3][9] = {{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7}};
...
{ /* block id: 0 */
    int64_t l_5 = 0L;
    (*g_8) = ((safe_mod_func_int32_t_s_s(g_4, g_4)) >= l_5);
    return g_7;
}
