...
/* --- GLOBAL VARIABLES --- */
static const volatile int8_t g_4 = 0xCDL;/* VOLATILE GLOBAL g_4 */
static int16_t g_6 = 0xD581L;
static int8_t g_9 = 0x00L;
static int32_t g_11 = (-1L);
static uint16_t g_12 = 0x6FEBL;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 2; i++)
        l_5[i] = (void*)0;
    g_6 = (safe_lshift_func_uint8_t_u_s(g_4, 6));
    g_12 = func_7((g_9 , (void*)0));
    return g_11;
}
