...
static volatile uint16_t g_10 = 0xBCB1L;/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t l_4 = 0xE672CA3CL;
    int32_t l_5 = 0x23371247L;
    int32_t *l_6 = &l_5;
    int32_t *l_7 = &l_4;
    int32_t *l_8[10] = {&l_5,&g_3,&g_3,&g_3,&g_3,&l_5,&g_3,&g_3,&g_3,&g_3};
    const int32_t l_13 = 0xE77E815FL;
    int i;
    g_10--;
    return l_13;
}
