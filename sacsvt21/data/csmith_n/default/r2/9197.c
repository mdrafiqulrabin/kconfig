...
static int8_t g_8 = 0xB9L;
static int32_t g_9 = 0x47941CE3L;
static volatile int32_t g_10[8] = {(-10L),(-10L),(-10L),(-10L),(-10L),(-10L),(-10L),(-10L)};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4 = &g_3;
    int32_t *l_5[9] = {&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3};
    int32_t l_7 = 0xB2AEE5A9L;
    uint64_t l_11[3][1];
    int i, j;
    for (i = 0; i < 3; i++)
    {
        for (j = 0; j < 1; j++)
            l_11[i][j] = 0x57511ECBFCF419C2LL;
    }
    --l_11[2][0];
    return g_10[1];
}
