...
/* --- GLOBAL VARIABLES --- */
static volatile int16_t g_2 = 0xDE0BL;/* VOLATILE GLOBAL g_2 */
...
{ /* block id: 0 */
    ...
    int32_t *l_8 = (void*)0;
    int32_t *l_9[2];
    uint64_t l_10[5][5] = {{0UL,0UL,0UL,0UL,0UL},{1UL,1UL,1UL,1UL,1UL},{0UL,0UL,0UL,0UL,0UL},{1UL,1UL,1UL,1UL,1UL},{0UL,0UL,0UL,0UL,0UL}};
    int i, j;
    for (i = 0; i < 2; i++)
        l_9[i] = &g_5;
    (*l_4) |= g_2;
