...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[2] = {0x06DE713AL,0x06DE713AL};
static int32_t g_6 = (-8L);
static const union U0 g_10 = {1L};
...
static const union U0  func_1(void)
{ /* block id: 0 */
    uint32_t l_7 = 0x588D0D3FL;
    for (g_2[0] = (-25); (g_2[0] <= 14); g_2[0] = safe_add_func_int16_t_s_s(g_2[0], 8))
    { /* block id: 3 */
        int32_t *l_5 = &g_6;
        l_7++;
        if (l_7)
