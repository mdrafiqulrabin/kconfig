...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[8] = {0x85F88E10L,(-1L),0x85F88E10L,0x85F88E10L,(-1L),0x85F88E10L,0x85F88E10L,(-1L)};
...
{ /* block id: 0 */
    ...
    int32_t *l_3 = &g_4[6];
    int32_t *l_5 = &g_4[2];
    int32_t *l_6[9] = {&g_4[6],&g_4[6],&g_4[6],&g_4[6],&g_4[6],&g_4[6],&g_4[6],&g_4[6],&g_4[6]};
    int64_t l_7 = 0xEB5EA28C7FFFAA23LL;
    uint64_t l_8 = 0x2A2EF7E291920B24LL;
    union U5 l_11 = {1UL};
    int i;
    l_8++;
    return l_11;
