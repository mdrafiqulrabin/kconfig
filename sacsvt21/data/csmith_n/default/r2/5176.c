...
static int32_t g_3 = 0xC36FE5ABL;
static int32_t g_9 = 0x3BC1B0FEL;
static int32_t *g_8 = &g_9;
static struct S5 g_10 = {735,721,3,10404};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    for (g_3 = (-16); (g_3 < 10); g_3 = safe_add_func_uint32_t_u_u(g_3, 8))
    { /* block id: 3 */
        int32_t **l_7 = (void*)0;
        g_8 = l_6;
    }
