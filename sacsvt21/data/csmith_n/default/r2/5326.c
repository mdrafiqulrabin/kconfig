...
static volatile int32_t g_3 = 0xF82D83D7L;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 0x89226C31L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 8L;
static volatile int32_t *g_11 = &g_4;
...
static const uint32_t  func_1(void)
{ /* block id: 0 */
    const uint32_t l_12 = 0x2DB785B6L;
    for (g_5 = 0; (g_5 <= 10); g_5 = safe_add_func_int64_t_s_s(g_5, 8))
    { /* block id: 3 */
        uint64_t l_8 = 0x03773672D714F98CLL;
        ++l_8;
    }
    g_11 = &g_3;
    return l_12;
