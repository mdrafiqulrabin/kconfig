...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[2][4] = {{(-4L),(-4L),(-4L),(-4L)},{(-4L),(-4L),(-4L),(-4L)}};
static int32_t g_3 = (-5L);
static int32_t * volatile g_7[10] = {&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3};
static int32_t * const  volatile g_8 = &g_3;/* VOLATILE GLOBAL g_8 */
...
static int64_t  func_1(void)
{ /* block id: 0 */
    int64_t l_6 = 0x111738AB659D568DLL;
    for (g_3 = 21; (g_3 <= 7); g_3 = safe_sub_func_int16_t_s_s(g_3, 1))
    { /* block id: 3 */
        return l_6;
    }
    (*g_8) = g_3;
