...
static union U0 g_8 = {0x4BL};/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t *l_4[3];
    int32_t **l_3[8][4] = {{&l_4[0],&l_4[0],&l_4[1],&l_4[2]},{&l_4[2],&l_4[1],&l_4[1],&l_4[1]},{&l_4[0],&l_4[2],&l_4[1],&l_4[1]},{&l_4[1],&l_4[2],&l_4[2],&l_4[1]},{&l_4[2],&l_4[1],&l_4[0],&l_4[2]},{&l_4[2],&l_4[0],&l_4[2],&l_4[1]},{&l_4[1],&l_4[2],&l_4[1],&l_4[1]},{&l_4[0],&l_4[0],&l_4[1],&l_4[2]}};
    int i, j;
    for (i = 0; i < 3; i++)
        l_4[i] = &g_5;
    g_7 = (g_6[7] = (l_2 = l_2));
