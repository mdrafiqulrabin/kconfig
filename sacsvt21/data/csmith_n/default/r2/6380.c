...
/* --- GLOBAL VARIABLES --- */
static volatile int8_t g_3 = 0x27L;/* VOLATILE GLOBAL g_3 */
static uint64_t g_4 = 18446744073709551614UL;
static int32_t g_7 = (-1L);
static int32_t g_9 = 0xBC657E3BL;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_4 g_7 g_9
 * writes: g_7 g_9
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_2 = 0xFECAL;
    uint16_t l_5[7];
    int32_t *l_6 = &g_7;
    int32_t *l_8 = &g_9;
    int i;
    for (i = 0; i < 7; i++)
        l_5[i] = 0xF792L;
    (*l_8) = ((*l_6) ^= ((0xC662A2B3B7BEDEDBLL && ((l_2 & (g_3 <= (g_4 || 0xAEF6E229L))) >= l_5[1])) | 1UL));
    return (*l_8);
}
