...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[2][10] = {{&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,(void*)0,&g_3,&g_3,(void*)0,&g_3,&g_3,(void*)0,&g_3}};
    int32_t l_4 = (-7L);
    int i, j;
    --g_6;
    g_3 = (safe_sub_func_uint8_t_u_u(4UL, g_3));
    return g_3;
}
