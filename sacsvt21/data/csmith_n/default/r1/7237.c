...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[1][6][1] = {{{0L},{0L},{0L},{0L},{0L},{0L}}};
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3[0][5][0];
    int32_t *l_5 = &g_3[0][1][0];
    int32_t *l_6 = (void*)0;
    int32_t *l_7 = &g_3[0][1][0];
    int32_t *l_8 = &g_3[0][3][0];
    int32_t *l_9 = (void*)0;
    int32_t *l_10 = &g_3[0][1][0];
    int32_t *l_11 = (void*)0;
    int32_t *l_12 = &g_3[0][1][0];
    int32_t *l_13[10] = {&g_3[0][2][0],&g_3[0][1][0],&g_3[0][2][0],&g_3[0][2][0],&g_3[0][1][0],&g_3[0][2][0],&g_3[0][2][0],&g_3[0][1][0],&g_3[0][2][0],&g_3[0][2][0]};
    int64_t l_14 = 0xF04B064BAE0FC36FLL;
    uint16_t l_15 = 0xEFBDL;
    int i;
    l_15++;
    return g_3[0][1][0];
}
