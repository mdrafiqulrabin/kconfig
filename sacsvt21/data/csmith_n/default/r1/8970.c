...
static struct S1 g_5 = {0x566A927213EC752FLL,1UL,-7L,255UL,9UL,-8L,-1L,1,2UL};/* VOLATILE GLOBAL g_5 */
static struct S1 * volatile g_6 = &g_5;/* VOLATILE GLOBAL g_6 */
