...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_2 = 0x02L;
static int32_t g_4 = 0L;
static volatile uint64_t g_21[1] = {18446744073709551607UL};
...
{ /* block id: 0 */
    ...
    int32_t *l_18 = &g_4;
    int32_t *l_19 = &l_17[0];
    int32_t *l_20[1][9] = {{(void*)0,&l_17[0],(void*)0,&l_17[0],(void*)0,&l_17[0],(void*)0,&l_17[0],(void*)0}};
    int i, j;
    for (i = 0; i < 1; i++)
        l_17[i] = 0x69BD697EL;
    (*l_3) &= g_2;
...
XXX percent of pointers has null in alias set: 6.25
