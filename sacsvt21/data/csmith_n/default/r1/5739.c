...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0x906C902DL;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 0xBD0A7084L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5[3] = {0xC3D069F4L,0xC3D069F4L,0xC3D069F4L};
static struct S0 g_6 = {0x8E9934B0L,0x4EL,0x66L,0x17L,0L,0xBA7B7E80D68F9855LL,0x9B58331C587C7AB8LL};/* VOLATILE GLOBAL g_6 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[10] = {0x16L,1UL,0x16L,1UL,0x16L,1UL,0x16L,1UL,0x16L,1UL};
    int i;
    for (g_5[2] = 7; (g_5[2] >= 0); g_5[2] -= 1)
    { /* block id: 3 */
        int i;
        if (l_2[(g_5[2] + 1)])
            break;
