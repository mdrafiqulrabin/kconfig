...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_2 = {3UL};
static union U1 g_4 = {0x21F1EB32L};/* VOLATILE GLOBAL g_4 */
...
static union U1  func_1(void)
{ /* block id: 0 */
    struct S0 *l_3[10][3] = {{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2},{&g_2,&g_2,&g_2}};
    int i, j;
    g_2 = g_2;
    return g_4;
}
