...
static int32_t *g_9 = &g_6;
static union U2 g_10 = {0};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    uint8_t l_4 = 0x3BL;
    int32_t *l_8 = &g_6;
    int32_t **l_7[4][7] = {{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8,&l_8},{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8,&l_8},{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8,&l_8},{&l_8,&l_8,&l_8,&l_8,&l_8,&l_8,&l_8}};
    int i, j;
    g_9 = func_2(l_4);
    return g_10;
}
