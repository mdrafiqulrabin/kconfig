...
/* --- GLOBAL VARIABLES --- */
static struct S2 g_2 = {{0x89L,-1,0xD6L,65535UL,0xA31CL,0xA9C5A74D4B4B26D8LL,-1L,1L,0x29EC6EA3L,65535UL},1,-8L,0xF47F28A996121589LL,1L,0x86L,9L};/* VOLATILE GLOBAL g_2 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc(g_2.f0.f9, "g_2.f0.f9", print_hash_value);
