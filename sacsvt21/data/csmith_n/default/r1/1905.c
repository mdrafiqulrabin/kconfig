...
static volatile int32_t g_4 = 0xEAC45307L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5[7] = {7L,1L,7L,7L,1L,7L,7L};
static int32_t g_9[6] = {0x5352F76EL,0x5352F76EL,0x6A205B29L,0x5352F76EL,0x5352F76EL,0x6A205B29L};
...
{ /* block id: 0 */
    uint16_t l_13 = 7UL;
    for (g_5[4] = (-13); (g_5[4] <= 16); g_5[4]++)
    { /* block id: 3 */
        int32_t *l_8 = &g_9[1];
        int32_t *l_10 = &g_9[4];
        int32_t l_11[6] = {(-10L),(-10L),(-10L),(-10L),(-10L),(-10L)};
        int32_t *l_12 = &g_9[1];
        int i;
        ++l_13;
        (*l_12) = ((g_5[4] < 1UL) && (*l_10));
