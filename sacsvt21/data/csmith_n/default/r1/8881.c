...
static volatile int8_t g_7[2] = {0xD2L,0xD2L};
static volatile int8_t g_8 = 0x13L;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t *l_3[1][5] = {{(void*)0,(void*)0,(void*)0,(void*)0,(void*)0}};
    int8_t l_5[3];
    int32_t l_6 = 0xAEE5A986L;
    uint32_t l_9 = 0x40A98CEEL;
    int i, j;
    for (i = 0; i < 3; i++)
        l_5[i] = (-6L);
    --l_9;
