...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[8] = {0x38EC3268L,0x9A22DB78L,0x38EC3268L,0x38EC3268L,0x9A22DB78L,0x38EC3268L,0x38EC3268L,0x9A22DB78L};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 10; i++)
        l_4[i] = &g_3[7];
    g_3[7] = (safe_unary_minus_func_uint32_t_u(g_3[7]));
    return g_3[4];
}
