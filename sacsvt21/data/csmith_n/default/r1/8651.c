...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xD1022782L;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    const uint64_t l_7 = 0x941CE3CB5AF9F7C8LL;
    for (g_2 = 0; (g_2 == (-11)); g_2 = safe_sub_func_int16_t_s_s(g_2, 9))
    { /* block id: 3 */
        int32_t *l_8 = &g_9;
        (*l_8) &= (safe_rshift_func_uint16_t_u_u((g_2 >= l_7), 1));
        return l_7;
    }
    return l_7;
}
