...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_3 = {0};/* VOLATILE GLOBAL g_3 */
static volatile struct S0 * volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
static int32_t g_5 = 0x0C544087L;
static int32_t g_9[3] = {0x6373A4C9L,0x6373A4C9L,0x6373A4C9L};
static struct S2 g_10 = {26182};/* VOLATILE GLOBAL g_10 */
...
static struct S2  func_1(void)
{ /* block id: 0 */
    volatile struct S0 * volatile l_4 = &g_3;/* VOLATILE GLOBAL l_4 */
    l_4 = g_2;
    for (g_5 = 25; (g_5 == (-24)); --g_5)
    { /* block id: 4 */
        int32_t *l_8[6] = {&g_9[2],&g_9[2],&g_9[2],&g_9[2],&g_9[2],&g_9[2]};
        int i;
        g_9[1] &= 8L;
    }
    return g_10;
