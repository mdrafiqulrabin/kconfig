...
static struct S0 g_8 = {0xF2121F90L,-7L,0x7D7CL,18446744073709551606UL,-936,9UL};/* VOLATILE GLOBAL g_8 */
static struct S0 *g_7 = &g_8;
static struct S0 ** volatile g_9 = &g_7;/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    uint8_t l_4 = 6UL;
    (*g_5) = (safe_sub_func_uint32_t_u_u(l_4, l_4));
    (*g_9) = g_7;
    return l_4;
}
