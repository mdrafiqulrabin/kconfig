...
static int32_t g_5[9][1] = {{0L},{0x4822B165L},{0L},{0x4822B165L},{0L},{0x4822B165L},{0L},{0x4822B165L},{0L}};
static int32_t g_9 = 0x3B7BEDEDL;
static int32_t g_11 = 1L;
static volatile uint8_t g_12 = 0x72L;/* VOLATILE GLOBAL g_12 */
...
static const uint32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_15 = 0x82BAL;
    for (g_2 = 21; (g_2 != (-23)); --g_2)
    { /* block id: 3 */
        if (g_2)
            break;
        for (g_5[0][0] = 0; (g_5[0][0] >= 26); g_5[0][0] = safe_add_func_uint64_t_u_u(g_5[0][0], 1))
        { /* block id: 7 */
            int32_t *l_8 = &g_9;
            int32_t *l_10[8] = {&g_2,&g_2,&g_2,&g_2,&g_2,&g_2,&g_2,&g_2};
            int i;
            ++g_12;
        }
        if (l_15)
