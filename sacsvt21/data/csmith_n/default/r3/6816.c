...
/* --- GLOBAL VARIABLES --- */
static union U2 g_3 = {3UL};
static union U2 *g_2[4] = {&g_3,&g_3,&g_3,&g_3};
static union U2 ** volatile g_4 = (void*)0;/* VOLATILE GLOBAL g_4 */
static int32_t g_7 = 0x2A8D3A18L;
...
{ /* block id: 0 */
    ...
    (*l_5) = g_2[3];
    ++g_11;
    (*l_9) = (safe_mod_func_int16_t_s_s(1L, (safe_div_func_uint64_t_u_u(g_3.f0, (-8L)))));
