...
static volatile int32_t g_5 = 0x34C865B4L;/* VOLATILE GLOBAL g_5 */
static uint16_t g_6 = 0x6520L;
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4[8][2] = {{&g_3,&g_3},{&g_3,&g_3},{&g_3,&g_3},{(void*)0,&g_3},{&g_3,&g_3},{&g_3,&g_3},{&g_3,(void*)0},{&g_3,&g_3}};
    int i, j;
    --g_6;
    return g_6;
}
