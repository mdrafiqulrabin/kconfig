...
/* --- GLOBAL VARIABLES --- */
static int16_t g_2 = 0xD8DAL;
static int32_t g_6 = 0x3C891C55L;
static int32_t * volatile g_7[3][1][1] = {{{(void*)0}},{{(void*)0}},{{(void*)0}}};
static int32_t g_9 = 0xEF307D7CL;
static int32_t * const  volatile g_8[8] = {&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9};
...
{ /* block id: 0 */
    int32_t *l_5 = &g_6;
    (*g_10) = ((*l_5) = (g_2 > (safe_add_func_uint32_t_u_u(0x4074DD03L, 0x8C66F5A9L))));
    return (*l_5);
}
