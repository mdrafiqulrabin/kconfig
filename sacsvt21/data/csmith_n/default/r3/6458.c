...
static volatile uint8_t g_6 = 0x3EL;/* VOLATILE GLOBAL g_6 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t l_4[4] = {9L,9L,9L,9L};
    int32_t *l_5[10] = {&l_4[3],&l_4[3],&l_4[1],&l_4[1],&l_4[1],&l_4[3],&l_4[3],&l_4[1],&l_4[1],&l_4[1]};
    int i;
    --g_6;
    return g_3;
}
