...
static int32_t g_5[7] = {7L,7L,7L,7L,7L,7L,7L};
static volatile int8_t g_6 = 0x6CL;/* VOLATILE GLOBAL g_6 */
...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t *l_4[7] = {&g_5[6],&g_5[6],&g_5[0],&g_5[6],&g_5[6],&g_5[0],&g_5[6]};
    uint32_t l_7 = 0x8FAD7494L;
    int i;
    ++l_7;
    return g_5[4];
}
