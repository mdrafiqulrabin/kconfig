...
static int64_t g_15 = 0x90FC520EA0C8D467LL;
...
{ /* block id: 0 */
    int32_t *l_5 = &g_4;
    int32_t *l_6 = &g_4;
    int32_t l_7[6][7] = {{0x843046B6L,0xBF9ACF25L,0L,0L,0xBF9ACF25L,0x843046B6L,0xBF9ACF25L},{0L,5L,5L,0L,0xAA29C146L,0L,5L},{(-1L),(-1L),0x843046B6L,0L,0x843046B6L,(-1L),(-1L)},{0x9253A34CL,5L,1L,5L,0x9253A34CL,0x9253A34CL,5L},{0x42B48371L,0xBF9ACF25L,0x42B48371L,0x843046B6L,0x843046B6L,0x42B48371L,0xBF9ACF25L},{5L,0xAA29C146L,1L,1L,0xAA29C146L,5L,0xAA29C146L}};
    int32_t *l_8 = &l_7[5][1];
    int32_t *l_9 = (void*)0;
    int32_t *l_10 = &l_7[0][5];
    int32_t *l_11 = &l_7[0][5];
    int32_t *l_12 = &l_7[0][5];
    int32_t *l_13 = &l_7[0][5];
    int32_t *l_14[2];
    int i, j;
    for (i = 0; i < 2; i++)
        l_14[i] = (void*)0;
    (*g_3) = (safe_unary_minus_func_uint32_t_u(4294967295UL));
    ++g_16;
    (*l_8) = 0x635290CEL;
    return g_15;
}
