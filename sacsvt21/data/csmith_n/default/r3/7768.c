...
static int32_t g_8[9] = {(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L),(-6L)};
static union U1 g_14 = {0x7D96L};/* VOLATILE GLOBAL g_14 */
...
{ /* block id: 0 */
    ...
    int16_t l_13 = 0x53A3L;
    for (g_4 = 14; (g_4 != 14); g_4 = safe_add_func_int8_t_s_s(g_4, 5))
    { /* block id: 3 */
        int32_t *l_7 = &g_8[7];
        int32_t *l_9[4] = {&g_8[8],&g_8[8],&g_8[8],&g_8[8]};
        int i;
        l_10++;
        l_13 = g_8[8];
        if (g_8[7])
