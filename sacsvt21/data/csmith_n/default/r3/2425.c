...
static volatile uint16_t g_6 = 0xDF82L;/* VOLATILE GLOBAL g_6 */
...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int32_t *l_3 = &g_4;
    int32_t *l_5[5][4] = {{&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4},{&g_4,&g_4,&g_4,&g_4}};
    int i, j;
lbl_11:
    --g_6;
    for (g_4 = 0; (g_4 >= 18); g_4 = safe_add_func_int16_t_s_s(g_4, 6))
    { /* block id: 4 */
        if (g_4)
            goto lbl_11;
        return g_4;
