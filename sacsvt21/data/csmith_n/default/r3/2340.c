...
/* --- GLOBAL VARIABLES --- */
static int32_t g_6 = 0x5E08CCCDL;
static uint16_t g_11[1] = {65534UL};
static uint32_t g_13 = 0xCB8F6C21L;
...
/* 
 * reads : g_6 g_13 g_18
 * writes: g_11 g_13 g_19
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_5 = &g_6;
    uint16_t *l_10 = &g_11[0];
    (*g_18) = func_2(((void*)0 != l_5), ((l_5 == l_5) && (!((*l_10) = g_6))));
    return (*l_5);
}
