...
static volatile int32_t g_8 = 0x831EB239L;/* VOLATILE GLOBAL g_8 */
static int8_t g_9 = 6L;
static volatile int32_t g_10 = 0xAF72B572L;/* VOLATILE GLOBAL g_10 */
static volatile int8_t g_11 = 0xB5L;/* VOLATILE GLOBAL g_11 */
static int64_t g_12 = 0xCB5AF9F7C8B166C1LL;
...
{ /* block id: 0 */
    ...
    int32_t l_5 = (-2L);
    int32_t *l_6 = &l_5;
    int32_t *l_7[6] = {&l_5,&l_5,&l_5,&l_5,&l_5,&l_5};
    uint32_t l_13 = 0x551B32E2L;
    int i;
    ++l_13;
    return (*l_3);
}
