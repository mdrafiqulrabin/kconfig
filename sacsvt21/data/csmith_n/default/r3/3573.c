...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[3] = {0xE3556834L,0xE3556834L,0xE3556834L};
static int32_t g_3 = 0x3606DE71L;
static uint16_t g_11 = 0x6930L;
static int32_t g_17 = 0x6A1C17C7L;
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        if (g_2[g_3])
            break;
        (*g_16) = (safe_lshift_func_uint16_t_u_u(((safe_sub_func_uint16_t_u_u(65535UL, (safe_div_func_int64_t_s_s(g_2[g_3], g_2[g_3])))) , (l_13--)), 0));
    }
    return g_17;
}
