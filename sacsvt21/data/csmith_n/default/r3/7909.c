...
/* --- GLOBAL VARIABLES --- */
static const union U2 g_5 = {9L};/* VOLATILE GLOBAL g_5 */
static const union U2 *g_4 = &g_5;
static const union U2 ** volatile g_3 = &g_4;/* VOLATILE GLOBAL g_3 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    const union U2 *l_2 = (void*)0;
    int32_t l_6 = 0x43EB6069L;
    (*g_3) = l_2;
    return l_6;
}
