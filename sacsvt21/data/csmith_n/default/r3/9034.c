...
static volatile int32_t g_5 = 0xA7275995L;/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_6 = (-4L);/* VOLATILE GLOBAL g_6 */
static int32_t g_7[1][9][1] = {{{0xD020BD2AL},{(-3L)},{0xD020BD2AL},{(-3L)},{0xD020BD2AL},{(-3L)},{0xD020BD2AL},{(-3L)},{0xD020BD2AL}}};
static int32_t g_8 = 0x9C213245L;
...
/* ------------------------------------------ */
/* 
 * reads : g_7 g_8 g_5 g_4
 * writes: g_7 g_8 g_4
 */
static const int64_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_2[9] = {7UL,0x2304L,7UL,0x2304L,7UL,0x2304L,7UL,0x2304L,7UL};
    int i;
    for (g_7[0][3][0] = 0; (g_7[0][3][0] <= 8); g_7[0][3][0] += 1)
    { /* block id: 3 */
        int32_t l_12 = 0xAF12A83AL;
        int i;
        if (l_2[g_7[0][3][0]])
            break;
