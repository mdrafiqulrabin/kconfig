...
static struct S0 g_5 = {0x4307E4A90611BC38LL,10,-0,-2,163};/* VOLATILE GLOBAL g_5 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_5 g_7 g_4
 * writes: g_3 g_4
 */
static struct S0  func_1(void)
{ /* block id: 0 */
    uint16_t l_2[8] = {0UL,0xE64FL,0UL,0UL,0xE64FL,0UL,0UL,0xE64FL};
    const int16_t l_6 = 4L;
    int i;
