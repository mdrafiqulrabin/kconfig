...
static volatile uint64_t g_7 = 0x831D26EC17E5C285LL;/* VOLATILE GLOBAL g_7 */
static int32_t g_10 = 0xDBBE5689L;
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = (void*)0;
    int32_t *l_5 = &g_3;
    int32_t *l_6[4][4] = {{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3}};
    int i, j;
    --g_7;
    g_10 ^= (*l_2);
    return g_7;
