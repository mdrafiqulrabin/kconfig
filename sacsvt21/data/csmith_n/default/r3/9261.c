...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[5] = {0xC4B4E126L,0xC4B4E126L,0xC4B4E126L,0xC4B4E126L,0xC4B4E126L};
...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &g_3[1];
    int32_t *l_8 = &g_3[1];
    int32_t l_9 = 0x4FD9E2A8L;
    int32_t *l_10 = &g_3[1];
    int32_t *l_11 = (void*)0;
    int32_t *l_12 = &g_3[1];
    int32_t *l_13 = &l_9;
    int32_t *l_14[6] = {&g_3[1],&g_3[1],&g_3[1],&g_3[1],&g_3[1],&g_3[1]};
    uint16_t l_15 = 7UL;
    int i;
    --l_15;
    return g_3[1];
