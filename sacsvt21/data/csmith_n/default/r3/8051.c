...
static int32_t g_4[1][7][7] = {{{0L,1L,0x4A0D461EL,0x4A0D461EL,1L,0L,1L},{4L,0L,0L,4L,1L,4L,0L},{0x4EB4C8F0L,0x4EB4C8F0L,0L,0x4A0D461EL,0L,0x4EB4C8F0L,0x4EB4C8F0L},{0x4EB4C8F0L,0L,0x4A0D461EL,0L,0x4EB4C8F0L,0x4EB4C8F0L,0L},{4L,1L,4L,0L,0L,4L,1L},{0L,1L,0x4A0D461EL,0x4A0D461EL,1L,0L,1L},{4L,0L,0L,4L,0x4EB4C8F0L,0x4A0D461EL,4L}}};
static struct S1 g_5 = {168,3L,-1859,542,1,142,32};/* VOLATILE GLOBAL g_5 */
