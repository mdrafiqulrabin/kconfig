...
static volatile int32_t g_9[8] = {0x24B54114L,0x24B54114L,0x24B54114L,0x24B54114L,0x24B54114L,0x24B54114L,0x24B54114L,0x24B54114L};
static struct S0 g_15 = {-511,29534,4,-1L,75,0xE516L,1,-20506,19};/* VOLATILE GLOBAL g_15 */
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = (void*)0;
    int32_t *l_7 = &l_4[1];
    int32_t *l_8[9] = {&l_4[0],&l_4[0],&l_4[0],&l_4[0],&l_4[0],&l_4[0],&l_4[0],&l_4[0],&l_4[0]};
    int32_t l_10 = 0x37C57F39L;
    int16_t l_11 = 0L;
    uint64_t l_12 = 0x17216709E149CFF2LL;
    int i;
    for (i = 0; i < 3; i++)
        l_4[i] = 5L;
    --l_12;
