...
static volatile int32_t g_4 = 0x061F6656L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5[6][4][1] = {{{0L},{1L},{0L},{1L}},{{0L},{1L},{0L},{1L}},{{0L},{1L},{0L},{1L}},{{0L},{1L},{0L},{1L}},{{0L},{1L},{0L},{1L}},{{0L},{1L},{0L},{1L}}};
...
static int64_t  func_1(void)
{ /* block id: 0 */
    for (g_5[5][0][0] = 0; (g_5[5][0][0] <= 6); ++g_5[5][0][0])
    { /* block id: 3 */
        if (g_4)
            break;
    }
