...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &l_4[1];
    int32_t *l_8 = &g_3;
    int32_t *l_9[5][7] = {{(void*)0,&l_4[0],&l_4[0],&l_4[1],&l_4[0],&l_4[0],(void*)0},{&l_4[1],&g_3,&l_4[6],&l_4[1],&l_4[1],&l_4[4],(void*)0},{&l_4[1],(void*)0,&g_3,&g_3,(void*)0,&l_4[1],&l_4[1]},{&l_4[0],&g_3,&l_4[6],&l_4[1],&l_4[8],&l_4[1],&l_4[1]},{&l_4[1],&l_4[8],&l_4[0],&l_4[8],&l_4[1],&l_4[4],&l_4[0]}};
    int i, j;
    for (i = 0; i < 9; i++)
        l_4[i] = 2L;
    ++g_10;
