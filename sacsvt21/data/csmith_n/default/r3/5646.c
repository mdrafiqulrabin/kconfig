...
static volatile int32_t g_3 = 0x54320E32L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0x15D7249AL;
static int32_t g_9 = 0xD210EC32L;
static struct S0 g_15 = {2509};/* VOLATILE GLOBAL g_15 */
static struct S0 g_16 = {580};/* VOLATILE GLOBAL g_16 */
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_12[i] = 0UL;
    for (g_4 = 0; (g_4 <= 24); g_4 = safe_add_func_int16_t_s_s(g_4, 7))
    { /* block id: 3 */
        int32_t *l_7 = (void*)0;
        int32_t *l_8 = &g_9;
        int32_t *l_10 = &g_9;
        int32_t *l_11[8][4] = {{&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9}};
        int i, j;
        l_12[0]++;
        return g_15;
    }
