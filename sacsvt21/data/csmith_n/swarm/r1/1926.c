...
{ /* block id: 36 */
    int64_t l_33 = (-7L);
    int32_t l_35 = 0xADE661FBL;
    int32_t *l_34 = &l_35;
    uint32_t l_36 = 3UL;
    (*l_34) |= (safe_lshift_func_int16_t_s_s(l_33, l_33));
    return l_36;
}
