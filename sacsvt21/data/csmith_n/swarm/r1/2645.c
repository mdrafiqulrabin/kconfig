...
/* --- GLOBAL VARIABLES --- */
static const volatile uint32_t g_4 = 0xECF54C3C;/* VOLATILE GLOBAL g_4 */
static const int32_t g_6 = (-6);
static int32_t * volatile g_7 = (void*)0;/* VOLATILE GLOBAL g_7 */
static float g_9 = 0xC.5E08CCp-78;
...
{ /* block id: 0 */
    int32_t l_8 = (-1);
    l_8 = (safe_sub_func_uint32_t_u_u((g_4 || (!g_4)), g_6));
    return g_6;
}
