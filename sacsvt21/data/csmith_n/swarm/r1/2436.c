...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2[5] = {0xDB3AE355,0xDB3AE355,0xDB3AE355,0xDB3AE355,0xDB3AE355};
    int i;
    for (l_2[0] = 0; (l_2[0] == (-5)); l_2[0] = safe_sub_func_uint32_t_u_u(l_2[0], 1))
    { /* block id: 3 */
        int32_t *l_6 = &l_2[4];
        int32_t **l_5 = &l_6;
        (*l_5) = &l_2[4];
