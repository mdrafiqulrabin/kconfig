 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --no-compound-assignment --consts --divs --no-embedded-assigns --no-pre-incr-operator --pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --longlong --int8 --uint8 --no-float --math64 --no-inline-function --no-muls --no-safe-math --no-packed-struct --paranoid --pointers --structs --unions --no-volatiles --volatile-pointers --no-const-pointers --global-variabless --no-builtins
 * Seed:      2909516262
 */
...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_2 = 0x3E34B64B5C6F8B8ALL;
static uint32_t g_3 = 1UL;
static uint16_t g_6 = 65529UL;
static int32_t g_8 = 0xB064BAE0L;
...
{ /* block id: 0 */
    int32_t *l_7 = &g_8;
    g_3 = g_2;
    (*l_7) = ((int8_t)g_6 - (int8_t)(0x1E12AA53L < g_3));
    return (*l_7);
}
