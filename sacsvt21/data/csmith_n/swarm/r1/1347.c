 ...
 * Git version: 30dccd7
 * Options:   --no-argc --arrays --bitfields --no-comma-operators --compound-assignment --no-consts --no-divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --no-longlong --no-int8 --uint8 --float --math64 --no-inline-function --muls --no-safe-math --no-packed-struct --paranoid --pointers --no-structs --no-unions --no-volatiles --no-volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      1797467218
 */
...
static int32_t g_31 = 0x1D594D03;
...
/* ------------------------------------------ */
/* 
 * reads : g_25 g_31 g_29
 * writes: g_25 g_29 g_31
 */
static int32_t  func_24(void)
{ /* block id: 36 */
    int32_t *l_28 = &g_29;
    int32_t *l_30 = &g_31;
    g_25 = g_25;
    (*l_30) ^= ((*l_28) = ((int16_t)(g_25 == g_25) + (int16_t)0xA9C2));
    return (*l_28);
}
