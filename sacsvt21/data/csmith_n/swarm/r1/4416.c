 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --no-compound-assignment --consts --no-divs --no-embedded-assigns --pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --jumps --longlong --no-int8 --uint8 --no-float --no-math64 --no-inline-function --muls --safe-math --no-packed-struct --no-paranoid --pointers --no-structs --unions --no-volatiles --no-volatile-pointers --no-const-pointers --no-global-variables --builtins
 * Seed:      2027473466
 */
...
static uint8_t  func_32(void)
{ /* block id: 36 */
    const uint32_t l_33 = 8UL;
    int32_t *l_34 = (void*)0;
    int32_t l_36 = (-3L);
    int32_t *l_35 = &l_36;
    int32_t **l_37 = &l_34;
    int32_t l_38 = 0x46758E35L;
    (*l_35) = l_33;
    (*l_37) = (void*)0;
    return l_38;
}
