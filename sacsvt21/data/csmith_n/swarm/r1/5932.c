...
{ /* block id: 0 */
    ...
    int32_t ***l_5 = &l_6;
    float l_7 = 0x1.6p+1;
    int64_t l_8 = 0x6D21CD4309642E40LL;
    (*l_3) = 0xC85F70ADL;
    (*l_5) = &l_2;
    /* statement id: 2 */
    assert (l_6 == &l_2);
