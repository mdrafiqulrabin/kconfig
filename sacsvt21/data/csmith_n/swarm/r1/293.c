...
static int8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_3 = 0x6F5020F8L;
    int32_t *l_2 = &l_3;
    uint32_t l_4 = 0xB770A77CL;
    (*l_2) |= 0xDDC85F70L;
    (*l_2) &= (-1L);
    return l_4;
}
