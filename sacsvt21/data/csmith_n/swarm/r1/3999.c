 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --no-compound-assignment --no-consts --divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --uint8 --no-float --no-math64 --inline-function --muls --no-safe-math --no-packed-struct --paranoid --pointers --structs --unions --no-volatiles --volatile-pointers --const-pointers --no-global-variables --builtins
 * Seed:      599948844
 */
...
inline static uint32_t  func_31(void)
{ /* block id: 36 */
    struct S2 l_33 = {0x7D96711DL,6UL,0x4EDC0223L,0xEC99L,18446744073709551613UL,0x26A9L};
    struct S2 *l_32 = &l_33;
    struct S2 **l_34 = &l_32;
    struct S2 *l_36 = &l_33;
    struct S2 **l_35 = &l_36;
