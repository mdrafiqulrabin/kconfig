 ...
 * Git version: 30dccd7
 * Options:   --argc --no-arrays --no-bitfields --no-comma-operators --compound-assignment --consts --divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --post-decr-operator --no-unary-plus-operator --jumps --no-longlong --int8 --no-uint8 --float --math64 --no-inline-function --muls --safe-math --packed-struct --paranoid --pointers --structs --no-unions --volatiles --volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      692287850
 */
...
/* --- GLOBAL VARIABLES --- */
static int16_t g_7 = 0xA59C;
static int32_t g_34 = 0xCFBCE008;
static int32_t * volatile g_33 = &g_34;/* VOLATILE GLOBAL g_33 */
static int32_t * volatile *g_36 = (void*)0;
static int32_t * volatile ** volatile g_35 = &g_36;/* VOLATILE GLOBAL g_35 */
