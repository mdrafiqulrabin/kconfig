...
{ /* block id: 36 */
    int32_t l_30 = (-1L);
    for (l_30 = 22; (l_30 <= 4); l_30 -= 8)
    { /* block id: 39 */
        uint32_t l_33 = 0x5C8100C4L;
