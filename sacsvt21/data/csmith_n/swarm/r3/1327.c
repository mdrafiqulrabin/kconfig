...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_8 = 0x78FA8F90L;
    for (g_3 = 0; (g_3 == (-6)); g_3 = safe_sub_func_uint16_t_u_u(g_3, 1))
    { /* block id: 3 */
        g_2 &= (-1L);
    }
    g_2 |= (g_3 , (l_8 > (0xF4FFL < ((0xFEB9E9D6L == (!(-1L))) ^ (l_8 , l_8)))));
    return l_8;
}
