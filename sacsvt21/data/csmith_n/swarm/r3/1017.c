...
/* --- GLOBAL VARIABLES --- */
static int16_t g_7 = 0xFD49L;
static int32_t g_12[3] = {8L,8L,8L};
static int32_t g_16 = 0x4B5C6F8BL;
...
static float  func_1(void)
{ /* block id: 0 */
    uint16_t l_10 = 0x4173L;
    int32_t *l_11 = &g_12[1];
    int32_t **l_19 = &l_11;
    (*l_19) = func_2(g_7, (safe_mod_func_uint64_t_u_u(0x5B7CEFA9D19AC196LL, l_10)), l_11, g_12[1]);
    return g_12[1];
}
