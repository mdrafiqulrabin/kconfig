 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --comma-operators --no-compound-assignment --no-consts --no-divs --no-embedded-assigns --no-pre-incr-operator --pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --jumps --longlong --int8 --uint8 --float --no-math64 --no-inline-function --no-muls --no-safe-math --packed-struct --paranoid --pointers --structs --unions --no-volatiles --no-volatile-pointers --const-pointers --no-global-variables --no-builtins
 * Seed:      174976780
 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0x2B165808L;
    int32_t *l_3 = &l_4;
    int32_t **l_2 = &l_3;
    uint32_t l_5 = 1UL;
    int16_t l_6 = 0xD44AL;
    float l_8 = 0xE.0FECAFp-61;
    float *l_7 = &l_8;
    (*l_2) = (void*)0;
    /* statement id: 1 */
    assert (l_3 == 0);
