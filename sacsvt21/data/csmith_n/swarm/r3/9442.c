 ...
 * Git version: 30dccd7
 * Options:   --no-argc --no-arrays --bitfields --no-comma-operators --compound-assignment --no-consts --no-divs --embedded-assigns --no-pre-incr-operator --pre-decr-operator --post-incr-operator --no-post-decr-operator --unary-plus-operator --no-jumps --longlong --int8 --no-uint8 --float --math64 --no-inline-function --muls --no-safe-math --no-packed-struct --no-paranoid --no-pointers --structs --unions --no-volatiles --volatile-pointers --no-const-pointers --global-variabless --builtins
 * Seed:      4038761192
 */
...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_7 = 0xD94B4B13L;
static uint64_t g_30 = 1UL;
static uint32_t g_31 = 0x83674579L;
...
static int16_t  func_26(void)
{ /* block id: 36 */
    uint32_t l_29 = 0xA4C924B5L;
    g_31 &= (g_30 = ((int16_t)l_29 >> (int16_t)1));
    return l_29;
}
