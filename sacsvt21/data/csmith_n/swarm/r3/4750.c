 ...
 * Git version: 30dccd7
 * Options:   --no-argc --arrays --bitfields --comma-operators --no-compound-assignment --consts --no-divs --no-embedded-assigns --no-pre-incr-operator --no-pre-decr-operator --no-post-incr-operator --post-decr-operator --unary-plus-operator --no-jumps --longlong --no-int8 --uint8 --float --no-math64 --no-inline-function --no-muls --safe-math --packed-struct --paranoid --pointers --structs --no-unions --no-volatiles --no-volatile-pointers --const-pointers --global-variabless --builtins
 * Seed:      2379656470
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[10] = {(-1L),(-1L),0x7B04800FL,0x7B04800FL,(-1L),(-1L),(-1L),0x7B04800FL,0x7B04800FL,(-1L)};
...
{ /* block id: 36 */
    ...
    (*l_29) = (void*)0;
    /* statement id: 37 */
    //assert (l_30[0] == 0 || (l_30[0] >= &g_4[0] && l_30[0] <= &g_4[9]));
    return g_4[8];
}
