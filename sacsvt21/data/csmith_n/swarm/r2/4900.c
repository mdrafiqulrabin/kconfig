...
inline static const int32_t  func_1(void)
{ /* block id: 0 */
    const int64_t l_4 = 0x18D9DCEE34EDF6B3LL;
    int32_t l_6 = (-1L);
    int32_t *l_5 = &l_6;
    const uint32_t l_7 = 0xF9953E80L;
    (*l_5) = (((int16_t)l_4 % (int16_t)l_4) , l_4);
    return l_7;
}
...
XXX percentage a fresh-made variable is used: 8
