...
static const int32_t  func_24(void)
{ /* block id: 36 */
    const uint32_t l_25 = 18446744073709551615UL;
    if (g_3)
    { /* block id: 37 */
        return l_25;
    }
