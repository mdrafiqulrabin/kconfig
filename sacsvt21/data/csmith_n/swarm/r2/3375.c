...
{ /* block id: 0 */
    ...
    int32_t l_3 = (-1L);
    union U0 l_6 = {4294967292UL};
    l_3 ^= l_2;
    l_2 = ((uint16_t)65535UL / (uint16_t)0x733CL);
    return l_6;
    /* statement id: 3 */
    }
