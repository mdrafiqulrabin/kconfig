...
lbl_5:
    l_4 = l_4;
    l_4 = ((l_2 > l_2) , l_2);
    for (l_2 = 7; (l_2 != 23); l_2 = safe_add_func_uint32_t_u_u(l_2, 1))
    { /* block id: 7 */
        if (l_2)
            goto lbl_8;
    }
