...
static volatile int32_t g_6 = 0x5121AC48;/* VOLATILE GLOBAL g_6 */
static volatile int32_t * volatile g_5[1] = {&g_6};
...
{ /* block id: 0 */
    int32_t *l_3 = &g_4;
    int32_t **l_2[1];
    int8_t l_7[5][2] = {{0x31,(-1)},{0x31,(-1)},{0x31,(-1)},{0x31,(-1)},{0x31,(-1)}};
    int i, j;
    for (i = 0; i < 1; i = i + 1)
        l_2[i] = &l_3;
    g_5[0] = (void*)0;
    /* statement id: 1 */
    //assert (g_5[0] == 0 || g_5[0] == &g_6);
    return l_7[2][0];
}
