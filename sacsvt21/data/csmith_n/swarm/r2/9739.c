...
{ /* block id: 0 */
    ...
    int32_t l_7 = 0x14C405B4L;
    for (l_2 = 21; (l_2 >= 8); l_2 -= 1)
    { /* block id: 3 */
        return l_2;
    }
    for (l_2 = 11; (l_2 == (-7)); l_2 -= 1)
    { /* block id: 8 */
        int8_t l_8 = 0x70L;
        l_7 ^= (-10L);
        if (l_8)
