...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &g_8;
    uint16_t *l_18 = &g_19;
    g_20 = ((l_2 < (g_3 >= ((uint16_t)(g_3 & ((*l_7) = l_2)) >> (uint16_t)(((int16_t)(-(int16_t)1L) << (int16_t)g_3) ^ ((uint16_t)(((*l_18) = (func_14(g_3) != func_14((func_14(g_3) != g_3)))) == 9L) * (uint16_t)g_3))))) < g_3);
    (*l_7) = 0x992F1E5CL;
    l_6 = l_6;
    return (*l_7);
}
