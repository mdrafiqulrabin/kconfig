...
static uint32_t  func_1(void)
{ /* block id: 0 */
    struct S0 l_2[3] = {{0xDE2167FA5C62E089LL},{0xDE2167FA5C62E089LL},{0xDE2167FA5C62E089LL}};
    int32_t l_3[4];
    int32_t **l_4 = (void*)0;
    const int32_t *l_6 = &l_3[3];
    const int32_t **l_5 = &l_6;
    int i;
    for (i = 0; i < 4; i++)
        l_3[i] = 0x4C000111L;
    for (l_3[3] = 0; l_3[3] < 3; l_3[3] += 1)
    {
        struct S0 tmp = {0x9BA095A97963BA20LL};
        l_2[l_3[3]] = tmp;
    }
    (*l_5) = (void*)0;
    /* statement id: 2 */
