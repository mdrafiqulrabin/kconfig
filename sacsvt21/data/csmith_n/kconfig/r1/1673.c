...
static uint32_t g_35 = 0x85E0710D;
...
/* 
 * reads : g_3 g_35
 * writes: g_3 g_35 g_55
 */
static uint32_t  func_30(void)
{ /* block id: 36 */
    uint16_t l_53 = 0x3393;
    for (g_3 = 0; (g_3 < (-6)); g_3 -= 8)
    { /* block id: 39 */
        int16_t l_54 = 0x1606;
        g_35 = func_33(g_3);
        g_55 = (~((int16_t)g_35 + (int16_t)(((((int32_t)g_35 % (int32_t)g_3) && ((((((~(((int16_t)g_3 % (int16_t)((uint16_t)g_3 % (uint16_t)((uint16_t)((int32_t)(!(1U > 0)) + (int32_t)0xED0BD2F2) << (uint16_t)(0 & g_3)))) <= 4)) != 0U) || g_35) | l_53) > l_54) == 8)) >= l_53) >= l_53)));
    }
    return l_53;
}
