...
{ /* block id: 36 */
    ...
    uint32_t l_34 = 0x2E4A6B2C;
    g_35 = (((65533U & (__builtin_ffsll(((-2) <= ((0x3A4C924B == g_5) & (((int16_t)(((int16_t)(-1) + (int16_t)(-1)) >= (((l_32 & ((((-(int16_t)((1U || g_5) || l_32)) <= g_5) <= g_5) > g_5)) >= l_34) < l_34)) + (int16_t)l_34) | 0x6367)))) ^ 0)) & l_32) <= 0x0F1F);
    g_35 = 0;
    return l_32;
}
