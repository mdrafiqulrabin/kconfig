...
{ /* block id: 0 */
    ...
    int32_t *l_3[4][2][3] = {{{&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4}},{{&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4}},{{&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4}},{{&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4}}};
    uint32_t l_5 = 0x54114571L;
    int64_t l_8 = 0xB0881DDA8DB8846BLL;
    int i, j, k;
    l_5--;
    return l_8;
}
