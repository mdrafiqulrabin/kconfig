...
static int32_t g_31 = 0xC19C50EDL;
static uint8_t g_32[7] = {0xA3L,0xECL,0xA3L,0xA3L,0xECL,0xA3L,0xA3L};
...
static int64_t  func_28(void)
{ /* block id: 36 */
    int16_t l_29[9][5] = {{(-2L),0xEFC3L,(-7L),(-2L),(-7L)},{0x36C2L,(-6L),1L,1L,(-6L)},{(-7L),(-1L),1L,8L,0xEFB4L},{0xEFC3L,(-7L),(-7L),0xCA18L,8L},{(-8L),(-2L),0xEFB4L,0x36C2L,(-6L)},{0xEFC3L,0x36C2L,0L,(-6L),0L},{(-7L),(-7L),0x6D23L,(-6L),0x7795L},{0x36C2L,0xEFC3L,(-1L),0x36C2L,0x37FFL},{(-1L),0x0BDEL,0x6D23L,0xEFB4L,0x0BDEL}};
    int32_t *l_30 = &g_31;
    int i, j;
    (*l_30) |= (0xE7E64BFCL ^ l_29[1][4]);
    l_30 = &g_31;
    return g_32[5];
}
