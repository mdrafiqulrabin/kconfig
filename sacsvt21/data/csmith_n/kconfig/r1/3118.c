...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_3 = 0x0ADE;
static uint32_t g_41 = 0x300CE3D9;


/* --- FORWARD DECLARATIONS --- */
inline static uint32_t  func_25(void);
static int32_t  func_27(uint32_t  p_28, uint32_t  p_29, int32_t  p_30, uint32_t  p_31, int32_t  p_32);
...
{ /* block id: 36 */
    ...
    uint32_t *l_40 = &g_41;
    int16_t l_42 = 0x26B5;
    const int32_t l_43 = (-4);
    uint32_t l_44 = 0xE96BB645;
    int32_t *l_46 = &l_37;
    (*l_46) = (l_26 , func_27(((l_26 ^ ((int16_t)(((((l_37 = __builtin_ffsl(((uint16_t)65535U << (uint16_t)0))) & ((0xB146 >= (((int16_t)(__builtin_parity(((*l_40) = 0x18838009)) >= __builtin_clzl(l_42)) - (int16_t)l_26) <= 0x3A4C)) < 1)) == l_26) != l_43) >= g_3) % (int16_t)l_44)) < l_43), l_26, l_43, g_3, l_44));
    return g_3;
}
