...
static int16_t  func_32(void)
{ /* block id: 36 */
    int32_t l_33 = 0xAAF5BFB6L;
    int8_t l_41 = 0x85L;
    for (l_33 = 1; (l_33 != 12); l_33 = safe_add_func_uint64_t_u_u(l_33, 1))
    { /* block id: 39 */
        int32_t *l_37 = &l_33;
        int32_t **l_36 = &l_37;
        int32_t l_38 = (-9L);
        (*l_36) = &l_33;
        for (l_38 = 0; (l_38 >= (-11)); l_38 = safe_sub_func_int8_t_s_s(l_38, 1))
        { /* block id: 43 */
            uint32_t l_42 = 0xA5308633L;
            if (l_41)
                break;
            l_42++;
        }
