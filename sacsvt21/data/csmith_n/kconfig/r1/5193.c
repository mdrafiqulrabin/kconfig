...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_8[9] = {0xFC3AL,0xFC3AL,0xFC3AL,0xFC3AL,0xFC3AL,0xFC3AL,0xFC3AL,0xFC3AL,0xFC3AL};
...
inline static float  func_27(void)
{ /* block id: 36 */
    uint32_t l_28[10] = {0x3C27F355L,0xF7B1466AL,0x3C27F355L,0x3C27F355L,0xF7B1466AL,0x3C27F355L,0x3C27F355L,0xF7B1466AL,0x3C27F355L,0x3C27F355L};
    int i;
    l_28[2] &= g_8[7];
    return l_28[1];
}
