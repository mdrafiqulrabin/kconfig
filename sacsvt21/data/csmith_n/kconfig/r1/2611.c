...
static int32_t  func_25(void)
{ /* block id: 36 */
    uint16_t l_26 = 0x4A0D;
    int32_t l_38 = 0x6C2E3A4C;
    g_5 = l_26;
    ...
    l_38 = ((uint16_t)((0xDF9C || (g_29 == (0x3D6C && ((uint32_t)((g_5 >= 2U) | (((uint16_t)l_26 + (uint16_t)g_29) >= ((uint16_t)((g_5 == 0xBD18) == g_5) >> (uint16_t)9))) - (uint32_t)l_26)))) <= 0xA7BF748B) << (uint16_t)g_29);
    return g_5;
}
