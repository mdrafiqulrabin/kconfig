...
inline static const int16_t  func_33(void)
{ /* block id: 36 */
    const int8_t l_34[7][1][4] = {{{1L,0x1AL,1L,0x99L}},{{(-6L),0x1AL,0xBFL,0x6FL}},{{0x1AL,0x2CL,0x2CL,0x1AL}},{{1L,0x6FL,0x2CL,0x99L}},{{0x1AL,(-6L),0xBFL,(-6L)}},{{(-6L),0x2CL,1L,(-6L)}},{{1L,(-6L),0x99L,0x99L}}};
    int i, j, k;
    return l_34[5][0][3];
}
