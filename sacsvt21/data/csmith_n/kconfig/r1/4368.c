...
static volatile uint32_t g_30[2][4] = {{0xC1DFE936,4294967295U,0xC1DFE936,0xC1DFE936},{4294967295U,4294967295U,1U,4294967295U}};
...
inline static float  func_29(void)
{ /* block id: 36 */
    uint32_t l_33[9] = {3U,1U,1U,3U,1U,1U,3U,1U,1U};
    int i;
    ++g_30[1][2];
    return l_33[8];
}
