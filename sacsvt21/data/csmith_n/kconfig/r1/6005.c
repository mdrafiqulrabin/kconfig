...
/* --- GLOBAL VARIABLES --- */
static float g_3 = 0xE.C03342p+94;
static int64_t g_15[3] = {0x906C902DAFBBD0A7LL,0x906C902DAFBBD0A7LL,0x906C902DAFBBD0A7LL};
static int64_t g_17 = 0x9F4981FF29ACD409LL;
