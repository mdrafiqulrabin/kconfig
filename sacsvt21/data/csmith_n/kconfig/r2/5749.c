...
/* --- GLOBAL VARIABLES --- */
static const float g_3 = 0x0.9p+1;
static const uint16_t g_4 = 1UL;
static float g_33 = (-0x1.1p+1);
static float g_38 = 0x8.8p+1;
...
inline static uint8_t  func_30(void)
{ /* block id: 36 */
    uint64_t l_31 = 0xDB06862EAE264689LL;
    float *l_32 = &g_33;
    int32_t l_36 = 0L;
    float *l_37 = &g_38;
    (*l_37) = (l_31 == (((*l_32) = 0xF.DC9A81p-31) < ((float)(l_36 = __builtin_ffs(l_36)) * (float)g_4)));
    return g_4;
}
