...
{ /* block id: 36 */
    float l_39 = 0x1.5p-1;
    const int32_t l_40 = 0x6A530863L;
    int32_t l_42 = 0x813C27F3L;
    int32_t *l_41 = &l_42;
    uint32_t l_43 = 0x748BBE26L;
    (*l_41) |= (((!(safe_div_func_uint8_t_u_u((safe_lshift_func_int8_t_s_s(((-10L) >= (l_40 && 0xC0L)), (l_40 >= l_40))), l_40))) != l_40) != l_40);
    return l_43;
}
