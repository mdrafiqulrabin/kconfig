...
{ /* block id: 36 */
    int32_t l_33 = (-1);
    int32_t l_34 = 0x38E5161E;
    int16_t l_37 = 0x6A77;
    int32_t l_40 = 0x520C3D8D;
    int8_t l_41 = 0xD9;
    uint32_t l_42 = 0U;
    struct S1 l_43 = {0,0x7FB108F9,-9,4294967295U,524};
    l_41 = (__builtin_ffs((l_40 ^= (((((((uint32_t)__builtin_ctz((((((l_34 = l_33) || ((int16_t)l_33 << (int16_t)14)) , l_34) != (l_37 , ((int16_t)(l_33 < 0x8DAD) + (int16_t)(-2)))) || 0x33F2A6AD)) % (uint32_t)l_33) ^ l_33) , l_34) >= (-1)) && 0U) , l_37))) < (-1));
    l_34 = l_42;
    return l_43;
}
