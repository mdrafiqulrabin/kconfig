...
{ /* block id: 36 */
    ...
    int32_t *l_35 = &l_31;
    int32_t *l_36 = (void*)0;
    int32_t *l_37[10] = {&l_31,&l_31,&l_31,&l_31,&l_31,&l_31,&l_31,&l_31,&l_31,&l_31};
    uint32_t l_38 = 0x0DE57413L;
    int8_t l_41[8][8] = {{0x52L,0xAEL,0L,0xB2L,(-1L),(-1L),0xB2L,0L},{0xFCL,0xFCL,0L,0x0AL,0x80L,0x88L,0x29L,0x52L},{(-1L),0x29L,0x16L,0xFCL,0x16L,0x29L,(-1L),0x52L},{0x29L,0x88L,0x80L,0x0AL,0L,0xFCL,0xFCL,0L},{0xB2L,(-1L),(-1L),0xB2L,0x29L,0x6BL,(-3L),0L},{0x0AL,0x80L,0x88L,0x29L,0x52L,0x29L,0x88L,0x80L},{0xB2L,0x80L,0L,0x88L,0x16L,0x6BL,0xAEL,0xAEL},{0L,0xB2L,(-1L),(-1L),0xB2L,0L,0xAEL,0x52L}};
    int i, j;
    for (i = 0; i < 2; i++)
        l_30[i] = 0x40874B28L;
    l_31 |= l_30[0];
