...
{ /* block id: 344 */
    ...
    return p_66;
    /* statement id: 346 */
    //assert (func_64_rv == &l_560 || func_64_rv == 0 || func_64_rv == &l_644 || func_64_rv == &l_588);
}
    ...
    { /* block id: 280 */
        ...
        { /* block id: 281 */
            ...
            { /* block id: 286 */
                ...
                /* facts after branching */
                //assert (l_439 == dangling || l_439 == &l_88);
                assert (l_446 == 0 || l_446 == &l_444);
                (*l_449) = (*l_451);
        ...
        //assert (l_477 == &l_58 || l_477 == &l_88 || l_477 == &l_560);
    }
    else
    { /* block id: 331 */
...
lbl_267:
    (*l_91) = p_77;
    /* statement id: 41 */
    //assert (l_92 == &l_58 || l_92 == &l_88 || l_92 == &l_433.f2 || l_92 == &l_560);
...
lbl_266:
            ...
            { /* block id: 145 */
                ...
                { /* block id: 154 */
                    ...
                    (*l_281) = p_76;
                    /* statement id: 155 */
                    //assert (l_282 == &l_88 || l_282 == &l_58 || l_282 == &l_560);
                    return l_277;
                }
            }
            (*l_285) = l_283;
...
lbl_337:
    ...
    /* facts after branching */
    //assert (l_92 == dangling || l_92 == &l_58 || l_92 == &l_88 || l_92 == &l_433.f2 || l_92 == &l_560);
...
/* ------------------------------------------ */
/* 
 * reads : l_88 l_58 l_433.f2 l_560
 * writes:
 */
inline static int32_t  func_95(union U4  p_96, int32_t * p_97, int16_t  p_98, float * p_99)
{ /* block id: 131 */
...
/* ------------------------------------------ */
/* 
 * reads : l_58 l_88 l_433.f2 l_560
 * writes:
 */
inline static union U4  func_100(float * p_101, union U4  p_102, int32_t * p_103, float * const  p_104)
{ /* block id: 43 */
    ...
    { /* block id: 51 */
        ...
        /* facts after for loop */
        //assert (l_244 == &l_241 || l_244 == dangling || l_244 == &l_245);
    }
    /* facts after for loop */
        ...
        { /* block id: 75 */
            ...
            { /* block id: 76 */
                ...
                { /* block id: 79 */
                    return p_116;
                    /* statement id: 80 */
                    //assert (func_115_rv == 0 || func_115_rv == &l_251);
                }
            }
            else
            { /* block id: 82 */
