...
/* --- GLOBAL VARIABLES --- */
static int16_t g_4 = 0xB008L;
static const uint32_t g_21 = 4294967295UL;
static uint8_t g_34[8] = {0x41L,0x5AL,0x41L,0x41L,0x5AL,0x41L,0x41L,0x5AL};
