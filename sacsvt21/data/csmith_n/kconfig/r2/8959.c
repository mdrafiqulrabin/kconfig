...
static struct S0 g_9 = {-10L,0x0B4EF66BL,0x7B722BA7L,0x7E80D68FL,-1L,7UL,0x5833L,0xB.587C7Ap-32,-9L};/* VOLATILE GLOBAL g_9 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc_bytes (&g_9.f7, sizeof(g_9.f7), "g_9.f7", print_hash_value);
