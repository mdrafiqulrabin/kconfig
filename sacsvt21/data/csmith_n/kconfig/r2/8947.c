...
static int32_t g_29 = 0xC99CDF9CL;
...
inline static int32_t  func_25(void)
{ /* block id: 36 */
    int32_t l_27[2][5] = {{0xFB66FEBFL,0x3A065C2DL,0xFB66FEBFL,0xFB66FEBFL,0x3A065C2DL},{0x3A065C2DL,0xFB66FEBFL,0xFB66FEBFL,0x3A065C2DL,0xFB66FEBFL}};
    int32_t *l_28 = &g_29;
    int i, j;
    (*l_28) = (!l_27[1][4]);
    return g_30;
