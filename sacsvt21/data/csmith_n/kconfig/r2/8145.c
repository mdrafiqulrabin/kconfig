...
inline static union U0  func_1(void)
{ /* block id: 0 */
    uint16_t l_4[5] = {0UL,0UL,0UL,0UL,0UL};
    ...
    int32_t *l_14 = &l_9;
    int32_t *l_15[3];
    float l_16 = 0x8.5900B0p-51;
    float l_17 = 0x2.149CFFp+22;
    int8_t l_18[7] = {(-2L),0x6FL,0x6FL,(-2L),0x6FL,0x6FL,(-2L)};
    float l_19 = 0x6.9CE856p-87;
    uint32_t l_20[7];
    union U0 l_23 = {0xB0L};
    int i;
    for (i = 0; i < 3; i++)
