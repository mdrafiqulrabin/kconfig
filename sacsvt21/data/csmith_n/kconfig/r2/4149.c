...
static int8_t g_24 = 0xFAL;
static uint8_t g_44 = 0xEBL;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_24 g_44 g_45
 * writes: g_44 g_45
 */
static uint32_t  func_32(void)
{ /* block id: 36 */
    int64_t l_39 = 0xE526954EB856A759LL;
    int32_t l_40 = (-1L);
    int32_t *l_41 = &l_40;
    uint32_t l_42 = 0xDFE98D7EL;
    uint8_t *l_43 = &g_44;
    g_45 ^= (((*l_43) &= (((uint8_t)((uint8_t)((((uint8_t)__builtin_ffsll(l_39) << (uint8_t)3) | (l_39 , g_4)) == (3L & ((*l_41) = ((l_39 && l_39) , l_40)))) << (uint8_t)l_39) / (uint8_t)g_24) | l_42)) , (*l_41));
    return g_4;
}
