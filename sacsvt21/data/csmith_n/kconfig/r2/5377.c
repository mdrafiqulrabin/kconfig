...
static int32_t * func_5(int8_t  p_6, uint16_t  p_7, int64_t  p_8);
...
{ /* block id: 0 */
    ...
    int32_t *l_3 = &l_4;
    int32_t **l_20 = &l_3;
    (*l_3) = ((l_2 <= 1UL) == 0x256A9EF7L);
    (*l_20) = func_5((0x1D21F1EB32A831D2LL < (*l_3)), (*l_3), (*l_3));
    return l_4;
}
...
{ /* block id: 2 */
    ...
    int32_t *l_18 = &l_13;
    int32_t *l_19 = (void*)0;
    l_13 = ((uint8_t)((l_11 | l_11) != l_11) + (uint8_t)((void*)0 != l_12));
    (*l_15) = (-(int8_t)p_8);
    return l_19;
}
