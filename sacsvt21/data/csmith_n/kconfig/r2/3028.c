...
/* --- GLOBAL VARIABLES --- */
static float g_5 = 0xD.59E57Ap-49;
static uint32_t g_9 = 0x0A290BE4;
static const uint32_t g_25 = 0x01BA028E;
static union U0 g_31 = {0xB90F};/* VOLATILE GLOBAL g_31 */
...
{ /* block id: 36 */
    uint32_t l_29 = 0U;
    float l_30 = (-0x1.Bp+1);
    l_30 = (safe_mul_func_float_f_f(0x2.74A520p+49, (g_5 = l_29)));
    return g_31;
    /* statement id: 39 */
    }
