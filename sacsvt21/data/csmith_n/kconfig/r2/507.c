...
{ /* block id: 0 */
    ...
    int i;
    for (i = 0; i < 6; i++)
        l_2[i] = 0xFF0EA75C96DD1E1ELL;
    for (i = 0; i < 3; i++)
        l_3[i] = (-3L);
    for (l_3[0] = 5; (l_3[0] >= 0); l_3[0] -= 1)
    { /* block id: 3 */
        int32_t l_5 = 0xBEF7D651L;
        int32_t *l_4[6][7] = {{&l_3[0],&l_3[0],&l_5,&l_3[1],&l_5,&l_3[0],&l_3[0]},{&l_3[0],&l_5,&l_3[1],&l_3[0],&l_5,&l_5,&l_5},{&l_3[0],&l_5,&l_5,&l_3[0],&l_3[2],&l_3[0],&l_3[1]},{&l_3[0],&l_3[0],&l_3[1],&l_3[2],&l_3[2],&l_3[1],&l_3[0]},{&l_3[2],&l_3[0],&l_5,&l_5,&l_5,&l_3[1],&l_3[1]},{&l_5,&l_3[0],&l_3[2],&l_3[0],&l_5,&l_5,&l_5}};
        int i, j;
        l_4[4][6] = &l_3[0];
    }
    return l_2[2];
