...
/* --- GLOBAL VARIABLES --- */
static float g_7 = 0x7.9p+1;
static int32_t g_12 = 5L;
static int32_t * volatile g_32 = &g_12;/* VOLATILE GLOBAL g_32 */
...
inline static uint32_t  func_31(void)
{ /* block id: 36 */
    int32_t l_33[7][4] = {{9L,1L,1L,9L},{1L,9L,0x703C5764L,0L},{1L,0x703C5764L,1L,0x9D87263BL},{9L,0L,0x9D87263BL,0x9D87263BL},{0x703C5764L,0x703C5764L,9L,0L},{0L,9L,9L,9L},{0x703C5764L,1L,0x9D87263BL,9L}};
    int i, j;
    (*g_32) = g_12;
    return l_33[0][2];
}
