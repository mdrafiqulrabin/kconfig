...
inline static int32_t  func_26(void)
{ /* block id: 36 */
    float l_27[1][5][8] = {{{0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1)},{(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1},{(-0x2.0p+1),(-0x2.0p+1),0x1.D1B40Ep+76,(-0x2.0p+1),(-0x2.0p+1),0x1.D1B40Ep+76,(-0x2.0p+1),(-0x2.0p+1)},{0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1)},{(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1,0x1.Dp+1,(-0x2.0p+1),0x1.Dp+1}}};
    int32_t l_28 = 0L;
    int i, j, k;
    return l_28;
}
