...
static uint16_t g_28 = 0xBAE0;
static uint16_t g_30[4][9] = {{0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A},{1U,1U,1U,1U,1U,1U,1U,1U,1U},{0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A,0xCA1A},{1U,1U,1U,1U,1U,1U,1U,1U,1U}};
...
inline static uint32_t  func_27(void)
{ /* block id: 36 */
    int32_t l_29 = 0xB06C0E26;
    l_29 = ((__builtin_clzll(g_5[1]) | g_28) || l_29);
    g_30[0][4] |= g_28;
    return g_30[0][4];
}
