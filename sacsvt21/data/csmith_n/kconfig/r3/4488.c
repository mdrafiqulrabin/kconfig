...
static union U4 g_29[1][8] = {{{-0x1.0p-1},{-0x1.0p-1},{-0x1.0p-1},{-0x1.0p-1},{-0x1.0p-1},{-0x1.0p-1},{-0x1.0p-1},{-0x1.0p-1}}};
...
static int16_t  func_26(void)
{ /* block id: 36 */
    union U4 *l_28 = &g_29[0][5];
    union U4 **l_27 = &l_28;
    int32_t l_30 = 0x29C8DDACL;
    (*l_27) = (void*)0;
    return l_30;
}
...
int main (int argc, char* argv[])
{
    ...
    for (i = 0; i < 1; i++)
    {
        for (j = 0; j < 8; j++)
        {
            transparent_crc_bytes(&g_29[i][j].f0, sizeof(g_29[i][j].f0), "g_29[i][j].f0", print_hash_value);
