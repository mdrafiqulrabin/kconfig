...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_11 = 0xB7CEFA9DL;
...
inline static uint32_t  func_29(void)
{ /* block id: 36 */
    uint8_t l_30[4][9] = {{252UL,255UL,0xE2L,1UL,0xE2L,255UL,252UL,0x05L,0x4AL},{0UL,0x4AL,252UL,0x1BL,0x05L,0x1BL,252UL,0x4AL,0UL},{255UL,0x1BL,0UL,0x05L,0x67L,0xE2L,0x67L,0x05L,0UL},{0x67L,0x67L,255UL,0xA1L,0x4AL,1UL,0UL,1UL,0x4AL}};
    int i, j;
    return l_30[3][1];
}
