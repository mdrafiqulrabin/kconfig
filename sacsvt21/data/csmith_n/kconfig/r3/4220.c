...
/* --- GLOBAL VARIABLES --- */
static const uint32_t g_4 = 0x3E90A624L;
static int32_t * volatile g_29 = (void*)0;/* VOLATILE GLOBAL g_29 */
static int32_t g_44 = 0x2B2FAA96L;
...
{ /* block id: 36 */
    ...
    for (i = 0; i < 9; i++)
        l_39[i] = 0xC3F30B91L;
    g_29 = (void*)0;
    (*l_43) &= ((uint8_t)l_32 >> (uint8_t)((((int16_t)(__builtin_popcount(l_32) < ((uint16_t)((uint64_t)1UL / (uint64_t)g_4) + (uint16_t)(((l_39[6] < ((int8_t)((g_4 & l_39[6]) && ((void*)0 == l_42)) >> (int8_t)l_39[6])) != 0xDDL) >= 0xC5AD058BBE58ED0BLL))) << (int16_t)2) || 0x37F4A1D2L) != 6L));
    return g_44;
}
