...
static float g_33 = 0xF.FF5452p-8;
static struct S1 g_37 = {0xEE4CFF15L,-1L,0x44D99649L,0x440271DBL,1L,1UL,0xB8CFF26AL,-1L,-1L};
...
{ /* block id: 36 */
    ...
    int32_t *l_36 = &l_34;
    int32_t **l_35 = &l_36;
    l_34 = ((float)((*l_32) = g_3) + (float)(g_3 == l_34));
    (*l_35) = &l_34;
    return g_37;
}
