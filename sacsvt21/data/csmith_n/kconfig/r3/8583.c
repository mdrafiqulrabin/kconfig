...
static uint32_t  func_28(void)
{ /* block id: 36 */
    uint32_t l_31 = 0xF885EA6E;
    int32_t l_36 = 0xB34C266D;
    int32_t *l_35 = &l_36;
    uint32_t l_37 = 9U;
    (*l_35) = (((uint16_t)__builtin_parity((l_31 || __builtin_ctzll(l_31))) + (uint16_t)0) || (((!(l_31 , l_31)) | l_31) != ((int32_t)l_31 - (int32_t)l_31)));
    return l_37;
}
