...
/* --- GLOBAL VARIABLES --- */
static int16_t g_5[7][8] = {{(-2L),0xD061L,(-2L),0L,0xD061L,0L,0L,0xD061L},{0xD061L,0L,0L,0xD061L,0L,(-2L),0xD061L,(-2L)},{0xD061L,0xB2E4L,0xCC47L,0xB2E4L,0xD061L,0xCC47L,0x0738L,0x0738L},{(-2L),0xB2E4L,0L,0L,0xB2E4L,(-2L),0L,0xB2E4L},{0x0738L,0L,0L,0x0738L,0L,0L,0x0738L,(-2L)},{0xB2E4L,0xD061L,0xCC47L,0x0738L,0x0738L,0xCC47L,0L,0L},{0x7473L,(-2L),0xCC47L,(-9L),(-2L),(-9L),0xCC47L,(-2L)}};
static int32_t g_17 = 0xAD901516L;
