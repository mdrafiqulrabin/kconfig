...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        int32_t l_28 = 1;
        l_28 = ((l_5 > (g_2 & (((safe_sub_func_int32_t_s_s((safe_rshift_func_int8_t_s_s((!(safe_lshift_func_uint8_t_u_s((safe_lshift_func_uint16_t_u_s(((safe_lshift_func_uint8_t_u_u((safe_div_func_int8_t_s_s(g_2, 0x17)), (g_2 ^ ((safe_sub_func_uint8_t_u_u((safe_div_func_uint32_t_u_u((l_5 >= 0x76ACB8F2), (g_2 | (safe_mod_func_int32_t_s_s((safe_mod_func_uint8_t_u_u((0 && g_2), g_2)), l_5))))), l_27)) || g_2)))) || l_5), 11)), l_27))), 7)), l_5)) > l_5) != g_2))) == g_2);
    }
    return l_5;
}
