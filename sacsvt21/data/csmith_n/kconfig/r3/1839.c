...
{ /* block id: 0 */
    ...
    int8_t **l_2 = &l_3;
    int8_t ***l_5 = &l_2;
    int32_t l_6[5][6] = {{1,1,0,0,0,1},{0,0x74006310,0,0,0x74006310,0},{1,0,0,0,1,1},{0xB5CABFC3,0,0,0xB5CABFC3,0x74006310,0xB5CABFC3},{0xB5CABFC3,0x74006310,0xB5CABFC3,0,0,0xB5CABFC3}};
    int i, j;
    (*l_5) = l_2;
    return l_6[0][3];
}
