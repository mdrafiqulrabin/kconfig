...
static uint32_t  func_24(void)
{ /* block id: 36 */
    uint16_t l_27 = 0xC207;
    int32_t l_38 = 0xA1C3D076;
    l_38 = ((((uint32_t)(l_27 <= 0xCB8F) % (uint32_t)l_27) <= __builtin_ia32_crc32qi(l_27, l_27)) && ((int16_t)((g_3 != (__builtin_clzl(((((int16_t)((int16_t)0x3AE4 << (int16_t)(((uint16_t)((uint16_t)g_3 >> (uint16_t)8) << (uint16_t)10) | g_3)) << (int16_t)g_3) > 1) >= g_3)) < 0xED09)) | g_3) >> (int16_t)1));
    return l_27;
}
