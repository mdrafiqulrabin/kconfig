...
/* --- GLOBAL VARIABLES --- */
static uint64_t g_5 = 0x47DC4B4E1265AB3ELL;
static float g_30[3] = {0xB.A90611p+24,0xB.A90611p+24,0xB.A90611p+24};
...
static float  func_25(void)
{ /* block id: 36 */
    for (g_5 = 0; (g_5 >= 11); g_5 = safe_add_func_int8_t_s_s(g_5, 7))
    { /* block id: 39 */
        int32_t l_28 = 0x1245C810L;
        float *l_29 = &g_30[2];
        (*l_29) = (g_5 , l_28);
    }
    return g_5;
