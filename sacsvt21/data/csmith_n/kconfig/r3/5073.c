...
static const volatile union U2 g_7 = {0x3A18L};/* VOLATILE GLOBAL g_7 */
static const volatile union U2 *g_6 = &g_7;
static const volatile union U2 ** volatile g_8 = &g_6;/* VOLATILE GLOBAL g_8 */
