...
inline static int8_t  func_32(void)
{ /* block id: 36 */
    float l_33 = 0x8.919ADBp+35;
    int32_t l_40 = 0L;
    int32_t l_42 = 0x2E26595AL;
    int32_t *l_41 = &l_42;
    int16_t l_43 = 0x419CL;
    l_33 = 0x0.9p-1;
    (*l_41) ^= (safe_div_func_int16_t_s_s(1L, (safe_add_func_int8_t_s_s((safe_mod_func_uint16_t_u_u(l_40, l_40)), (l_40 || (l_40 || 0xEFL))))));
    return l_43;
}
