...
static struct S0  func_30(void)
{ /* block id: 36 */
    int32_t l_35 = 0x55C0C8FBL;
    uint32_t l_36 = 18446744073709551609UL;
    int32_t l_37[5] = {(-5L),(-5L),(-5L),(-5L),(-5L)};
    struct S0 l_42 = {4133,7,-36,2,0UL,31,-1};
    int i;
lbl_40:
    l_37[1] = (safe_lshift_func_int16_t_s_u((safe_mod_func_uint32_t_u_u(l_35, l_36)), 1));
    for (l_36 = (-27); (l_36 != 52); ++l_36)
    { /* block id: 40 */
        struct S0 l_41 = {-5732,3,65,1,5UL,-10,0};
        if (l_35)
            goto lbl_40;
        return l_41;
    }
