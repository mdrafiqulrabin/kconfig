...
{ /* block id: 36 */
    int32_t l_33 = 0L;
    int32_t l_37 = 8L;
    for (l_33 = 5; (l_33 > (-20)); l_33 = safe_sub_func_uint8_t_u_u(l_33, 1))
    { /* block id: 39 */
        uint32_t l_36[3][3] = {{0xC53D8B3DL,4294967288UL,0xC53D8B3DL},{0xC53D8B3DL,4294967288UL,0xC53D8B3DL},{0xC53D8B3DL,4294967288UL,0xC53D8B3DL}};
        int i, j;
        l_36[0][1] = 0x1.Dp-1;
        l_37 = l_36[1][1];
    }
