...
static int32_t g_37 = 0x1B7E280B;
...
static int32_t  func_24(void)
{ /* block id: 36 */
    uint32_t l_27 = 0x0B101AAE;
    uint32_t l_36 = 4294967288U;
    int32_t l_38 = (-3);
    l_38 = ((safe_lshift_func_uint16_t_u_s(l_27, g_3)) < (safe_mod_func_uint32_t_u_u((safe_add_func_int32_t_s_s((((((((l_27 != l_27) < (g_3 & (-10))) > (safe_rshift_func_int16_t_s_s(((safe_add_func_uint16_t_u_u((g_3 || l_27), (g_37 = ((__builtin_ctzl(__builtin_ctzll(g_3)) ^ 0xDDB74A71) | l_36)))) && 0xB467BB1A), 8))) ^ l_27) , 1U) >= g_3) , g_3), g_3)), g_3)));
    return g_37;
}
