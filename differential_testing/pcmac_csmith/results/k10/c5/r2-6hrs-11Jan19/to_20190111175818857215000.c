...
static uint32_t g_28 = 0x91CB4E76;
static int32_t g_29 = 0xB959C45C;
...
static int32_t  func_26(void)
{ /* block id: 36 */
    int32_t l_27 = 0x5E3EDFA8;
lbl_30:
    g_28 = (l_27 |= 0x86BA47C9);
    g_29 = (g_28 >= 4294967295U);
    if (l_27)
        goto lbl_30;
    g_32 = (~(l_27 = 0xD3672969));
    return l_27;
}
