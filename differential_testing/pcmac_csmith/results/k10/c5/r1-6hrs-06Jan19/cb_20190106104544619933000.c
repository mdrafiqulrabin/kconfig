...
{ /* block id: 36 */
    uint32_t l_31 = 1U;
    g_36 = ((safe_add_func_int32_t_s_s(0xC17C7747, (__builtin_ia32_crc32qi(g_10, l_31) && l_31))) > (0xFBC9FA8B != ((g_10 ^ ((l_31 <= (safe_rshift_func_uint16_t_u_u((safe_sub_func_int32_t_s_s((-10), l_31)), g_10))) <= 0x02A3062A)) & 0x9973063D)));
    g_37++;
    return g_37;
}
