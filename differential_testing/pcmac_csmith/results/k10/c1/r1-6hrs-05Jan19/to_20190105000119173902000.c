...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t *l_6 = &g_7;
        (*l_6) ^= (safe_unary_minus_func_int32_t_s(g_2));
    }
    return g_2;
}
