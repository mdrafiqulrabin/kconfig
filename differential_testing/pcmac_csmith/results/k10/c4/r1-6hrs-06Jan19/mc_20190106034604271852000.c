...
/* --- GLOBAL VARIABLES --- */
static int16_t g_7 = 0x0F94;
static uint32_t g_33 = 0x5F8D9A2B;
...
static uint32_t  func_28(void)
{ /* block id: 36 */
    uint32_t l_29 = 0xA8CDA2AE;
    int32_t l_30 = 4;
    l_30 = l_29;
    g_33 = __builtin_ctzl(((safe_sub_func_uint32_t_u_u(g_7, 0U)) < (l_30 && g_7)));
