...
static uint32_t g_30 = 0xF609B2B5;
...
{ /* block id: 36 */
    ...
    int32_t l_31 = 9;
    int32_t l_32 = 0x2EF51AE9;
    l_32 ^= ((safe_lshift_func_uint16_t_u_s(__builtin_ia32_crc32qi(l_29, (g_4 , g_4)), (g_30 |= 0x82D5))) , ((l_31 = (__builtin_ffsl((g_30 , (1U || 4294967295U))) , g_4)) <= 0x3AC9));
    return g_4;
}
