...
static uint32_t g_5 = 0xA76AABEC;
static int16_t g_27 = 0xE813;
...
{ /* block id: 36 */
    ...
    { /* block id: 39 */
        l_28 = (((g_27 = g_3) == g_5) , 1);
        for (l_28 = 0; (l_28 < (-25)); l_28 = safe_sub_func_uint32_t_u_u(l_28, 2))
        { /* block id: 44 */
            l_31 = __builtin_ia32_crc32qi(l_28, g_27);
        }
    }
    return l_32;
}
