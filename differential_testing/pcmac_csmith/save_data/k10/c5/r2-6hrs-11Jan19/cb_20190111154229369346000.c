...
static uint32_t g_32 = 0x479B69B2;
...
{ /* block id: 36 */
    uint32_t l_34 = 0U;
    int32_t l_36 = 0xEC7E4343;
    uint16_t l_37 = 0x0A6F;
    int32_t l_40 = 0x9BC00EAD;
    if (g_15)
    { /* block id: 37 */
        uint32_t l_33 = 4294967290U;
        g_32 ^= (safe_rshift_func_int16_t_s_u((-7), 15));
        l_33 &= g_32;
    }
    else
    { /* block id: 40 */
    ...
    l_37 = (0xEA0C != (l_36 ^= l_34));
    l_40 ^= __builtin_ia32_crc32qi((l_36 = (safe_rshift_func_int16_t_s_u((g_32 > 2), 2))), l_37);
    return l_34;
}
