...
/* 
 * reads : g_5 g_30 g_33
 * writes: g_5 g_30 g_33
 */
static uint16_t  func_27(void)
{ /* block id: 36 */
    int32_t l_38 = (-1);
    uint32_t l_39 = 0x709BA87A;
    uint32_t l_40 = 4294967288U;
lbl_44:
    for (g_5 = 0; (g_5 != 2); g_5 = safe_add_func_int16_t_s_s(g_5, 2))
    { /* block id: 39 */
        uint32_t l_41 = 0x0C4E2BF5;
        for (g_30 = 0; (g_30 > 18); g_30 = safe_add_func_int16_t_s_s(g_30, 3))
        { /* block id: 42 */
            int32_t l_34 = 5;
            int32_t l_35 = 0x5F5B1B6F;
            g_33 |= g_5;
            l_35 ^= __builtin_ffsll(l_34);
            l_39 = (safe_lshift_func_int16_t_s_s(l_34, (l_38 <= g_30)));
            l_41 = l_40;
        }
    }
    for (g_5 = (-20); (g_5 >= 50); g_5++)
    { /* block id: 51 */
        if (l_38)
            goto lbl_44;
        return g_5;
