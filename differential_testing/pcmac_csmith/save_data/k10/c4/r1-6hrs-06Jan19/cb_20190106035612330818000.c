...
{ /* block id: 36 */
    uint16_t l_25 = 1U;
    int32_t l_32 = 0x411AA84C;
    l_32 = ((__builtin_parity(l_25) < (safe_lshift_func_int16_t_s_u((g_19 = (g_19 <= 0x46710139)), (__builtin_ia32_crc32qi(g_8, (((safe_rshift_func_uint16_t_u_u(g_8, (safe_lshift_func_int16_t_s_u(l_25, g_8)))) ^ g_8) != g_8)) && l_25)))) != g_8);
    return g_8;
}
