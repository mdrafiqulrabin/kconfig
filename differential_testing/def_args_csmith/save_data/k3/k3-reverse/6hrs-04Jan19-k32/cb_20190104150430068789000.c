...
{ /* block id: 36 */
    float l_34 = 0x1.Cp-1;
    int32_t l_35[9] = {0x37BD55FDL,0x37BD55FDL,0x37BD55FDL,0x37BD55FDL,0x37BD55FDL,0x37BD55FDL,0x37BD55FDL,0x37BD55FDL,0x37BD55FDL};
    int8_t l_36 = 0x90L;
    int i;
    l_35[0] = __builtin_ia32_crc32qi(l_35[3], l_35[4]);
    l_35[3] = l_35[3];
    l_35[1] = l_36;
    return l_36;
}
