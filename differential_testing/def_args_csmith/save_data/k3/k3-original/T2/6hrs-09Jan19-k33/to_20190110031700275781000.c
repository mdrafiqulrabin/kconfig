...
{ /* block id: 0 */
    int32_t l_2 = 4;
    int32_t l_6 = (-1);
    for (l_2 = (-1); (l_2 > 23); l_2 = safe_add_func_int16_t_s_s(l_2, 1))
    { /* block id: 3 */
        int16_t l_5 = (-7);
        int32_t l_11 = (-5);
        l_6 = l_5;
...
lbl_18:
    for (l_2 = (-5); (l_2 == (-19)); l_2 = safe_sub_func_uint16_t_u_u(l_2, 6))
    { /* block id: 13 */
        uint32_t l_14 = 0x6D8D3833;
        int32_t l_17 = 0x4E665969;
        l_17 = ((func_7(l_14) == (safe_lshift_func_uint16_t_u_u(func_7(l_2), 15))) <= l_6);
        return l_17;
    }
    l_2 = l_2;
    if (l_2)
...
{ /* block id: 5 */
    int16_t l_10 = 0x4800;
    l_10 = (safe_unary_minus_func_uint16_t_u(p_8));
    return l_10;
}
