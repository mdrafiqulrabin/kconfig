...
lbl_30:
    ...
    if (l_28)
        goto lbl_30;
    for (g_3 = 15; (g_3 > (-1)); g_3 = safe_sub_func_uint32_t_u_u(g_3, 6))
    { /* block id: 42 */
        uint16_t l_35 = 0x5018;
        for (l_28 = (-5); (l_28 != 21); l_28 = safe_add_func_uint32_t_u_u(l_28, 1))
        { /* block id: 45 */
            return g_19;
        }
        if (l_35)
