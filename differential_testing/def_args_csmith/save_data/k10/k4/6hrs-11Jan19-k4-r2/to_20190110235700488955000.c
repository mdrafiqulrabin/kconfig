...
static int32_t  func_26(void)
{ /* block id: 36 */
    uint16_t l_29 = 0x82D8;
    int32_t l_30 = 0xD4E70302;
lbl_33:
    l_30 = (safe_sub_func_int16_t_s_s(l_29, (__builtin_ffsll(g_3) >= 1U)));
    for (l_29 = (-1); (l_29 > 52); l_29 = safe_add_func_int16_t_s_s(l_29, 1))
    { /* block id: 40 */
        if (l_29)
            goto lbl_33;
    }
