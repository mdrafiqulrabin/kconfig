...
{ /* block id: 36 */
    uint32_t l_37 = 0U;
    int32_t l_38 = 0xEA4D59FF;
    g_5 = g_5;
    l_37 = (safe_unary_minus_func_uint32_t_u(func_33(__builtin_ia32_crc32qi(g_5, g_5))));
    g_5 = (65535U && l_37);
    l_38 = 0xEE507704;
    return g_5;
}
