...
static int32_t g_38 = 0xB5AF9F7C;
...
{ /* block id: 36 */
    ...
    int32_t **l_41 = (void*)0;
    int32_t **l_42 = &g_37;
    (*l_42) = func_27(((((safe_add_func_int16_t_s_s(__builtin_ia32_crc32qi(g_3, g_3), 0x2278)) && l_35) & g_3) ^ (!(g_3 | (g_37 != (void*)0)))), &l_35, g_3, &l_35, l_35);
    return g_38;
}
