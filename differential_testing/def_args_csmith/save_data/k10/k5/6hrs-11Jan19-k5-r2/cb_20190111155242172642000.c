...
{ /* block id: 36 */
    ...
    int32_t l_38 = 0;
    int32_t l_39 = (-1);
    g_36 = (((0x3303 <= l_29) <= (!(((g_4 & (__builtin_ia32_crc32qi(l_31, l_29) < ((((safe_add_func_uint32_t_u_u(((0xFC3E == 0U) & l_31), g_4)) > g_4) , 0x33EE6768) <= g_4))) || g_4) , (-10)))) < l_29);
    l_39 ^= (l_38 &= (l_37 = (g_36 , ((g_4 & 0x6D8F) ^ l_29))));
    return g_4;
}
