...
/* --- GLOBAL VARIABLES --- */
static int16_t g_4 = 0x3556;
static int32_t g_30 = 0xB4746A1C;
...
{ /* block id: 36 */
    int16_t l_33 = 0;
    for (g_4 = 7; (g_4 != (-22)); g_4 = safe_sub_func_int32_t_s_s(g_4, 1))
    { /* block id: 39 */
        int32_t l_34 = 8;
        for (g_30 = (-23); (g_30 != (-11)); g_30 = safe_add_func_uint16_t_u_u(g_30, 4))
        { /* block id: 42 */
            l_34 &= l_33;
        }
    }
