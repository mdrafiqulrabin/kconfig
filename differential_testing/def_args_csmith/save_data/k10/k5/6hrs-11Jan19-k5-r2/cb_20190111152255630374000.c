...
static uint32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_33 = 0x81479B69;
    int32_t l_41 = 0xC00EADD5;
    g_43 ^= (safe_lshift_func_uint16_t_u_s(l_33, (g_8 = ((safe_lshift_func_int16_t_s_u(l_33, (!0U))) | __builtin_ia32_crc32qi(g_8, (0xC8D46758 > (((safe_lshift_func_uint16_t_u_s((g_8 , ((g_8 > (safe_rshift_func_int16_t_s_u((l_41 = g_8), (safe_unary_minus_func_uint32_t_u((__builtin_popcount(((l_33 && l_33) <= g_8)) | (-7))))))) | 0x06982B35)), 15)) > 1U) , 7)))))));
    return l_41;
}
