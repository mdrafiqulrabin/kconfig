...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_5 = 0x7E8EDF1F;
...
{ /* block id: 36 */
    uint32_t l_28 = 0U;
    int32_t l_32 = 0x951BB35B;
    l_32 = (((l_28 ^ (g_5 ^ l_28)) >= ((__builtin_parity((~(((g_5 <= __builtin_ia32_crc32qi((safe_sub_func_int32_t_s_s(g_5, (0xEC71 <= (2 ^ g_5)))), g_5)) , l_28) | l_28))) < g_5) != 0x193208AF)) < g_5);
    return g_5;
}
