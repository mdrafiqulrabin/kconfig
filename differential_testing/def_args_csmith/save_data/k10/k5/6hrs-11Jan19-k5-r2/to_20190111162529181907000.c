...
/* 
 * reads : g_6 g_31 g_36
 * writes: g_31 g_6 g_36
 */
static uint32_t  func_26(void)
{ /* block id: 36 */
    int16_t l_35 = 1;
lbl_34:
    g_31 ^= (safe_lshift_func_uint16_t_u_s((safe_lshift_func_int16_t_s_u(g_6, 10)), 3));
    for (g_6 = 0; (g_6 > (-13)); g_6 = safe_sub_func_int32_t_s_s(g_6, 4))
    { /* block id: 40 */
        if (g_6)
            goto lbl_34;
        g_36 &= l_35;
