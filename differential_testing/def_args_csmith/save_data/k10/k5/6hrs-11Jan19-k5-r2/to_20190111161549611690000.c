...
static uint32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_31 = 0xA7525D2D;
    int32_t l_37 = 0xD06BDE64;
    l_31 = g_7;
    for (l_31 = (-2); (l_31 > (-9)); l_31 = safe_sub_func_uint16_t_u_u(l_31, 1))
    { /* block id: 40 */
        g_7 = 0xBCE008FB;
    }
    for (g_7 = (-3); (g_7 >= 11); g_7++)
    { /* block id: 45 */
        g_38 &= (l_37 |= (safe_unary_minus_func_uint16_t_u(0x6284)));
    }
    return g_7;
}
