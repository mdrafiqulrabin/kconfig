...
static uint32_t  func_28(void)
{ /* block id: 36 */
    int32_t l_35 = 0x7E0D1B71;
    for (g_5 = 14; (g_5 != (-9)); g_5 = safe_sub_func_uint16_t_u_u(g_5, 1))
    { /* block id: 39 */
        int32_t l_33 = 0x6CE028F4;
        l_35 = (safe_lshift_func_int16_t_s_u(0, ((g_34 = l_33) < (l_35 <= ((((l_35 , (((l_33 && (g_5 >= l_33)) == l_33) <= g_5)) <= g_5) != g_5) , l_35)))));
        if (l_33)
            continue;
        if (g_5)
            break;
