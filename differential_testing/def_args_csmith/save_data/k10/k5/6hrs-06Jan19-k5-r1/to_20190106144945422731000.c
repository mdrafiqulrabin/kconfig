...
/* 
 * reads : g_3
 * writes: g_3 g_32 g_44
 */
static uint32_t  func_27(void)
{ /* block id: 36 */
    uint32_t l_45 = 0xD3E99730;
    for (g_3 = 0; (g_3 != (-28)); g_3 = safe_sub_func_uint16_t_u_u(g_3, 4))
    { /* block id: 39 */
        uint16_t l_43 = 0xAE8B;
        g_44 = (safe_add_func_uint32_t_u_u((g_32 = 0x83DC0E3E), (safe_add_func_int32_t_s_s((safe_sub_func_uint16_t_u_u(((safe_rshift_func_int16_t_s_u(0, g_3)) , g_3), 0x720D)), ((safe_rshift_func_uint16_t_u_s((safe_add_func_int32_t_s_s((-5), g_3)), 7)) , (l_43 , g_3))))));
    }
    l_45 |= g_3;
    return l_45;
}
