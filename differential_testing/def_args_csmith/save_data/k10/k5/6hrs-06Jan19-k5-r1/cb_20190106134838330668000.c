...
static int32_t g_42 = 0xFEDAACDA;
...
static int32_t  func_29(void)
{ /* block id: 36 */
    int32_t l_35 = 0x637C5B15;
    int32_t l_40 = 1;
    uint16_t l_41 = 0xCF8B;
    g_42 ^= ((((!g_11) != (safe_rshift_func_int16_t_s_s((safe_rshift_func_int16_t_s_s(g_11, (l_35 > (safe_sub_func_uint16_t_u_u((l_35 > 4294967293U), (((((safe_sub_func_uint16_t_u_u(g_11, (__builtin_ia32_crc32qi((l_40 = l_35), l_35) || g_11))) <= 0xA922) ^ l_41) <= g_11) & g_11)))))), g_11))) == g_11) , g_11);
    return l_35;
}
