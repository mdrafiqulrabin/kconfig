...
/* 
 * reads : g_6 g_29 g_35
 * writes: g_29 g_35 g_6
 */
static int16_t  func_27(void)
{ /* block id: 36 */
    uint32_t l_28 = 0xA715CC48;
    int32_t l_33 = 0x9A56718E;
    int32_t l_41 = 2;
    g_6 = (l_28 ^ ((g_6 ^ (((g_29 |= 0x0D0E75D5) <= func_30(l_33, l_28)) ^ __builtin_clz((((safe_mod_func_uint16_t_u_u((((~((safe_rshift_func_int16_t_s_s(g_6, 14)) & g_6)) && l_33) < g_6), g_6)) > (-1)) , g_6)))) >= l_28));
lbl_43:
    if (l_28)
        goto lbl_42;
lbl_42:
