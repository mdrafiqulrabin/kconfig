...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_8 = 0x13A473EB;
static int32_t g_33 = 1;
static uint32_t g_34 = 0x3F300457;
static int16_t g_35 = 0;
static uint32_t g_37 = 0xDE7504ED;
...
/* ------------------------------------------ */
/* 
 * reads : g_8 g_33 g_34 g_35
 * writes: g_33 g_34 g_35 g_37
 */
static int32_t  func_24(void)
{ /* block id: 36 */
    int16_t l_31 = (-2);
    int32_t l_32 = 0xBC1C234A;
    int32_t l_36 = 3;
lbl_38:
    l_36 = (g_35 = (g_34 |= ((g_8 == (g_33 ^= (safe_rshift_func_uint16_t_u_u(((safe_add_func_uint32_t_u_u((g_8 >= ((safe_sub_func_uint16_t_u_u((l_31 || (l_31 < l_31)), 0x7C28)) , ((l_32 = 0x0069) == (((g_8 && l_31) ^ 9U) < 0x63D6)))), l_31)) == l_31), 10)))) > l_31)));
    g_37 = (g_33 , __builtin_ffsl(g_35));
    if (g_8)
        goto lbl_38;
    return l_31;
}
