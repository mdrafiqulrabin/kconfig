...
lbl_41:
    ...
    if (l_30)
        goto lbl_40;
lbl_40:
    g_39 &= ((l_38 = (safe_mod_func_uint32_t_u_u(((__builtin_ffsll(l_30) || ((safe_rshift_func_uint16_t_u_s(l_30, 7)) & l_35)) != g_3), (l_37 |= ((l_36 = g_3) , l_36))))) != g_3);
    if (l_36)
        goto lbl_41;
    return l_30;
}
