...
{ /* block id: 36 */
    int32_t l_35 = (-1);
    int32_t l_39 = 0x3C576436;
    int32_t l_44 = (-1);
    int32_t l_45 = 0xE834AB46;
    l_45 ^= (safe_lshift_func_uint16_t_u_s((g_36 = (l_35 = __builtin_ctzl((safe_rshift_func_int16_t_s_u((g_3 , (g_3 != 7)), 15))))), (safe_lshift_func_uint16_t_u_s((l_39 == (g_3 > (safe_mod_func_uint16_t_u_u((((safe_mod_func_uint16_t_u_u(l_39, (l_44 = ((l_39 <= 0x6CEF3CF6) , l_39)))) | 5U) == l_39), l_39)))), 12))));
    return g_36;
}
