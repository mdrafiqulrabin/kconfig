...
{ /* block id: 36 */
    int32_t l_28 = 1;
    int32_t l_29 = 0;
    g_30 = __builtin_bswap64(((((((safe_rshift_func_int16_t_s_u(__builtin_clz(g_3), (65535U != g_3))) && ((l_28 = (l_28 , (__builtin_ia32_crc32qi(l_28, ((((l_28 & (l_28 == (l_28 , g_3))) >= g_3) != 65535U) <= g_3)) != g_3))) ^ l_29)) , g_3) & g_3) || l_28) , l_29));
    return g_3;
}
