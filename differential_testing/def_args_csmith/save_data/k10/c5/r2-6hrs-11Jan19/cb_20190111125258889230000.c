...
static uint32_t g_29 = 0xD70512A3;
...
static int16_t  func_25(void)
{ /* block id: 36 */
    int32_t l_26 = 0x6F3F17E2;
    int32_t l_30 = 0x66C4A87F;
    g_29 = ((__builtin_ia32_crc32qi(g_5, l_26) ^ 0xD44C039E) ^ ((1 && g_5) & (safe_lshift_func_uint16_t_u_s(1U, 2))));
    return l_30;
}
