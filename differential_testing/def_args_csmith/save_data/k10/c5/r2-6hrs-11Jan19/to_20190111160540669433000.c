...
{ /* block id: 36 */
    int16_t l_39 = 0x9ED0;
lbl_35:
    for (g_4 = (-29); (g_4 <= 54); g_4 = safe_add_func_int32_t_s_s(g_4, 1))
    { /* block id: 39 */
        g_30 &= g_4;
    }
    for (g_30 = 0; (g_30 != (-8)); g_30 = safe_sub_func_uint16_t_u_u(g_30, 4))
    { /* block id: 44 */
        int32_t l_37 = 0x7E434392;
        int32_t l_38 = 0x635290CE;
        for (g_4 = 0; (g_4 > 12); g_4 = safe_add_func_int32_t_s_s(g_4, 1))
        { /* block id: 47 */
            if (g_30)
                goto lbl_35;
            l_38 |= ((!__builtin_parityll(l_37)) != (l_37 || g_30));
        }
    }
    return l_39;
}
