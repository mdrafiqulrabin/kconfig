...
static uint16_t  func_35(uint16_t  p_36, uint32_t  p_37, int32_t  p_38, uint32_t  p_39);
...
/* 
 * reads : g_3 g_48 g_50
 * writes: g_3 g_50 g_48
 */
static int32_t  func_30(void)
{ /* block id: 36 */
    int32_t l_41 = 0x3C86992F;
    int32_t l_45 = 3;
    for (g_3 = 0; (g_3 >= (-3)); g_3 = safe_sub_func_uint16_t_u_u(g_3, 1))
    { /* block id: 39 */
        int32_t l_40 = 1;
        int32_t l_49 = 1;
        g_48 = (safe_add_func_uint16_t_u_u((((((func_35(l_40, l_41, (safe_add_func_uint32_t_u_u(4294967295U, (!(g_50 ^= (l_49 = ((l_45 = (-1)) == ((g_3 == ((__builtin_ctzll(__builtin_popcountl(g_3)) >= ((safe_sub_func_int16_t_s_s((((l_41 != g_3) > g_3) == g_48), l_40)) != l_41)) <= l_41)) , l_41))))))), l_40) < 0x8E4C) , l_45) != g_48) || l_41) > l_41), g_48));
    }
    return l_41;
}
