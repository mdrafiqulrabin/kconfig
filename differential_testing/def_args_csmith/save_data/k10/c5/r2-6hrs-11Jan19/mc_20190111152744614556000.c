...
static uint32_t g_26 = 0x3A266D21;
static uint16_t g_30 = 0xC946;
...
{ /* block id: 36 */
    ...
    int32_t l_31 = (-1);
    g_25 = (g_5 | g_5);
    l_31 = (((((g_26 = __builtin_clz(g_25)) > g_5) , l_27) , __builtin_parityll((safe_sub_func_int16_t_s_s((g_30 = (((-1) == __builtin_ctzl(l_27)) <= (l_27 , l_27))), g_25)))) , (-1));
    g_32 = l_31;
    return g_26;
}
