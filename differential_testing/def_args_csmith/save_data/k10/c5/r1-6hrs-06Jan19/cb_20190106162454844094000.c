...
static uint32_t g_32 = 0x86B6FEB9;
...
static int32_t  func_25(void)
{ /* block id: 36 */
    uint32_t l_31 = 0xFFCF33F2;
    for (g_3 = 0; (g_3 > 33); g_3 = safe_add_func_int16_t_s_s(g_3, 1))
    { /* block id: 39 */
        uint16_t l_28 = 0xF545;
        if (l_28)
            break;
        g_32 = (safe_sub_func_int32_t_s_s(2, __builtin_ia32_crc32qi(l_31, g_3)));
    }
    return l_31;
}
