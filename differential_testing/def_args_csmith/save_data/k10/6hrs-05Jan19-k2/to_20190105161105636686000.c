...
{ /* block id: 0 */
    int32_t l_2 = 1;
    for (l_2 = 0; (l_2 > (-20)); l_2 = safe_sub_func_uint16_t_u_u(l_2, 5))
    { /* block id: 3 */
        int16_t l_9 = 0x59D5;
        int32_t l_14 = 7;
        l_14 = ((safe_sub_func_int16_t_s_s((safe_rshift_func_uint16_t_u_s(l_9, 8)), l_9)) && (safe_add_func_int16_t_s_s(l_9, (safe_rshift_func_int16_t_s_s(l_2, 12)))));
    }
    return l_2;
}
