...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_13 = 0x708EF6B8;
static int32_t g_32 = 0x14F4E797;
...
/* 
 * reads : g_13
 * writes: g_13 g_32 g_33
 */
static int32_t  func_29(void)
{ /* block id: 36 */
    int16_t l_35 = 0x2AFF;
lbl_34:
    for (g_13 = (-19); (g_13 <= 26); g_13 = safe_add_func_uint32_t_u_u(g_13, 1))
    { /* block id: 39 */
        g_33 = (g_32 = g_13);
    }
    g_32 = (g_13 ^ (-1));
