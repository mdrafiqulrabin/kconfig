...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_7 = 0xBE1D925B;
...
static int32_t  func_31(void)
{ /* block id: 36 */
    uint32_t l_37 = 0xD2466E9F;
    for (g_7 = 0; (g_7 > 3); g_7 = safe_add_func_int16_t_s_s(g_7, 1))
    { /* block id: 39 */
        int32_t l_34 = 1;
        int32_t *l_35 = &l_34;
        uint32_t l_36 = 6U;
        (*l_35) = __builtin_ia32_crc32qi(g_7, l_34);
        if (l_36)
            break;
    }
    return l_37;
