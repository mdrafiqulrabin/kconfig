...
static int64_t g_8 = 0x23DCDF5EF889A278LL;
static volatile uint8_t g_9 = 0xA7L;/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    ...
    int32_t *l_4 = &g_3;
    int32_t *l_5[1];
    int16_t l_6[8][4] = {{1L,0L,1L,0x44ADL},{0x2D76L,0xA4BEL,0x2D76L,0x44ADL},{1L,0L,1L,0x15F0L},{(-8L),0xC157L,0L,0L},{0L,0L,0L,0x2D76L},{(-8L),1L,1L,0xC157L},{1L,1L,0x2D76L,1L},{0x2D76L,1L,1L,0xC157L}};
    int32_t *l_12 = &g_3;
    int i, j;
    for (i = 0; i < 1; i++)
        l_5[i] = &g_3;
