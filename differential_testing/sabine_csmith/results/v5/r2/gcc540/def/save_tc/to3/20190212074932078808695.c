...
static volatile struct S0 g_5 = {3201,0x6B9DD952L};/* VOLATILE GLOBAL g_5 */
static union U1 g_10 = {0xC865B49DL};/* VOLATILE GLOBAL g_10 */
...
lbl_9:
    (*l_6) = g_5;
    for (g_3 = 2; (g_3 >= (-11)); g_3 = safe_sub_func_int32_t_s_s(g_3, 6))
    { /* block id: 5 */
        if (g_3)
            goto lbl_9;
    }
