...
static uint32_t g_30 = 4294967292U;
static int32_t g_33 = 0x97F51EF9;
...
{ /* block id: 36 */
    int16_t l_31 = 0;
    int32_t l_32 = (-1);
    uint16_t l_39 = 0x5761;
    g_30 = g_3;
    l_39 = ((l_32 |= l_31) , ((((g_30 = 1U) <= g_3) || g_30) != __builtin_popcountl((((0x8D5F | (g_33 = __builtin_clz(l_31))) >= (func_34(g_3, l_31, g_3, g_3) != g_3)) || 0x9495))));
    g_33 ^= g_30;
    l_32 = 0x3B9C309A;
    return g_30;
}
