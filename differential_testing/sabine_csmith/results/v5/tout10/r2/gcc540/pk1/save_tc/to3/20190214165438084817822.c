...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0x3606DE71;
static uint32_t g_7 = 0x46A1C17C;
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    struct S0 l_6 = {0,0x56251324,-1,4294967290U};
    int16_t l_8 = 1;
    for (g_2 = 28; (g_2 != (-22)); g_2 = safe_sub_func_uint16_t_u_u(g_2, 2))
    { /* block id: 3 */
        struct S0 l_5 = {7,4294967295U,0x8D526D2E,4294967290U};
        l_6 = l_5;
        g_7 ^= l_5.f2;
        l_8 = l_5.f2;
    }
