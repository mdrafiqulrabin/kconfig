...
static uint16_t  func_26(void)
{ /* block id: 36 */
    int32_t l_31 = 0x76ACB8F2;
    int32_t *l_34 = &g_35;
    (*l_34) = (safe_lshift_func_uint16_t_u_u(__builtin_clzll((safe_mod_func_int32_t_s_s(((g_7 , ((((g_7 & l_31) , ((((safe_rshift_func_int16_t_s_s(__builtin_parityl(l_31), 8)) || ((*l_34) = (g_7 ^ g_7))) || (safe_sub_func_int32_t_s_s(func_38(&g_35, (__builtin_ffsl(((((g_7 , &g_35) == (void*)0) , 3) > (*l_34))) & (*l_34))), (*l_34)))) && g_7)) == g_7) | 0xD20A2E71)) , g_35), 0x138B36CE))), g_7));
    return (*l_34);
}
