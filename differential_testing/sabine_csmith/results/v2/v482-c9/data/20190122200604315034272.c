...
/* 
 * reads : g_3 g_38 g_40
 * writes: g_3 g_32 g_34 g_40 g_38
 */
static uint16_t  func_28(void)
{ /* block id: 36 */
    uint32_t l_33 = 0xCD430964;
    int32_t *l_37 = &g_38;
    int32_t l_41 = (-1);
    for (g_3 = (-14); (g_3 <= 55); g_3 = safe_add_func_uint16_t_u_u(g_3, 1))
    { /* block id: 39 */
        int32_t *l_31 = &g_32;
        int16_t *l_39 = &g_40;
        (*l_37) = (((((*l_31) = g_3) < 1U) | (g_3 > ((g_34 = l_33) & ((l_33 & 0x3A4D) > ((safe_mod_func_int16_t_s_s((l_37 == l_37), ((l_41 = ((*l_39) = 1)) | g_38))) & g_38))))) || 4294967289U);
    }
    return g_40;
}
