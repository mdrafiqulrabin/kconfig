...
static int32_t g_8 = 0x108F8256;
static uint32_t g_33 = 0x495761BE;
static int32_t g_35 = 0x1E2DB80E;
...
{ /* block id: 36 */
    ...
    int32_t *l_34 = &g_35;
    (*l_31) = l_30;
    (*l_34) = (((0U && g_3) && 4U) || ((*l_32) = (((**l_31) = (g_3 == g_3)) , __builtin_popcountll(g_8))));
    return (*l_34);
}
