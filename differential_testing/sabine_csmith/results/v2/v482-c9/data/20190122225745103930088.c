...
static uint32_t g_36 = 0x36FE5AB0;
static uint16_t g_38 = 0xB641;
...
{ /* block id: 36 */
    ...
    uint16_t *l_37 = &g_38;
    int32_t *l_39 = &g_40;
    (*l_39) &= ((((safe_rshift_func_int16_t_s_s(l_31, (safe_unary_minus_func_uint16_t_u(((*l_37) = __builtin_popcount((safe_mod_func_uint32_t_u_u((0xF0D3ECF0 | ((*l_35) = l_31)), g_5)))))))) , (g_5 >= g_5)) & (l_37 == (void*)0)) | l_31);
    (*l_39) = g_38;
    return g_38;
}
