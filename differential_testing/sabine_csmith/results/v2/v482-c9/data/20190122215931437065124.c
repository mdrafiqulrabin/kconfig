...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_5 = 0x9FE387FB;
static int32_t g_21 = (-3);
static int32_t g_35 = 0x8018D9DC;
...
static int32_t  func_29(void)
{ /* block id: 36 */
    for (g_21 = 0; (g_21 >= 28); g_21 = safe_add_func_int32_t_s_s(g_21, 5))
    { /* block id: 39 */
        int32_t *l_34 = &g_35;
        (*l_34) = (safe_unary_minus_func_int32_t_s((~__builtin_ctz(g_5))));
        (*l_34) = g_5;
        if ((*l_34))
            break;
    }
