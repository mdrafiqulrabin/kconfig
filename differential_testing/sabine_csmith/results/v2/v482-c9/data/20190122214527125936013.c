...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_11 = 0xC8FC558B;
static int32_t g_42 = 0x38EB16E2;
static uint32_t g_44 = 0x9BA5B042;
...
{ /* block id: 36 */
    ...
    int32_t *l_45 = (void*)0;
    int32_t *l_46 = &g_47;
    (*l_46) ^= (safe_lshift_func_int16_t_s_s(((((safe_add_func_uint32_t_u_u(((!((l_34 < 0x694D2B5F) > (g_11 <= ((g_11 && 0x7C8B) >= (-2))))) > g_11), g_11)) , ((*l_43) = __builtin_ffs((safe_mod_func_uint16_t_u_u((func_37(g_11, l_34, l_34) , 65531U), l_34))))) == l_34) , 0x7FD0), 4));
    return (*l_46);
}
