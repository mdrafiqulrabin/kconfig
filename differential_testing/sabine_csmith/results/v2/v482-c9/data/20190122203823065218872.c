...
static int32_t g_13 = 0x15912491;
static int32_t g_40 = 0xCDEDFC3E;
...
{ /* block id: 36 */
    ...
    int32_t *l_38 = (void*)0;
    int32_t *l_39 = &g_40;
    (*l_39) |= ((((!(safe_sub_func_int32_t_s_s(l_31, (~l_31)))) , func_33(l_31)) > 0U) , ((safe_mod_func_uint32_t_u_u(g_4, func_33((func_33(l_31) , g_13)))) ^ g_4));
    return (*l_39);
}
