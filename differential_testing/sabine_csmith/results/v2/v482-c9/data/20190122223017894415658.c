...
{ /* block id: 36 */
    ...
    const int32_t l_34 = 0xDD7770B1;
    int32_t *l_37 = &l_33;
    (*l_37) = (safe_lshift_func_uint16_t_u_s((((safe_mod_func_uint32_t_u_u((!0xB0B4), l_33)) ^ (l_33 || l_34)) , ((l_33 != (safe_mod_func_uint32_t_u_u((g_12 <= (g_12 || g_12)), l_33))) || g_6)), g_6));
    return g_6;
}
