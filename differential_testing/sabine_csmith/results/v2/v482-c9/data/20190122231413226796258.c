...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_6 = 0x1F2C29A3;
static int32_t g_34 = 0x8E486AEB;
...
static const int32_t  func_27(void)
{ /* block id: 36 */
    const uint32_t l_32 = 0x8C38EC32;
    int32_t *l_33 = &g_34;
    (*l_33) = (safe_rshift_func_uint16_t_u_s(((__builtin_bswap64(((safe_add_func_int16_t_s_s(g_6, 0x4E66)) , 4294967295U)) == l_32) , l_32), 11));
    return (*l_33);
}
