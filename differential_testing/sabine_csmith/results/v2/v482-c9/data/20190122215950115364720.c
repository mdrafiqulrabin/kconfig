...
static uint32_t g_34 = 0xD6525681;
static int32_t g_36 = 0xCD49598A;
...
{ /* block id: 36 */
    ...
    uint32_t *l_33 = &g_34;
    int32_t *l_35 = &g_36;
    for (g_9 = (-7); (g_9 < (-7)); g_9 = safe_add_func_uint32_t_u_u(g_9, 1))
    { /* block id: 39 */
        uint16_t l_28 = 65526U;
        return l_28;
    }
    (*l_35) ^= (__builtin_ffs(l_29) || (safe_mod_func_uint32_t_u_u(((*l_33) = 1U), g_9)));
    return (*l_35);
}
