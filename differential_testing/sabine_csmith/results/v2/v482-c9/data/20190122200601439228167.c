...
static int32_t g_29 = 0x253A34C8;
...
{ /* block id: 36 */
    ...
    int32_t **l_27 = &l_28;
    int32_t *l_37 = (void*)0;
    int32_t l_38 = 0x8E356EC7;
    int32_t *l_39 = &g_29;
    (*l_27) = (void*)0;
    for (g_29 = 0; (g_29 >= (-21)); g_29 = safe_sub_func_uint32_t_u_u(g_29, 5))
    { /* block id: 40 */
        int32_t *l_32 = (void*)0;
        g_33 = (((void*)0 == l_32) && 0x5C17);
    }
    (*l_39) = (safe_unary_minus_func_uint16_t_u((safe_mod_func_int32_t_s_s((l_38 |= (-5)), 0x34392F20))));
    return g_29;
}
