...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2 = 0x47DC4B4E;
static uint32_t g_7 = 0U;
static int32_t g_13 = 0x3582F80C;
...
{ /* block id: 0 */
    int16_t l_11 = 0xD9E2;
    int32_t l_12 = (-1);
    g_13 = (l_12 = ((g_2 = 6U) ^ ((safe_mod_func_int16_t_s_s((safe_rshift_func_uint16_t_u_s(g_7, 6)), (safe_unary_minus_func_uint16_t_u(0x0707)))) & (safe_sub_func_int16_t_s_s(l_11, 65535U)))));
    return l_12;
}
