...
/* --- GLOBAL VARIABLES --- */
static struct S3 g_7 = {65527UL,0x37C57F39L,0xEE24B2E8L,1UL,255UL,0xBDD48407L,27};/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    ...
    (*l_8) |= (safe_div_func_uint64_t_u_u((0x5761BE36L != l_4[0][0]), (safe_mul_func_int8_t_s_s(0x33L, (g_7 , 5L)))));
    return l_10;
}
