...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_18 = 0x4455;
static int32_t g_42 = 0x452FA814;
...
{ /* block id: 36 */
    int32_t *l_34 = (void*)0;
    int32_t **l_43 = &l_34;
    (*l_43) = ((safe_lshift_func_uint16_t_u_u(0xA124, 12)) , func_32(l_34));
    return (**l_43);
}
...
{ /* block id: 37 */
    int16_t l_37 = 0x1A05;
    int32_t *l_41 = &g_42;
    for (g_18 = (-12); (g_18 < 20); g_18 = safe_add_func_int32_t_s_s(g_18, 1))
    { /* block id: 40 */
        uint32_t l_38 = 0x130DFDDA;
        int32_t *l_39 = (void*)0;
        int32_t **l_40 = &l_39;
        (*l_40) = ((((-1) != l_37) < l_38) , l_39);
    }
    return l_41;
}
