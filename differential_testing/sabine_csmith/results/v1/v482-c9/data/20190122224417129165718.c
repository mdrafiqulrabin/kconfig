...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_32 g_40 g_5
 * writes: g_32 g_5 g_40
 */
static uint32_t  func_30(void)
{ /* block id: 36 */
    int16_t *l_31 = &g_32;
    int32_t l_35 = 0xB43D2717;
    int32_t *l_37 = &g_5;
    int32_t *l_38 = (void*)0;
    int32_t *l_39 = &g_40;
    (*l_39) |= (0xA266D210 > ((0xD14C <= ((*l_31) ^= (g_3 != 0xA3DFAD5B))) || (g_3 > (safe_add_func_int16_t_s_s(l_35, (~((*l_37) = l_35)))))));
    (*l_39) &= 0xDAB551FA;
    return (*l_37);
}
