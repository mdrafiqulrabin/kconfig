...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_7 = 0x9DADA439;
static int16_t g_29 = 0x3FAA;
...
{ /* block id: 36 */
    int16_t l_25 = 0;
    int32_t l_26 = 0x2F80C341;
    l_26 = (l_25 & ((g_7 , g_7) != g_7));
    g_29 &= (safe_sub_func_int16_t_s_s(g_7, (l_25 <= 0xBC383C67)));
    return l_26;
}
