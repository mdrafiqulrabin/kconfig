...
static int32_t g_31 = 0x0CBEB969;
...
static int16_t  func_28(void)
{ /* block id: 36 */
    for (g_3 = 5; (g_3 >= 29); g_3 = safe_add_func_int32_t_s_s(g_3, 1))
    { /* block id: 39 */
        for (g_31 = 0; (g_31 != 24); g_31 = safe_add_func_int32_t_s_s(g_31, 3))
        { /* block id: 42 */
            const uint32_t l_38 = 0x81ECA6C8;
            int32_t l_39 = 0;
            int32_t *l_42 = &l_39;
            (*l_42) = (g_31 | func_34(l_38, g_31, l_39));
            if ((*l_42))
                continue;
        }
    }
