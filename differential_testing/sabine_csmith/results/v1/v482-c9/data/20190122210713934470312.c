...
static int32_t g_43 = 0x02DA3C3D;
static int32_t g_47 = 0xB15A8DF0;
static int32_t g_49 = 0;


/* --- FORWARD DECLARATIONS --- */
static int16_t  func_29(void);
static int16_t  func_32(const int32_t  p_33, int32_t  p_34, int32_t  p_35, int32_t  p_36);
...
{ /* block id: 36 */
    ...
    int32_t **l_51 = (void*)0;
    int32_t **l_52 = &l_46;
    (*l_48) &= (safe_rshift_func_uint16_t_u_u(g_8, (func_32((safe_rshift_func_uint16_t_u_u((((*l_46) &= ((l_39 , ((~(safe_mod_func_uint32_t_u_u(g_8, l_39))) && (g_43 = g_8))) < __builtin_parityll(g_8))) || ((void*)0 != &g_43)), g_8)), g_8, g_8, g_8) , g_47)));
    (*l_52) = (l_44 = ((*l_50) = &g_47));
    return g_8;
}
