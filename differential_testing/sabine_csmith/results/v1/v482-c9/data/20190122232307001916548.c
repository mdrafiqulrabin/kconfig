...
static int32_t g_37 = 0x193FE696;
...
{ /* block id: 36 */
    ...
    int32_t *l_36 = &g_37;
    int16_t l_38 = 1;
    (*l_36) |= (g_35 = (((g_7 | ((((safe_sub_func_uint32_t_u_u(((((*l_28) = (-1)) == l_30) , (safe_rshift_func_uint16_t_u_u(0x7FA3, (g_7 != (g_29 ^ (*l_28)))))), (((~(-1)) >= l_30) != 0))) > l_30) , (*l_28)) , 4294967291U)) != g_7) > l_34));
    return l_38;
}
