...
static uint32_t g_41 = 0xF9ED02E8;
...
{ /* block id: 36 */
    ...
    int32_t l_42 = 1;
    int32_t *l_43 = &g_44;
    (*l_43) |= (safe_lshift_func_int16_t_s_u((g_5 > ((~0) < (g_5 < (safe_add_func_uint16_t_u_u((((safe_sub_func_uint32_t_u_u((safe_sub_func_uint16_t_u_u((safe_rshift_func_int16_t_s_s(((!(((*l_40) = (0x0CAD > (-1))) == 0xEC0021FB)) , (0xBC00EADD == ((*l_40) = g_41))), 13)), (g_5 == l_42))), g_5)) != 0x57F039D3) <= 0x4B67), g_5))))), 14));
    return g_5;
}
