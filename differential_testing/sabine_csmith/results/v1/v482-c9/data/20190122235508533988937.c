...
/* --- GLOBAL VARIABLES --- */
static const int32_t g_6 = 0xB0B02971;
static int32_t g_27 = 0x42760385;
...
lbl_33:
        (*l_28) = (*l_26);
        (*l_28) &= g_27;
        for (g_29 = (-22); (g_29 == (-25)); g_29 = safe_sub_func_int16_t_s_s(g_29, 1))
        { /* block id: 46 */
            if (g_27)
                goto lbl_33;
            (*l_26) = g_29;
