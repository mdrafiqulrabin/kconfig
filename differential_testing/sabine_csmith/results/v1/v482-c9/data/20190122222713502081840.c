...
static int32_t g_38 = 0xB0639E6A;
static int32_t g_45 = 0x0BADCAB3;
static int16_t g_47 = 0x3899;
...
/* ------------------------------------------ */
/* 
 * reads : g_5 g_29 g_32 g_33 g_47
 * writes: g_29 g_38 g_45 g_47 g_32
 */
static uint32_t  func_26(void)
{ /* block id: 36 */
    int32_t *l_28 = &g_29;
...
/* ------------------------------------------ */
/* 
 * reads : g_5 g_32 g_33 g_47
 * writes: g_29 g_38 g_45 g_47
 */
static int32_t ** func_30(int32_t ** p_31)
{ /* block id: 38 */
    int32_t l_34 = 0xDFAD5BEF;
    uint32_t l_43 = 0x5123020F;
    int32_t *l_44 = &g_45;
    int16_t *l_46 = &g_47;
    l_34 = ((l_34 , (0x1912 < ((((*l_46) &= ((safe_lshift_func_uint16_t_u_u(((g_38 = ((**g_32) = ((g_5 & (safe_unary_minus_func_uint32_t_u(l_34))) > 0xD25BB086))) <= ((safe_unary_minus_func_uint32_t_u(((((safe_add_func_int32_t_s_s(((*l_44) = (l_43 ^= ((l_34 | ((~0x1355) == l_34)) != 0x601C))), l_34)) >= 6) <= l_34) & l_34))) == g_5)), g_5)) > 0xFBF3)) ^ g_5) ^ g_5))) >= l_34);
    return &g_33;
}
