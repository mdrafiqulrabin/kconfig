...
static int32_t g_36 = 0xC7104272;
...
static const uint32_t  func_27(void)
{ /* block id: 36 */
    int32_t l_34 = 0xF8B8AE50;
    int32_t *l_35 = &g_36;
    g_5 = (safe_lshift_func_int16_t_s_s((safe_mod_func_int32_t_s_s((safe_add_func_int32_t_s_s(l_34, g_5)), ((*l_35) = g_5))), 10));
    return (*l_35);
}
