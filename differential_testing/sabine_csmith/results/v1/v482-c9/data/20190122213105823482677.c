...
{ /* block id: 36 */
    ...
    int32_t l_40 = 1;
    (*l_30) = (void*)0;
    g_8 = ((((safe_lshift_func_uint16_t_u_s((((g_8 , (safe_unary_minus_func_int16_t_s(g_8))) & g_8) , (g_8 , ((g_8 & (((2 & (__builtin_ctz((safe_add_func_int16_t_s_s(g_8, (g_38 = (0xC7C4 != 0x9964))))) && g_38)) & l_39) < g_8)) >= g_8))), g_8)) | (-4)) ^ g_8) >= l_40);
    return g_8;
}
