...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_7 = 0x8B72FD49;
static int32_t g_32 = 0;
static int32_t g_39 = 0xB74A71A6;
...
{ /* block id: 36 */
    ...
    int32_t *l_38 = &g_39;
lbl_36:
    for (g_7 = (-22); (g_7 < 35); g_7 = safe_add_func_uint16_t_u_u(g_7, 1))
    { /* block id: 39 */
        for (g_32 = 0; (g_32 == (-11)); g_32 = safe_sub_func_uint32_t_u_u(g_32, 7))
        { /* block id: 42 */
            return g_7;
        }
    }
    ...
    if (g_7)
        goto lbl_36;
    (*l_38) ^= ((*l_35) > (((*l_35) || ((g_7 && (~(*l_35))) && __builtin_ctz((*l_35)))) & 0xE74A6E8F));
    return g_39;
}
