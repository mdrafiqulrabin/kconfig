...
{ /* block id: 36 */
    int16_t l_29 = 6;
    uint32_t l_34 = 1U;
    g_3 = ((safe_add_func_uint16_t_u_u(l_29, g_3)) != (((((__builtin_ffsl(l_29) || l_29) , ((l_29 ^ g_3) < ((safe_lshift_func_uint16_t_u_s((safe_rshift_func_uint16_t_u_u(65532U, 1)), g_3)) == l_34))) >= 0xD02268F6) <= 0xF118C84B) && g_3));
    return g_3;
}
