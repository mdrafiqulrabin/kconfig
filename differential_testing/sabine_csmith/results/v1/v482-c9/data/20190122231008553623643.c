...
static int32_t g_32 = 0xC5336DE0;
static uint32_t g_33 = 0x80FC3A06;
...
static uint16_t  func_27(void)
{ /* block id: 36 */
    uint32_t l_30 = 0x4C8F0D07;
    int32_t *l_31 = &g_32;
lbl_34:
    g_33 |= ((*l_31) |= (safe_rshift_func_uint16_t_u_u(l_30, 4)));
    (*l_31) ^= (0xAF5BFB66 <= g_33);
    if (g_32)
        goto lbl_34;
    return g_32;
}
