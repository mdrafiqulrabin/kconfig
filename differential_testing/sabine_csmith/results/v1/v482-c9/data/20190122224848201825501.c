...
static int32_t g_32 = 0xFF29ACD4;
static int32_t g_41 = 0x85755261;
...
{ /* block id: 36 */
    ...
    int32_t *l_40 = &g_41;
lbl_39:
    l_36 = (l_35 = func_29(l_31));
    for (g_3 = (-15); (g_3 >= 19); g_3 = safe_add_func_int16_t_s_s(g_3, 3))
    { /* block id: 44 */
        (*l_31) &= 0;
        if (g_3)
            goto lbl_39;
