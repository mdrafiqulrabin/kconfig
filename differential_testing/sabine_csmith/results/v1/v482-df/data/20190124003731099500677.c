...
/* --- GLOBAL VARIABLES --- */
static const uint16_t g_11 = 5UL;
static int8_t g_13[5] = {(-3L),(-3L),(-3L),(-3L),(-3L)};
...
{ /* block id: 0 */
    int8_t *l_12 = &g_13[1];
    int32_t l_16 = (-2L);
    (*g_18) &= func_2(((*l_12) &= (safe_lshift_func_uint16_t_u_u((((safe_rshift_func_int16_t_s_u((safe_sub_func_int8_t_s_s(0xCBL, 0xCEL)), 5)) , (g_11 & 65535UL)) , 0xAA0AL), 13))), (safe_mul_func_uint8_t_u_u((l_16 <= 0x6C38L), g_11)));
    return g_13[1];
}
