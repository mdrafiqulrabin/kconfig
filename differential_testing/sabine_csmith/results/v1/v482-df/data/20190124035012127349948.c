...
static const int32_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 == 4); g_2 = safe_add_func_int64_t_s_s(g_2, 1))
    { /* block id: 3 */
        int32_t l_9[3];
        int32_t *l_10 = (void*)0;
        int32_t *l_11 = (void*)0;
        ...
        for (i = 0; i < 3; i++)
            l_9[i] = 0xF3C34EEAL;
        g_12 = ((safe_rshift_func_uint8_t_u_u((safe_unary_minus_func_uint8_t_u(g_2)), 4)) & (~(l_9[0] || g_2)));
    }
    return g_12;
}
