...
static volatile struct S1 g_7 = {342,-4460,0xB1L,11102,-1255,504,11,168,5521};/* VOLATILE GLOBAL g_7 */
static volatile struct S1 *g_6 = &g_7;
static volatile struct S1 ** const  volatile g_8 = (void*)0;/* VOLATILE GLOBAL g_8 */
static volatile struct S1 ** volatile g_9 = &g_6;/* VOLATILE GLOBAL g_9 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_6 g_9 g_7.f4
 * writes: g_3 g_6
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[2][4] = {{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3}};
    int i, j;
    g_3 |= 0xA6C9CD49L;
    for (g_3 = 0; (g_3 > (-5)); --g_3)
    { /* block id: 4 */
