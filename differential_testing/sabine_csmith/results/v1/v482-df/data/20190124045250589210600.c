...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0xD37A5B7DL;
static int8_t g_6 = (-1L);
static int64_t g_7 = (-2L);
static uint64_t g_8 = 0x2466E9F08664A116LL;
static struct S0 g_13 = {65526UL,0x530CL,0xE2BF5F40L,0x13F5E3D1L,7UL,5L,0x77CCCAEAL,0xA9F4F9A0L};/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    int i;
    --g_8;
    for (g_6 = 0; (g_6 == 0); g_6 = safe_add_func_int32_t_s_s(g_6, 5))
    { /* block id: 4 */
        if (g_6)
            break;
    }
