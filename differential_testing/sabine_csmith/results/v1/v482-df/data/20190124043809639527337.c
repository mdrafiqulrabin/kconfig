...
/* --- GLOBAL VARIABLES --- */
static const volatile int8_t g_2 = 0L;/* VOLATILE GLOBAL g_2 */
static uint64_t g_3 = 2UL;
static int32_t g_7[8] = {(-4L),(-4L),(-4L),(-4L),(-4L),(-4L),(-4L),(-4L)};
static int32_t * volatile g_6 = &g_7[7];/* VOLATILE GLOBAL g_6 */
static struct S1 g_8 = {1L,-1L,-2L,0xD177CCE45D764CE3LL,0xAAFBEBF0A0CD95FFLL,0x9FACD4A7L,0x74L};/* VOLATILE GLOBAL g_8 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_3 g_6 g_8
 * writes: g_7
 */
static struct S1  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 4L;
    int16_t l_5[10] = {8L,1L,1L,8L,1L,1L,8L,1L,1L,8L};
    int i;
    (*g_6) = (((g_2 < g_3) >= l_4) , ((g_3 <= 0x3AC9L) == l_5[1]));
    return g_8;
}
