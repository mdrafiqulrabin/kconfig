...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[4] = {0x10E164CAL,0x10E164CAL,0x10E164CAL,0x10E164CAL};
static volatile int8_t g_10 = 0xE7L;/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    int32_t *l_8 = &g_3[3];
    int32_t *l_9[1];
    uint8_t l_11[4] = {0xEEL,0xEEL,0xEEL,0xEEL};
    int i;
    for (i = 0; i < 1; i++)
        l_9[i] = &g_3[1];
    l_11[0]--;
