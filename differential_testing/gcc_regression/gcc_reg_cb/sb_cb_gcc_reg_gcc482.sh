#!/bin/bash
#SBATCH -J sb_cb_gcc_reg_gcc482
#SBATCH -o sb_cb_gcc_reg_gcc482.o%j.txt
#SBATCH -t 12:01:01
#SBATCH -p alipour
...
function compile_tc {
    ...
    for ol in {0..3}; do
        out=$tc-$vn-$ol.out
        timeout $tout /project/alipour/rabin/bin/gcc482-bin/bin/gcc -c -O$ol -I /project/alipour/rabin/bin/csmith230-bin/include/csmith-2.3.0 -w -msse4.2 $tc -o $out 2> cb.txt
